...
const newCommands = [
    ...
    new ApiCommand('vscode.extensionPromptFileProvider', '_listExtensionPromptFiles', 'Get all extension-contributed prompt files (custom agents, instructions, and prompt files).', [], new ApiCommandResult('A promise that resolves to an array of objects containing uri and type.', (value) => {
        if (!value) {
            return [];
        }
