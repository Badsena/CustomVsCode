...
let MainThreadTunnelService = class MainThreadTunnelService extends Disposable {
    ...
    async elevationPrompt(tunnelOptions, tunnel, source) {
        return this.notificationService.prompt(Severity.Info, nls.localize(3413, null, source, tunnelOptions.remoteAddress.port, tunnelOptions.localAddressPort), [{
                label: nls.localize(3414, null, tunnel.tunnelRemotePort),
                run: async () => {
