    ...
    update(askToRelaunch) {
        ...
        if (askToRelaunch && changed && this.hostService.hasFocus) {
            this.doConfirm(isNative ?
                localize(13883, null) :
                localize(13884, null), isNative ?
                localize(13885, null, this.productService.nameLong) :
                localize(13886, null, this.productService.nameLong), isNative ?
                localize(13887, null) :
                localize(13888, null), () => this.hostService.restart());
        }
    }
    ...
    constructor(contextService, extensionService, hostService, environmentService) {
        ...
        this.extensionHostRestarter = this._register(new RunOnceScheduler(async () => {
            ...
            if (environmentService.remoteAuthority) {
                ...
                const stopped = await extensionService.stopExtensionHosts(localize(13889, null));
                if (stopped) {
