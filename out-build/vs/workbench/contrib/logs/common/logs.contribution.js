...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11942, "Set Default Log Level"),
            category: Categories.Developer,
        });
    }
...
let LogOutputChannels = class LogOutputChannels extends Disposable {
    ...
    registerLogChannel(logger) {
        ...
        const label = hasToAppendRemote ? nls.localize(11941, null, logger.name ?? logger.id) : logger.name ?? logger.id;
        ...
        this._register(registerAction2(class ShowWindowLogAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(11943, "Show Window Log"),
                    category: Categories.Developer,
                    f1: true
                });
            }
