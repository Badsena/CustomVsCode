    ...
    toggleStatusbarItem(active) {
        if (active) {
            if (!this.statusBarEntry.value) {
                const text = localize(14383, null);
                const tooltip = localize(14384, null);
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    id: 'workbench.action.toggleLockedScrolling',
                    title: {
                        ...localize2(14388, "Toggle Locked Scrolling Across Editors"),
                        mnemonicTitle: localize(14385, null),
                    },
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: {
                        ...localize2(14389, "Hold Locked Scrolling Across Editors"),
                        mnemonicTitle: localize(14387, null),
                    },
                    category: Categories.View,
                });
            }
