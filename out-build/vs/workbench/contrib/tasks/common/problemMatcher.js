...
export class ProblemPatternParser extends Parser {
    ...
    parse(value) {
        if (Config.NamedMultiLineCheckedProblemPattern.is(value)) {
            ...
            this.error(localize(15212, null));
            return null;
        }
    }
        ...
        for (let i = 0; i < values.length; i++) {
            ...
            if (i < values.length - 1) {
                if (!Types.isUndefined(pattern.loop) && pattern.loop) {
                    pattern.loop = false;
                    this.error(localize(15213, null));
                }
            }
            result.push(pattern);
        }
        if (!result || result.length === 0) {
            this.error(localize(15214, null));
            return null;
        }
    ...
    validateProblemPattern(values) {
        if (!values || values.length === 0) {
            this.error(localize(15215, null));
            return false;
        }
        ...
        values.forEach((pattern, i) => {
            if (i !== 0 && pattern.kind) {
                this.error(localize(15216, null));
            }
        ...
        if (!(file && message)) {
            this.error(localize(15217, null));
            return false;
        }
        if (locationKind === ProblemLocationKind.Location && !(location || line)) {
            this.error(localize(15218, null));
            return false;
        }
        return true;
    }
    createRegularExpression(value) {
        ...
        try {
            ...
            this.error(localize(15219, null, value));
        }
        return result;
    }
}
...
(function (Schemas) {
    Schemas.ProblemPattern = {
        ...
        properties: {
            regexp: {
                type: 'string',
                description: localize(15220, null)
            },
            kind: {
                type: 'string',
                description: localize(15221, null)
            },
            file: {
                type: 'integer',
                description: localize(15222, null)
            },
            location: {
                type: 'integer',
                description: localize(15223, null)
            },
            line: {
                type: 'integer',
                description: localize(15224, null)
            },
            column: {
                type: 'integer',
                description: localize(15225, null)
            },
            endLine: {
                type: 'integer',
                description: localize(15226, null)
            },
            endColumn: {
                type: 'integer',
                description: localize(15227, null)
            },
            severity: {
                type: 'integer',
                description: localize(15228, null)
            },
            code: {
                type: 'integer',
                description: localize(15229, null)
            },
            message: {
                type: 'integer',
                description: localize(15230, null)
            },
            loop: {
                type: 'boolean',
                description: localize(15231, null)
            }
        }
    };
    ...
    Schemas.NamedProblemPattern.properties['name'] = {
        type: 'string',
        description: localize(15232, null)
    };
    ...
    Schemas.NamedMultiLineProblemPattern = {
        ...
        properties: {
            name: {
                type: 'string',
                description: localize(15233, null)
            },
            patterns: {
                type: 'array',
                description: localize(15234, null),
                items: Schemas.ProblemPattern
            }
        }
    };
    Schemas.WatchingPattern = {
        ...
        properties: {
            regexp: {
                type: 'string',
                description: localize(15235, null)
            },
            file: {
                type: 'integer',
                description: localize(15236, null)
            },
        }
    };
    Schemas.PatternType = {
        anyOf: [
            {
                type: 'string',
                description: localize(15237, null)
            },
            Schemas.ProblemPattern,
            Schemas.MultiLineProblemPattern
        ],
        description: localize(15238, null)
    };
    Schemas.ProblemMatcher = {
        ...
        properties: {
            base: {
                type: 'string',
                description: localize(15239, null)
            },
            owner: {
                type: 'string',
                description: localize(15240, null)
            },
            source: {
                type: 'string',
                description: localize(15241, null)
            },
            severity: {
                type: 'string',
                enum: ['error', 'warning', 'info'],
                description: localize(15242, null)
            },
            applyTo: {
                type: 'string',
                enum: ['allDocuments', 'openDocuments', 'closedDocuments'],
                description: localize(15243, null)
            },
            ...
            fileLocation: {
                ...
                description: localize(15244, null)
            },
            background: {
                type: 'object',
                additionalProperties: false,
                description: localize(15245, null),
                properties: {
                    activeOnStart: {
                        type: 'boolean',
                        description: localize(15246, null)
                    },
                    beginsPattern: {
                        oneOf: [
                            {
                        ...
                        description: localize(15247, null)
                    },
                    endsPattern: {
                        oneOf: [
                            {
                        ...
                        description: localize(15248, null)
                    }
                }
            },
            watching: {
                type: 'object',
                additionalProperties: false,
                deprecationMessage: localize(15249, null),
                description: localize(15250, null),
                properties: {
                    activeOnStart: {
                        type: 'boolean',
                        description: localize(15251, null)
                    },
                    beginsPattern: {
                        oneOf: [
                            {
                        ...
                        description: localize(15252, null)
                    },
                    endsPattern: {
                        oneOf: [
                            {
                        ...
                        description: localize(15253, null)
                    }
                }
            }
        }
    ...
    Schemas.LegacyProblemMatcher.properties['watchedTaskBeginsRegExp'] = {
        type: 'string',
        deprecationMessage: localize(15254, null),
        description: localize(15255, null)
    };
    Schemas.LegacyProblemMatcher.properties['watchedTaskEndsRegExp'] = {
        type: 'string',
        deprecationMessage: localize(15256, null),
        description: localize(15257, null)
    };
                        ...
                        for (const pattern of problemPatterns) {
                            if (Config.NamedMultiLineCheckedProblemPattern.is(pattern)) {
                                ...
                                if (parser.problemReporter.status.state < 3 /* ValidationState.Error */) {
                                    ...
                                    extension.collector.error(localize(15261, null));
                                ...
                                if (parser.problemReporter.status.state < 3 /* ValidationState.Error */) {
                                    ...
                                    extension.collector.error(localize(15262, null));
                                    extension.collector.error(JSON.stringify(pattern, undefined, 4));
                                }
                            }
                            parser.reset();
...
export class ProblemMatcherParser extends Parser {
    ...
    checkProblemMatcherValid(externalProblemMatcher, problemMatcher) {
        if (!problemMatcher) {
            this.error(localize(15263, null, JSON.stringify(externalProblemMatcher, null, 4)));
            return false;
        }
        if (!problemMatcher.pattern) {
            this.error(localize(15264, null, JSON.stringify(externalProblemMatcher, null, 4)));
            return false;
        }
        if (!problemMatcher.owner) {
            this.error(localize(15265, null, JSON.stringify(externalProblemMatcher, null, 4)));
            return false;
        }
        if (Types.isUndefined(problemMatcher.fileLocation)) {
            this.error(localize(15266, null, JSON.stringify(externalProblemMatcher, null, 4)));
            return false;
        }
        return true;
    }
    createProblemMatcher(description) {
        ...
        if (severity === Severity.Ignore) {
            this.info(localize(15267, null, description.severity));
    ...
    createProblemPattern(value) {
        if (Types.isString(value)) {
            ...
            if (variableName.length > 1 && variableName[0] === '$') {
                ...
                if (!result) {
                    this.error(localize(15268, null, variableName));
                }
                return result;
            }
            else {
                if (variableName.length === 0) {
                    this.error(localize(15269, null));
                }
                else {
                    this.error(localize(15270, null, variableName));
                }
            }
        }
        else if (value) {
    ...
    addWatchingMatcher(external, internal) {
        ...
        if (begins || ends) {
            this.error(localize(15271, null));
        }
    }
    ...
    createRegularExpression(value) {
        ...
        try {
            ...
            this.error(localize(15272, null, value));
        }
        return result;
    }
}
const problemMatchersExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: localize(15273, null),
        type: 'array',
