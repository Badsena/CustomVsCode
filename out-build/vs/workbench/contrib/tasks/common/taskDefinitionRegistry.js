...
const taskDefinitionSchema = {
    ...
    properties: {
        type: {
            type: 'string',
            description: nls.localize(15298, null)
        },
        required: {
            type: 'array',
            items: {
        ...
        properties: {
            type: 'object',
            description: nls.localize(15299, null),
        ...
        when: {
            type: 'string',
            markdownDescription: nls.localize(15300, null),
            default: ''
        }
    }
};
...
(function (Configuration) {
    function from(value, extensionId, messageCollector) {
        ...
        if (!taskType || taskType.length === 0) {
            messageCollector.error(nls.localize(15301, null));
            return undefined;
        }
        const required = [];
...
const taskDefinitionsExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: nls.localize(15302, null),
        type: 'array',
