            ...
            allOf: [
                {
                    ...
                    properties: {
                        version: {
                            type: 'string',
                            enum: ['0.1.0'],
                            deprecationMessage: nls.localize(15073, null),
                            description: nls.localize(15074, null)
                        },
                        _runner: {
                            deprecationMessage: nls.localize(15075, null)
                        },
                        runner: {
                            type: 'string',
                            enum: ['process', 'terminal'],
                            default: 'process',
                            description: nls.localize(15076, null)
                        },
                        windows: {
                            $ref: '#/definitions/taskRunnerConfiguration',
                            description: nls.localize(15077, null)
                        },
                        osx: {
                            $ref: '#/definitions/taskRunnerConfiguration',
                            description: nls.localize(15078, null)
                        },
                        linux: {
                            $ref: '#/definitions/taskRunnerConfiguration',
                            description: nls.localize(15079, null)
                        }
                    }
                },
                {
...
const shellCommand = {
    type: 'boolean',
    default: true,
    description: nls.localize(15080, null)
};
