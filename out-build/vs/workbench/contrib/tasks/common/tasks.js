...
export const TASK_RUNNING_STATE = new RawContextKey('taskRunning', false, nls.localize(15303, null));
/** Whether the active terminal is a task terminal. */
export const TASK_TERMINAL_ACTIVE = new RawContextKey('taskTerminalActive', false, nls.localize(15304, null));
export const TASKS_CATEGORY = nls.localize2(15307, "Tasks");
                ...
                if (schema.default !== undefined) {
                    ...
                    switch (schema.type) {
                        ...
                        case 'string':
                            ...
                            break;
                        default:
                            reporter.error(nls.localize(15305, null, JSON.stringify(external, undefined, 0), property));
                            return undefined;
                    }
                }
            }
...
export const rerunTaskIcon = registerIcon('rerun-task', Codicon.refresh, nls.localize(15306, null));
