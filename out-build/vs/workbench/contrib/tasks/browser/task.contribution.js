...
let TaskStatusBarContributions = class TaskStatusBarContributions extends Disposable {
        ...
        this._register(this._taskService.onDidStateChange(event => {
            ...
            if (promise && (event.kind === TaskEventKind.Active) && (this._activeTasksCount === 1)) {
                this._progressService.withProgress({ location: 10 /* ProgressLocation.Window */, command: 'workbench.action.tasks.showTasks' }, progress => {
                    progress.report({ message: nls.localize(14978, null) });
                    return promise;
                }).then(() => {
                    promise = undefined;
                });
    ...
    async _updateRunningTasksStatus() {
        ...
        if (tasks.length === 0) {
            ...
            const itemProps = {
                name: nls.localize(14979, null),
                text: `$(tools) ${tasks.length}`,
                ariaLabel: nls.localize(14980, null, tasks.length),
                tooltip: nls.localize(14981, null),
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        ...
        title: nls.localize2(15014, "Open Workspace Tasks"),
        category: TASKS_CATEGORY
    },
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        ...
        title: nls.localize2(15015, "Show Task Log"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        id: 'workbench.action.tasks.runTask',
        title: nls.localize2(15016, "Run Task"),
        category: TASKS_CATEGORY
    }
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        ...
        title: nls.localize2(15017, "Rerun Last Task"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        id: 'workbench.action.tasks.restartTask',
        title: nls.localize2(15018, "Restart Running Task"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        ...
        title: nls.localize2(15019, "Rerun All Running Tasks"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        id: 'workbench.action.tasks.showTasks',
        title: nls.localize2(15020, "Show Running Tasks"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        id: 'workbench.action.tasks.terminate',
        title: nls.localize2(15021, "Terminate Task"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        id: 'workbench.action.tasks.build',
        title: nls.localize2(15022, "Run Build Task"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        ...
        title: nls.localize2(15023, "Run Test Task"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        id: 'workbench.action.tasks.configureDefaultBuildTask',
        title: nls.localize2(15024, "Configure Default Build Task"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        ...
        title: nls.localize2(15025, "Configure Default Test Task"),
        category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        ...
        title: nls.localize2(15026, "Open User Tasks"), category: TASKS_CATEGORY
    },
    when: TaskExecutionSupportedContext
});
class UserTasksGlobalActionContribution extends Disposable {
    ...
    registerActions() {
        ...
        const title = nls.localize(14989, null);
...
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: nls.localize(14990, null),
    helpEntries: [{ description: nls.localize(14991, null), commandCenterOrder: 60 }]
});
...
configurationRegistry.registerConfiguration({
    id: 'task',
    order: 100,
    title: nls.localize(14992, null),
    type: 'object',
    properties: {
        ["task.problemMatchers.neverPrompt" /* TaskSettingId.ProblemMatchersNeverPrompt */]: {
            markdownDescription: nls.localize(14993, null),
            'oneOf': [
                {
                    type: 'boolean',
                    markdownDescription: nls.localize(14994, null)
                },
                {
                    type: 'object',
                    patternProperties: {
                    ...
                    markdownDescription: nls.localize(14995, null),
                    default: {
                        'shell': true
                    }
                }
        ...
        ["task.autoDetect" /* TaskSettingId.AutoDetect */]: {
            markdownDescription: nls.localize(14996, null),
            type: 'string',
            enum: ['on', 'off'],
            default: 'on'
        },
        ["task.slowProviderWarning" /* TaskSettingId.SlowProviderWarning */]: {
            markdownDescription: nls.localize(14997, null),
            'oneOf': [
                {
                    type: 'boolean',
                    markdownDescription: nls.localize(14998, null)
                },
                {
                    type: 'array',
                    items: {
                        type: 'string',
                        markdownDescription: nls.localize(14999, null)
                    }
                }
            ],
            default: true
        ...
        ["task.allowAutomaticTasks" /* TaskSettingId.AllowAutomaticTasks */]: {
            ...
            enum: ['on', 'off'],
            enumDescriptions: [
                nls.localize(15004, null),
                nls.localize(15005, null),
            ],
            description: nls.localize(15006, null),
            default: 'off',
        ...
        ["task.reconnection" /* TaskSettingId.Reconnection */]: {
            type: 'boolean',
            description: nls.localize(15007, null),
            default: true
        },
        ["task.saveBeforeRun" /* TaskSettingId.SaveBeforeRun */]: {
            markdownDescription: nls.localize(15008, null),
            type: 'string',
            enum: ['always', 'never', 'prompt'],
            enumDescriptions: [
                nls.localize(15009, null),
                nls.localize(15010, null),
                nls.localize(15011, null),
            ],
            default: 'always',
        },
        ["task.notifyWindowOnTaskCompletion" /* TaskSettingId.NotifyWindowOnTaskCompletion */]: {
            type: 'integer',
            markdownDescription: nls.localize(15012, null),
            default: 60000,
            minimum: -1
        },
        ["task.verboseLogging" /* TaskSettingId.VerboseLogging */]: {
            type: 'boolean',
            description: nls.localize(15013, null),
            default: false
        },
    }
});
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            icon: rerunTaskIcon,
            title: nls.localize2(15027, 'Rerun Task'),
