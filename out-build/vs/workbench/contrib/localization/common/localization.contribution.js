...
export class BaseLocalizationWorkbenchContribution extends Disposable {
    constructor() {
        ...
        ExtensionsRegistry.registerExtensionPoint({
            ...
            jsonSchema: {
                description: localize(11915, null),
                type: 'array',
                default: [],
                items: {
                    type: 'object',
                    ...
                    properties: {
                        languageId: {
                            description: localize(11916, null),
                            type: 'string'
                        },
                        languageName: {
                            description: localize(11917, null),
                            type: 'string'
                        },
                        localizedLanguageName: {
                            description: localize(11918, null),
                            type: 'string'
                        },
                        translations: {
                            description: localize(11919, null),
                            type: 'array',
                            ...
                            items: {
                                ...
                                properties: {
                                    id: {
                                        type: 'string',
                                        description: localize(11920, null),
                                        pattern: '^((vscode)|([a-z0-9A-Z][a-z0-9A-Z-]*)\\.([a-z0-9A-Z][a-z0-9A-Z-]*))$',
                                        patternErrorMessage: localize(11921, null)
                                    },
                                    path: {
                                        type: 'string',
                                        description: localize(11922, null)
                                    }
                                },
