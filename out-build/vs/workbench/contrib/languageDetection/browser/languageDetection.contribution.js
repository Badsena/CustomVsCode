    ...
    async _doUpdate() {
        ...
        if (disableLightbulb || !editorUri) {
            ...
            if (lang && lang !== existing && skip[existing] !== lang) {
                ...
                const tooltip = this._keybindingService.appendKeybinding(localize(11848, null, detectedName), detectLanguageCommandId);
                const props = {
                    name: localize(11849, null),
                    ariaLabel: localize(11850, null, lang),
                    tooltip,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(11852, "Detect Language from Content"),
            f1: true,
    ...
    async run(accessor) {
        ...
        if (editorUri) {
            ...
            if (lang) {
                ...
                notificationService.warn(localize(11851, null));
            }
        }
    }
});
