...
const TOGGLE_INLINE_COMMAND_TEXT = localize(16356, null);
const TOGGLE_INLINE_COMMAND_ID = 'testing.toggleInlineCoverage';
const BRANCH_MISS_INDICATOR_CHARS = 4;
const GO_TO_NEXT_MISSED_LINE_TITLE = localize2(16370, "Go to Next Uncovered Line");
const GO_TO_PREVIOUS_MISSED_LINE_TITLE = localize2(16371, "Go to Previous Uncovered Line");
    ...
    describe(detail, model) {
        if (detail.type === 0 /* DetailType.Declaration */) {
            ...
            if (detail.branches?.length) {
                ...
                return new MarkdownString().appendMarkdown(localize(16357, null, covered, detail.branches.length, text));
            }
            else {
            ...
            if (!count) {
                return new MarkdownString().appendMarkdown(localize(16358, null, label2, text));
            }
            else if (count === true) {
                return new MarkdownString().appendMarkdown(localize(16359, null, label2, text));
            }
            else {
                return new MarkdownString().appendMarkdown(localize(16360, null, label2, text, count));
            }
        }
        assertNever(detail);
    }
...
function namedDetailLabel(name, detail) {
    return new MarkdownString().appendMarkdown(!detail.count // 0 or false
        ? localize(16361, null, name)
        : typeof detail.count === 'number'
            ? localize(16362, null, name, detail.count)
            : localize(16363, null, name));
}
...
let CoverageToolbarWidget = class CoverageToolbarWidget extends Disposable {
    ...
    setActions() {
        ...
        const toggleAction = new ActionWithIcon('toggleInline', this.coverage.showInline.get()
            ? localize(16364, null)
            : localize(16365, null), testingCoverageReport, undefined, () => this.coverage.showInline.set(!this.coverage.showInline.get(), undefined));
        ...
        if (current.testId) {
            ...
            this.actionBar.push(new ActionWithIcon('perTestFilter', localize(16366, null, current.coverage.perTestData.size), testingFilterIcon, undefined, () => this.commandService.executeCommand("testing.coverageFilterToTestInEditor" /* TestCommandId.CoverageFilterToTestInEditor */, this.current, this.editor)));
        }
        this.actionBar.push(new ActionWithIcon('rerun', localize(16367, null), testingRerunIcon, !this.isRunning, () => this.rerunTest()));
    }
    show() {
        if (this.registered) {
            return;
...
registerAction2(class ToggleInlineCoverage extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16372, "Toggle Inline Coverage"),
...
registerAction2(class ToggleCoverageToolbar extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16373, "Show Test Coverage Toolbar"),
            metadata: {
                description: localize2(16374, 'Toggle the sticky coverage bar in the editor.')
            },
            category: Categories.Test,
            toggled: {
...
registerAction2(class FilterCoverageToTestInEditor extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16375, "Filter Coverage to Test"),
            category: Categories.Test,
            icon: Codicon.filter,
            toggled: {
...
registerAction2(class ToggleCoverageInExplorer extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16376, "Toggle Coverage in Explorer"),
            metadata: {
                description: localize2(16377, 'Toggle the display of test coverage in the File Explorer view.')
            },
            category: Categories.Test,
            toggled: {
                condition: ContextKeyExpr.equals('config.testing.showCoverageInExplorer', true),
                title: localize(16369, null),
            },
            menu: [
                { id: MenuId.CommandPalette, when: TestingContextKeys.isTestCoverageOpen },
            ]
...
registerAction2(class GoToNextMissedCoverageLine extends Action2 {
    constructor() {
        super({
            ...
            metadata: {
                description: localize2(16378, 'Navigate to the next line that is not covered by tests.')
            },
            category: Categories.Test,
...
registerAction2(class GoToPreviousMissedCoverageLine extends Action2 {
    constructor() {
        super({
            ...
            metadata: {
                description: localize2(16379, 'Navigate to the previous line that is not covered by tests.')
            },
            category: Categories.Test,
