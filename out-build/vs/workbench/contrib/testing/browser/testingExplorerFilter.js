...
const testFilterDescriptions = {
    ["@failed" /* TestFilterTerm.Failed */]: localize(16533, null),
    ["@executed" /* TestFilterTerm.Executed */]: localize(16534, null),
    ["@doc" /* TestFilterTerm.CurrentDoc */]: localize(16535, null),
    ["@openedFiles" /* TestFilterTerm.OpenedFiles */]: localize(16536, null),
    ["@hidden" /* TestFilterTerm.Hidden */]: localize(16537, null),
};
let TestingExplorerFilter = class TestingExplorerFilter extends BaseActionViewItem {
    constructor(action, options, state, instantiationService, testService) {
        ...
        this.filtersAction = new Action('markersFiltersAction', localize(16538, null), 'testing-filter-button ' + ThemeIcon.asClassName(testingFilterIcon));
    ...
    render(container) {
        ...
        const input = this.input = this._register(this.instantiationService.createInstance(ContextScopedSuggestEnabledInputWithHistory, {
            ...
            suggestOptions: {
                ...
                placeholderText: localize(16540, null),
            },
