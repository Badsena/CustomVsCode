    ...
    openCurrentInEditor() {
        ...
        if (current.isDiffable) {
            ...
            this.commandService.executeCommand('markdown.showPreview', current.messageUri).catch(err => {
                this.notificationService.error(localize(16559, null, err.message));
            });
        }
    }
    getActiveControl() {
...
let TestResultsPeek = class TestResultsPeek extends PeekViewWidget {
    ...
    async showInPlace(subject) {
        if (subject instanceof MessageSubject) {
            ...
            this.setTitle(localize(16560, null));
        }
        this.applyTheme();
...
export class GoToNextMessageAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            f1: true,
            title: localize2(16562, 'Go to Next Test Failure'),
            metadata: {
                description: localize2(16563, 'Shows the next failure message in your file')
            },
...
export class GoToPreviousMessageAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            f1: true,
            title: localize2(16564, 'Go to Previous Test Failure'),
            metadata: {
                description: localize2(16565, 'Shows the previous failure message in your file')
            },
...
export class CollapsePeekStack extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(16566, 'Collapse Stack Frames'),
...
export class OpenMessageInEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            f1: false,
            title: localize2(16567, 'Open in Editor'),
...
export class ToggleTestingPeekHistory extends Action2 {
    ...
    constructor() {
        super({
            ...
            f1: true,
            title: localize2(16568, 'Toggle Test History in Peek'),
            metadata: {
                description: localize2(16569, 'Shows or hides the history of test runs in the peek view')
            },
