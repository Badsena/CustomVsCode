...
export var labels;
(function (labels) {
    labels.showingFilterFor = (label) => localize(16380, null, label);
    labels.clickToChangeFiltering = localize(16381, null);
    labels.percentCoverage = (percent, precision) => localize(16382, null, displayPercent(percent, precision));
    labels.allTests = localize(16383, null);
    labels.pickShowCoverage = localize(16384, null);
})(labels || (labels = {}));
