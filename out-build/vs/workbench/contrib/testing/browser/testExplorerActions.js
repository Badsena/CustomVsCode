...
const LABEL_RUN_TESTS = localize2(16448, "Run Tests");
const LABEL_DEBUG_TESTS = localize2(16449, "Debug Tests");
const LABEL_COVERAGE_TESTS = localize2(16450, "Run Tests with Coverage");
export class HideTestAction extends Action2 {
    constructor() {
        super({
            id: "testing.hideTest" /* TestCommandId.HideTestAction */,
            title: localize2(16451, 'Hide Test'),
            menu: {
                id: MenuId.TestItem,
                group: 'builtin@2',
...
export class UnhideTestAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16452, 'Unhide Test'),
            menu: {
                id: MenuId.TestItem,
...
export class UnhideAllTestsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16453, 'Unhide All Tests'),
        });
    }
    run(accessor) {
        const service = accessor.get(ITestService);
...
export class DebugAction extends RunVisibleAction {
    constructor() {
        super(4 /* TestRunProfileBitset.Debug */, {
            ...
            title: localize2(16454, 'Debug Test'),
...
export class CoverageAction extends RunVisibleAction {
    constructor() {
        super(8 /* TestRunProfileBitset.Coverage */, {
            ...
            title: localize2(16455, 'Run Test with Coverage'),
...
export class RunUsingProfileAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16456, 'Execute Using Profile...'),
            icon: icons.testingDebugIcon,
            menu: {
                id: MenuId.TestItem,
...
export class RunAction extends RunVisibleAction {
    constructor() {
        super(2 /* TestRunProfileBitset.Run */, {
            ...
            title: localize2(16457, 'Run Test'),
...
export class SelectDefaultTestProfiles extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16458, 'Select Default Profile'),
...
export class ContinuousRunTestAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16459, 'Turn on Continuous Run'),
...
export class ContinuousRunUsingProfileTestAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16460, 'Start Continous Run Using...'),
            icon: icons.testingDebugIcon,
            menu: [
                {
                    id: MenuId.TestItem,
...
export class ConfigureTestProfilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16461, "Configure Test Profiles"),
            icon: icons.testingUpdateProfiles,
            f1: true,
            category,
            menu: {
    ...
    async run(acessor, onlyGroup) {
        ...
        const profile = await commands.executeCommand('vscode.pickTestProfile', {
            placeholder: localize(16433, null),
            showConfigureButtons: false,
...
class StopContinuousRunAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16462, 'Stop Continuous Run'),
            category,
...
function selectContinuousRunProfiles(crs, notificationService, quickInputService, profilesToPickFrom) {
    ...
    if (items.length === 0) {
        notificationService.info(localize(16434, null));
        return Promise.resolve([]);
    }
    ...
    quickpick.title = localize(16435, null);
...
class StartContinuousRunAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16463, "Start Continuous Run"),
            category,
            icon: icons.testingTurnContinuousRunOn,
...
export class GetSelectedProfiles extends Action2 {
    constructor() {
        super({ id: "testing.getSelectedProfiles" /* TestCommandId.GetSelectedProfiles */, title: localize2(16464, 'Get Selected Profiles') });
    }
    /**
     * @override
     */
...
export class GetExplorerSelection extends ViewAction {
    constructor() {
        super({ id: "_testing.getExplorerSelection" /* TestCommandId.GetExplorerSelection */, title: localize2(16465, 'Get Explorer Selection'), viewId: "workbench.view.testing" /* Testing.ExplorerViewId */ });
    }
    /**
     * @override
     */
...
export class RunAllAction extends RunOrDebugAllTestsAction {
    constructor() {
        super({
            ...
            title: localize2(16466, 'Run All Tests'),
            icon: icons.testingRunAllIcon,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 85 /* KeyCode.Semicolon */, 31 /* KeyCode.KeyA */),
            },
        }, 2 /* TestRunProfileBitset.Run */, localize(16437, null));
    }
}
...
export class CancelTestRunAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16469, 'Cancel Test Run'),
...
export class TestingViewAsListAction extends ViewAction {
    constructor() {
        super({
            ...
            viewId: "workbench.view.testing" /* Testing.ExplorerViewId */,
            title: localize2(16470, 'View as List'),
...
export class TestingViewAsTreeAction extends ViewAction {
    constructor() {
        super({
            ...
            viewId: "workbench.view.testing" /* Testing.ExplorerViewId */,
            title: localize2(16471, 'View as Tree'),
...
export class TestingSortByStatusAction extends ViewAction {
    constructor() {
        super({
            ...
            viewId: "workbench.view.testing" /* Testing.ExplorerViewId */,
            title: localize2(16472, 'Sort by Status'),
...
export class TestingSortByLocationAction extends ViewAction {
    constructor() {
        super({
            ...
            viewId: "workbench.view.testing" /* Testing.ExplorerViewId */,
            title: localize2(16473, 'Sort by Location'),
...
export class TestingSortByDurationAction extends ViewAction {
    constructor() {
        super({
            ...
            viewId: "workbench.view.testing" /* Testing.ExplorerViewId */,
            title: localize2(16474, 'Sort by Duration'),
...
export class ShowMostRecentOutputAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16475, 'Show Output'),
            category,
...
export class CollapseAllAction extends ViewAction {
    constructor() {
        super({
            ...
            viewId: "workbench.view.testing" /* Testing.ExplorerViewId */,
            title: localize2(16476, 'Collapse All Tests'),
...
export class ClearTestResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16477, 'Clear All Results'),
            category,
...
export class GoToTest extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16478, 'Go to Test'),
...
class ExecuteTestAtCursor extends Action2 {
    ...
    async run(accessor) {
        ...
        if (editor) {
            MessageController.get(editor)?.showMessage(localize(16440, null), position);
        }
    }
}
export class RunAtCursor extends ExecuteTestAtCursor {
    constructor() {
        super({
            ...
            title: localize2(16479, 'Run Test at Cursor'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class DebugAtCursor extends ExecuteTestAtCursor {
    constructor() {
        super({
            ...
            title: localize2(16480, 'Debug Test at Cursor'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                when: EditorContextKeys.editorTextFocus,
...
export class CoverageAtCursor extends ExecuteTestAtCursor {
    constructor() {
        super({
            ...
            title: localize2(16481, 'Run Test at Cursor with Coverage'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                when: EditorContextKeys.editorTextFocus,
...
class ExecuteTestsUnderUriAction extends Action2 {
    ...
    async run(accessor, uri) {
        ...
        if (!tests.length) {
            notificationService.notify({ message: localize(16441, null), severity: Severity.Info });
            return;
        }
...
class ExecuteTestsInCurrentFile extends Action2 {
    ...
    run(accessor, files) {
        ...
        if (editor) {
            MessageController.get(editor)?.showMessage(localize(16442, null), position);
        }
        return undefined;
    }
}
export class RunCurrentFile extends ExecuteTestsInCurrentFile {
    constructor() {
        super({
            ...
            title: localize2(16482, 'Run Tests in Current File'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                when: EditorContextKeys.editorTextFocus,
...
export class DebugCurrentFile extends ExecuteTestsInCurrentFile {
    constructor() {
        super({
            ...
            title: localize2(16483, 'Debug Tests in Current File'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                when: EditorContextKeys.editorTextFocus,
...
export class CoverageCurrentFile extends ExecuteTestsInCurrentFile {
    constructor() {
        super({
            ...
            title: localize2(16484, 'Run Tests with Coverage in Current File'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                when: EditorContextKeys.editorTextFocus,
...
export class ReRunFailedTests extends RunOrDebugFailedTests {
    constructor() {
        super({
            ...
            title: localize2(16485, 'Rerun Failed Tests'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class DebugFailedTests extends RunOrDebugFailedTests {
    constructor() {
        super({
            ...
            title: localize2(16486, 'Debug Failed Tests'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class ReRunLastRun extends RunOrDebugLastRun {
    constructor() {
        super({
            ...
            title: localize2(16487, 'Rerun Last Run'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class DebugLastRun extends RunOrDebugLastRun {
    constructor() {
        super({
            ...
            title: localize2(16488, 'Debug Last Run'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class CoverageLastRun extends RunOrDebugLastRun {
    constructor() {
        super({
            ...
            title: localize2(16489, 'Rerun Last Run with Coverage'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class ReRunFailedFromLastRun extends RunOrDebugFailedFromLastRun {
    constructor() {
        super({
            ...
            title: localize2(16490, 'Rerun Failed Tests from Last Run'),
            category,
        });
    }
    getGroup() {
...
export class DebugFailedFromLastRun extends RunOrDebugFailedFromLastRun {
    constructor() {
        super({
            ...
            title: localize2(16491, 'Debug Failed Tests from Last Run'),
            category,
        });
    }
    getGroup() {
...
export class SearchForTestExtension extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16492, 'Search for Test Extension'),
        });
    }
    async run(accessor) {
...
export class OpenOutputPeek extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16493, 'Peek Output'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class ToggleInlineTestOutput extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16494, 'Toggle Inline Test Output'),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class RefreshTestsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16495, 'Refresh Tests'),
            category,
...
export class CancelTestRefreshAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16496, 'Cancel Test Refresh'),
            category,
...
export class CleareCoverage extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16497, 'Clear Coverage'),
            icon: widgetClose,
            category,
            menu: [{
                    id: MenuId.ViewTitle,
...
export class OpenCoverage extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16498, 'Open Coverage'),
            category,
            menu: [{
                    id: MenuId.CommandPalette,
                    when: TestingContextKeys.hasAnyResults.isEqualTo(true),
    ...
    run(accessor) {
        ...
        if (!task) {
            const notificationService = accessor.get(INotificationService);
            notificationService.info(localize(16443, null));
            return;
        }
...
class GoToRelatedTestAction extends TestNavigationAction {
    async _getLocationModel(_languageFeaturesService, model, position, token) {
        ...
        return new ReferencesModel(tests.map(t => t.item.uri && ({ uri: t.item.uri, range: t.item.range || new Range(1, 1, 1, 1) })).filter(isDefined), localize(16444, null));
    }
    _getNoResultFoundMessage() {
        return localize(16445, null);
    }
}
class GoToRelatedTest extends GoToRelatedTestAction {
    constructor() {
        super({
            ...
            title: localize2(16499, 'Go to Related Test'),
            category,
...
class PeekRelatedTest extends GoToRelatedTestAction {
    constructor() {
        super({
            ...
            title: localize2(16500, 'Peek Related Test'),
            category,
...
class GoToRelatedCodeAction extends TestNavigationAction {
    async _getLocationModel(_languageFeaturesService, model, position, token) {
        ...
        return new ReferencesModel(code.flat(), localize(16446, null));
    }
    _getNoResultFoundMessage() {
        return localize(16447, null);
    }
}
class GoToRelatedCode extends GoToRelatedCodeAction {
    constructor() {
        super({
            ...
            title: localize2(16501, 'Go to Related Code'),
            category,
...
class PeekRelatedCode extends GoToRelatedCodeAction {
    constructor() {
        super({
            ...
            title: localize2(16502, 'Peek Related Code'),
            category,
...
export class ToggleResultsViewLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16503, 'Toggle Tree Position'),
            category,
