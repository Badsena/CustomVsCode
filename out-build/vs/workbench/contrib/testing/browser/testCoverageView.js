...
class RevealUncoveredDeclarations {
    get label() {
        return localize(16417, null, this.n);
    }
    constructor(n) {
        this.n = n;
        this.id = String(fnNodeId++);
...
class CurrentlyFilteredTo {
    get label() {
        return localize(16418, null, this.testItem.label);
    }
...
class LoadingDetails {
    constructor() {
        this.id = String(fnNodeId++);
        this.label = localize(16419, null);
    }
}
            ...
            accessibilityProvider: {
                getAriaLabel(element) {
                    if (isFileCoverage(element)) {
                        ...
                        return localize(16420, null, name, (element.value.tpc * 100).toFixed(2));
                    }
                    else {
...
registerAction2(class TestCoverageChangePerTestFilterAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(16429, 'Filter Coverage by Test'),
            icon: Codicon.filter,
            toggled: {
...
registerAction2(class TestCoverageChangeSortingAction extends ViewAction {
    constructor() {
        super({
            ...
            title: localize2(16430, 'Change Sort Order'),
    ...
    runInView(accessor, view) {
        ...
        const items = [
            { label: localize(16422, null), value: 1 /* CoverageSortOrder.Location */, description: localize(16423, null) },
            { label: localize(16424, null), value: 0 /* CoverageSortOrder.Coverage */, description: localize(16425, null) },
            { label: localize(16426, null), value: 2 /* CoverageSortOrder.Name */, description: localize(16427, null) },
        ];
        quickInput.placeholder = localize(16428, null);
...
registerAction2(class TestCoverageCollapseAllAction extends ViewAction {
    constructor() {
        super({
            ...
            viewId: "workbench.view.testCoverage" /* Testing.CoverageViewId */,
            title: localize2(16431, 'Collapse All Coverage'),
