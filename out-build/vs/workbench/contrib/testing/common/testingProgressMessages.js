...
export const getTestProgressText = ({ isRunning, passed, runSoFar, totalWillBeRun, skipped, failed }) => {
    ...
    if (isRunning) {
        if (runSoFar === 0) {
            return localize(16726, null);
        }
        else if (skipped === 0) {
            return localize(16727, null, passed, totalWillBeRun, percent.toPrecision(3));
        }
        else {
            return localize(16728, null, passed, totalWillBeRun, percent.toPrecision(3), skipped);
        }
    }
    else {
        if (skipped === 0) {
            return localize(16729, null, passed, runSoFar, percent.toPrecision(3));
        }
        else {
            return localize(16730, null, passed, runSoFar, percent.toPrecision(3), skipped);
        }
    }
};
