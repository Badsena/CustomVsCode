...
const testStateNames = {
    [6 /* TestResultState.Errored */]: localize(16671, null),
    [4 /* TestResultState.Failed */]: localize(16672, null),
    [3 /* TestResultState.Passed */]: localize(16673, null),
    [1 /* TestResultState.Queued */]: localize(16674, null),
    [2 /* TestResultState.Running */]: localize(16675, null),
    [5 /* TestResultState.Skipped */]: localize(16676, null),
    [0 /* TestResultState.Unset */]: localize(16677, null),
};
export const labelForTestInState = (label, state) => localize(16678, null, stripIcons(label), testStateNames[state]);



export const testConfigurationGroupNames = {
    [4 /* TestRunProfileBitset.Debug */]: localize(16679, null),
    [2 /* TestRunProfileBitset.Run */]: localize(16680, null),
    [8 /* TestRunProfileBitset.Coverage */]: localize(16681, null),
};
