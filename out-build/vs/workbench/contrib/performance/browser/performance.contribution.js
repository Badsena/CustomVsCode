...
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: 'perfview.show',
            title: localize2(13429, 'Startup Performance'),
...
registerAction2(class PrintServiceCycles extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13430, 'Print Service Cycles'),
            category: Categories.Developer,
            f1: true
        });
    }
...
registerAction2(class PrintServiceTraces extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13431, 'Print Service Traces'),
            category: Categories.Developer,
            f1: true
        });
    }
...
registerAction2(class PrintEventProfiling extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13432, 'Print Emitter Profiles'),
            category: Categories.Developer,
            f1: true
        });
    }
