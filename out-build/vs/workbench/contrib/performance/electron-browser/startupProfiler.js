    ...
    _stopProfiling() {
        ...
        markerFile.then(() => {
            ...
            return this._dialogService.confirm({
                type: 'info',
                message: localize(13435, null),
                detail: localize(13436, null, profileFiles),
                primaryButton: localize(13437, null),
                cancelButton: localize(13438, null)
            }).then(res => {
                if (res.confirmed) {
                    Promise.all([
                        ...
                        return this._dialogService.confirm({
                            type: 'info',
                            message: localize(13439, null),
                            detail: localize(13440, null, this._productService.nameLong),
                            primaryButton: localize(13441, null)
                        }).then(res => {
