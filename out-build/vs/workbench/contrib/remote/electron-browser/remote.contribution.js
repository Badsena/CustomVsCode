...
let WSLContextKeyInitializer = class WSLContextKeyInitializer extends Disposable {
    ...
    constructor(contextKeyService, nativeHostService, storageService, lifecycleService) {
        ...
        const hasWSLFeatureContext = new RawContextKey(contextKeyId, !!defaultValue, nls.localize(14086, null));
...
Registry.as(ConfigurationExtensions.Configuration)
    ...
    id: 'remote',
    title: nls.localize(14087, null),
    type: 'object',
    properties: {
        'remote.downloadExtensionsLocally': {
            type: 'boolean',
            markdownDescription: nls.localize(14088, null),
            default: false
        },
    }
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize(14089, null),
            category: localize(14090, null),
            menu: [{
