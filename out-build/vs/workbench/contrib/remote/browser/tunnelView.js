...
class PortColumn {
    constructor() {
        this.label = nls.localize(13980, null);
        this.tooltip = nls.localize(13981, null);
        this.weight = 1;
        this.templateId = 'actionbar';
    }
    project(row) {
...
class LocalAddressColumn {
    constructor() {
        this.label = nls.localize(13982, null);
        this.tooltip = nls.localize(13983, null);
        this.weight = 1;
        this.templateId = 'actionbar';
    }
    project(row) {
    ...
    static getHoverText(localAddress) {
        return function (configurationService) {
            ...
            if (editorConf.multiCursorModifier === 'ctrlCmd') {
                if (isMacintosh) {
                    clickLabel = nls.localize(13984, null);
                }
                else {
                    clickLabel = nls.localize(13985, null);
                }
            }
            else {
                if (isMacintosh) {
                    clickLabel = nls.localize(13986, null);
                }
                else {
                    clickLabel = nls.localize(13987, null);
                }
            }
...
class RunningProcessColumn {
    constructor() {
        this.label = nls.localize(13988, null);
        this.tooltip = nls.localize(13989, null);
        this.weight = 2;
        this.templateId = 'actionbar';
    }
    project(row) {
...
class OriginColumn {
    constructor() {
        this.label = nls.localize(13990, null);
        this.tooltip = nls.localize(13991, null);
        this.weight = 1;
        this.templateId = 'actionbar';
    }
    project(row) {
...
class PrivacyColumn {
    constructor() {
        this.label = nls.localize(13992, null);
        this.tooltip = nls.localize(13993, null);
        this.weight = 1;
        this.templateId = 'actionbar';
    }
    project(row) {
...
let ActionBarRenderer = class ActionBarRenderer {
    ...
    renderInputBox(templateData, editableData) {
        ...
        const inputBox = new InputBox(container, this.contextViewService, {
            ariaLabel: nls.localize(13994, null),
            validationOptions: {
                validation: (value) => {
...
class TunnelItem {
    ...
    get processDescription() {
        ...
        if (this.runningProcess) {
            ...
            description = nls.localize(13995, null);
        }
        return description;
    }
    get tooltipPostfix() {
        ...
        if (this.localAddress) {
            information = nls.localize(13996, null, this.remoteHost, this.remotePort, this.localAddress);
        }
        else {
            information = nls.localize(13997, null, this.remoteHost, this.remotePort);
        }
        return information;
    }
    get iconTooltip() {
        ...
        if (!isAdd) {
            return `${this.processDescription ? nls.localize(13998, null) :
                nls.localize(13999, null)}`;
        }
        else {
            return this.label;
        }
    ...
    get portTooltip() {
        const isAdd = this.tunnelType === TunnelType.Add;
        if (!isAdd) {
            return `${this.name ? nls.localize(14000, null, this.name) : ''}`;
        }
        else {
            return '';
        }
...
const TunnelViewFocusContextKey = new RawContextKey('tunnelViewFocus', false, nls.localize(14003, null));
...
let TunnelPanel = class TunnelPanel extends ViewPane {
    ...
    static { this.TITLE = nls.localize2(14035, "Ports"); }
    ...
    createTable() {
        ...
        this.table = this.instantiationService.createInstance(WorkbenchTable, 'RemoteTunnels', widgetContainer, new TunnelTreeVirtualDelegate(this.remoteExplorerService), columns, [actionBarRenderer], {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => nls.localize(14004, null)
            },
...
(function (LabelTunnelAction) {
    ...
    LabelTunnelAction.LABEL = nls.localize(14005, null);
            ...
            if (tunnelContext) {
                ...
                return new Promise(resolve => {
                    ...
                    remoteExplorerService.setEditable(tunnelItem, TunnelEditId.Label, {
                        ...
                        placeholder: nls.localize(14006, null),
                        startingValue
                    });
                });
            }
...
const invalidPortString = nls.localize(14007, null);
const maxPortNumber = 65536;
const invalidPortNumberString = nls.localize(14008, null, maxPortNumber);
const requiresSudoString = nls.localize(14009, null);
const alreadyForwarded = nls.localize(14010, null);
...
(function (ForwardPortAction) {
    ...
    ForwardPortAction.LABEL = nls.localize2(14036, "Forward a Port");
    ForwardPortAction.TREEITEM_LABEL = nls.localize(14011, null);
    const forwardPrompt = nls.localize(14012, null);
    ...
    function error(notificationService, tunnelOrError, host, port) {
        if (!tunnelOrError) {
            notificationService.warn(nls.localize(14013, null, host, port));
        }
        else if (typeof tunnelOrError === 'string') {
            notificationService.warn(nls.localize(14014, null, host, port, tunnelOrError));
        }
    }
...
function makeTunnelPicks(tunnels, remoteExplorerService, tunnelService) {
    ...
    if (picks.length === 0) {
        picks.push({
            label: nls.localize(14015, null, ForwardPortAction.LABEL.value)
        });
    }
    return picks;
}
...
(function (ClosePortAction) {
    ...
    ClosePortAction.LABEL = nls.localize2(14037, "Stop Forwarding Port");
    function inlineHandler() {
        return async (accessor, arg) => {
    ...
    function commandPaletteHandler() {
        return async (accessor) => {
            ...
            const result = await quickInputService.pick(picks, { placeHolder: nls.localize(14016, null) });
...
(function (OpenPortInBrowserAction) {
    ...
    OpenPortInBrowserAction.LABEL = nls.localize(14017, null);
    function handler() {
        return async (accessor, arg) => {
            let key;
            if (isITunnelItem(arg)) {
...
(function (OpenPortInPreviewAction) {
    ...
    OpenPortInPreviewAction.LABEL = nls.localize(14018, null);
    function handler() {
        return async (accessor, arg) => {
            let key;
            if (isITunnelItem(arg)) {
...
(function (OpenPortInBrowserCommandPaletteAction) {
    ...
    OpenPortInBrowserCommandPaletteAction.LABEL = nls.localize(14019, null);
    function handler() {
        return async (accessor, arg) => {
            const remoteExplorerService = accessor.get(IRemoteExplorerService);
            const tunnelService = accessor.get(ITunnelService);
            ...
            if (options.length === 0) {
                options.push({
                    label: nls.localize(14020, null)
                });
            }
            else {
                options.push({
                    label: nls.localize(14021, null)
                });
            }
            const picked = await quickPickService.pick(options, { placeHolder: nls.localize(14022, null) });
...
(function (CopyAddressAction) {
    ...
    CopyAddressAction.INLINE_LABEL = nls.localize(14023, null);
    CopyAddressAction.COMMANDPALETTE_LABEL = nls.localize(14024, null);
    ...
    function commandPaletteHandler() {
        return async (accessor, arg) => {
            ...
            const result = await quickInputService.pick(makeTunnelPicks(tunnels, remoteExplorerService, tunnelService), { placeHolder: nls.localize(14025, null) });
            if (result && result.tunnel) {
...
(function (ChangeLocalPortAction) {
    ...
    ChangeLocalPortAction.LABEL = nls.localize(14026, null);
    function validateInput(tunnelService, value, canElevate) {
        if (!value.match(/^[0-9]+$/)) {
            return { content: nls.localize(14027, null), severity: Severity.Error };
        }
                    ...
                    onFinish: async (value, success) => {
                        ...
                        if (success) {
                            ...
                            if (newForward && (typeof newForward !== 'string') && newForward.tunnelLocalPort !== numberValue) {
                                notificationService.warn(nls.localize(14028, null, value, newForward.tunnelLocalPort ?? newForward.localAddress));
                            }
                        }
                    },
                    validationMessage: (value) => validateInput(tunnelService, value, tunnelService.canElevate),
                    placeholder: nls.localize(14029, null)
                });
            }
        };
    }
...
(function (SetTunnelProtocolAction) {
    ...
    SetTunnelProtocolAction.LABEL_HTTP = nls.localize(14030, null);
    SetTunnelProtocolAction.LABEL_HTTPS = nls.localize(14031, null);
...
registerColor('ports.iconRunningProcessForeground', STATUS_BAR_REMOTE_ITEM_BACKGROUND, nls.localize(14034, null));
