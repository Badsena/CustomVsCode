...
function getAccessibilityHelpText() {
    return [
        localize(13132, null),
        localize(13133, null, '<keybinding:notebook.cell.edit>'),
        localize(13134, null, '<keybinding:notebook.cell.quitEdit>'),
        localize(13135, null, '<keybinding:notebook.cell.focusInOutput>'),
        localize(13136, null, '<keybinding:notebook.focusNextEditor>'),
        localize(13137, null, '<keybinding:notebook.focusPreviousEditor>'),
        localize(13138, null),
        localize(13139, null, '<keybinding:notebook.cell.executeAndFocusContainer>'),
        localize(13140, null, '<keybinding:notebook.cell.insertCodeCellAbove>', '<keybinding:notebook.cell.insertCodeCellBelow>'),
        localize(13141, null)
    ].join('\n');
}
