...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13046, 'Open File'),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13047, 'Toggle Collapse Unchanged Regions'),
            icon: Codicon.map,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            icon: openAsTextIcon,
            title: localize2(13048, 'Open Text Diff Editor'),
            precondition: ContextKeyExpr.or(ActiveEditorContext.isEqualTo(NotebookTextDiffEditor.ID), ActiveEditorContext.isEqualTo(NotebookMultiTextDiffEditor.ID)),
            menu: [{
                    id: MenuId.EditorTitle,
                    group: 'navigation',
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13049, 'Show Unchanged Cells'),
            icon: Codicon.unfold,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13050, 'Hide Unchanged Cells'),
            icon: Codicon.fold,
            precondition: ContextKeyExpr.and(ActiveEditorContext.isEqualTo(NotebookMultiTextDiffEditor.ID), ContextKeyExpr.has(NOTEBOOK_DIFF_HAS_UNCHANGED_CELLS.key)),
            menu: {
...
registerAction2(class GoToFileAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13051, 'Go To Cell'),
            icon: Codicon.goToFile,
            menu: {
...
const revertInput = localize(13034, null);
registerAction2(class extends Action2 {
    constructor() {
        super({
...
const revertOutputs = localize(13035, null);
registerAction2(class extends Action2 {
    constructor() {
        super({
...
const revertMetadata = localize(13036, null);
registerAction2(class extends Action2 {
    constructor() {
        super({
...
registerAction2(class extends ToggleRenderAction {
    constructor() {
        super('notebook.diff.showOutputs', localize2(13052, 'Show Outputs Differences'), ContextKeyExpr.or(ActiveEditorContext.isEqualTo(NotebookTextDiffEditor.ID), ActiveEditorContext.isEqualTo(NotebookMultiTextDiffEditor.ID)), ContextKeyExpr.notEquals('config.notebook.diff.ignoreOutputs', true), 2, true, undefined);
    }
});
registerAction2(class extends ToggleRenderAction {
    constructor() {
        super('notebook.diff.showMetadata', localize2(13053, 'Show Metadata Differences'), ContextKeyExpr.or(ActiveEditorContext.isEqualTo(NotebookTextDiffEditor.ID), ActiveEditorContext.isEqualTo(NotebookMultiTextDiffEditor.ID)), ContextKeyExpr.notEquals('config.notebook.diff.ignoreMetadata', true), 1, undefined, true);
    }
});
registerAction2(class extends Action2 {
    constructor() {
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    'properties': {
        'notebook.diff.ignoreMetadata': {
            type: 'boolean',
            default: false,
            markdownDescription: localize(13043, null)
        },
        'notebook.diff.ignoreOutputs': {
            type: 'boolean',
            default: false,
            markdownDescription: localize(13044, null)
        },
        'notebook.diff.experimental.toggleInline': {
            type: 'boolean',
            default: typeof product.quality === 'string' && product.quality !== 'stable', // only enable as default in insiders
            markdownDescription: localize(13045, null)
        },
    }
});
