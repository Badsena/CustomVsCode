...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12766, "Show Cell Failure Actions"),
        ...
        if (context.cell instanceof CodeCellViewModel) {
            ...
            if (error?.location) {
                ...
                if (editor) {
                    ...
                    controller?.manualTriggerAtCurrentPosition(localize(12765, null), CodeActionTriggerSource.Default, { include: CodeActionKind.QuickFix });
                }
            }
        }
    }
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12767, "Fix Cell Error"),
            precondition: ContextKeyExpr.and(NOTEBOOK_CELL_FOCUSED, NOTEBOOK_CELL_HAS_ERROR_DIAGNOSTICS, NOTEBOOK_CELL_EDITOR_FOCUSED.toNegated()),
            f1: true
        });
    }
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12768, "Explain Cell Error"),
            precondition: ContextKeyExpr.and(NOTEBOOK_CELL_FOCUSED, NOTEBOOK_CELL_HAS_ERROR_DIAGNOSTICS, NOTEBOOK_CELL_EDITOR_FOCUSED.toNegated()),
            f1: true
        });
    }
