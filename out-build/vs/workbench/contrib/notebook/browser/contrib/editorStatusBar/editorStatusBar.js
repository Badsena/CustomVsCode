    ...
    _showKernelStatus(notebook) {
        ...
        if (all.length === 0) {
            ...
            this._kernelInfoElement.add(this._statusbarService.addEntry({
                name: nls.localize(12787, null),
                text: `$(notebook-kernel-select) ${kernel.label}`,
                ariaLabel: kernel.label,
                tooltip: isSuggested ? nls.localize(12788, null, tooltip) : tooltip,
            ...
            this._kernelInfoElement.add(this._statusbarService.addEntry({
                name: nls.localize(12789, null),
                text: nls.localize(12790, null),
                ariaLabel: nls.localize(12791, null),
                command: SELECT_KERNEL_ID,
                kind: 'prominent'
            }, SELECT_KERNEL_ID, 1 /* StatusbarAlignment.RIGHT */, 10));
        }
...
let ActiveCellStatus = class ActiveCellStatus extends Disposable {
    ...
    _getSelectionsText(editor) {
        ...
        return numSelected > 1 ?
            nls.localize(12793, null, idxFocused, numSelected) :
            nls.localize(12794, null, idxFocused, totalCells);
    }
};
...
let NotebookIndentationStatus = class NotebookIndentationStatus extends Disposable {
    ...
    _show(editor) {
        ...
        const entry = {
            name: nls.localize(12795, null),
            text: newText,
            ariaLabel: newText,
            tooltip: nls.localize(12796, null),
