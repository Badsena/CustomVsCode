...
export const NOTEBOOK_TITLE = localize2(12851, "Notebook Variables");
export const REPL_TITLE = localize2(12852, "REPL Variables");
...
export class NotebookVariableAccessibilityProvider {
    ...
    getAriaLabel(element) {
        return localize(12850, null, element.name, element.value);
    }
}
