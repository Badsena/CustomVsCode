...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12745, "Move Cell Up"),
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12746, "Move Cell Down"),
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12747, "Copy Cell Up"),
            keybinding: {
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12748, "Copy Cell Down"),
            keybinding: {
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12749, "Split Cell"),
            menu: {
                id: MenuId.NotebookCellTitle,
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12750, "Join With Previous Cell"),
            keybinding: {
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12751, "Join With Next Cell"),
            keybinding: {
                when: NOTEBOOK_EDITOR_FOCUSED,
...
registerAction2(class extends NotebookCellAction {
    constructor() {
        super({
            ...
            title: localize2(12752, "Join Selected Cells"),
            menu: {
                id: MenuId.NotebookCellTitle,
                when: ContextKeyExpr.and(NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_EDITOR_EDITABLE),
                group: "3_edit" /* CellOverflowToolbarGroups.Edit */,
...
registerAction2(class ChangeCellToCodeAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12753, "Change Cell to Code"),
            keybinding: {
...
registerAction2(class ChangeCellToMarkdownAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12754, "Change Cell to Markdown"),
            keybinding: {
                when: ContextKeyExpr.and(NOTEBOOK_EDITOR_FOCUSED, ContextKeyExpr.not(InputFocusedContextKey), NOTEBOOK_OUTPUT_FOCUSED.toNegated()),
...
registerAction2(class CollapseCellInputAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12755, "Collapse Cell Input"),
            keybinding: {
...
registerAction2(class ExpandCellInputAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12756, "Expand Cell Input"),
            keybinding: {
...
registerAction2(class CollapseCellOutputAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12757, "Collapse Cell Output"),
            keybinding: {
...
registerAction2(class ExpandCellOuputAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12758, "Expand Cell Output"),
            keybinding: {
...
registerAction2(class extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12759, "Toggle Outputs"),
            metadata: {
                description: localize(12744, null),
...
registerAction2(class CollapseAllCellInputsAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12760, "Collapse All Cell Inputs"),
            f1: true,
        });
    }
    async runWithContext(accessor, context) {
...
registerAction2(class ExpandAllCellInputsAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12761, "Expand All Cell Inputs"),
            f1: true
        });
    }
    async runWithContext(accessor, context) {
...
registerAction2(class CollapseAllCellOutputsAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12762, "Collapse All Cell Outputs"),
            f1: true,
        });
    }
    async runWithContext(accessor, context) {
...
registerAction2(class ExpandAllCellOutputsAction extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12763, "Expand All Cell Outputs"),
            f1: true
        });
    }
    async runWithContext(accessor, context) {
...
registerAction2(class ToggleCellOutputScrolling extends NotebookMultiCellAction {
    constructor() {
        super({
            ...
            title: localize2(12764, "Toggle Scroll Cell Output"),
            keybinding: {
