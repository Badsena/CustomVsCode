...
const NLS_FIND_INPUT_LABEL = nls.localize(12801, null);
const NLS_FIND_INPUT_PLACEHOLDER = nls.localize(12802, null);
const NLS_PREVIOUS_MATCH_BTN_LABEL = nls.localize(12803, null);
const NLS_NEXT_MATCH_BTN_LABEL = nls.localize(12804, null);
const NLS_TOGGLE_SELECTION_FIND_TITLE = nls.localize(12805, null);
const NLS_CLOSE_BTN_LABEL = nls.localize(12806, null);
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = nls.localize(12807, null);
const NLS_REPLACE_INPUT_LABEL = nls.localize(12808, null);
const NLS_REPLACE_INPUT_PLACEHOLDER = nls.localize(12809, null);
const NLS_REPLACE_BTN_LABEL = nls.localize(12810, null);
const NLS_REPLACE_ALL_BTN_LABEL = nls.localize(12811, null);
export const findFilterButton = registerIcon('find-filter', Codicon.filter, nls.localize(12812, null));
const NOTEBOOK_FIND_FILTERS = nls.localize(12813, null);
const NOTEBOOK_FIND_IN_MARKUP_INPUT = nls.localize(12814, null);
const NOTEBOOK_FIND_IN_MARKUP_PREVIEW = nls.localize(12815, null);
const NOTEBOOK_FIND_IN_CODE_INPUT = nls.localize(12816, null);
const NOTEBOOK_FIND_IN_CODE_OUTPUT = nls.localize(12817, null);
