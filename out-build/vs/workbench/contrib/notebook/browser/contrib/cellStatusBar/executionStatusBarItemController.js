...
let TimerCellStatusBarItem = class TimerCellStatusBarItem extends Disposable {
    ...
    _getTimeItem(startTime, endTime, adjustment = 0, runtimeInformation) {
        ...
        if (runtimeInformation) {
            ...
            renderTimes += `\n*${localize(12774, null)}*\n`;
            tooltip = {
                value: localize(12775, null, lastExecution, formatCellDuration(executionDuration), formatCellDuration(timerDuration - executionDuration), renderTimes),
                isTrusted: true
            };
        }
        const executionText = this._isVerbose ?
            localize(12776, null, lastExecution, formatCellDuration(duration, false)) :
