...
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: 'notebook.format',
            title: localize2(12823, 'Format Notebook'),
    ...
    async run(accessor) {
        ...
        try {
            if (!formatApplied) {
                ...
                await bulkEditService.apply(/* edit */ allCellEdits.flat(), { label: localize(12821, null), code: 'undoredo.formatNotebook', });
            }
        }
        finally {
            disposable.dispose();
...
registerEditorAction(class FormatCellAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(12824, "Format Cell"),
...
let FormatOnCellExecutionParticipant = class FormatOnCellExecutionParticipant {
    ...
    async onWillExecuteCell(executions) {
        ...
        try {
            ...
            await this.bulkEditService.apply(/* edit */ allCellEdits.flat(), { label: localize(12822, null), code: 'undoredo.notebooks.onWillExecuteFormat', });
        }
        finally {
            disposable.dispose();
        }
