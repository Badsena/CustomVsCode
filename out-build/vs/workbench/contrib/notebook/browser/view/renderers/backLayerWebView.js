...
let BackLayerWebView = class BackLayerWebView extends Themable {
    ...
    _generateStyles() {
        return {
            ...
            'notebook-cell-markup-empty-content': nls.localize(13278, null),
            'notebook-cell-renderer-not-found-error': nls.localize(13279, null),



            'notebook-cell-renderer-fallbacks-exhausted': nls.localize(13280, null),
