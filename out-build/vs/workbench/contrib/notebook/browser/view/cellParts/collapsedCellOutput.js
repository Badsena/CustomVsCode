...
let CollapsedCellOutput = class CollapsedCellOutput extends CellContentPart {
    constructor(notebookEditor, cellOutputCollapseContainer, keybindingService) {
        ...
        placeholder.textContent = localize(13271, null);
        ...
        if (keybinding) {
            placeholder.title = localize(13272, null, keybinding.getLabel());
            cellOutputCollapseContainer.title = localize(13273, null, keybinding.getLabel());
        }
