...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    'properties': {
        'notebook.lineNumbers': {
            ...
            enum: ['off', 'on'],
            default: 'off',
            markdownDescription: localize(13251, null)
        }
    }
});
registerAction2(class ToggleLineNumberAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13254, 'Toggle Notebook Line Numbers'),
            shortTitle: localize2(13255, 'Line Numbers'),
