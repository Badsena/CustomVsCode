...
const editorOptionsCustomizationSchema = {
    description: nls.localize(13064, null),
    default: {},
    allOf: [
        {
            properties: schemas,
...
configurationRegistry.registerConfiguration({
    id: 'notebook',
    order: 100,
    title: nls.localize(13065, null),
    type: 'object',
    properties: {
        [NotebookSetting.displayOrder]: {
            description: nls.localize(13066, null),
            type: 'array',
            items: {
                type: 'string'
            },
        ...
        [NotebookSetting.cellToolbarLocation]: {
            description: nls.localize(13067, null),
            type: 'object',
            additionalProperties: {
                markdownDescription: nls.localize(13068, null),
                type: 'string',
        ...
        [NotebookSetting.showCellStatusBar]: {
            description: nls.localize(13069, null),
            type: 'string',
            enum: ['hidden', 'visible', 'visibleAfterExecute'],
            enumDescriptions: [
                nls.localize(13070, null),
                nls.localize(13071, null),
                nls.localize(13072, null)
            ],
            default: 'visible',
            tags: ['notebookLayout']
        },
        [NotebookSetting.cellExecutionTimeVerbosity]: {
            description: nls.localize(13073, null),
            type: 'string',
            enum: ['default', 'verbose'],
            enumDescriptions: [
                nls.localize(13074, null),
                nls.localize(13075, null)
            ],
            default: 'default',
            tags: ['notebookLayout']
        },
        [NotebookSetting.textDiffEditorPreview]: {
            description: nls.localize(13076, null),
            type: 'boolean',
            default: true,
            tags: ['notebookLayout']
        },
        [NotebookSetting.diffOverviewRuler]: {
            description: nls.localize(13077, null),
            type: 'boolean',
            default: false,
            tags: ['notebookLayout']
        },
        [NotebookSetting.cellToolbarVisibility]: {
            markdownDescription: nls.localize(13078, null),
            type: 'string',
            enum: ['hover', 'click'],
            default: 'click',
            tags: ['notebookLayout']
        ...
        [NotebookSetting.undoRedoPerCell]: {
            description: nls.localize(13079, null),
            type: 'boolean',
            default: true,
            tags: ['notebookLayout']
        },
        [NotebookSetting.compactView]: {
            description: nls.localize(13080, null),
            type: 'boolean',
            default: true,
            tags: ['notebookLayout']
        },
        [NotebookSetting.focusIndicator]: {
            description: nls.localize(13081, null),
            type: 'string',
            enum: ['border', 'gutter'],
            default: 'gutter',
            tags: ['notebookLayout']
        ...
        [NotebookSetting.insertToolbarLocation]: {
            description: nls.localize(13082, null),
            type: 'string',
            enum: ['betweenCells', 'notebookToolbar', 'both', 'hidden'],
            enumDescriptions: [
                nls.localize(13083, null),
                nls.localize(13084, null),
                nls.localize(13085, null),
                nls.localize(13086, null),
            ],
            default: 'both',
            tags: ['notebookLayout']
        },
        [NotebookSetting.globalToolbar]: {
            description: nls.localize(13087, null),
            type: 'boolean',
            default: true,
            tags: ['notebookLayout']
        },
        [NotebookSetting.stickyScrollEnabled]: {
            description: nls.localize(13088, null),
            type: 'boolean',
            default: false,
            tags: ['notebookLayout']
        },
        [NotebookSetting.stickyScrollMode]: {
            description: nls.localize(13089, null),
            type: 'string',
            enum: ['flat', 'indented'],
            enumDescriptions: [
                nls.localize(13090, null),
                nls.localize(13091, null),
            ],
            default: 'indented',
            tags: ['notebookLayout']
        },
        [NotebookSetting.consolidatedOutputButton]: {
            description: nls.localize(13092, null),
            type: 'boolean',
            default: true,
            tags: ['notebookLayout']
        },
        ...
        [NotebookSetting.showFoldingControls]: {
            description: nls.localize(13093, null),
            type: 'string',
            enum: ['always', 'never', 'mouseover'],
            enumDescriptions: [
                nls.localize(13094, null),
                nls.localize(13095, null),
                nls.localize(13096, null),
            ],
            default: 'mouseover',
            tags: ['notebookLayout']
        },
        [NotebookSetting.dragAndDropEnabled]: {
            description: nls.localize(13097, null),
            type: 'boolean',
            default: true,
            tags: ['notebookLayout']
        },
        [NotebookSetting.consolidatedRunButton]: {
            description: nls.localize(13098, null),
            type: 'boolean',
            default: false,
            tags: ['notebookLayout']
        },
        [NotebookSetting.globalToolbarShowLabel]: {
            description: nls.localize(13099, null),
            type: 'string',
        ...
        [NotebookSetting.textOutputLineLimit]: {
            markdownDescription: nls.localize(13100, null, '`#notebook.output.scrolling#`'),
            type: 'number',
            default: 30,
        ...
        [NotebookSetting.LinkifyOutputFilePaths]: {
            description: nls.localize(13101, null),
            type: 'boolean',
            default: true,
            tags: ['notebookOutputLayout']
        },
        [NotebookSetting.minimalErrorRendering]: {
            description: nls.localize(13102, null),
            type: 'boolean',
            default: false,
            tags: ['notebookOutputLayout']
        },
        [NotebookSetting.markupFontSize]: {
            markdownDescription: nls.localize(13103, null, '`0`', '`#editor.fontSize#`'),
            type: 'number',
            default: 0,
            tags: ['notebookLayout']
        },
        [NotebookSetting.markdownLineHeight]: {
            markdownDescription: nls.localize(13104, null, '`0`', '`normal`'),
            type: 'number',
            default: 0,
            tags: ['notebookLayout']
        },
        ...
        [NotebookSetting.interactiveWindowCollapseCodeCells]: {
            markdownDescription: nls.localize(13105, null),
            type: 'string',
            enum: ['always', 'never', 'fromEditor'],
            default: 'fromEditor'
        },
        [NotebookSetting.outputLineHeight]: {
            markdownDescription: nls.localize(13106, null),
            type: 'number',
            default: 0,
            tags: ['notebookLayout', 'notebookOutputLayout']
        },
        [NotebookSetting.outputFontSize]: {
            markdownDescription: nls.localize(13107, null, '`#editor.fontSize#`'),
            type: 'number',
            default: 0,
            tags: ['notebookLayout', 'notebookOutputLayout']
        },
        [NotebookSetting.outputFontFamily]: {
            markdownDescription: nls.localize(13108, null, '`#editor.fontFamily#`'),
            type: 'string',
            tags: ['notebookLayout', 'notebookOutputLayout']
        },
        [NotebookSetting.outputScrolling]: {
            markdownDescription: nls.localize(13109, null),
            type: 'boolean',
            tags: ['notebookLayout', 'notebookOutputLayout'],
            default: typeof product.quality === 'string' && product.quality !== 'stable' // only enable as default in insiders
        },
        [NotebookSetting.outputWordWrap]: {
            markdownDescription: nls.localize(13110, null),
            type: 'boolean',
            tags: ['notebookLayout', 'notebookOutputLayout'],
            default: false
        },
        [NotebookSetting.defaultFormatter]: {
            description: nls.localize(13111, null),
            type: ['string', 'null'],
            default: null,
        ...
        [NotebookSetting.formatOnSave]: {
            markdownDescription: nls.localize(13112, null, '`#files.autoSave#`'),
            type: 'boolean',
            tags: ['notebookLayout'],
            default: false
        },
        [NotebookSetting.insertFinalNewline]: {
            markdownDescription: nls.localize(13113, null),
            type: 'boolean',
            tags: ['notebookLayout'],
            default: false
        },
        [NotebookSetting.formatOnCellExecution]: {
            markdownDescription: nls.localize(13114, null),
            type: 'boolean',
            default: false
        },
        [NotebookSetting.confirmDeleteRunningCell]: {
            markdownDescription: nls.localize(13115, null),
            type: 'boolean',
            default: true
        },
        [NotebookSetting.findFilters]: {
            markdownDescription: nls.localize(13116, null),
            type: 'object',
            properties: {
                markupSource: {
                    type: 'boolean',
        ...
        [NotebookSetting.remoteSaving]: {
            markdownDescription: nls.localize(13117, null),
            type: 'boolean',
            default: typeof product.quality === 'string' && product.quality !== 'stable', // only enable as default in insiders
            tags: ['experimental']
        },
        [NotebookSetting.scrollToRevealCell]: {
            markdownDescription: nls.localize(13118, null, 'notebook.cell.executeAndSelectBelow'),
            type: 'string',
            enum: ['fullCell', 'firstLine', 'none'],
            markdownEnumDescriptions: [
                nls.localize(13119, null),
                nls.localize(13120, null),
                nls.localize(13121, null),
            ],
            default: 'fullCell'
        },
        [NotebookSetting.cellGenerate]: {
            markdownDescription: nls.localize(13122, null),
            type: 'boolean',
            default: true
        },
        [NotebookSetting.notebookVariablesView]: {
            markdownDescription: nls.localize(13123, null),
            type: 'boolean',
            default: false
        },
        [NotebookSetting.notebookInlineValues]: {
            markdownDescription: nls.localize(13124, null),
            type: 'string',
            enum: ['on', 'auto', 'off'],
            enumDescriptions: [
                nls.localize(13125, null),
                nls.localize(13126, null),
                nls.localize(13127, null),
            ],
            default: 'off'
        },
        [NotebookSetting.cellFailureDiagnostics]: {
            markdownDescription: nls.localize(13128, null),
            type: 'boolean',
            default: true
        },
        [NotebookSetting.outputBackupSizeLimit]: {
            markdownDescription: nls.localize(13129, null),
            type: 'number',
            default: 10000
        },
        [NotebookSetting.multiCursor]: {
            markdownDescription: nls.localize(13130, null),
            type: 'boolean',
            default: false
        },
        [NotebookSetting.markupFontFamily]: {
            markdownDescription: nls.localize(13131, null),
            type: 'string',
            default: '',
            tags: ['notebookLayout']
        }
