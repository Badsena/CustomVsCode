...
registerAction2(class extends NotebookAction {
    constructor() {
        super({
            ...
            title: {
                value: '$(sparkle) ' + localize(12886, null),
                original: '$(sparkle) Generate',
            },
            tooltip: localize(12887, null),
            metadata: {
...
registerAction2(class extends NotebookAction {
    constructor() {
        super({
            ...
            title: {
                value: '$(sparkle) ' + localize(12889, null),
                original: '$(sparkle) Generate',
            },
            tooltip: localize(12890, null),
            f1: false,
            menu: [
                {
...
MenuRegistry.appendMenuItem(MenuId.NotebookToolbar, {
    command: {
        ...
        title: localize(12891, null),
        tooltip: localize(12892, null)
    },
    order: -10,
...
export class AcceptChangesAndRun extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(12895, "Accept and Run"),
            shortTitle: localize(12893, null),
            tooltip: localize(12894, null),
            icon: Codicon.check,
            f1: true,
