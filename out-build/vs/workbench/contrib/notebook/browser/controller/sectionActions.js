...
export class NotebookRunSingleCellInSection extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(13017, "Run Cell"),
                mnemonicTitle: localize(13009, null),
            },
            shortTitle: localize(13010, null),
...
export class NotebookRunCellsInSection extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(13018, "Run Cells In Section"),
                mnemonicTitle: localize(13011, null),
            },
            shortTitle: localize(13012, null),
...
export class NotebookFoldSection extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(13019, "Fold Section"),
                mnemonicTitle: localize(13013, null),
            },
            shortTitle: localize(13014, null),
            menu: [
                {
                    id: MenuId.NotebookOutlineActionMenu,
...
export class NotebookExpandSection extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(13020, "Expand Section"),
                mnemonicTitle: localize(13015, null),
            },
            shortTitle: localize(13016, null),
            menu: [
                {
                    id: MenuId.NotebookOutlineActionMenu,
                    group: 'notebookFolding',
