...
registerAction2(class NotebookConfigureLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12989, "Select between Notebook Layouts"),
            f1: true,
...
registerAction2(class NotebookConfigureLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12990, "Customize Notebook Layout"),
            f1: true,
            category: NOTEBOOK_ACTIONS_CATEGORY,
            menu: [
                {
...
registerAction2(class NotebookConfigureLayoutFromEditorTitle extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12991, "Customize Notebook Layout"),
            f1: false,
            category: NOTEBOOK_ACTIONS_CATEGORY,
            menu: [
                {
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
    ...
    title: localize2(12992, "Customize Notebook..."),
    icon: Codicon.gear,
    group: 'navigation',
    order: -1,
    when: NOTEBOOK_IS_ACTIVE_EDITOR
...
registerAction2(class ToggleLineNumberFromEditorTitle extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12993, 'Toggle Notebook Line Numbers'),
            shortTitle: localize2(12994, 'Line Numbers'),
...
registerAction2(class ToggleCellToolbarPositionFromEditorTitle extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12995, 'Toggle Cell Toolbar Position'),
            menu: [{
                    id: MenuId.NotebookEditorLayoutConfigure,
                    group: 'notebookLayoutDetails',
                    order: 3
...
registerAction2(class ToggleBreadcrumbFromEditorTitle extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12996, 'Toggle Breadcrumbs'),
            shortTitle: localize2(12997, 'Breadcrumbs'),
            toggled: {
                condition: ContextKeyExpr.equals('config.breadcrumbs.enabled', true),
                title: localize(12982, null)
            },
            menu: [{
                    id: MenuId.NotebookEditorLayoutConfigure,
                    group: 'notebookLayoutDetails',
...
registerAction2(class SaveMimeTypeDisplayOrder extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12998, "Save Mimetype Display Order"),
            f1: true,
            category: NOTEBOOK_ACTIONS_CATEGORY,
    ...
    run(accessor) {
        ...
        qp.placeholder = localize(12983, null);
        qp.items = [
            { target: 2 /* ConfigurationTarget.USER */, label: localize(12984, null) },
            { target: 5 /* ConfigurationTarget.WORKSPACE */, label: localize(12985, null) },
        ];
...
registerAction2(class NotebookWebviewResetAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12999, "Reset Notebook Webview"),
            f1: false,
            category: NOTEBOOK_ACTIONS_CATEGORY
        });
    }
...
registerAction2(class ToggleNotebookStickyScroll extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(13000, "Toggle Notebook Sticky Scroll"),
                mnemonicTitle: localize(12986, null),
            },
            shortTitle: localize2(13001, "Sticky Scroll"),
            category: Categories.View,
            toggled: {
                condition: ContextKeyExpr.equals('config.notebook.stickyScroll.enabled', true),
                title: localize(12987, null),
                mnemonicTitle: localize(12988, null),
            },
            menu: [
