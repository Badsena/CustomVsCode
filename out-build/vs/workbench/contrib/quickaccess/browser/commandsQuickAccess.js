...
let CommandsQuickAccessProvider = class CommandsQuickAccessProvider extends AbstractEditorCommandsQuickAccessProvider {
    ...
    getGlobalCommandPicks() {
        ...
        for (const action of globalCommandsMenuActions) {
            ...
            if (category) {
                label = localize(13854, null, category, label);
            }
            // Alias
...
export class ShowAllCommandsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(13858, 'Show All Commands'),
            keybinding: {
...
export class ClearCommandHistoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(13859, 'Clear Command History'),
            f1: true
        });
    }
    async run(accessor) {
        ...
        if (commandHistoryLength > 0) {
            ...
            const { confirmed } = await dialogService.confirm({
                type: 'warning',
                message: localize(13855, null),
                detail: localize(13856, null),
                primaryButton: localize(13857, null)
            });
            if (!confirmed) {
                return;
            }
