...
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: localize(13860, null, HelpQuickAccessProvider.PREFIX),
    helpEntries: [{
            description: localize(13861, null),
            commandCenterOrder: 70,
            commandCenterLabel: localize(13862, null)
        }]
});
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: localize(13863, null),
    helpEntries: [{ description: localize(13864, null), commandId: OpenViewPickerAction.ID }]
});
quickAccessRegistry.registerQuickAccessProvider({
    ctor: CommandsQuickAccessProvider,
    prefix: CommandsQuickAccessProvider.PREFIX,
    contextKey: 'inCommandsPicker',
    placeholder: localize(13865, null),
    helpEntries: [{ description: localize(13866, null), commandId: ShowAllCommandsAction.ID, commandCenterOrder: 20 }]
});
//#endregion
