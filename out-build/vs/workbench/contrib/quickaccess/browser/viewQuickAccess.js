...
let ViewQuickAccessProvider = class ViewQuickAccessProvider extends PickerQuickAccessProvider {
    ...
    doGetViewPickItems() {
        ...
        // Viewlets / Panels
        addPaneComposites(0 /* ViewContainerLocation.Sidebar */, localize(13874, null));
        addPaneComposites(1 /* ViewContainerLocation.Panel */, localize(13875, null));
        addPaneComposites(2 /* ViewContainerLocation.AuxiliaryBar */, localize(13876, null));
        ...
        this.terminalGroupService.groups.forEach((group, groupIndex) => {
            group.terminalInstances.forEach((terminal, terminalIndex) => {
                const label = localize(13877, null, `${groupIndex + 1}.${terminalIndex + 1}`, terminal.title);
                viewEntries.push({
                    label,
                    containerLabel: localize(13878, null),
                    accept: async () => {
        ...
        this.debugService.getModel().getSessions(true).filter(s => s.hasSeparateRepl()).forEach((session, _) => {
            ...
            viewEntries.push({
                label,
                containerLabel: localize(13879, null),
                accept: async () => {
        ...
        for (const channel of channels) {
            viewEntries.push({
                label: channel.label,
                containerLabel: localize(13880, null),
...
export class OpenViewPickerAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(13881, 'Open View'),
...
export class QuickAccessViewPickerAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(13882, 'Quick Open View'),
            category: Categories.View,
