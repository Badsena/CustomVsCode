...
suite('TerminalSandboxService - allowTrustedDomains', () => {
    ...
    setup(() => {
        ...
        configurationService.setUserConfiguration("chat.tools.terminal.sandbox.enabled" /* TerminalChatAgentToolsSettingId.TerminalSandboxEnabled */, true);
        configurationService.setUserConfiguration("chat.tools.terminal.sandbox.network" /* TerminalChatAgentToolsSettingId.TerminalSandboxNetwork */, {
            allowedDomains: [],
            deniedDomains: [],
    ...
    test('should refresh allowWrite paths when workspace folders change', async () => {
        configurationService.setUserConfiguration("chat.tools.terminal.sandbox.linuxFileSystem" /* TerminalChatAgentToolsSettingId.TerminalSandboxLinuxFileSystem */, {
