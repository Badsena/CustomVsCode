...
suite('RunInTerminalTool', () => {
    ...
    setup(() => {
        ...
        terminalSandboxService = {
            ...
            getOS: () => Promise.resolve(1 /* OperatingSystem.Windows */)
        };
    ...
    suite('sandbox invocation messaging', () => {
        test('should use sandbox labels when command is sandbox wrapped', async () => {
            ...
            ok(preparedInvocation, 'Expected prepared invocation to be defined');
            strictEqual(preparedInvocation.invocationMessage.value, '$(lock) Running `echo hello` in sandbox');
    ...
    suite('session auto approval', () => {
        ...
        test('should circuit break repeated denied command attempts in auto approval sessions', async () => {
            ...
            const firstData = first.toolSpecificData;
            const secondData = second.toolSpecificData;
            const thirdData = third.toolSpecificData;
...
//# sourceMappingURL=runInTerminalTool.test.js.map