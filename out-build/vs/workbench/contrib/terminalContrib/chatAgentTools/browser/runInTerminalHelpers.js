...
export function generateAutoApproveActions(commandLine, subCommands, autoApproveResult) {
    ...
    actions.push({
        label: localize(15880, null),
        tooltip: localize(15881, null),
        data: {
