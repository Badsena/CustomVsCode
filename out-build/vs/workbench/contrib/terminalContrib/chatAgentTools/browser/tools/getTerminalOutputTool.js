...
export const GetTerminalOutputToolData = {
    ...
    displayName: localize(15908, null),
    modelDescription: `Get the output of a terminal command previously started with ${"run_in_terminal" /* TerminalToolId.RunInTerminal */}`,
...
export class GetTerminalOutputTool extends Disposable {
    async prepareToolInvocation(context, token) {
        return {
            invocationMessage: localize(15909, null),
            pastTenseMessage: localize(15910, null),
        };
    }
