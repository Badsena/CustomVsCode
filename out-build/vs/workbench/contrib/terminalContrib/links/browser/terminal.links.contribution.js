...
registerActiveInstanceAction({
    ...
    title: localize2(16142, 'Open Detected Link...'),
    f1: true,
    category,
...
registerActiveInstanceAction({
    ...
    title: localize2(16143, 'Open Last URL Link'),
    metadata: {
        description: localize2(16144, 'Opens the last detected URL/URI link in the terminal')
    },
    f1: true,
    category,
    precondition: TerminalContextKeys.terminalHasBeenCreated,
...
registerActiveInstanceAction({
    ...
    title: localize2(16145, 'Open Last Local File Link'),
    f1: true,
    category,
    precondition: TerminalContextKeys.terminalHasBeenCreated,
