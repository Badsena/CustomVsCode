...
let TerminalLinkDetectorAdapter = class TerminalLinkDetectorAdapter extends Disposable {
    ...
    _getLabel(type) {
        switch (type) {
            case "Search" /* TerminalBuiltinLinkType.Search */: return localize(16146, null);
            case "LocalFile" /* TerminalBuiltinLinkType.LocalFile */: return localize(16147, null);
            case "LocalFolderInWorkspace" /* TerminalBuiltinLinkType.LocalFolderInWorkspace */: return localize(16148, null);
            case "LocalFolderOutsideWorkspace" /* TerminalBuiltinLinkType.LocalFolderOutsideWorkspace */: return localize(16149, null);
            case "Url" /* TerminalBuiltinLinkType.Url */:
            default:
                return localize(16150, null);
        }
    }
};
