...
const quickFixExtensionPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: localize(16185, null),
        type: 'array',
        items: {
            type: 'object',
            ...
            properties: {
                id: {
                    description: localize(16186, null),
                    type: 'string',
                },
                commandLineMatcher: {
                    description: localize(16187, null),
                    type: 'string',
                },
                outputMatcher: {
                    markdownDescription: localize(16188, null),
                    type: 'object',
                ...
                commandExitResult: {
                    description: localize(16189, null),
                    enum: ['success', 'error'],
                    enumDescriptions: [
                ...
                kind: {
                    description: localize(16190, null, '`"fix"`'),
