...
let SuggestAddon = class SuggestAddon extends Disposable {
    ...
    constructor(_sessionId, shellType, _capabilities, _terminalSuggestWidgetVisibleContextKey, _terminalCompletionService, _configurationService, _instantiationService, _terminalConfigurationService, _logService) {
        ...
        this._kindToKindLabelMap = new Map([
            [TerminalCompletionItemKind.File, localize(16244, null)],
            [TerminalCompletionItemKind.Folder, localize(16245, null)],
            [TerminalCompletionItemKind.SymbolicLinkFile, localize(16246, null)],
            [TerminalCompletionItemKind.SymbolicLinkFolder, localize(16247, null)],
            [TerminalCompletionItemKind.Method, localize(16248, null)],
            [TerminalCompletionItemKind.Alias, localize(16249, null)],
            [TerminalCompletionItemKind.Argument, localize(16250, null)],
            [TerminalCompletionItemKind.Option, localize(16251, null)],
            [TerminalCompletionItemKind.OptionValue, localize(16252, null)],
            [TerminalCompletionItemKind.Flag, localize(16253, null)],
            [TerminalCompletionItemKind.Commit, localize(16254, null)],
            [TerminalCompletionItemKind.Branch, localize(16255, null)],
            [TerminalCompletionItemKind.Tag, localize(16256, null)],
            [TerminalCompletionItemKind.Stash, localize(16257, null)],
            [TerminalCompletionItemKind.Remote, localize(16258, null)],
            [TerminalCompletionItemKind.PullRequest, localize(16259, null)],
            [TerminalCompletionItemKind.PullRequestDone, localize(16260, null)],
            [TerminalCompletionItemKind.InlineSuggestion, localize(16261, null)],
            [TerminalCompletionItemKind.InlineSuggestionAlwaysOnTop, localize(16262, null)],
        ]);
