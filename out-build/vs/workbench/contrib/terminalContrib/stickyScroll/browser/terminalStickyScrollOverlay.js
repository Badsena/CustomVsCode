...
let TerminalStickyScrollOverlay = class TerminalStickyScrollOverlay extends Disposable {
    ...
    _ensureElement() {
        ...
        // Fill tooltip
        let hoverTitle = localize(16215, null);
        ...
        if (scrollToPreviousCommandKeybinding) {
            ...
            if (label) {
                hoverTitle += '\n' + localize(16216, null, terminalStrings.scrollToPreviousCommand.value, label);
            }
        }
        ...
        if (scrollToNextCommandKeybinding) {
            ...
            if (label) {
                hoverTitle += '\n' + localize(16217, null, terminalStrings.scrollToNextCommand.value, label);
            }
        }
