...
registerActiveXtermAction({
    ...
    title: localize2(16079, 'Focus Find'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(16080, 'Hide Find'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(16081, 'Toggle Find Using Regex'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(16082, 'Toggle Find Using Whole Word'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(16083, 'Toggle Find Using Case Sensitive'),
    keybinding: {
...
registerActiveXtermAction({
    ...
    title: localize2(16084, 'Find Next'),
    keybinding: [
        {
...
registerActiveXtermAction({
    ...
    title: localize2(16085, 'Find Previous'),
    keybinding: [
        {
...
registerActiveInstanceAction({
    ...
    title: localize2(16086, 'Search Workspace'),
    keybinding: [
        {
