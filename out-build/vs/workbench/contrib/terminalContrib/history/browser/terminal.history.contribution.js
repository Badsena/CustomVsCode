...
registerTerminalAction({
    ...
    title: localize2(16116, 'Clear Previous Session History'),
    precondition,
...
registerActiveInstanceAction({
    ...
    title: localize2(16117, 'Go to Recent Directory...'),
    metadata: {
        description: localize2(16118, 'Goes to a recent folder'),
    },
    precondition,
    keybinding: {
...
registerTerminalAction({
    ...
    title: localize2(16119, 'Run Recent Command...'),
    precondition,
    keybinding: [
        {
