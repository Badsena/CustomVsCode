...
quickAccessRegistry.registerQuickAccessProvider({
    ...
    placeholder: nls.localize(16173, null),
    helpEntries: [{ description: nls.localize(16174, null), commandId: "workbench.action.quickOpenTerm" /* TerminalQuickAccessCommandId.QuickOpenTerm */ }]
});
...
registerTerminalAction({
    ...
    title: nls.localize2(16175, 'Switch Active Terminal'),
