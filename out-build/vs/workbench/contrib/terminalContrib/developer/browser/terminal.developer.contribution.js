...
registerTerminalAction({
    ...
    title: localize2(16071, 'Show Terminal Texture Atlas'),
...
registerTerminalAction({
    ...
    title: localize2(16072, 'Write Data to Terminal'),
    category: Categories.Developer,
    run: async (c, accessor) => {
...
registerTerminalAction({
    ...
    title: localize2(16073, 'Record Terminal Session'),
    category: Categories.Developer,
    run: async (c, accessor) => {
        ...
        const text = localize(16070, null);
...
registerTerminalAction({
    ...
    title: localize2(16074, 'Restart Pty Host'),
    category: Categories.Developer,
    run: async (c, accessor) => {
