...
export class EditorWalkThroughAction extends Action2 {
    ...
    static { this.LABEL = localize2(17577, 'Interactive Editor Playground'); }
    constructor() {
        super({
            ...
            f1: true,
            metadata: {
                description: localize2(17578, "Opens an interactive playground for learning about the editor.")
            }
        });
    }
    run(serviceAccessor) {
