...
Registry.as(EditorExtensions.EditorPane)
    .registerEditorPane(EditorPaneDescriptor.create(WalkThroughPart, WalkThroughPart.ID, localize(17579, null)), [new SyncDescriptor(WalkThroughInput)]);
