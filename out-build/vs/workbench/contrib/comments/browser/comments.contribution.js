...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    id: 'comments',
    order: 20,
    title: nls.localize(9362, null),
    type: 'object',
    properties: {
        'comments.openPanel': {
            enum: ['neverOpen', 'openOnSessionStart', 'openOnSessionStartWithComments'],
            default: 'openOnSessionStartWithComments',
            description: nls.localize(9363, null),
            restricted: false,
            markdownDeprecationMessage: nls.localize(9364, null)
        },
        'comments.openView': {
            enum: ['never', 'file', 'firstFile', 'firstFileUnresolved'],
            enumDescriptions: [nls.localize(9365, null), nls.localize(9366, null), nls.localize(9367, null), nls.localize(9368, null)],
            default: 'firstFile',
            description: nls.localize(9369, null),
            restricted: false
        },
        'comments.useRelativeTime': {
            type: 'boolean',
            default: true,
            description: nls.localize(9370, null)
        },
        'comments.visible': {
            type: 'boolean',
            default: true,
            description: nls.localize(9371, null)
        },
        'comments.maxHeight': {
            type: 'boolean',
            default: true,
            description: nls.localize(9372, null)
        },
        'comments.collapseOnResolve': {
            type: 'boolean',
            default: true,
            description: nls.localize(9373, null)
        },
        'comments.thread.confirmOnCollapse': {
            type: 'string',
            enum: ['whenHasUnsubmittedComments', 'never'],
            enumDescriptions: [nls.localize(9374, null), nls.localize(9375, null)],
            default: 'whenHasUnsubmittedComments',
            description: nls.localize(9376, null)
        }
    }
});
...
let UnresolvedCommentsBadge = class UnresolvedCommentsBadge extends Disposable {
    ...
    updateBadge(unresolved) {
        ...
        const message = nls.localize(9377, null, this.totalUnresolved);
