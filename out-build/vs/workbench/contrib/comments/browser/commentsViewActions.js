...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(9448, null),
            category: localize(9449, null),
            toggled: {
                condition: CONTEXT_KEY_SHOW_UNRESOLVED,
                title: localize(9450, null),
            },
            menu: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(9451, null),
            category: localize(9452, null),
            toggled: {
                condition: CONTEXT_KEY_SHOW_RESOLVED,
                title: localize(9453, null),
            },
            menu: {
                id: viewFilterSubmenu,
                group: '1_filter',
