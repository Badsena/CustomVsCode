...
const collapseIcon = registerIcon('review-comment-collapse', Codicon.chevronUp, nls.localize(9464, null));
...
let CommentThreadHeader = class CommentThreadHeader extends Disposable {
    ...
    _fillHead() {
        ...
        this._collapseAction = new Action("workbench.action.hideComment" /* CommentCommandId.Hide */, nls.localize(9465, null), collapseClass, true, () => this._delegate.collapse());
