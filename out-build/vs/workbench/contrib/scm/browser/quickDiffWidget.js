...
let QuickDiffPickerViewItem = class QuickDiffPickerViewItem extends SelectActionViewItem {
    constructor(action, contextViewService, themeService, configurationService) {
        ...
        super(null, action, [], 0, contextViewService, styles, { ariaLabel: nls.localize(14169, null), useCustomDrawn: !hasNativeContextMenu(configurationService) });
        this.optionsItems = [];
    }
...
export class QuickDiffPickerBaseAction extends Action {
    ...
    static { this.LABEL = nls.localize(14170, null); }
...
let QuickDiffWidget = class QuickDiffWidget extends PeekViewWidget {
    ...
    renderTitle() {
        ...
        if (!this.shouldUseDropdown()) {
            ...
            detail = this.model.changes.length > 1
                ? nls.localize(14171, null, label, providerIndex + 1, providerChanges.length)
                : nls.localize(14172, null, label, providerIndex + 1, providerChanges.length);
            this.dropdownContainer.style.display = 'none';
        }
        else {
            detail = this.model.changes.length > 1
                ? nls.localize(14173, null, providerIndex + 1, providerChanges.length)
                : nls.localize(14174, null, providerIndex + 1, providerChanges.length);
    ...
    updateActions() {
        ...
        this._actionbarWidget.push(this._disposables.add(new Action('peekview.close', nls.localize(14175, null), ThemeIcon.asClassName(Codicon.close), true, () => this.dispose())), { label: false, icon: true });
    }
    updateDropdown() {
        const quickDiffs = this.getQuickDiffsContainingChange();
...
export class ShowPreviousChangeAction extends EditorAction {
    constructor(outerEditor) {
        super({
            ...
            label: nls.localize2(14178, "Show Previous Change"),
...
export class ShowNextChangeAction extends EditorAction {
    constructor(outerEditor) {
        super({
            ...
            label: nls.localize2(14179, "Show Next Change"),
            precondition: TextCompareEditorActiveContext.toNegated(),
...
export class GotoPreviousChangeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(14180, "Go to Previous Change"),
...
export class GotoNextChangeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(14181, "Go to Next Change"),
            precondition: ContextKeyExpr.and(TextCompareEditorActiveContext.toNegated(), quickDiffDecorationCount.notEqualsTo(0)),
