...
let OutputViewPane = class OutputViewPane extends FilterViewPane {
    ...
    constructor(options, keybindingService, contextMenuService, configurationService, contextKeyService, viewDescriptorService, instantiationService, openerService, themeService, hoverService, outputService, storageService) {
        ...
        super({
            ...options,
            filterOptions: {
                placeholder: localize(13424, null),
    ...
    createInput(channel) {
        return this.instantiationService.createInstance(TextResourceEditorInput, channel.uri, nls.localize(13425, null, channel.label), nls.localize(13426, null, channel.label), undefined, undefined);
    }
    saveState() {
        const filters = this.outputService.filters;
...
let OutputEditor = class OutputEditor extends AbstractTextResourceEditor {
    ...
    getTitle() {
        return nls.localize(13427, null);
    }
    ...
    getAriaLabel() {
        return this.input ? this.input.getAriaLabel() : nls.localize(13428, null);
    }
    computeAriaLabel() {
