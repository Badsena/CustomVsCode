...
const outputViewIcon = registerIcon('output-view-icon', Codicon.output, nls.localize(13351, null));
const VIEW_CONTAINER = Registry.as(ViewContainerExtensions.ViewContainersRegistry).registerViewContainer({
    id: OUTPUT_VIEW_ID,
    title: nls.localize2(13376, "Output"),
    icon: outputViewIcon,
    order: 1,
...
Registry.as(ViewContainerExtensions.ViewsRegistry).registerViews([{
        id: OUTPUT_VIEW_ID,
        name: nls.localize2(13377, "Output"),
        ...
        openCommandActionDescriptor: {
            ...
            mnemonicTitle: nls.localize(13352, null),
            keybindings: {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13378, "Add Compound Log..."),
                    category: nls.localize2(13379, "Output"),
                    f1: true,
                    menu: [{
                            id: MenuId.ViewTitle,
                            when: ContextKeyExpr.equals('view', OUTPUT_VIEW_ID),
            ...
            async run(accessor) {
                ...
                if (extensionLogs.length && logs.length) {
                    entries.push({ type: 'separator', label: nls.localize(13355, null) });
                }
                for (const log of extensionLogs.sort((a, b) => a.label.localeCompare(b.label))) {
                    entries.push(log);
                }
                const result = await quickInputService.pick(entries, { placeHolder: nls.localize(13356, null), canPickMany: true });
                if (result?.length) {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13380, "Remove Output..."),
                    category: nls.localize2(13381, "Output"),
                    f1: true
                });
            }
            async run(accessor) {
                ...
                if (entries.length === 0) {
                    notificationService.info(nls.localize(13357, null));
                    return;
                }
                const result = await quickInputService.pick(entries, { placeHolder: nls.localize(13358, null), canPickMany: true });
                if (!result?.length) {
                    return;
                }
                const outputChannelRegistry = Registry.as(Extensions.OutputChannels);
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13382, "Show Output Channels..."),
                    category: nls.localize2(13383, "Output"),
                    f1: true
                });
            }
            async run(accessor) {
                ...
                const entry = await quickInputService.pick(entries, { placeHolder: nls.localize(13359, null) });
                if (entry) {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13384, "Clear Output"),
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13385, "Toggle Auto Scrolling"),
                    tooltip: nls.localize(13360, null),
                    menu: {
                        id: MenuId.ViewTitle,
                    ...
                    toggled: {
                        ...
                        icon: Codicon.unlock,
                        tooltip: nls.localize(13361, null)
                    }
                });
            }
            async run(accessor) {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13386, "Open Output in Editor"),
                    menu: [{
                            id: MenuId.ViewTitle,
                            when: ContextKeyExpr.equals('view', OUTPUT_VIEW_ID),
                            group: 'navigation',
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13387, "Open Output in New Window"),
                    menu: [{
                            id: MenuId.ViewTitle,
                            when: ContextKeyExpr.equals('view', OUTPUT_VIEW_ID),
                            group: 'navigation',
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13388, "Save Output As..."),
                    menu: [{
                            id: MenuId.ViewTitle,
                            when: ContextKeyExpr.equals('view', OUTPUT_VIEW_ID),
                            group: '1_export',
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13389, "Show Logs..."),
            ...
            async run(accessor) {
                ...
                if (extensionLogs.length && logs.length) {
                    entries.push({ type: 'separator', label: nls.localize(13364, null) });
                }
                for (const { id, label } of extensionLogs) {
                    entries.push({ id, label });
                }
                const entry = await quickInputService.pick(entries, { placeHolder: nls.localize(13365, null) });
                if (entry) {
                    return outputService.showChannel(entry.id);
                }
            }
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13390, "Open Log..."),
                    category: Categories.Developer,
                    menu: {
                        id: MenuId.CommandPalette,
                    },
                    metadata: {
                        ...
                        args: [{
                                name: 'logFile',
                                schema: {
                                    markdownDescription: nls.localize(13366, null),
                                    type: 'string'
                                }
                            }]
                    },
            ...
            async run(accessor, args) {
                ...
                if (!entry) {
                    ...
                    entry = await quickInputService.pick(entries, { placeHolder: nls.localize(13367, null) });
                }
                if (entry?.id) {
            ...
            this._register(registerAction2(class extends ViewAction {
                constructor() {
                    super({
                        ...
                        title: LogLevelToLocalizedString(logLevel).value,
                        metadata: {
                            description: localize2(13391, "Show or hide {0} messages in the output", LogLevelToString(logLevel))
                        },
                        toggled,
                        menu: {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13392, "Export Logs..."),
                    f1: true,
                    category: Categories.Developer,
                    menu: [{
                            id: MenuId.ViewTitle,
            ...
            async run(accessor, arg) {
                ...
                if (extensionLogs.length && logs.length) {
                    entries.push({ type: 'separator', label: nls.localize(13369, null) });
                }
                for (const log of extensionLogs.sort((a, b) => a.label.localeCompare(b.label))) {
                    entries.push(log);
                }
                if (userLogs.length && (extensionLogs.length || logs.length)) {
                    entries.push({ type: 'separator', label: nls.localize(13370, null) });
                }
                ...
                if (arg?.outputChannelIds) {
                    ...
                    selectedOutputChannels = await quickInputService.pick(entries, { placeHolder: nls.localize(13371, null), canPickMany: true });
                }
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13393, "Import Log..."),
                    f1: true,
                    category: Categories.Developer,
                    menu: [{
                            id: MenuId.ViewTitle,
            ...
            async run(accessor) {
                ...
                const result = await fileDialogService.showOpenDialog({
                    title: nls.localize(13372, null),
                    canSelectFiles: true,
                    canSelectFolders: false,
                    canSelectMany: true,
                    filters: [{
                            name: nls.localize(13373, null),
                            extensions: ['log']
                        }]
                });
                if (result?.length) {
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    id: 'output',
    order: 30,
    title: nls.localize(13374, null),
    type: 'object',
    properties: {
        'output.smartScroll.enabled': {
            type: 'boolean',
            description: nls.localize(13375, null),
            default: true,
