...
suite('ChatSubagentContentPart', () => {
    ...
    function createPart(toolInvocation, context, idOverride) {
        const part = store.add(instantiationService.createInstance(ChatSubagentContentPart, idOverride ?? toolInvocation.subAgentInvocationId ?? toolInvocation.toolCallId, toolInvocation, context, mockMarkdownRenderer, mockListPool, mockEditorPool, () => 500, mockCodeBlockModelCollection, announcedToolProgressKeys));
...
//# sourceMappingURL=chatSubagentContentPart.test.js.map