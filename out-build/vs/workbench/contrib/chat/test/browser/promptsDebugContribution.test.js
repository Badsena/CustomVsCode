...
suite('PromptsDebugContribution', () => {
    ...
    let promptsOnDidLogDiscovery;
    let instaService;
    setup(() => {
        instaService = disposables.add(new TestInstantiationService());
        chatDebugService = disposables.add(new ChatDebugServiceImpl());
        instaService.stub(IChatDebugService, chatDebugService);
        promptsOnDidLogDiscovery = disposables.add(new Emitter());
        instaService.stub(IPromptsService, { onDidLogDiscovery: promptsOnDidLogDiscovery.event });
    });
...
//# sourceMappingURL=promptsDebugContribution.test.js.map