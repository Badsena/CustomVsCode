...
suite('RunSubagentTool', () => {
    ...
    suite('prepareToolInvocation', () => {
        test('returns correct toolSpecificData', async () => {
            ...
            const tool = testDisposables.add(new RunSubagentTool({}, {}, mockToolsService, {}, new NullLogService(), mockToolsService, configService, promptsService, {}, {}));
    ...
    suite('model fallback behavior', () => {
        ...
        function createTool(opts) {
            ...
            const tool = testDisposables.add(new RunSubagentTool({}, {}, mockToolsService, mockLanguageModelsService, new NullLogService(), mockToolsService, configService, promptsService, {}, {}));
            return tool;
        }
...
//# sourceMappingURL=runSubagentTool.test.js.map