...
class TestPluginDiscovery extends AbstractAgentPluginDiscovery {
    constructor(fileService, pathService, logService, instantiationService) {
...
suite('AgentPlugin format detection', () => {
    ...
    function createDiscovery() {
        return store.add(new TestPluginDiscovery(fileService, instantiationService.get(IPathService), logService, instantiationService));
    }
...
//# sourceMappingURL=agentPluginFormatDetection.test.js.map