...
suite('parsePluginSource', () => {
    ...
    test('parses github object source', () => {
        ...
        assert.deepStrictEqual(result, { kind: "github" /* PluginSourceKind.GitHub */, repo: 'owner/repo', ref: undefined, sha: undefined });
    });
    test('parses github object source with ref and sha', () => {
        ...
        assert.deepStrictEqual(result, { kind: "github" /* PluginSourceKind.GitHub */, repo: 'owner/repo', ref: 'v2.0.0', sha: 'a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0' });
    });
...
//# sourceMappingURL=pluginMarketplaceService.test.js.map