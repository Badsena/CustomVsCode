...
suite('PromptsService', () => {
    ...
    suite('getPromptSlashCommands - userInvocable filtering', () => {
        ...
        test('should return correct userInvocable value for skills with user-invocable: false', async () => {
            ...
            assert.strictEqual(hiddenSkillCommand.parsedPromptFile?.header?.userInvocable, false, 'Should have userInvocable=false in parsed header');
        ...
        test('should return correct userInvocable value for skills with user-invocable: true', async () => {
            ...
            assert.strictEqual(visibleSkillCommand.parsedPromptFile?.header?.userInvocable, true, 'Should have userInvocable=true in parsed header');
        ...
        test('should default to true for skills without user-invocable attribute', async () => {
            ...
            assert.strictEqual(defaultSkillCommand.parsedPromptFile?.header?.userInvocable, undefined, 'Should have userInvocable=undefined when attribute is not specified');
        ...
        test('should handle prompts with user-invocable: false', async () => {
            ...
            assert.strictEqual(hiddenPromptCommand.parsedPromptFile?.header?.userInvocable, false, 'Should have userInvocable=false in parsed header');
        ...
        test('should handle skills with missing header gracefully', async () => {
            ...
            const noHeaderSkill = slashCommands.find(cmd => cmd.promptPath.uri.path.includes('no-header-skill'));
            assert.ok(noHeaderSkill, 'Should find skill without header in slash commands');
            assert.strictEqual(noHeaderSkill.parsedPromptFile?.header, undefined, 'Should have undefined header');
            ...
            const filteredCommands = slashCommands.filter(c => c.parsedPromptFile?.header?.userInvocable !== false);
            const noHeaderSkillInFiltered = filteredCommands.find(cmd => cmd.promptPath.uri.path.includes('no-header-skill'));
...
//# sourceMappingURL=promptsService.test.js.map