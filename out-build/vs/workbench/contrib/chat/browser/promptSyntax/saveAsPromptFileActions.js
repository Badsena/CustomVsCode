...
export class SaveAsPromptFileAction extends BaseSaveAsPromptFileAction {
    constructor() {
        super(createOptions(SAVE_AS_PROMPT_FILE_ACTION_ID, localize2(7758, "Save As Prompt File"), localize2(7759, "Save as prompt file"), PROMPT_LANGUAGE_ID), PromptsType.prompt);
    }
}
...
export class SaveAsAgentFileAction extends BaseSaveAsPromptFileAction {
    constructor() {
        super(createOptions(SAVE_AS_AGENT_FILE_ACTION_ID, localize2(7760, "Save As Agent File"), localize2(7761, "Save as agent file"), AGENT_LANGUAGE_ID), PromptsType.agent);
    }
}
...
export class SaveAsInstructionsFileAction extends BaseSaveAsPromptFileAction {
    constructor() {
        super(createOptions(SAVE_AS_INSTRUCTIONS_FILE_ACTION_ID, localize2(7762, "Save As Instructions File"), localize2(7763, "Save as instructions file"), INSTRUCTIONS_LANGUAGE_ID), PromptsType.instructions);
    }
}
