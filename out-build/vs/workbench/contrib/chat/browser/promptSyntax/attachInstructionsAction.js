...
class ManageInstructionsFilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(7620, "Configure Instructions & Rules..."),
            shortTitle: localize2(7621, "Instructions & Rules"),
    ...
    async run(accessor) {
        ...
        const placeholder = localize(7616, null);
...
let ChatInstructionsPickerPick = class ChatInstructionsPickerPick {
    ...
    asPicker() {
        ...
        return {
            placeholder: localize(7618, null),
            picks,
            configure: {
                label: localize(7619, null),
