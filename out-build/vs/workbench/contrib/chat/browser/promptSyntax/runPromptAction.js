...
const RUN_CURRENT_PROMPT_ACTION_TITLE = localize2(7753, "Run Prompt in Current Chat");
...
class RunSelectedPromptAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(7754, "Run Prompt..."),
    ...
    async run(accessor) {
        ...
        const placeholder = localize(7751, null, UILabelProvider.modifierLabels[OS].ctrlKey);
...
class ManagePromptFilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(7755, "Configure Prompt Files..."),
            shortTitle: localize2(7756, "Prompt Files"),
            icon: Codicon.bookmark,
            f1: true,
            precondition: ChatContextKeys.enabled,
            category: CHAT_CATEGORY,
    ...
    async run(accessor) {
        ...
        const instaService = accessor.get(IInstantiationService);
        const pickers = instaService.createInstance(PromptFilePickers);
        const placeholder = localize(7752, null);
...
const RUN_IN_NEW_CHAT_ACTION_TITLE = localize2(7757, "Run Prompt In New Chat");
/**
