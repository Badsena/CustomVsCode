...
const chatViewsWelcomeJsonSchema = {
    ...
    properties: {
        icon: {
            type: 'string',
            description: localize(7846, null),
        },
        title: {
            type: 'string',
            description: localize(7847, null),
        },
        content: {
            type: 'string',
            description: localize(7848, null),
        },
        when: {
            type: 'string',
            description: localize(7849, null),
        }
    }
};
const chatViewsWelcomeExtensionPoint = extensionsRegistry.ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: localize(7850, null),
        type: 'array',
