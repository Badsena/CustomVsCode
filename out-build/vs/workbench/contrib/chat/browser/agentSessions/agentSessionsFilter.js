...
let AgentSessionsFilter = class AgentSessionsFilter extends Disposable {
    ...
    registerStateActions(disposables, menuId) {
        const states = [
            { id: 1 /* AgentSessionStatus.Completed */, label: localize(6235, null) },
            { id: 2 /* AgentSessionStatus.InProgress */, label: localize(6236, null) },
            { id: 3 /* AgentSessionStatus.NeedsInput */, label: localize(6237, null) },
            { id: 0 /* AgentSessionStatus.Failed */, label: localize(6238, null) },
        ];
        const that = this;
        let counter = 0;
