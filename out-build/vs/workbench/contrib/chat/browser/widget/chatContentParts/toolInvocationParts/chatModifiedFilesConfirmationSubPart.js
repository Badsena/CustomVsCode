...
let ChatModifiedFilesConfirmationSubPart = class ChatModifiedFilesConfirmationSubPart extends AbstractToolConfirmationSubPart {
    ...
    createModifiedFilesElement(data) {
        ...
        const filesLabel = data.modifiedFiles.length === 1
            ? localize(8068, null)
            : localize(8069, null, data.modifiedFiles.length);
        ...
        if (hasDiffStats) {
            ...
            titleButton.element.setAttribute('aria-label', localize(8070, null, filesLabel, added, removed));
            countsContainer.setAttribute('aria-label', localize(8071, null, added, removed));
        }
        else {
        ...
        const viewAllChangesButton = this._register(new Button(actions, {
            ...
            small: true,
            supportIcons: true,
            ariaLabel: localize(8072, null),
            title: localize(8073, null),
        }));
