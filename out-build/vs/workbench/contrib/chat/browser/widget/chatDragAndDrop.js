...
let ChatDragAndDrop = class ChatDragAndDrop extends Themable {
    ...
    getDropTypeName(type) {
        switch (type) {
            case ChatDragAndDropType.FILE_INTERNAL: return localize(8136, null);
            case ChatDragAndDropType.FILE_EXTERNAL: return localize(8137, null);
            case ChatDragAndDropType.FOLDER: return localize(8138, null);
            case ChatDragAndDropType.IMAGE: return localize(8139, null);
            case ChatDragAndDropType.SYMBOL: return localize(8140, null);
            case ChatDragAndDropType.MARKER: return localize(8141, null);
            case ChatDragAndDropType.HTML: return localize(8142, null);
            case ChatDragAndDropType.NOTEBOOK_CELL_OUTPUT: return localize(8143, null);
            case ChatDragAndDropType.SCM_HISTORY_ITEM: return localize(8144, null);
        }
    }
    ...
    async resolveHTMLAttachContext(e) {
        ...
        const createDisplayName = () => {
            const baseName = localize(8145, null);
    ...
    getOverlayText(type) {
        ...
        return localize(8146, null, typeName);
    }
