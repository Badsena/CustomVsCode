...
registerAction2(class OpenFileInDiffAction extends WorkingSetAction {
    constructor() {
        super({
            ...
            title: localize2(7097, 'Open Changes in Diff Editor'),
...
export class ChatEditingAcceptAllAction extends EditingSessionAction {
    constructor() {
        super({
            ...
            title: localize(7072, null),
            icon: Codicon.check,
            tooltip: localize(7073, null),
...
export class ChatEditingDiscardAllAction extends EditingSessionAction {
    constructor() {
        super({
            ...
            title: localize(7074, null),
            icon: Codicon.discard,
            tooltip: localize(7075, null),
            precondition: hasUndecidedChatEditingResourceContextKey,
            menu: [
                {
                    id: MenuId.ChatEditingWidgetToolbar,
...
export class ToggleExplanationWidgetAction extends EditingSessionAction {
    ...
    constructor() {
        super({
            ...
            title: localize(7076, null),
            tooltip: localize(7077, null),
            precondition: hasUndecidedChatEditingResourceContextKey,
            menu: [
                {
                    id: MenuId.ChatEditingWidgetToolbar,
...
export async function discardAllEditsWithConfirmation(accessor, currentEditingSession) {
    ...
    if (entries.length > 0) {
        const confirmation = await dialogService.confirm({
            title: localize(7078, null),
            message: entries.length === 1
                ? localize(7079, null, basename(entries[0].modifiedURI))
                : localize(7080, null, entries.length),
            primaryButton: localize(7081, null),
            type: 'info'
        });
...
export class ChatEditingShowChangesAction extends EditingSessionAction {
    ...
    static { this.LABEL = localize(7082, null); }
    constructor() {
        super({
...
export class ViewAllSessionChangesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(7100, 'View All Changes'),
            icon: Codicon.diffMultiple,
            category: CHAT_CATEGORY,
...
async function restoreSnapshotWithConfirmationByRequestId(accessor, sessionResource, requestId) {
    ...
    if (editsToUndo === 1) {
        if (entriesModifiedInRequestsToRemove.length === 1) {
            message = localize(7084, null, basename(entriesModifiedInRequestsToRemove[0].modifiedURI));
        }
        else {
            message = localize(7085, null, entriesModifiedInRequestsToRemove.length);
        }
    }
    else {
        if (entriesModifiedInRequestsToRemove.length === 1) {
            message = localize(7086, null, basename(entriesModifiedInRequestsToRemove[0].modifiedURI));
        }
        else {
            message = localize(7087, null, entriesModifiedInRequestsToRemove.length);
        }
    }
    const confirmation = shouldPrompt
        ? await dialogService.confirm({
            title: editsToUndo === 1
                ? localize(7088, null)
                : localize(7089, null, editsToUndo),
            message: message,
            primaryButton: localize(7090, null),
            checkbox: { label: localize(7091, null), checked: false },
            type: 'info'
        })
        : { confirmed: true };
    if (!confirmation.confirmed) {
...
registerAction2(class RemoveAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(7101, "Undo Requests"),
            f1: false,
            category: CHAT_CATEGORY,
            icon: Codicon.discard,
            keybinding: {
...
registerAction2(class RestoreCheckpointAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(7102, "Restore Checkpoint"),
            tooltip: localize2(7103, "Restores workspace and chat to this point"),
            f1: false,
            category: CHAT_CATEGORY,
            keybinding: {
                primary: 20 /* KeyCode.Delete */,
...
registerAction2(class RestoreLastCheckpoint extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(7104, "Restore to Last Checkpoint"),
            f1: true,
            category: CHAT_CATEGORY,
            icon: Codicon.discard,
...
registerAction2(class EditAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(7105, "Edit Request"),
            f1: false,
            category: CHAT_CATEGORY,
            icon: Codicon.edit,
            keybinding: {
...
registerAction2(class OpenWorkingSetHistoryAction extends Action2 {
    ...
    async run(accessor, ...args) {
        ...
        if (snapshot) {
            const editor = await editorService.openEditor({ resource: snapshot, label: localize(7095, null, basename(context.uri)), options: { activation: EditorActivation.ACTIVATE } });
...
registerAction2(class ResolveSymbolsContextAction extends EditingSessionAction {
    constructor() {
        super({
            ...
            title: localize2(7106, "Add Files From References"),
            f1: false,
            category: CHAT_CATEGORY,
            menu: {
...
export class ViewPreviousEditsAction extends EditingSessionAction {
    ...
    static { this.Label = localize(7096, null); }
    constructor() {
        super({
