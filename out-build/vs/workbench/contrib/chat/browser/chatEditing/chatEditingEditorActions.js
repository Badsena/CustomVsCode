...
class NavigateAction extends ChatEditingEditorAction {
    constructor(next) {
        super({
            ...
            title: next
                ? localize2(7112, 'Go to Next Chat Edit')
                : localize2(7113, 'Go to Previous Chat Edit'),
...
class KeepOrUndoAction extends ChatEditingEditorAction {
    constructor(id, _keep) {
        super({
            id,
            title: _keep
                ? localize2(7114, 'Keep Chat Edits')
                : localize2(7115, 'Undo Chat Edits'),
            shortTitle: _keep
                ? localize2(7116, 'Keep')
                : localize2(7117, 'Undo'),
            tooltip: _keep
                ? localize2(7118, 'Keep Chat Edits in this File')
                : localize2(7119, 'Undo Chat Edits in this File'),
...
class AcceptRejectHunkAction extends ChatEditingEditorAction {
    constructor(_accept) {
        super({
            ...
            title: _accept ? localize2(7120, 'Keep this Change') : localize2(7121, 'Undo this Change'),
            shortTitle: _accept ? localize2(7122, 'Keep') : localize2(7123, 'Undo'),
            precondition: ContextKeyExpr.and(ctxHasEditorModification, ctxIsCurrentlyBeingModified.negate()),
            f1: true,
            keybinding: {
...
class ToggleDiffAction extends ChatEditingEditorAction {
    constructor() {
        super({
            ...
            title: localize2(7124, 'Toggle Diff Editor for Chat Edits'),
            category: CHAT_CATEGORY,
            toggled: {
...
class ToggleAccessibleDiffViewAction extends ChatEditingEditorAction {
    constructor() {
        super({
            ...
            title: localize2(7125, 'Show Accessible Diff View for Chat Edits'),
            f1: true,
            precondition: ContextKeyExpr.and(ctxHasEditorModification, ctxIsCurrentlyBeingModified.negate()),
            keybinding: {
...
export class AcceptAllEditsAction extends ChatEditingEditorAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(7127, 'Keep All Chat Edits'),
            tooltip: localize2(7128, 'Keep All Chat Edits in this Session'),
            precondition: ContextKeyExpr.and(ctxHasEditorModification, ctxIsCurrentlyBeingModified.negate()),
...
class MultiDiffAcceptDiscardAction extends Action2 {
    constructor(accept) {
        super({
            ...
            title: accept ? localize(7108, null) : localize(7109, null),
