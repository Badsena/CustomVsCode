...
export const ctxIsGlobalEditingSession = new RawContextKey('chatEdits.isGlobalEditingSession', undefined, localize(7129, null));
export const ctxHasEditorModification = new RawContextKey('chatEdits.hasEditorModifications', undefined, localize(7130, null));
export const ctxIsCurrentlyBeingModified = new RawContextKey('chatEdits.isCurrentlyBeingModified', undefined, localize(7131, null));
export const ctxReviewModeEnabled = new RawContextKey('chatEdits.isReviewModeEnabled', true, localize(7132, null));
export const ctxHasRequestInProgress = new RawContextKey('chatEdits.isRequestInProgress', false, localize(7133, null));
export const ctxRequestCount = new RawContextKey('chatEdits.requestCount', 0, localize(7134, null));
export const ctxCursorInChangeRange = new RawContextKey('chatEdits.cursorInChangeRange', false, localize(7135, null));
