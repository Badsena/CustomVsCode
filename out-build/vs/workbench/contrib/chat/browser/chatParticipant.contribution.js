...
const chatViewDescriptor = {
    ...
    name: localize2(7306, "Chat"),
    canToggleVisibility: false,
    canMoveView: true,
    openCommandActionDescriptor: {
        id: ChatViewContainerId,
        title: chatViewContainer.title,
        mnemonicTitle: localize(7275, null),
        keybindings: {
...
const chatParticipantExtensionPoint = extensionsRegistry.ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: localize(7276, null),
        type: 'array',
        items: {
            ...
            properties: {
                id: {
                    description: localize(7277, null),
                    type: 'string'
                },
                name: {
                    description: localize(7278, null),
                    type: 'string',
                    pattern: '^[\\w-]+$'
                },
                fullName: {
                    markdownDescription: localize(7279, null, '`name`'),
                    type: 'string'
                },
                description: {
                    description: localize(7280, null),
                    type: 'string'
                },
                isSticky: {
                    description: localize(7281, null),
                    type: 'boolean'
                },
                sampleRequest: {
                    description: localize(7282, null),
                    type: 'string'
                },
                when: {
                    description: localize(7283, null),
                    type: 'string'
                },
                disambiguation: {
                    description: localize(7284, null),
                    type: 'array',
                    items: {
                        additionalProperties: false,
                        type: 'object',
                        ...
                        properties: {
                            category: {
                                markdownDescription: localize(7285, null),
                                type: 'string'
                            },
                            description: {
                                description: localize(7286, null),
                                type: 'string'
                            },
                            examples: {
                                description: localize(7287, null),
                                type: 'array'
                            },
                        }
                    }
                ...
                commands: {
                    markdownDescription: localize(7288, null),
                    type: 'array',
                    items: {
                        additionalProperties: false,
                        type: 'object',
                        ...
                        properties: {
                            name: {
                                description: localize(7289, null),
                                type: 'string'
                            },
                            description: {
                                description: localize(7290, null),
                                type: 'string'
                            },
                            when: {
                                description: localize(7291, null),
                                type: 'string'
                            },
                            sampleRequest: {
                                description: localize(7292, null),
                                type: 'string'
                            },
                            isSticky: {
                                description: localize(7293, null),
                                type: 'boolean'
                            },
                            disambiguation: {
                                description: localize(7294, null),
                                type: 'array',
                                items: {
                                    additionalProperties: false,
                                    type: 'object',
                                    ...
                                    properties: {
                                        category: {
                                            markdownDescription: localize(7295, null),
                                            type: 'string'
                                        },
                                        description: {
                                            description: localize(7296, null),
                                            type: 'string'
                                        },
                                        examples: {
                                            description: localize(7297, null),
                                            type: 'array'
                                        },
                                    }
                                }
...
let ChatCompatibilityNotifier = class ChatCompatibilityNotifier extends Disposable {
    ...
    registerWelcomeView(chatExtension) {
        ...
        const showExtensionLabel = localize(7298, null);
        const mainMessage = localize(7299, null, this.productService.nameLong);
