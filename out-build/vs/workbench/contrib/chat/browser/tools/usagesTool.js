...
let UsagesTool = class UsagesTool extends Disposable {
    ...
    getToolData() {
        ...
        return {
            ...
            displayName: localize(7840, null),
            userDescription: localize(7841, null),
            modelDescription,
    ...
    async prepareToolInvocation(context, _token) {
        ...
        return {
            invocationMessage: localize(7842, null, input.symbol),
        };
    }
    async invoke(invocation, _countTokens, _progress, token) {
        ...
        try {
            ...
            if (references.length === 0) {
                ...
                result.toolResultMessage = new MarkdownString(localize(7843, null, input.symbol));
                return result;
            }
            ...
            result.toolResultMessage = references.length === 1
                ? new MarkdownString(localize(7844, null, input.symbol))
                : new MarkdownString(localize(7845, null, input.symbol, references.length));
