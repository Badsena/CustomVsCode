 ...
 */
export const CONTEXT_AI_CUSTOMIZATION_MANAGEMENT_EDITOR = new RawContextKey('aiCustomizationManagementEditorFocused', false, localize(6447, null));
/**
 * Context key for the currently selected section.
 */
export const CONTEXT_AI_CUSTOMIZATION_MANAGEMENT_SECTION = new RawContextKey('aiCustomizationManagementSection', AICustomizationManagementSection.Agents, localize(6448, null));
/**
