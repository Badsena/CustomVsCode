    ...
    registerAction2(class OpenInChatViewAction extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(6067, "Open in Chat View"),
                f1: false,
    ...
    registerAction2(class CloseQuickChatAction extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(6068, "Close Quick Chat"),
                f1: false,
                category: CHAT_CATEGORY,
                icon: Codicon.close,
                menu: {
...
class QuickChatGlobalAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(6069, 'Open Quick Chat'),
            ...
            metadata: {
                description: localize(6063, null),
                args: [{
                        name: 'args',
                        schema: {
                            anyOf: [
                                {
                                    ...
                                    properties: {
                                        query: {
                                            description: localize(6064, null),
                                            type: 'string'
                                        },
                                        isPartialQuery: {
                                            description: localize(6065, null),
                                            type: 'boolean'
                                        }
                                    },
                                },
                                {
                                    type: 'string',
                                    description: localize(6066, null)
                                }
                            ]
                        }
                    }]
...
class AskQuickChatAction extends Action2 {
    constructor() {
        super({
            ...
            category: CHAT_CATEGORY,
            title: localize2(6070, "Open Quick Chat"),
            precondition: ChatContextKeys.enabled,
            f1: true
        });
    }
