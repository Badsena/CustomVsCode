    ...
    registerAction2(class MarkUnhelpfulAction extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(6077, "Unhelpful"),
                f1: false,
                category: CHAT_CATEGORY,
    ...
    registerAction2(class ReportIssueForBugAction extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(6078, "Report Issue"),
                f1: false,
                category: CHAT_CATEGORY,
                icon: Codicon.report,
                menu: [{
            ...
            if (chatModel && (mode === ChatModeKind.Edit || mode === ChatModeKind.Agent)) {
                ...
                const confirmation = shouldPrompt
                    ? await dialogService.confirm({
                        title: localize(6071, null),
                        message: entriesModifiedInLastRequest.length === 1
                            ? localize(6072, null, basename(entriesModifiedInLastRequest[0].modifiedURI))
                            : localize(6073, null, entriesModifiedInLastRequest.length),
                        primaryButton: localize(6074, null),
                        checkbox: { label: localize(6075, null), checked: false },
                        type: 'info'
                    })
                    : { confirmed: true };
    ...
    registerAction2(class InsertToNotebookAction extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(6080, "Insert into Notebook"),
                f1: false,
                category: CHAT_CATEGORY,
                icon: Codicon.insert,
                menu: {
