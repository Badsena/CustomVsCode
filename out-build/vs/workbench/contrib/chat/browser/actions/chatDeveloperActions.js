...
class LogChatInputHistoryAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(5948, "Log Chat Input History"),
            icon: Codicon.attach,
...
class LogChatIndexAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(5949, "Log Chat Index"),
            icon: Codicon.attach,
            category: Categories.Developer,
            f1: true,
            precondition: ChatContextKeys.enabled
...
class InspectChatModelAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(5950, "Inspect Chat Model"),
...
class ClearRecentlyUsedLanguageModelsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(5951, "Clear Recently Used Language Models"),
            category: Categories.Developer,
            f1: true,
            precondition: ChatContextKeys.enabled
        });
