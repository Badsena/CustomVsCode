...
class AttachFileToChatAction extends AttachResourceAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(5930, "Add File to Chat"),
...
class AttachFolderToChatAction extends AttachResourceAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(5931, "Add Folder to Chat"),
            category: CHAT_CATEGORY,
            f1: false,
            menu: {
                id: MenuId.ExplorerContext,
...
class AttachPinnedEditorsToChatAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(5932, "Add Pinned Editors to Chat"),
            category: CHAT_CATEGORY,
            precondition: ChatContextKeys.enabled,
            f1: true,
        });
...
class AttachSelectionToChatAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(5933, "Add Selection to Chat"),
            category: CHAT_CATEGORY,
            icon: Codicon.attach,
            f1: true,
            precondition: ChatContextKeys.enabled,
...
export class AttachSearchResultAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(5934, 'Add Search Results to Chat'),
            category: CHAT_CATEGORY,
            f1: false,
            menu: [{
                    id: MenuId.SearchContext,
...
export class AttachContextAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(5935, "Add Context..."),
            icon: Codicon.add,
            category: CHAT_CATEGORY,
            keybinding: {
    ...
    _show(accessor, widget, additionPicks, placeholder) {
        ...
        quickInputService.quickAccess.show('', {
            ...
            placeholder: placeholder ?? localize(5928, null),
            providerOptions,
        });
    }
