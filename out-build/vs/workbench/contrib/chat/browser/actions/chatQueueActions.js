...
export class ChatQueueMessageAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(6055, "Add to Queue"),
            tooltip: localize(6053, null),
            icon: Codicon.add,
            f1: false,
...
export class ChatSteerWithMessageAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(6056, "Steer with Message"),
            tooltip: localize(6054, null),
...
export class ChatRemovePendingRequestAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(6057, "Remove from Queue"),
            icon: Codicon.close,
            f1: false,
            category: CHAT_CATEGORY,
            menu: [{
...
export class ChatSendPendingImmediatelyAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(6058, "Send Immediately"),
            icon: Codicon.arrowUp,
            f1: false,
            category: CHAT_CATEGORY,
            menu: [{
...
export class ChatRemoveAllPendingRequestsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(6059, "Remove All Queued"),
...
export function registerChatQueueActions() {
    ...
    MenuRegistry.appendMenuItem(MenuId.ChatExecuteQueue, {
        command: { id: ChatQueueMessageAction.ID, title: localize2(6060, "Add to Queue"), icon: Codicon.add },
        group: 'navigation',
        order: 1,
    });
    MenuRegistry.appendMenuItem(MenuId.ChatExecuteQueue, {
        command: { id: ChatSteerWithMessageAction.ID, title: localize2(6061, "Steer with Message"), icon: Codicon.arrowUp },
        group: 'navigation',
        order: 2,
    });
    MenuRegistry.appendMenuItem(MenuId.ChatExecute, {
        submenu: MenuId.ChatExecuteQueue,
        title: localize2(6062, "Queue"),
