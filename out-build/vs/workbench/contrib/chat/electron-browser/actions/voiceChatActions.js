...
const ScopedVoiceChatGettingReady = new RawContextKey('scopedVoiceChatGettingReady', false, { type: 'boolean', description: localize(8997, null) });
const ScopedVoiceChatInProgress = new RawContextKey('scopedVoiceChatInProgress', undefined, { type: 'string', description: localize(8998, null) });
...
let VoiceChatSessions = class VoiceChatSessions {
    ...
    onDidSpeechToTextSessionStart(controller, disposables) {
        ...
        const updatePlaceholder = () => {
            ...
            controller.setInputPlaceholder(`${localize(8999, null)}${'.'.repeat(dotCount)}`);
...
export class VoiceChatInChatViewAction extends VoiceChatWithHoldModeAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(9010, "Voice Chat in Chat View"),
...
export class HoldToVoiceChatInChatViewAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(9011, "Hold to Voice Chat in Chat View"),
            keybinding: {
...
export class InlineVoiceChatAction extends VoiceChatWithHoldModeAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(9012, "Inline Voice Chat"),
            category: CHAT_CATEGORY,
...
export class QuickVoiceChatAction extends VoiceChatWithHoldModeAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(9013, "Quick Voice Chat"),
            category: CHAT_CATEGORY,
            precondition: CanVoiceChat,
            f1: true
        }, 'quick');
...
export class StartVoiceChatAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(9014, "Start Voice Chat"),
            category: CHAT_CATEGORY,
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class StopListeningAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(9015, "Stop Listening"),
            category: CHAT_CATEGORY,
            f1: true,
            keybinding: {
...
export class StopListeningAndSubmitAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(9016, "Stop Listening and Submit"),
            category: CHAT_CATEGORY,
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
const ScopedChatSynthesisInProgress = new RawContextKey('scopedChatSynthesisInProgress', false, { type: 'boolean', description: localize(9000, null) });
...
export class ReadChatResponseAloud extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9017, "Read Aloud"),
            icon: Codicon.unmute,
            precondition: CanVoiceChat,
            menu: [{
...
export class StopReadAloud extends Action2 {
    ...
    constructor() {
        super({
            id: StopReadAloud.ID,
            icon: syncing,
            title: localize2(9018, "Stop Reading Aloud"),
            f1: true,
            category: CHAT_CATEGORY,
...
export class StopReadChatItemAloud extends Action2 {
    ...
    constructor() {
        super({
            ...
            icon: Codicon.mute,
            title: localize2(9019, "Stop Reading Aloud"),
        ...
        registry.registerConfiguration({
            ...
            properties: {
                [KEYWORD_ACTIVIATION_SETTING_ID]: {
                    ...
                    'description': localize(9006, null),
                    'default': 'off',
                    'tags': ['accessibility']
                }
            }
...
let KeywordActivationStatusEntry = class KeywordActivationStatusEntry extends Disposable {
    ...
    static { this.STATUS_NAME = localize(9007, null); }
    static { this.STATUS_COMMAND = 'keywordActivation.status.command'; }
    static { this.STATUS_ACTIVE = localize(9008, null); }
    static { this.STATUS_INACTIVE = localize(9009, null); }
