...
export const HOOK_COMMAND_FIELD_DESCRIPTIONS = {
    type: nls.localize(8513, null),
    command: nls.localize(8514, null),
    windows: nls.localize(8515, null),
    linux: nls.localize(8516, null),
    osx: nls.localize(8517, null),
    bash: nls.localize(8518, null),
    powershell: nls.localize(8519, null),
    cwd: nls.localize(8520, null),
    env: nls.localize(8521, null),
    timeout: nls.localize(8522, null),
    timeoutSec: nls.localize(8523, null),
};
/**
...
const vscodeHookCommandSchema = {
    ...
    errorMessage: nls.localize(8524, null),
    properties: {
        type: {
            type: 'string',
            enum: ['command'],
...
const copilotCliHookCommandSchema = {
    ...
    errorMessage: nls.localize(8525, null),
    properties: {
        type: {
            type: 'string',
            enum: ['command'],
...
export const hookFileSchema = {
    ...
    type: 'object',
    description: nls.localize(8526, null),
    additionalProperties: true,
    required: ['hooks'],
    properties: {
        hooks: {
            type: 'object',
            description: nls.localize(8527, null),
            additionalProperties: true,
        }
    },
    ...
    then: {
        ...
        properties: {
            version: {
                type: 'number',
                description: nls.localize(8528, null),
            },
            hooks: {
    ...
    defaultSnippets: [
        {
            label: nls.localize(8529, null),
            description: nls.localize(8530, null),
            body: {
                hooks: {
                    SessionStart: [
                        {
