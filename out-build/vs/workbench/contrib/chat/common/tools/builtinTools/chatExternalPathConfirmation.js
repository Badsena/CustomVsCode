...
export class ChatExternalPathConfirmationContribution {
    ...
    getPreConfirmActions(ref) {
        ...
        const actions = [
            {
                label: localize(8860, null),
                detail: localize(8861, null),
                select: async () => {
        ...
        if (this._findGitRoot) {
            ...
            if (cached === null) {
                ...
                actions.push({
                    label: localize(8862, null),
                    detail: localize(8863, null, cached.fsPath),
                    select: async () => {
                ...
                actions.push({
                    label: localize(8864, null),
                    detail: localize(8865, null),
                    select: async () => {
    ...
    getManageActions() {
        ...
        for (const folderUri of workspaceFolders) {
            items.push({
                ...
                description: localize(8866, null),
                checked: true,
        ...
        for (const folderUri of allSessionFolders) {
            ...
            items.push({
                label: this._labelService.getUriLabel(folderUri),
                description: localize(8867, null),
                checked: true,
                onDidChangeChecked: (checked) => {
                    if (!checked) {
        ...
        if (this._pickFolder) {
            ...
            items.push({
                pickable: false,
                label: localize(8868, null),
                description: localize(8869, null),
                onDidOpen: async () => {
