...
const customEditorsContributionSchema = {
    ...
    properties: {
        [Fields.viewType]: {
            type: 'string',
            markdownDescription: nls.localize(9498, null),
        },
        [Fields.displayName]: {
            type: 'string',
            description: nls.localize(9499, null),
        },
        [Fields.selector]: {
            type: 'array',
            description: nls.localize(9500, null),
            items: {
                type: 'object',
                defaultSnippets: [{
                        body: {
                ...
                properties: {
                    filenamePattern: {
                        type: 'string',
                        description: nls.localize(9501, null),
                    },
                }
            }
        },
        [Fields.priority]: {
            type: 'string',
            markdownDeprecationMessage: nls.localize(9502, null),
            enum: [
                "default" /* CustomEditorPriority.default */,
                "option" /* CustomEditorPriority.option */,
            ],
            markdownEnumDescriptions: [
                nls.localize(9503, null),
                nls.localize(9504, null),
            ],
...
export const customEditorsExtensionPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: nls.localize(9505, null),
        type: 'array',
        defaultSnippets: [{
                body: [{
                        [Fields.viewType]: '$1',
...
class CustomEditorsDataRenderer extends Disposable {
    ...
    render(manifest) {
        ...
        const headers = [
            nls.localize(9506, null),
            nls.localize(9507, null),
            nls.localize(9508, null),
        ];
