...
const copyPathCommand = {
    ...
    title: nls.localize(11202, null)
};
const copyRelativePathCommand = {
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: nls.localize(11203, null)
};
export const revealInSideBarCommand = {
    id: REVEAL_IN_EXPLORER_COMMAND_ID,
    title: nls.localize(11204, null)
};
...
appendSaveConflictEditorTitleAction('workbench.files.action.acceptLocalChanges', nls.localize(11205, null), Codicon.check, -10, acceptLocalChangesCommand);
appendSaveConflictEditorTitleAction('workbench.files.action.revertLocalChanges', nls.localize(11206, null), Codicon.discard, -9, revertLocalChangesCommand);
...
appendToCommandPalette({
    id: COPY_PATH_COMMAND_ID,
    title: nls.localize2(11225, "Copy Path of Active File"),
    category: Categories.File
});
appendToCommandPalette({
    id: COPY_RELATIVE_PATH_COMMAND_ID,
    title: nls.localize2(11226, "Copy Relative Path of Active File"),
    category: Categories.File
});
appendToCommandPalette({
...
appendToCommandPalette({
    ...
    title: nls.localize2(11227, "Save All in Group"),
    category: Categories.File
});
appendToCommandPalette({
    id: SAVE_FILES_COMMAND_ID,
    title: nls.localize2(11228, "Save All Files"),
    category: Categories.File
});
appendToCommandPalette({
    id: REVERT_FILE_COMMAND_ID,
    title: nls.localize2(11229, "Revert File"),
    category: Categories.File
});
appendToCommandPalette({
    id: COMPARE_WITH_SAVED_COMMAND_ID,
    title: nls.localize2(11230, "Compare Active File with Saved"),
    category: Categories.File,
    metadata: {
        description: nls.localize2(11231, "Opens a new diff editor to compare the active file with the version on disk.")
    }
});
appendToCommandPalette({
...
appendToCommandPalette({
    ...
    category: Categories.File,
    metadata: { description: nls.localize2(11232, "Create a new folder or directory") }
}, WorkspaceFolderCountContext.notEqualsTo('0'));
appendToCommandPalette({
