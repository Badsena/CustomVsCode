...
let ExplorerView = class ExplorerView extends ViewPane {
    ...
    renderHeader(container) {
        ...
        const setHeader = () => {
            ...
            this.ariaHeaderLabel = nls.localize(11492, null, this.name);
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11495, "Refresh Explorer"),
            f1: true,
            ...
            metadata: {
                description: nls.localize2(11496, "Forces a refresh of the Explorer.")
            },
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11497, "Collapse Folders in Explorer"),
            f1: true,
            ...
            metadata: {
                description: nls.localize2(11498, "Folds all folders in the Explorer.")
            }
        });
    }
    run(accessor) {
