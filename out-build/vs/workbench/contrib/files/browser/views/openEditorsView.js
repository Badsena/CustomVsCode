...
let OpenEditorsView = class OpenEditorsView extends ViewPane {
    ...
    static { this.NAME = nls.localize2(11519, "Open Editors"); }
    ...
    updateDirtyIndicator(workingCopy) {
        ...
        if (dirty === 0) {
            ...
            this.dirtyCountElement.textContent = nls.localize(11516, null, dirty);
...
class OpenEditorsAccessibilityProvider {
    getWidgetAriaLabel() {
        return nls.localize(11517, null);
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11520, "Toggle Vertical/Horizontal Editor Layout"),
            f1: true,
            keybinding: {
...
MenuRegistry.appendMenuItem(MenuId.MenubarLayoutMenu, {
    ...
    command: {
        ...
        title: {
            ...nls.localize2(11521, "Flip Layout"),
            mnemonicTitle: nls.localize(11518, null)
        }
    },
    order: 1
});
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(11522, "New Untitled Text File"),
            f1: false,
