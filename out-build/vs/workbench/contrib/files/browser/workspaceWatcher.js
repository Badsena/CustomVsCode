...
let WorkspaceWatcher = class WorkspaceWatcher extends Disposable {
    ...
    onDidWatchError(error) {
        ...
        if (msg.indexOf('ENOSPC') >= 0) {
            reason = 'ENOSPC';
            this.notificationService.prompt(Severity.Warning, localize(11523, null), [{
                    label: localize(11524, null),
        ...
        // Detect when the watcher throws an error unexpectedly
            ...
            reason = 'EUNKNOWN';
            this.notificationService.prompt(Severity.Warning, localize(11525, null), [{
                    label: localize(11526, null),
