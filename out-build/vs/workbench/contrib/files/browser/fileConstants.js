...
export const SAVE_FILE_AS_LABEL = nls.localize2(11336, "Save As...");
export const SAVE_FILE_COMMAND_ID = 'workbench.action.files.save';
export const SAVE_FILE_LABEL = nls.localize2(11337, "Save");
export const SAVE_FILE_WITHOUT_FORMATTING_COMMAND_ID = 'workbench.action.files.saveWithoutFormatting';
export const SAVE_FILE_WITHOUT_FORMATTING_LABEL = nls.localize2(11338, "Save without Formatting");
export const SAVE_ALL_COMMAND_ID = 'saveAll';
export const SAVE_ALL_LABEL = nls.localize2(11339, "Save All");
...
export const REMOVE_ROOT_FOLDER_LABEL = nls.localize(11335, null);
...
export const NEW_UNTITLED_FILE_LABEL = nls.localize2(11340, "New Untitled Text File");
