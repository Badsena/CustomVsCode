...
const explorerViewIcon = registerIcon('explorer-view-icon', Codicon.files, localize(11196, null));
const openEditorsViewIcon = registerIcon('open-editors-view-icon', Codicon.book, localize(11197, null));
...
export const VIEW_CONTAINER = viewContainerRegistry.registerViewContainer({
    id: VIEWLET_ID,
    title: localize2(11200, "Explorer"),
    ...
    openCommandActionDescriptor: {
        id: VIEWLET_ID,
        title: localize2(11201, "Explorer"),
        mnemonicTitle: localize(11198, null),
