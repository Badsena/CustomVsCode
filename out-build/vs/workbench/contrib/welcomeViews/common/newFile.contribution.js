...
const builtInSource = localize(17557, null);
const category = localize2(17565, 'Create');
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: 'welcome.showNewFileEntries',
            title: localize2(17566, 'New File...'),
            category,
            f1: true,
            keybinding: {
...
let NewFileTemplatesManager = class NewFileTemplatesManager extends Disposable {
    ...
    async selectNewEntry(entries) {
        ...
        qp.title = localize(17558, null);
        qp.placeholder = localize(17559, null);
        ...
        const displayCategory = {
            'file': localize(17560, null),
            'notebook': localize(17561, null),
        };
