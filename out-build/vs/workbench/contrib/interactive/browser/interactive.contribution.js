...
const interactiveWindowCategory = localize2(11718, "Interactive Window");
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(11719, 'Open Interactive Window'),
            f1: false,
            category: interactiveWindowCategory,
            metadata: {
                description: localize(11709, null),
                args: [
                    {
                        name: 'showOptions',
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(11720, 'Execute Code'),
            category: interactiveWindowCategory,
            keybinding: [{
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(11721, 'Clear the interactive window input editor contents'),
            category: interactiveWindowCategory,
            f1: false
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(11722, 'Previous value in history'),
            category: interactiveWindowCategory,
            f1: false,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(11723, 'Next value in history'),
            category: interactiveWindowCategory,
            f1: false,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(11724, 'Focus Input Editor'),
            category: interactiveWindowCategory,
            menu: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(11725, 'Focus History'),
            category: interactiveWindowCategory,
            menu: {
                id: MenuId.CommandPalette,
                when: ContextKeyExpr.equals('activeEditor', 'workbench.editor.interactive'),
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    'properties': {
        [ReplEditorSettings.interactiveWindowAlwaysScrollOnNewCell]: {
            type: 'boolean',
            default: true,
            markdownDescription: localize(11714, null)
        },
        [NotebookSetting.InteractiveWindowPromptToSave]: {
            type: 'boolean',
            default: false,
            markdownDescription: localize(11715, null)
        },
        [ReplEditorSettings.executeWithShiftEnter]: {
            type: 'boolean',
            default: false,
            markdownDescription: localize(11716, null),
            tags: ['replExecute']
        },
        [ReplEditorSettings.showExecutionHint]: {
            type: 'boolean',
            default: true,
            markdownDescription: localize(11717, null),
            tags: ['replExecute']
        }
    }
});
