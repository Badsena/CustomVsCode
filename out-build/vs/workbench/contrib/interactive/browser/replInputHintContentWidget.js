...
let ReplInputHintContentWidget = class ReplInputHintContentWidget extends Disposable {
    ...
    setHint() {
        ...
        if (keybinding && keybindingHintLabel) {
            const actionPart = localize(11726, null, keybindingHintLabel);
            ...
            const helpInfo = helpKeybinding
                ? localize(11727, null, helpKeybinding)
                : localize(11728, null);
            this.ariaLabel = actionPart.concat(helpInfo, localize(11729, null, "accessibility.verbosity.replEditor" /* AccessibilityVerbositySettingId.ReplEditor */));
        }
    }
    getKeybinding() {
