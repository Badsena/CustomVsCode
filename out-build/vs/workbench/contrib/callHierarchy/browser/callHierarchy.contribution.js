...
const _ctxHasCallHierarchyProvider = new RawContextKey('editorHasCallHierarchyProvider', false, localize(5718, null));
const _ctxCallHierarchyVisible = new RawContextKey('callHierarchyVisible', false, localize(5719, null));
const _ctxCallHierarchyDirection = new RawContextKey('callHierarchyDirection', undefined, { type: 'string', description: localize(5720, null) });
    ...
    _showCallHierarchyWidget(position, direction, model, cts) {
        ...
        model.then(model => {
            ...
            if (model) {
                ...
                this._widget.showMessage(localize(5721, null));
            }
        }).catch(err => {
            ...
            this._widget.showMessage(localize(5722, null));
        });
    }
    showOutgoingCalls() {
...
registerAction2(class PeekCallHierarchyAction extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(5726, 'Peek Call Hierarchy'),
            menu: {
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(5727, 'Show Incoming Calls'),
            icon: registerIcon('callhierarchy-incoming', Codicon.callIncoming, localize(5723, null)),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(5728, 'Show Outgoing Calls'),
            icon: registerIcon('callhierarchy-outgoing', Codicon.callOutgoing, localize(5724, null)),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(5729, 'Refocus Call Hierarchy'),
