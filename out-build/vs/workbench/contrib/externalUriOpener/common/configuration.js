...
export const externalUriOpenersConfigurationNode = {
    ...
    properties: {
        [externalUriOpenersSettingId]: {
            type: 'object',
            markdownDescription: nls.localize(11158, null),
            defaultSnippets: [{
                    body: {
                        'example.com': '$1'
                    }
            ...
            additionalProperties: {
                anyOf: [
                    {
                        type: 'string',
                        markdownDescription: nls.localize(11159, null, exampleUriPatterns),
                    },
                    {
                        type: 'string',
                        markdownDescription: nls.localize(11160, null, exampleUriPatterns),
                        enum: [defaultExternalUriOpenerId],
                        enumDescriptions: [nls.localize(11161, null)],
                    },
