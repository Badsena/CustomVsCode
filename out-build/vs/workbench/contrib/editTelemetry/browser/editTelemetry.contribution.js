...
configurationRegistry.registerConfiguration({
    id: 'task',
    order: 100,
    title: localize(10437, null),
    type: 'object',
    properties: {
        [EDIT_TELEMETRY_SETTING_ID]: {
            markdownDescription: localize(10438, null),
            type: 'boolean',
            default: true,
            tags: ['experimental'],
        },
        [AI_STATS_SETTING_ID]: {
            markdownDescription: localize(10439, null),
            type: 'boolean',
            default: false,
            tags: ['experimental'],
            experiment: {
        ...
        [EDIT_TELEMETRY_DETAILS_SETTING_ID]: {
            markdownDescription: localize(10440, null),
            type: 'boolean',
            default: false,
            tags: ['experimental'],
            experiment: {
        ...
        [EDIT_TELEMETRY_SHOW_STATUS_BAR]: {
            markdownDescription: localize(10441, null),
            type: 'boolean',
            default: false,
            tags: ['experimental'],
        },
        [EDIT_TELEMETRY_SHOW_DECORATIONS]: {
            markdownDescription: localize(10442, null),
            type: 'boolean',
            default: false,
            tags: ['experimental'],
        },
