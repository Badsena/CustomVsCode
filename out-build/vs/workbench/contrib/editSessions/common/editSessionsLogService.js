...
let EditSessionsLogService = class EditSessionsLogService extends AbstractLogger {
    constructor(loggerService, environmentService) {
        super();
        this.logger = this._register(loggerService.createLogger(joinPath(environmentService.logsHome, `${editSessionsLogId}.log`), { id: editSessionsLogId, name: localize(10425, null), group: windowLogGroup }));
    }
    trace(message, ...args) {
