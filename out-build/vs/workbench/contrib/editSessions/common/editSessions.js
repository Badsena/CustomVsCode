...
export const EDIT_SESSION_SYNC_CATEGORY = localize2(10423, 'Cloud Changes');
...
export const EDIT_SESSIONS_TITLE = localize2(10424, 'Cloud Changes');
export const EDIT_SESSIONS_VIEW_ICON = registerIcon('edit-sessions-view-icon', Codicon.cloudDownload, localize(10422, null));
