...
const resumeProgressOptionsTitle = `[${localize(10346, null)}](command:${showOutputChannelCommand.id})`;
...
let EditSessionsContribution = class EditSessionsContribution extends Disposable {
    ...
    constructor(editSessionsStorageService, fileService, progressService, openerService, telemetryService, scmService, notificationService, dialogService, logService, environmentService, instantiationService, productService, configurationService, contextService, editSessionIdentityService, quickInputService, commandService, contextKeyService, fileDialogService, lifecycleService, storageService, activityService, editorService, remoteAgentService, extensionService, requestService, userDataProfilesService, uriIdentityService, workspaceIdentityService) {
        ...
        this._register(this.lifecycleService.onWillShutdown((e) => {
            if (e.reason !== 3 /* ShutdownReason.RELOAD */ && this.editSessionsStorageService.isSignedIn && this.configurationService.getValue('workbench.experimental.cloudChanges.autoStore') === 'onShutdown' && !isWeb) {
                e.join(this.autoStoreEditSession(), { id: 'autoStoreWorkingChanges', label: localize(10347, null) });
            }
        }));
    ...
    updateAccountsMenuBadge() {
        ...
        const badge = new NumberBadge(1, () => localize(10348, null));
        ...
        this._register(registerAction2(class ShowEditSessionView extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(10394, 'Show Cloud Changes'),
                    category: EDIT_SESSION_SYNC_CATEGORY,
                    f1: true
                });
            }
        ...
        this._register(registerAction2(class ResumeLatestEditSessionAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(10395, 'Resume Latest Changes from Cloud'),
                    category: EDIT_SESSION_SYNC_CATEGORY,
                    f1: true,
                });
            }
        ...
        this._register(registerAction2(class ResumeLatestEditSessionAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(10396, 'Resume Changes from Serialized Data'),
                    category: 'Developer',
                    f1: true,
                });
            }
        ...
        this._register(registerAction2(class StoreLatestEditSessionAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(10397, 'Store Working Changes in Cloud'),
                    category: EDIT_SESSION_SYNC_CATEGORY,
                    f1: true,
                });
            }
    ...
    async resumeEditSession(ref, silent, forceApplyUnrelatedChange, applyPartialMatch, progress, serializedData) {
        ...
        progress?.report({ message: localize(10352, null) });
        const data = serializedData ? { content: serializedData, ref: '' } : await this.editSessionsStorageService.read('editSessions', ref);
        if (!data) {
            if (ref === undefined && !silent) {
                this.notificationService.info(localize(10353, null));
            }
            else if (ref !== undefined) {
                this.notificationService.warn(localize(10354, null, ref));
            }
        ...
        if (editSession.version > EditSessionSchemaVersion) {
            this.notificationService.error(localize(10355, null, this.productService.nameLong));
        ...
        try {
            ...
            if (conflictingChanges.length > 0) {
                ...
                const { confirmed } = await this.dialogService.confirm({
                    ...
                    message: conflictingChanges.length > 1 ?
                        localize(10356, null, conflictingChanges.length) :
                        localize(10357, null, basename(conflictingChanges[0].uri)),
            ...
            this.notificationService.error(localize(10358, null));
        }
                    ...
                    if (identity !== undefined) {
                        ...
                        if (match === EditSessionIdentityMatch.Complete) {
                            ...
                            if (!applyPartialMatch) {
                                ...
                                this.notificationService.prompt(Severity.Info, localize(10359, null), [{ label: localize(10360, null), run: () => this.resumeEditSession(ref, false, undefined, true) }]);
                            }
                            else {
                                folderRoot = f;
                                break;
    ...
    async storeEditSession(fromStoreCommand, cancellationToken) {
            ...
            for (const uri of trackedUris) {
                ...
                if (await this.fileService.exists(uri)) {
                    ...
                    if (editSessionSize > this.editSessionsStorageService.SIZE_LIMIT) {
                        this.notificationService.error(localize(10361, null));
                        return undefined;
                    }
        ...
        if (!hasEdits) {
            ...
            if (fromStoreCommand) {
                this.notificationService.info(localize(10362, null));
            }
            return undefined;
        }
            ...
            if (ex instanceof UserDataSyncStoreError) {
                switch (ex.code) {
                    case "TooLarge" /* UserDataSyncErrorCode.TooLarge */:
                        ...
                        this.notificationService.error(localize(10363, null));
                        break;
                    default:
                        this.telemetryService.publicLog2('editSessions.upload.failed', { reason: 'unknown' });
                        this.notificationService.error(localize(10364, null));
                        break;
                }
            }
        }
    ...
    async shouldContinueOnWithEditSession() {
        ...
        if (this.hasEditSession()) {
            ...
            quickpick.placeholder = localize(10365, null);
            quickpick.ok = false;
            quickpick.ignoreFocusOut = true;
            const withCloudChanges = { label: localize(10366, null) };
            const withoutCloudChanges = { label: localize(10367, null) };
    ...
    registerContinueInLocalFolderAction() {
        ...
        if (getVirtualWorkspaceLocation(this.contextService.getWorkspace()) !== undefined && isNative) {
            this.generateStandaloneOptionCommand(openLocalFolderCommand.id, localize(10369, null), undefined, openLocalFolderCommand.precondition, undefined);
        }
    }
    async pickContinueEditSessionDestination() {
        ...
        quickPick.placeholder = localize(10370, null, `'${workspaceContext}'`);
    ...
    createPickItems() {
        ...
        if (getVirtualWorkspaceLocation(this.contextService.getWorkspace()) !== undefined && isNative) {
            items.push(new ContinueEditSessionItem('$(folder) ' + localize(10371, null), openLocalFolderCommand.id, localize(10372, null)));
        }
...
const continueEditSessionExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: localize(10374, null),
        type: 'array',
        items: {
            type: 'object',
            properties: {
                command: {
                    description: localize(10375, null),
                    type: 'string'
                },
                group: {
                    description: localize(10376, null),
                    type: 'string'
                },
                qualifiedName: {
                    description: localize(10377, null),
                    type: 'string'
                },
                description: {
                    description: localize(10378, null),
                    type: 'string'
                },
                remoteGroup: {
                    description: localize(10379, null),
                    type: 'string'
                },
                when: {
                    description: localize(10380, null),
                    type: 'string'
                }
            },
            required: ['command']
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    'properties': {
        'workbench.experimental.cloudChanges.autoStore': {
            ...
            'default': 'off',
            'markdownDescription': localize(10383, null),
        },
        'workbench.cloudChanges.autoResume': {
            ...
            'default': 'onReload',
            'markdownDescription': localize(10386, null),
        },
        'workbench.cloudChanges.continueOn': {
            ...
            tags: ['usesOnlineServices'],
            default: 'prompt',
            markdownDescription: localize(10389, null)
        },
        'workbench.experimental.cloudChanges.partialMatches.enabled': {
            'type': 'boolean',
            'tags': ['experimental', 'usesOnlineServices'],
            'default': false,
            'markdownDescription': localize(10390, null)
        }
    }
});
