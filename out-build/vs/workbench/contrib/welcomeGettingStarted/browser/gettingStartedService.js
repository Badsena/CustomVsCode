...
const BUILT_IN_SOURCE = localize(17418, null);
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            category: localize2(17419, "Developer"),
            title: localize2(17420, "Reset Welcome Page Walkthrough Progress"),
            f1: true,
            metadata: {
                description: localize2(17421, 'Reset the progress of all Walkthrough steps on the Welcome Page to make them appear as if they are being viewed for the first time, providing a fresh start to the getting started experience.'),
            }
        });
    }
    run(accessor) {
