...
const timelineViewIcon = registerIcon('timeline-view-icon', Codicon.history, localize(16786, null));
const timelineOpenIcon = registerIcon('timeline-open', Codicon.history, localize(16787, null));
...
configurationRegistry.registerConfiguration({
    id: 'timeline',
    order: 1001,
    title: localize(16788, null),
    type: 'object',
    properties: {
        'timeline.pageSize': {
            type: ['number', 'null'],
            default: 50,
            markdownDescription: localize(16789, null),
        },
        'timeline.pageOnScroll': {
            type: 'boolean',
            default: true,
            description: localize(16790, null),
        },
    }
});
...
(function (OpenTimelineAction) {
    ...
    OpenTimelineAction.LABEL = localize(16791, null);
    function handler() {
        return (accessor, arg) => {
...
const timelineFilter = registerIcon('timeline-filter', Codicon.filter, localize(16792, null));
MenuRegistry.appendMenuItem(MenuId.TimelineTitle, {
    submenu: MenuId.TimelineFilterSubMenu,
    title: localize(16793, null),
    group: 'navigation',
    order: 100,
    icon: timelineFilter
});
