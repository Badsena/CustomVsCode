...
class LoadMoreCommand {
    ...
    get label() {
        return this.loading ? localize(16794, null) : localize(16795, null);
    }
    get themeIcon() {
        return undefined;
    }
...
let TimelinePane = class TimelinePane extends ViewPane {
    static { this.TITLE = localize2(16809, "Timeline"); }
    ...
    *getItems() {
    ...
    refresh() {
        ...
        if (this.uri === undefined) {
            ...
            this.message = localize(16796, null);
        }
        else if (this._isEmpty) {
    ...
    renderBody(container) {
        ...
        this.message = localize(16802, null);
        ...
        this.tree = this.instantiationService.createInstance((WorkbenchObjectTree), 'TimelinePane', this.$tree, new TimelineListVirtualDelegate(), [this.treeRenderer], {
            ...
            accessibilityProvider: {
                getAriaLabel(element) {
                    ...
                    return element.accessibilityInformation ? element.accessibilityInformation.label : localize(16803, null, element.relativeTimeFullWord ?? '', element.label);
                },
                getRole(element) {
                    if (isLoadMoreCommand(element)) {
                        return 'treeitem';
    ...
    setLoadingUriMessage() {
        ...
        this.message = file ? localize(16805, null, file) : '';
    }
...
const timelineRefresh = registerIcon('timeline-refresh', Codicon.refresh, localize(16806, null));
const timelinePin = registerIcon('timeline-pin', Codicon.pin, localize(16807, null));
const timelineUnpin = registerIcon('timeline-unpin', Codicon.pinned, localize(16808, null));
    ...
    constructor(pane, timelineService, storageService, contextKeyService, menuService) {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    id: 'timeline.refresh',
                    title: localize2(16810, "Refresh"),
                    icon: timelineRefresh,
                    category: localize2(16811, "Timeline"),
                    menu: {
        ...
        this._register(MenuRegistry.appendMenuItem(MenuId.TimelineTitle, ({
            command: {
                ...
                title: localize2(16812, 'Pin the Current Timeline'),
                icon: timelinePin,
                category: localize2(16813, "Timeline"),
            },
            group: 'navigation',
            order: 98,
        ...
        this._register(MenuRegistry.appendMenuItem(MenuId.TimelineTitle, ({
            command: {
                id: 'timeline.toggleFollowActiveEditor',
                title: localize2(16814, 'Unpin the Current Timeline'),
                icon: timelineUnpin,
                category: localize2(16815, "Timeline"),
            },
            group: 'navigation',
            order: 98,
