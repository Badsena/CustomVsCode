    ...
    async _previewEdit(edits) {
        ...
        if (view.hasInput()) {
            const { confirmed } = await this._dialogService.confirm({
                type: Severity.Info,
                message: localize(5678, null),
                detail: localize(5679, null),
                primaryButton: localize(5680, null)
            });
            if (!confirmed) {
                return [];
            }
...
registerAction2(class ApplyAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(5682, "Apply Refactoring"),
            category: localize2(5683, "Refactor Preview"),
            icon: Codicon.check,
...
registerAction2(class DiscardAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(5684, "Discard Refactoring"),
            category: localize2(5685, "Refactor Preview"),
...
registerAction2(class ToggleAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(5686, "Toggle Change"),
            category: localize2(5687, "Refactor Preview"),
            precondition: BulkEditPreviewContribution.ctxEnabled,
            keybinding: {
...
registerAction2(class GroupByFile extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(5688, "Group Changes By File"),
            category: localize2(5689, "Refactor Preview"),
...
registerAction2(class GroupByType extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(5690, "Group Changes By Type"),
            category: localize2(5691, "Refactor Preview"),
...
registerAction2(class ToggleGrouping extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(5692, "Group Changes By Type"),
            category: localize2(5693, "Refactor Preview"),
...
const refactorPreviewViewIcon = registerIcon('refactor-preview-view-icon', Codicon.lightbulb, localize(5681, null));
const container = Registry.as(ViewContainerExtensions.ViewContainersRegistry).registerViewContainer({
    id: BulkEditPane.ID,
    title: localize2(5694, "Refactor Preview"),
    hideIfEmpty: true,
...
Registry.as(ViewContainerExtensions.ViewsRegistry).registerViews([{
        id: BulkEditPane.ID,
        name: localize2(5695, "Refactor Preview"),
