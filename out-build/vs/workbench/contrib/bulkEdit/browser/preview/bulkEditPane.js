...
let BulkEditPane = class BulkEditPane extends ViewPane {
    ...
    renderBody(parent) {
        ...
        btnConfirm.label = localize(5696, null);
        btnConfirm.onDidClick(() => this.accept(), this, this._disposables);
        const btnCancel = buttonBar.addButton({ ...defaultButtonStyles, secondary: true });
        btnCancel.label = localize(5697, null);
        btnCancel.onDidClick(() => this.discard(), this, this._disposables);
        // message
        this._message = document.createElement('span');
        this._message.className = 'message';
        this._message.innerText = localize(5698, null);
    ...
    accept() {
        ...
        if (conflicts.length === 1) {
            message = localize(5699, null, this._labelService.getUriLabel(conflicts[0], { relative: true }));
        }
        else {
            message = localize(5700, null, conflicts.length);
        }
