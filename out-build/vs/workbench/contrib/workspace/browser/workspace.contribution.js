...
let WorkspaceTrustRequestHandler = class WorkspaceTrustRequestHandler extends Disposable {
    ...
    registerListeners() {
        ...
        this._register(this.workspaceTrustRequestService.onDidInitiateResourcesTrustRequest(async (options) => {
            ...
            // Details
            const markdownDetails = [
                options?.message ?? localize(17592, null),
                localize(17593, null),
            ...
            await this.dialogService.prompt({
                type: Severity.Info,
                message: localize(17594, null),
                buttons: [
                    {
                        label: localize(17595, null),
        ...
        this._register(this.workspaceTrustRequestService.onDidInitiateWorkspaceTrustRequest(async (requestOptions) => {
            ...
            const message = this.useWorkspaceLanguage ?
                ...
                localize(17597, null);
            // Message
            const defaultDetails = localize(17598, null);
            const details = requestOptions?.message ?? defaultDetails;
            // Buttons
            const buttons = requestOptions?.buttons ?? [
                { label: this.useWorkspaceLanguage ? localize(17599, null) : localize(17600, null), type: 'ContinueWithTrust' },
                { label: localize(17601, null), type: 'Manage' }
            ];
            // Add Cancel button if not provided
            if (!buttons.some(b => b.type === 'Cancel')) {
                buttons.push({ label: localize(17602, null), type: 'Cancel' });
            }
            // Dialog
            const { result } = await this.dialogService.prompt({
                ...
                custom: {
                    ...
                    markdownDetails: [
                        ...
                        { markdown: new MarkdownString(localize(17603, null)) }
                    ]
                },
...
let WorkspaceTrustUXHandler = class WorkspaceTrustUXHandler extends Disposable {
    ...
    registerListeners() {
                ...
                if (trusted && (e.changes.added.length || e.changes.changed.length)) {
                    ...
                    if (!addedFoldersTrustInfo.map(info => info.trusted).every(trusted => trusted)) {
                        const { confirmed } = await this.dialogService.confirm({
                            type: Severity.Info,
                            message: localize(17604, null),
                            detail: localize(17605, null),
                            cancelButton: localize(17606, null),
        ...
        this._register(this.workspaceTrustRequestService.onDidInitiateWorkspaceTrustRequestOnStartup(async () => {
            ...
            if (!isAiGeneratedWorkspace && this.workspaceTrustManagementService.canSetParentFolderTrust()) {
                ...
                checkboxText = localize(17609, null, name);
            }
            // Show Workspace Trust Start Dialog
            this.doShowModal(title, { label: trustOption ?? localize(17610, null), sublabel: isSingleFolderWorkspace ? localize(17611, null) : localize(17612, null) }, { label: dontTrustOption ?? localize(17613, null), sublabel: isSingleFolderWorkspace ? localize(17614, null) : localize(17615, null) }, [
                !isSingleFolderWorkspace ?
                    localize(17616, null, this.productService.nameShort) :
                    localize(17617, null, this.productService.nameShort),
                learnMoreString ?? localize(17618, null),
                !isEmptyWindow ?
    ...
    getBannerItem(restrictedMode) {
        ...
        const actions = [
            {
                label: localize(17619, null),
                href: 'command:' + MANAGE_TRUST_COMMAND_ID
            },
            {
                label: localize(17620, null),
    ...
    getBannerItemAriaLabels() {
        switch (this.workspaceContextService.getWorkbenchState()) {
            case 1 /* WorkbenchState.EMPTY */:
                return localize(17621, null);
            case 2 /* WorkbenchState.FOLDER */:
                return localize(17622, null);
            case 3 /* WorkbenchState.WORKSPACE */:
                return localize(17623, null);
        }
    }
    getBannerItemMessages() {
        switch (this.workspaceContextService.getWorkbenchState()) {
            case 1 /* WorkbenchState.EMPTY */:
                return localize(17624, null);
            case 2 /* WorkbenchState.FOLDER */:
                return localize(17625, null);
            case 3 /* WorkbenchState.WORKSPACE */:
                return localize(17626, null);
        }
    }
    get bannerSetting() {
    ...
    getRestrictedModeStatusbarEntry() {
        ...
        switch (this.workspaceContextService.getWorkbenchState()) {
            case 1 /* WorkbenchState.EMPTY */: {
                ariaLabel = localize(17627, null);
                toolTip = {
                    value: localize(17628, null, `command:${LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID}`, `command:${MANAGE_TRUST_COMMAND_ID}`),
                    isTrusted: true,
            ...
            case 2 /* WorkbenchState.FOLDER */: {
                ariaLabel = localize(17629, null);
                toolTip = {
                    value: localize(17630, null, `command:${LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID}`, `command:${MANAGE_TRUST_COMMAND_ID}`),
                    isTrusted: true,
                    supportThemeIcons: true
                };
                break;
            ...
            case 3 /* WorkbenchState.WORKSPACE */: {
                ariaLabel = localize(17631, null);
                toolTip = {
                    value: localize(17632, null, `command:${LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID}`, `command:${MANAGE_TRUST_COMMAND_ID}`),
                    isTrusted: true,
                    supportThemeIcons: true
                };
                break;
        ...
        return {
            name: localize(17633, null),
            text: `$(shield) ${localize(17634, null)}`,
            ariaLabel: ariaLabel,
            tooltip: toolTip,
...
Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(WorkspaceTrustEditor, WorkspaceTrustEditor.ID, localize(17635, null)), [
...
const WORKSPACES_CATEGORY = localize2(17650, 'Workspaces');
registerAction2(class extends Action2 {
    constructor() {
        super({
            id: CONFIGURE_TRUST_COMMAND_ID,
            title: localize2(17651, "Configure Workspace Trust Settings"),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17652, "Manage Workspace Trust"),
            precondition: ContextKeyExpr.and(WorkspaceTrustContext.IsEnabled, ContextKeyExpr.equals(`config.${WORKSPACE_TRUST_ENABLED}`, true)),
            category: WORKSPACES_CATEGORY,
            f1: true,
        });
...
Registry.as(ConfigurationExtensions.Configuration)
    ...
    properties: {
        [WORKSPACE_TRUST_ENABLED]: {
            type: 'boolean',
            default: true,
            description: localize(17636, null),
        ...
        [WORKSPACE_TRUST_STARTUP_PROMPT]: {
            type: 'string',
            default: 'once',
            description: localize(17637, null),
            tags: [WORKSPACE_TRUST_SETTING_TAG],
            scope: 1 /* ConfigurationScope.APPLICATION */,
        ...
        [WORKSPACE_TRUST_BANNER]: {
            ...
            description: localize(17641, null),
            tags: [WORKSPACE_TRUST_SETTING_TAG],
            scope: 1 /* ConfigurationScope.APPLICATION */,
        ...
        [WORKSPACE_TRUST_UNTRUSTED_FILES]: {
            type: 'string',
            default: 'prompt',
            markdownDescription: localize(17645, null, WORKSPACE_TRUST_EMPTY_WINDOW),
            tags: [WORKSPACE_TRUST_SETTING_TAG],
            scope: 1 /* ConfigurationScope.APPLICATION */,
        ...
        [WORKSPACE_TRUST_EMPTY_WINDOW]: {
            type: 'boolean',
            default: true,
            markdownDescription: localize(17649, null, WORKSPACE_TRUST_UNTRUSTED_FILES),
            tags: [WORKSPACE_TRUST_SETTING_TAG],
            scope: 1 /* ConfigurationScope.APPLICATION */
        }
    }
