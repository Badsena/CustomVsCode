...
let TerminalViewPane = class TerminalViewPane extends ViewPane {
    ...
    _updateTabActionBar(profiles) {
        ...
        this._disposableStore.add(this._configurationService.onDidChangeConfiguration(e => {
            if (e.affectsConfiguration("terminal.integrated.experimental.aiProfileGrouping" /* TerminalSettingId.ExperimentalAiProfileGrouping */)) {
...
let SwitchTerminalActionViewItem = class SwitchTerminalActionViewItem extends SelectActionViewItem {
    constructor(action, _terminalService, _terminalGroupService, contextViewService, terminalProfileService, configurationService) {
        super(null, action, getTerminalSelectOpenItems(_terminalService, _terminalGroupService), _terminalGroupService.activeGroupIndex, contextViewService, defaultSelectBoxStyles, { ariaLabel: nls.localize(15523, null), optionsAsChildren: true, useCustomDrawn: !hasNativeContextMenu(configurationService) });
        this._terminalService = _terminalService;
        this._terminalGroupService = _terminalGroupService;
...
function getTerminalSelectOpenItems(terminalService, terminalGroupService) {
    ...
    if (terminalService.connectionState === 1 /* TerminalConnectionState.Connected */) {
        ...
        items = [{ text: nls.localize(15524, null) }];
    }
