...
export const switchTerminalShowTabsTitle = localize(15335, null);
        ...
        case 'workspaceRoot':
            if (folders !== undefined && commandService !== undefined) {
                if (folders.length === 1) {
                    ...
                    const options = {
                        placeHolder: localize(15336, null)
                    };
...
let TerminalLaunchHelpAction = class TerminalLaunchHelpAction extends Action {
    constructor(_openerService) {
        super('workbench.action.terminal.launchHelp', localize(15337, null));
...
export function registerTerminalActions() {
    registerTerminalAction({
        ...
        title: localize2(15354, 'Create New Terminal (In Active Workspace)'),
        run: async (c) => {
    ...
    registerTerminalAction({
        ...
        title: localize2(15355, 'Create New Terminal in Editor Area'),
        run: async (c, _, args) => {
    ...
    registerTerminalAction({
        ...
        title: localize2(15356, 'Create New Terminal in Editor Area'),
        f1: false,
    ...
    registerTerminalAction({
        ...
        title: localize2(15357, 'Create New Terminal in Editor Area to the Side'),
        run: async (c) => {
            const instance = await c.service.createTerminal({
    ...
    registerTerminalAction({
        ...
        title: localize2(15358, 'Focus Previous Terminal in Terminal Group'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15359, 'Focus Next Terminal in Terminal Group'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15360, 'Resize Terminal Left'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15361, 'Resize Terminal Right'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15362, 'Resize Terminal Up'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15363, 'Resize Terminal Down'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15364, 'Focus Terminal Tabs View'),
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15365, 'Focus Next Terminal Group'),
        precondition: sharedWhenClause.terminalAvailable,
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15366, 'Focus Previous Terminal Group'),
        precondition: sharedWhenClause.terminalAvailable,
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15367, 'Run Selected Text In Active Terminal'),
    ...
    registerTerminalAction({
        ...
        title: localize2(15368, 'Run Active File In Active Terminal'),
        precondition: sharedWhenClause.terminalAvailable,
        run: async (c, accessor) => {
            const codeEditorService = accessor.get(ICodeEditorService);
            ...
            if ((!isRemote && uri.scheme !== Schemas.file && uri.scheme !== Schemas.vscodeUserData) || (isRemote && uri.scheme !== Schemas.vscodeRemote)) {
                notificationService.warn(localize(15338, null));
                return;
            }
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15369, 'Scroll Down (Line)'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15370, 'Scroll Down (Page)'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15371, 'Scroll to Bottom'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15372, 'Scroll Up (Line)'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15373, 'Scroll Up (Page)'),
        f1: true,
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15374, 'Scroll to Top'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15375, 'Clear Selection'),
        keybinding: {
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(15376, 'Detach Session'),
    ...
    registerTerminalAction({
        ...
        title: localize2(15377, 'Attach to Session'),
        run: async (c, accessor) => {
            ...
            if (items.length === 0) {
                notificationService.info(localize(15339, null));
                return;
            }
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(15378, 'Select to Previous Command'),
        keybinding: {
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(15379, 'Select to Next Command'),
        keybinding: {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15380, 'Select to Previous Line'),
        precondition: sharedWhenClause.terminalAvailable,
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15381, 'Select to Next Line'),
        precondition: sharedWhenClause.terminalAvailable,
        run: async (xterm, _, instance) => {
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            cwd: {
                                description: localize(15340, null),
                                type: 'string'
                            }
                        },
                    }
    ...
    registerActiveInstanceAction({
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            name: {
                                description: localize(15341, null),
                                type: 'string',
                                minLength: 1
                            }
                        }
        ...
        run: async (activeInstance, c, accessor, args) => {
            ...
            if (!name) {
                notificationService.warn(localize(15342, null));
                return;
            }
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(15382, 'Relaunch Active Terminal'),
    ...
    registerTerminalAction({
        ...
        title: localize2(15383, 'Join Terminals'),
    ...
    registerTerminalAction({
        ...
        title: localize2(15384, 'Join Terminals...'),
        precondition: sharedWhenClause.terminalAvailable,
        run: async (c, accessor) => {
            ...
            if (c.groupService.instances.length <= 1) {
                notificationService.warn(localize(15343, null));
                return;
            }
            ...
            if (picks.length === 0) {
                notificationService.warn(localize(15344, null));
                return;
            }
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(15385, 'Split Terminal (In Active Workspace)'),
        run: async (instance, c) => {
    ...
    registerActiveXtermAction({
        ...
        title: localize2(15386, 'Select All'),
        precondition: sharedWhenClause.terminalAvailable,
        keybinding: [{
    ...
    registerTerminalAction({
        ...
        title: localize2(15387, 'Create New Terminal'),
        precondition: ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.webExtensionContributedProfile),
    ...
    registerTerminalAction({
        ...
        title: localize2(15388, 'Kill the Active Terminal Instance'),
    ...
    registerTerminalAction({
        ...
        title: localize2(15389, 'Kill All Terminals'),
        precondition: ContextKeyExpr.or(sharedWhenClause.terminalAvailable, TerminalContextKeys.isOpen),
        icon: Codicon.trash,
        run: async (c) => {
    ...
    registerTerminalAction({
        ...
        title: localize2(15390, 'Kill the Active Terminal in Editor Area'),
        precondition: sharedWhenClause.terminalAvailable,
        keybinding: {
    ...
    registerTerminalAction({
        ...
        title: localize2(15392, 'Select Default Profile'),
    ...
    registerTerminalAction({
        ...
        title: localize2(15393, 'Configure Terminal Settings'),
        precondition: sharedWhenClause.terminalAvailable,
    ...
    registerActiveInstanceAction({
        ...
        title: localize2(15394, 'Set Fixed Dimensions'),
        precondition: sharedWhenClause.terminalAvailable_and_opened,
    ...
    registerTerminalAction({
        ...
        title: localize2(15395, 'Switch Terminal'),
        precondition: sharedWhenClause.terminalAvailable,
        run: async (c, accessor, args) => {
    ...
    newWithProfileAction = registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(15396, 'Create New Terminal (With Profile)'),
                f1: true,
                precondition: ContextKeyExpr.or(TerminalContextKeys.processSupported, TerminalContextKeys.webExtensionContributedProfile),
                metadata: {
        ...
        async run(accessor, eventOrOptionsOrProfile, profile) {
            ...
            if (folders.length > 1) {
                ...
                const options = {
                    placeHolder: localize(15350, null)
                };
                const workspace = await commandService.executeCommand(PICK_WORKSPACE_FOLDER_COMMAND_ID, [options]);
                if (!workspace) {
                    // Don't create the instance if the workspace picker was canceled
...
async function pickTerminalCwd(accessor, cancel) {
    ...
    const folderPicks = shrinkedPairs.map(pair => {
        ...
        const description = pair.isOverridden
            ? localize(15351, null, labelService.getUriLabel(pair.cwd, { relative: !pair.isAbsolute }))
    ...
    const options = {
        placeHolder: localize(15352, null),
