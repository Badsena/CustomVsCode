...
export const terminalContributionsDescriptor = {
    ...
    jsonSchema: {
        description: nls.localize(15557, null),
        type: 'object',
        properties: {
            profiles: {
                type: 'array',
                description: nls.localize(15558, null),
                items: {
                    type: 'object',
                    required: ['id', 'title'],
                    defaultSnippets: [{
                    ...
                    properties: {
                        id: {
                            description: nls.localize(15559, null),
                            type: 'string',
                        },
                        title: {
                            description: nls.localize(15560, null),
                            type: 'string',
                        },
                        icon: {
                            description: nls.localize(15561, null),
                            anyOf: [{
                                    type: 'string',
                                },
                                {
                                    ...
                                    properties: {
                                        light: {
                                            description: nls.localize(15562, null),
                                            type: 'string'
                                        },
                                        dark: {
                                            description: nls.localize(15563, null),
                                            type: 'string'
                                        }
                                    }
                                }]
                        ...
                        titleTemplate: {
                            description: nls.localize(15564, null),
                            type: 'string',
                        },
                    },
                },
            ...
            completionProviders: {
                type: 'array',
                description: nls.localize(15565, null),
                items: {
                    type: 'object',
                    required: ['id'],
                    defaultSnippets: [{
                    ...
                    properties: {
                        description: {
                            description: nls.localize(15566, null),
                            type: 'string',
                        },
                    },
                },
