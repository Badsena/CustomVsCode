...
export const CONTEXT_BROWSER_CAN_GO_BACK = new RawContextKey('browserCanGoBack', false, localize(5518, null));
export const CONTEXT_BROWSER_CAN_GO_FORWARD = new RawContextKey('browserCanGoForward', false, localize(5519, null));
export const CONTEXT_BROWSER_FOCUSED = new RawContextKey('browserFocused', true, localize(5520, null));
export const CONTEXT_BROWSER_STORAGE_SCOPE = new RawContextKey('browserStorageScope', '', localize(5521, null));
export const CONTEXT_BROWSER_HAS_URL = new RawContextKey('browserHasUrl', false, localize(5522, null));
export const CONTEXT_BROWSER_HAS_ERROR = new RawContextKey('browserHasError', false, localize(5523, null));
export const CONTEXT_BROWSER_DEVTOOLS_OPEN = new RawContextKey('browserDevToolsOpen', false, localize(5524, null));
...
class BrowserNavigationBar extends Disposable {
    constructor(editor, container, instantiationService, scopedContextKeyService) {
        ...
        this._urlInput.placeholder = localize(5525, null);
    ...
    _updateDisplay() {
        ...
        if (hasCertError && url.startsWith(httpsPrefix)) {
            ...
            this._urlDisplay.textContent = url || localize(5526, null);
        }
    }
    clear() {
...
let BrowserEditor = class BrowserEditor extends EditorPane {
    ...
    updateOverlayPauseMessage(overlappingOverlays) {
        ...
        if (hasNotificationOverlay) {
            this._overlayPauseHeading.textContent = localize(5527, null);
            this._overlayPauseDetail.textContent = localize(5528, null);
        }
        else {
    ...
    updateErrorDisplay() {
        ...
        if (error) {
            ...
            urlLabel.textContent = localize(5532, null);
            const urlValue = $('code');
            ...
            if (error.certificateError) {
                ...
                extraWarning.textContent = localize(5533, null);
            ...
            if (error.certificateError) {
                ...
                heading.textContent = localize(5534, null);
                ...
                addRow(localize(5535, null), certError.error);
                addRow(localize(5536, null), certError.issuerName);
                addRow(localize(5537, null), certError.subjectName);
                const formatDate = (epoch) => new Date(epoch * 1000).toLocaleDateString();
                addRow(localize(5538, null), `${formatDate(certError.validStart)} - ${formatDate(certError.validExpiry)}`);
                addRow(localize(5539, null), certError.fingerprint);
                ...
                secondaryButton.label = localize(5542, null);
    ...
    createWelcomeContainer() {
        ...
        title.textContent = localize(5543, null);
