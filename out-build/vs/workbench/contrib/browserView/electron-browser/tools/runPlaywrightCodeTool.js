...
export const RunPlaywrightCodeToolData = {
    ...
    displayName: localize(5646, null),
    userDescription: localize(5647, null),
...
let RunPlaywrightCodeTool = class RunPlaywrightCodeTool {
    ...
    async prepareToolInvocation(context, _token) {
        ...
        return {
            invocationMessage: new MarkdownString(localize(5648, null)),
            pastTenseMessage: new MarkdownString(localize(5649, null)),
            confirmationMessages: {
                title: localize(5650, null),
                message: new MarkdownString(`\`\`\`javascript\n${code.trim()}\n\`\`\``),
                disclaimer: localize(5651, null),
    ...
    async invoke(invocation, _countTokens, _progress, _token) {
        ...
        if (result.result) {
            ...
            outputMessage.appendMarkdown(localize(5652, null));
