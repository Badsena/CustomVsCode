...
export class ShowSignalSoundHelp extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(5434, "Help: List Signal Sounds"),
            f1: true,
            metadata: {
                description: localize(5427, null)
            }
        });
    }
    async run(accessor) {
        ...
        qp.placeholder = localize(5429, null);
...
export class ShowAccessibilityAnnouncementHelp extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(5435, "Help: List Signal Announcements"),
            f1: true,
            metadata: {
                description: localize(5430, null)
            }
        });
    }
    async run(accessor) {
        ...
        disposables.add(qp.onDidHide(() => disposables.dispose()));
        qp.placeholder = screenReaderOptimized ? localize(5432, null) : localize(5433, null);
        qp.canSelectMany = true;
        await qp.show();
    }
}
