...
export const HasSpeechProvider = new RawContextKey('hasSpeechProvider', false, { type: 'boolean', description: localize(14819, null) });
export const SpeechToTextInProgress = new RawContextKey('speechToTextInProgress', false, { type: 'boolean', description: localize(14820, null) });
export const TextToSpeechInProgress = new RawContextKey('textToSpeechInProgress', false, { type: 'boolean', description: localize(14821, null) });
...
export const SPEECH_LANGUAGES = {
    ['da-DK']: {
        name: localize(14822, null)
    },
    ['de-DE']: {
        name: localize(14823, null)
    },
    ['en-AU']: {
        name: localize(14824, null)
    },
    ['en-CA']: {
        name: localize(14825, null)
    },
    ['en-GB']: {
        name: localize(14826, null)
    },
    ['en-IE']: {
        name: localize(14827, null)
    },
    ['en-IN']: {
        name: localize(14828, null)
    },
    ['en-NZ']: {
        name: localize(14829, null)
    },
    ['en-US']: {
        name: localize(14830, null)
    },
    ['es-ES']: {
        name: localize(14831, null)
    },
    ['es-MX']: {
        name: localize(14832, null)
    },
    ['fr-CA']: {
        name: localize(14833, null)
    },
    ['fr-FR']: {
        name: localize(14834, null)
    },
    ['hi-IN']: {
        name: localize(14835, null)
    },
    ['it-IT']: {
        name: localize(14836, null)
    },
    ['ja-JP']: {
        name: localize(14837, null)
    },
    ['ko-KR']: {
        name: localize(14838, null)
    },
    ['nl-NL']: {
        name: localize(14839, null)
    },
    ['pt-PT']: {
        name: localize(14840, null)
    },
    ['pt-BR']: {
        name: localize(14841, null)
    },
    ['ru-RU']: {
        name: localize(14842, null)
    },
    ['sv-SE']: {
        name: localize(14843, null)
    },
    ['tr-TR']: {
        // allow-any-unicode-next-line
        name: localize(14844, null)
    },
    ['zh-CN']: {
        name: localize(14845, null)
    },
    ['zh-HK']: {
        name: localize(14846, null)
    },
    ['zh-TW']: {
        name: localize(14847, null)
    }
};
