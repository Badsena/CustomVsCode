...
let IssueFormService = class IssueFormService {
    ...
    async showConfirmCloseDialog() {
        await this.dialogService.prompt({
            ...
            message: localize(11772, null),
            buttons: [
                {
                    label: localize(11773, null),
                    run: () => {
                        this.closeReporter();
                        this.issueReporterWindow = null;
                    }
    ...
    async showClipboardDialog() {
        ...
        await this.dialogService.prompt({
            type: Severity.Warning,
            message: localize(11775, null),
            buttons: [
                {
                    label: localize(11776, null),
                    run: () => { result = true; }
                },
                {
                    label: localize(11777, null),
                    run: () => { result = false; }
                }
            ]
        });
