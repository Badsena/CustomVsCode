...
let InlayHintsAccessibility = class InlayHintsAccessibility {
    ...
    static { this.IsReading = new RawContextKey('isReadingLineWithInlayHints', false, { type: 'boolean', description: localize(11593, null) }); }
    ...
    constructor(_editor, contextKeyService, _accessibilitySignalService, _instaService) {
        ...
        this._ariaElement.setAttribute('aria-description', localize(11594, null));
...
registerAction2(class StartReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(11595, "Read Line with Inlay Hints"),
...
registerAction2(class StopReadHints extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(11596, "Stop Inlay Hints Reading"),
