...
export class GoToFileAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12733, 'Open File'),
...
export class GoToNextChangeAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12734, 'Go to Next Change'),
...
export class GoToPreviousChangeAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12735, 'Go to Previous Change'),
...
export class CollapseAllAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12736, 'Collapse All Diffs'),
...
export class ExpandAllAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12737, 'Expand All Diffs'),
