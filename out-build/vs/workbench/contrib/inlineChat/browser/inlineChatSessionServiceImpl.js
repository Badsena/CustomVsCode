...
let InlineChatEscapeToolContribution = class InlineChatEscapeToolContribution extends Disposable {
    ...
    static { this._data = {
        ...
        displayName: localize(11639, null),
        ...
        inputSchema: {
            ...
            properties: {
                response: {
                    type: 'string',
                    description: localize(11640, null),
                    maxLength: 200,
                }
            }
        }
        ...
        this._store.add(lmTools.registerTool(InlineChatEscapeToolContribution_1._data, {
            invoke: async (invocation, _tokenCountFn, _progress, _token) => {
                ...
                if (!lastRequest) {
                    ...
                    return { content: [{ kind: 'text', value: 'Cancel' }], toolResultMessage: localize(11641, null) };
                }
                ...
                if (dontAskAgain !== undefined) {
                    ...
                    result = await dialogService.confirm({
                        type: 'question',
                        title: localize(11643, null),
                        message: localize(11644, null),
                        detail: localize(11645, null),
                        primaryButton: localize(11646, null),
                        cancelButton: localize(11647, null),
                        checkbox: { label: localize(11648, null), checked: false },
                    });
                }
...
registerAction2(class ResetMoveToPanelChatChoice extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(11649, "Reset Choice for 'Move Inline Chat to Panel Chat'"),
            f1: true
        });
    }
    run(accessor) {
