...
const _ctxHasTypeHierarchyProvider = new RawContextKey('editorHasTypeHierarchyProvider', false, localize(16816, null));
const _ctxTypeHierarchyVisible = new RawContextKey('typeHierarchyVisible', false, localize(16817, null));
const _ctxTypeHierarchyDirection = new RawContextKey('typeHierarchyDirection', undefined, { type: 'string', description: localize(16818, null) });
    ...
    _showTypeHierarchyWidget(position, direction, model, cts) {
        ...
        model.then(model => {
            ...
            if (model) {
                ...
                this._widget.showMessage(localize(16819, null));
            }
        }).catch(err => {
            ...
            this._widget.showMessage(localize(16820, null));
        });
    }
...
registerAction2(class PeekTypeHierarchyAction extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(16822, 'Peek Type Hierarchy'),
            menu: {
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(16823, 'Show Supertypes'),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(16824, 'Show Subtypes'),
...
registerAction2(class extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(16825, 'Refocus Type Hierarchy'),
