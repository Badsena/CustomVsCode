...
registerAction2(class OpenSyncBackupsFolder extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17249, "Open Local Backups Folder"),
            category: SYNC_TITLE,
            menu: {
    ...
    async run(accessor) {
        ...
        if (await fileService.exists(syncHome)) {
            ...
            notificationService.info(localize(17246, null));
        }
    }
});
registerAction2(class DownloadSyncActivityAction extends Action2 {
    ...
    async run(accessor) {
        ...
        if (folder) {
            notificationService.prompt(Severity.Info, localize(17247, null), [{
                    label: localize(17248, null),
