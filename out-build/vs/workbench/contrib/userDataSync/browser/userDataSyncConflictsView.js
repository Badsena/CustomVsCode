...
let UserDataSyncConflictsViewPane = class UserDataSyncConflictsViewPane extends TreeViewPane {
    ...
    renderTreeView(container) {
        ...
        const that = this;
        this.treeView.message = localize(17205, null);
    ...
    async open(conflictToOpen) {
        ...
        const remoteResourceName = localize(17209, null, basename(conflictToOpen.remoteResource));
        const localResourceName = localize(17210, null, basename(conflictToOpen.remoteResource));
        await this.editorService.openEditor({
            input1: { resource: conflictToOpen.remoteResource, label: localize(17211, null), description: remoteResourceName },
            input2: { resource: conflictToOpen.localResource, label: localize(17212, null), description: localResourceName },
