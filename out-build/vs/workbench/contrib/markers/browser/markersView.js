...
let MarkersView = class MarkersView extends FilterViewPane {
    ...
    updateBadge(total, filtered) {
        this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : localize(12078, null, filtered, total));
    }
    checkMoreFilters() {
    ...
    renderMessage() {
        ...
        if (filtered === 0) {
            ...
            if (filtered === total) {
                this.setAriaLabel(localize(12079, null, total));
            }
            else {
                this.setAriaLabel(localize(12080, null, filtered, total));
            }
    ...
    renderFilteredByFilterMessage(container) {
        ...
        link.textContent = localize(12081, null);
