...
let MarkerChatContextPick = class MarkerChatContextPick {
    constructor(_markerService, _labelService, _editorService) {
        ...
        this.label = localize(12061, null);
    ...
    asPicker() {
        return {
            placeholder: localize(12062, null),
        ...
        for (const group of sortedGroups) {
            ...
            for (const marker of group) {
                ...
                items.push({
                    ...
                    description: localize(12063, null, '' + marker.startLineNumber, '' + marker.startColumn),
                    asAttachment() {
