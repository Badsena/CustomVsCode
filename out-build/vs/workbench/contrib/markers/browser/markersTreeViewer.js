...
const expandedIcon = registerIcon('markers-view-multi-line-expanded', Codicon.chevronUp, localize(12074, null));
const collapsedIcon = registerIcon('markers-view-multi-line-collapsed', Codicon.chevronDown, localize(12075, null));
...
class MarkerWidget extends Disposable {
    ...
    renderMultilineActionbar(marker, parent) {
        ...
        action.tooltip = multiline ? localize(12076, null) : localize(12077, null);
