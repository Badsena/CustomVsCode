...
const markersViewIcon = registerIcon('markers-view-icon', Codicon.warning, localize(11978, null));
...
Registry.as(ViewContainerExtensions.ViewsRegistry).registerViews([{
        ...
        openCommandActionDescriptor: {
            ...
            mnemonicTitle: localize(11979, null),
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(11980, null),
            metadata: {
                description: localize2(12008, "Show the problems view as a tree.")
            },
            menu: {
                id: MenuId.ViewTitle,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(11981, null),
            metadata: {
                description: localize2(12009, "Show the problems view as a table.")
            },
            menu: {
                id: MenuId.ViewTitle,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(11982, null),
            metadata: {
                description: localize2(12010, "Show or hide errors in the problems view.")
            },
            category: localize(11983, null),
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(11984, null),
            metadata: {
                description: localize2(12011, "Show or hide warnings in the problems view.")
            },
            category: localize(11985, null),
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(11986, null),
            category: localize(11987, null),
            toggled: MarkersContextKeys.ShowInfoFilterContextKey,
            metadata: {
                description: localize2(12012, "Show or hide infos in the problems view.")
            },
            menu: {
                id: viewFilterSubmenu,
                group: '1_filter',
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(11988, null),
            metadata: {
                description: localize2(12013, "Show or hide problems (errors, warnings, info) only from the active file in the problems view.")
            },
            category: localize(11989, null),
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(11990, null),
            metadata: {
                description: localize2(12014, "Show or hide excluded files in the problems view.")
            },
            category: localize(11991, null),
...
registerAction2(class extends MarkersViewAction {
    constructor() {
        super({
            ...
            title: localize2(12016, 'Copy Message'),
            menu: {
                id: MenuId.ProblemsPanelContext,
                when: MarkersContextKeys.MarkerFocusContextKey,
                group: 'navigation'
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize2(12017, 'Copy Message'),
            menu: {
                id: MenuId.ProblemsPanelContext,
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize2(12018, "Show message in multiple lines"),
            category: localize(11994, null),
            menu: {
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize2(12019, "Show message in single line"),
            category: localize(11995, null),
            menu: {
                id: MenuId.CommandPalette,
                when: ContextKeyExpr.has(getVisbileViewContextKey(Markers.MARKERS_VIEW_ID))
            },
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            title: localize(11996, null),
            category: localize(11997, null),
            keybinding: {
                when: MarkersContextKeys.MarkerViewFilterFocusContextKey,
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
let MarkersStatusBarContributions = class MarkersStatusBarContributions extends Disposable {
    ...
    getMarkersItemTurnedOff() {
        ...
        const tooltip = localize(12000, null);
        return {
            name: localize(12001, null),
            text: '$(whole-word)',
            ariaLabel: tooltip,
            tooltip,
            kind: 'warning',
    ...
    getMarkersTooltip(stats) {
        const errorTitle = (n) => localize(12002, null, n);
        const warningTitle = (n) => localize(12003, null, n);
        const infoTitle = (n) => localize(12004, null, n);
        const titles = [];
        if (stats.errors > 0) {
    ...
    packNumber(n) {
        const manyProblems = localize(12006, null);
...
let ActivityUpdater = class ActivityUpdater extends Disposable {
    ...
    updateBadge() {
        ...
        if (total > 0) {
            const message = localize(12007, null, total);
