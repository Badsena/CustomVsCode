...
class MarkersDecorationsProvider {
    constructor(_markerService) {
        ...
        this.label = localize(12065, null);
    ...
    provideDecorations(resource) {
        ...
        return {
            ...
            bubble: true,
            tooltip: markers.length === 1 ? localize(12066, null) : localize(12067, null, markers.length),
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    'properties': {
        'problems.decorations.enabled': {
            'markdownDescription': localize(12068, null, '`#problems.visibility#`'),
            'type': 'boolean',
            'default': true
        }
    }
