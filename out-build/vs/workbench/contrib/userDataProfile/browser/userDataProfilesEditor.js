...
const editIcon = registerIcon('profiles-editor-edit-folder', Codicon.edit, localize(17012, null));
const removeIcon = registerIcon('profiles-editor-remove-folder', Codicon.close, localize(17013, null));
export const profilesSashBorder = registerColor('profiles.sashBorder', PANEL_BORDER, localize(17014, null));
...
let UserDataProfilesEditor = class UserDataProfilesEditor extends EditorPane {
    ...
    renderNewProfileButton(parent) {
            ...
            actions: {
                getActions: () => {
                    ...
                    if (this.templates.length) {
                        actions.push(new SubmenuAction('from.template', localize(17016, null), this.getCreateFromTemplateActions()));
        ...
        button.label = localize(17018, null);
    ...
    getTreeContextMenuActions() {
        ...
        if (templateActions.length) {
            actions.push(new SubmenuAction('from.template', localize(17020, null), templateActions));
        }
        actions.push(new Separator());
        actions.push(toAction({
            id: 'importProfile',
            label: localize(17021, null),
            run: () => this.importProfile()
        }));
        return actions;
    }
    async importProfile() {
        ...
        const updateQuickPickItems = (value) => {
            ...
            if (value) {
                quickPickItems.push({ label: quickPick.value, description: localize(17022, null) });
            }
            quickPickItems.push({ label: localize(17023, null) });
            quickPick.items = quickPickItems;
        };
        quickPick.title = localize(17024, null);
        quickPick.placeholder = localize(17025, null);
...
let ProfileElementRenderer = class ProfileElementRenderer {
    ...
    renderTemplate(container) {
        ...
        append(description, $(`span${ThemeIcon.asCSSSelector(Codicon.check)}`), $('span', undefined, localize(17027, null)));
...
let ProfileWidget = class ProfileWidget extends Disposable {
    ...
    constructor(parent, editorProgressService, instantiationService) {
        ...
        this.builtInLabel = append(title, $('.profile-built-in-label', undefined, localize(17028, null)));
...
let ProfileNameRenderer = class ProfileNameRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(nameContainer, $('.profile-label-element', undefined, localize(17035, null)));
        const nameInput = disposables.add(new InputBox(nameContainer, this.contextViewService, {
            inputBoxStyles: getInputBoxStyle({
                inputBorder: settingsTextInputBorder
            }),
            ariaLabel: localize(17036, null),
            placeholder: localize(17037, null),
            validationOptions: {
                validation: (value) => {
                    if (!value) {
                        return {
                            content: localize(17038, null),
                    ...
                    if (initialName !== value && this.userDataProfilesService.profiles.some(p => !p.isTransient && p.name === value)) {
                        return {
                            content: localize(17039, null, value),
                            type: 2 /* MessageType.WARNING */
                        };
                    }
                    return null;
        ...
        const renderName = (profileElement) => {
            ...
            if (isSystemProfile) {
                nameInput.setTooltip(localize(17040, null));
            }
            else {
                nameInput.setTooltip(localize(17041, null));
            }
        };
        return {
            set element(element) {
...
let ProfileIconRenderer = class ProfileIconRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(iconContainer, $('.profile-label-element', undefined, localize(17042, null)));
        const iconValueContainer = append(iconContainer, $('.profile-icon-container'));
        const iconElement = append(iconValueContainer, $(`${ThemeIcon.asCSSSelector(DEFAULT_ICON)}`, { 'tabindex': '0', 'role': 'button', 'aria-label': localize(17043, null) }));
        ...
        append(iconValueContainer, $('.profile-description-element', undefined, localize(17044, null)));
        const renderIcon = (profileElement) => {
            if (profileElement?.root instanceof UserDataProfileElement && profileElement.root.profile.isDefault) {
                iconValueContainer.classList.add('disabled');
                iconHover.update(localize(17045, null));
            }
            else {
                iconHover.update(localize(17046, null));
...
let UseForCurrentWindowPropertyRenderer = class UseForCurrentWindowPropertyRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(useForCurrentWindowContainer, $('.profile-label-element', undefined, localize(17047, null)));
        const useForCurrentWindowValueContainer = append(useForCurrentWindowContainer, $('.profile-use-for-current-container'));
        const useForCurrentWindowTitle = localize(17048, null);
...
class UseAsDefaultProfileRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(useAsDefaultProfileContainer, $('.profile-label-element', undefined, localize(17049, null)));
        const useAsDefaultProfileValueContainer = append(useAsDefaultProfileContainer, $('.profile-use-as-default-container'));
        const useAsDefaultProfileTitle = localize(17050, null);
...
let CopyFromProfileRenderer = class CopyFromProfileRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(copyFromContainer, $('.profile-label-element', undefined, localize(17051, null)));
        append(copyFromContainer, $('.profile-description-element', undefined, localize(17052, null)));
    ...
    getCopyFromOptions(profileElement) {
        ...
        copyFromOptions.push({ text: localize(17054, null) });
        ...
        if (this.templates.length) {
            copyFromOptions.push({ ...SeparatorSelectOption, decoratorRight: localize(17055, null) });
            for (const template of this.templates) {
                copyFromOptions.push({ text: template.name, id: template.url, source: URI.parse(template.url) });
            }
        }
        copyFromOptions.push({ ...SeparatorSelectOption, decoratorRight: localize(17056, null) });
...
let ContentsProfileRenderer = class ContentsProfileRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(configureRowContainer, $('.profile-label-element', undefined, localize(17057, null)));
        ...
        const optionsLabel = $('.options-header', undefined, $('span', undefined, localize(17058, null)));
        append(contentsTreeHeader, $(''), $('', undefined, localize(17059, null)), optionsLabel, $(''));
        ...
        const updateDescription = (element) => {
            ...
            if (element.root instanceof UserDataProfileElement && element.root.profile.isDefault) {
                markdown.appendMarkdown(localize(17060, null));
            }
            else {
                markdown.appendMarkdown(localize(17061, null));
                if (element.root instanceof NewProfileElement) {
                    ...
                    const optionName = copyFromName === this.userDataProfilesService.defaultProfile.name
                        ? localize(17062, null, copyFromName)
                        : copyFromName;
                    if (optionName) {
                        markdown
                            .appendMarkdown(localize(17063, null, optionName, copyFromName));
                    }
                    markdown
                        .appendMarkdown(localize(17064, null))
                        .appendMarkdown(localize(17065, null));
                }
            }
...
let ProfileWorkspacesRenderer = class ProfileWorkspacesRenderer extends ProfilePropertyRenderer {
    ...
    renderTemplate(parent) {
        ...
        append(profileWorkspacesRowContainer, $('.profile-label-element', undefined, localize(17066, null)));
            ...
            accessibilityProvider: {
                getAriaLabel: (item) => {
                    ...
                    if (hostLabel === undefined || hostLabel.length === 0) {
                        return localize(17069, null, this.labelService.getUriLabel(item.workspace));
                    }
                    return localize(17070, null, this.labelService.getUriLabel(item.workspace), hostLabel);
                },
                getWidgetAriaLabel: () => localize(17071, null)
            },
            identityProvider: {
                getId(element) {
        ...
        const addButton = this._register(buttonBar.addButton({ title: localize(17072, null), ...defaultButtonStyles }));
        addButton.label = localize(17073, null);
        disposables.add(addButton.onDidClick(async () => {
            const uris = await this.fileDialogService.showOpenDialog({
                canSelectFiles: false,
                canSelectFolders: true,
                canSelectMany: true,
                openLabel: localize(17074, null),
                title: localize(17075, null)
            });
            if (uris) {
                if (profileElement?.root instanceof UserDataProfileElement) {
        ...
        const updateTable = () => {
            if (profileElement?.root instanceof UserDataProfileElement && profileElement.root.workspaces?.length) {
                profileWorkspacesDescriptionElement.textContent = localize(17076, null);
                ...
                profileWorkspacesDescriptionElement.textContent = localize(17077, null);
    ...
    renderElement({ element: profileResourceTreeElement }, index, templateData) {
        ...
        const updateRadioItems = () => {
            templateData.radio.setItems([{
                    text: localize(17078, null),
                    tooltip: localize(17079, null, resourceTypeTitle),
                    isActive: root.getFlag(element.resourceType)
                },
                {
                    text: root.name,
                    tooltip: localize(17080, null, resourceTypeTitle, root.name),
                    isActive: !root.getFlag(element.resourceType)
                }]);
        };
...
let NewProfileResourceTreeRenderer = class NewProfileResourceTreeRenderer extends AbstractProfileResourceTreeRenderer {
    ...
    renderElement({ element: profileResourceTreeElement }, index, templateData) {
        ...
        const renderRadioItems = () => {
            const options = [{
                    text: localize(17081, null),
                    tooltip: localize(17082, null, resourceTypeTitle),
                },
                {
                    text: localize(17083, null),
                    tooltip: localize(17084, null, resourceTypeTitle)
                }];
            const copyFromName = root.getCopyFromName();
            const name = copyFromName === this.userDataProfilesService.defaultProfile.name
                ? localize(17085, null, copyFromName)
                : copyFromName;
            if (root.copyFrom && name) {
                templateData.radio.setItems([
                    {
                        text: name,
                        tooltip: name ? localize(17086, null, resourceTypeTitle, name) : localize(17087, null),
                    },
                    ...options
                ]);
...
let ChangeProfileAction = class ChangeProfileAction {
    constructor(item, userDataProfilesService, uriIdentityService, environmentService) {
        ...
        this.tooltip = localize(17088, null);
        this.checked = false;
...
function getHostLabel(labelService, workspaceUri) {
    return workspaceUri.authority ? labelService.getHostLabel(workspaceUri.scheme, workspaceUri.authority) : localize(17091, null);
}
let UserDataProfilesEditorInput = class UserDataProfilesEditorInput extends EditorInput {
    ...
    getName() { return localize(17092, null); }
