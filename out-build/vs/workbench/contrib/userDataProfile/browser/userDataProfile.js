...
let UserDataProfilesWorkbenchContribution = class UserDataProfilesWorkbenchContribution extends Disposable {
    ...
    registerEditor() {
        Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(UserDataProfilesEditor, UserDataProfilesEditor.ID, localize(16986, null)), [
        ...
        this._register(dndRegistry.registerDropHandler(new class UserDataProfileDropHandler {
            async handleDrop(resource, accessor) {
                ...
                if (uriIdentityService.extUri.extname(resource) === `.${PROFILE_EXTENSION}`) {
                    ...
                    if (!template) {
                        notificationService.warn(localize(16987, null));
    ...
    registerProfileSubMenu() {
        const getProfilesTitle = () => {
            return localize(16988, null, this.userDataProfileService.currentProfile.name);
        };
        ...
        return registerAction2(class ProfileEntryAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: profile.name,
                    metadata: {
                        description: localize2(16996, "Switch to {0} profile", profile.name),
                    },
        ...
        return registerAction2(class NewWindowWithProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(16997, "New Window with Profile..."),
            ...
            async run(accessor) {
                ...
                const pick = await quickInputService.pick(userDataProfilesService.profiles.map(profile => ({
                    ...
                    title: localize(16989, null),
                    placeHolder: localize(16990, null),
                    canPickMany: false
                });
                if (pick) {
    ...
    registerNewWindowAction(profile) {
        ...
        disposables.add(registerAction2(class NewWindowAction extends Action2 {
            constructor() {
                super({
                    id,
                    title: localize2(16998, "{0}", profile.name),
                    metadata: {
                        description: localize2(16999, "Open New Window with {0} Profile", profile.name),
                    },
                    menu: {
                        id: OpenProfileMenu,
                        group: '0_profiles',
        ...
        disposables.add(MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
            command: {
                id,
                category: PROFILES_CATEGORY,
                title: localize2(17000, "Open {0} Profile", profile.name),
                precondition
            },
        }));
        return disposables;
        ...
        return registerAction2(class SwitchProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(17001, 'Switch Profile...'),
                    category: PROFILES_CATEGORY,
                    f1: true,
                });
            }
            async run(accessor) {
                ...
                const result = await quickInputService.pick(items.sort((a, b) => a.profile.name.localeCompare(b.profile.name)), {
                    placeHolder: localize(16991, null)
                });
                if (result) {
    ...
    registerManageProfilesAction() {
        ...
        disposables.add(registerAction2(class ManageProfilesAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: {
                        ...localize2(17002, "Profiles"),
                        mnemonicTitle: localize(16992, null),
                    },
                    menu: [
                        {
        ...
        disposables.add(MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
            command: {
                ...
                title: localize2(17003, "Open Profiles (UI)"),
            },
        }));
        return disposables;
    }
    registerExportCurrentProfileAction() {
        ...
        disposables.add(registerAction2(class ExportProfileAction extends Action2 {
            constructor() {
                super({
                    id,
                    title: localize2(17004, "Export Profile..."),
                    category: PROFILES_CATEGORY,
                    f1: true,
                });
            }
        ...
        disposables.add(MenuRegistry.appendMenuItem(MenuId.MenubarShare, {
            command: {
                id,
                title: localize2(17005, "Export Profile ({0})...", that.userDataProfileService.currentProfile.name),
            },
        }));
        return disposables;
    }
        ...
        this._register(registerAction2(class CreateFromCurrentProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(17006, "Save Current Profile As..."),
                    category: PROFILES_CATEGORY,
                    f1: true,
                });
            }
        ...
        this._register(registerAction2(class CreateProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(17007, "New Profile..."),
                    category: PROFILES_CATEGORY,
                    f1: true,
                    menu: [
                        {
        ...
        this._register(registerAction2(class DeleteProfileAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(17008, "Delete Profile..."),
                    category: PROFILES_CATEGORY,
                    f1: true,
                    precondition: HAS_PROFILES_CONTEXT,
                });
            ...
            async run(accessor) {
                ...
                if (profiles.length) {
                    const picks = await quickInputService.pick(profiles.map(profile => ({
                        label: profile.name,
                        description: profile.id === userDataProfileService.currentProfile.id ? localize(16993, null) : undefined,
                        profile
                    })), {
                        title: localize(16994, null),
                        placeHolder: localize(16995, null),
                        canPickMany: true
                    });
                    if (picks) {
                        try {
