...
class CreateTransientProfileAction extends Action2 {
    ...
    static { this.TITLE = localize2(17009, "New Window with Temporary Profile"); }
    constructor() {
        super({
...
registerAction2(class CleanupProfilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17010, "Cleanup Profiles"),
...
registerAction2(class ResetWorkspacesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17011, "Reset Workspace Profiles Associations"),
            category: Categories.Developer,
            f1: true,
        });
    }
