...
const MERGE_EDITOR_CATEGORY = localize2(12718, 'Merge Editor (Dev)');
export class MergeEditorOpenContentsFromJSON extends Action2 {
    constructor() {
        super({
            id: 'merge.dev.openContentsJson',
            category: MERGE_EDITOR_CATEGORY,
            title: localize2(12719, "Open Merge Editor State from JSON"),
...
export class OpenSelectionInTemporaryMergeEditor extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: MERGE_EDITOR_CATEGORY,
            title: localize2(12720, "Open Selection In Temporary Merge Editor"),
            icon: Codicon.layoutCentered,
            f1: true,
        });
    }
