...
export class MergeEditorAccessibilityHelpProvider {
    ...
    getProvider(accessor) {
        ...
        const content = [
            localize(12612, null),
            localize(12613, null, '<keybinding:merge.goToNextUnhandledConflict>', '<keybinding:merge.goToPreviousUnhandledConflict>'),
            localize(12614, null, '<keybinding:merge.acceptAllInput1>', '<keybinding:merge.acceptAllInput2>'),
            localize(12615, null, '<keybinding:mergeEditor.acceptMerge>'),
            localize(12616, null, '<keybinding:mergeEditor.toggleBetweenInputs>'),
        ];
