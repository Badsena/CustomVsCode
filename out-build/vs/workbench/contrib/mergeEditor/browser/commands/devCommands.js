...
const MERGE_EDITOR_CATEGORY = localize2(12605, 'Merge Editor (Dev)');
export class MergeEditorCopyContentsToJSON extends Action2 {
    constructor() {
        super({
            id: 'merge.dev.copyContentsJson',
            category: MERGE_EDITOR_CATEGORY,
            title: localize2(12606, "Copy Merge Editor State as JSON"),
    ...
    run(accessor) {
        ...
        if (!(activeEditorPane instanceof MergeEditor)) {
            notificationService.info({
                name: localize(12595, null),
                message: localize(12596, null)
            });
            return;
        }
        ...
        notificationService.info({
            name: localize(12597, null),
            message: localize(12598, null),
        });
    }
}
export class MergeEditorSaveContentsToFolder extends Action2 {
    constructor() {
        super({
            ...
            category: MERGE_EDITOR_CATEGORY,
            title: localize2(12607, "Save Merge Editor State to Folder"),
            icon: Codicon.layoutCentered,
            f1: true,
            precondition: ctxIsMergeEditor,
        });
    ...
    async run(accessor) {
        ...
        if (!(activeEditorPane instanceof MergeEditor)) {
            notificationService.info({
                name: localize(12599, null),
                message: localize(12600, null)
            });
            return;
        }
        const model = activeEditorPane.model;
        ...
        notificationService.info({
            name: localize(12602, null),
            message: localize(12603, null),
        });
    }
}
export class MergeEditorLoadContentsFromFolder extends Action2 {
    constructor() {
        super({
            ...
            category: MERGE_EDITOR_CATEGORY,
            title: localize2(12608, "Load Merge Editor State from Folder"),
            icon: Codicon.layoutCentered,
            f1: true
        });
    }
