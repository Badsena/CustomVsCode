...
export class OpenMergeEditor extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12572, 'Open Merge Editor'),
        });
    }
    run(accessor, ...args) {
...
export class SetMixedLayout extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12573, "Mixed Layout"),
...
export class SetColumnLayout extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12574, 'Column Layout'),
...
export class ShowNonConflictingChanges extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12575, "Show Non-Conflicting Changes"),
...
export class ShowHideBase extends Action2 {
    constructor() {
        super({
            id: 'merge.showBase',
            title: localize2(12576, "Show Base"),
...
export class ShowHideTopBase extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12577, "Show Base Top"),
...
export class ShowHideCenterBase extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12578, "Show Base Center"),
...
const mergeEditorCategory = localize2(12579, "Merge Editor");
export class OpenResultResource extends MergeEditorAction {
    constructor() {
        super({
            id: 'merge.openResult',
            icon: Codicon.goToFile,
            title: localize2(12580, "Open File"),
...
export class GoToNextUnhandledConflict extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12581, "Go to Next Unhandled Conflict"),
...
export class GoToPreviousUnhandledConflict extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12582, "Go to Previous Unhandled Conflict"),
...
export class ToggleActiveConflictInput1 extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12583, "Toggle Current Conflict from Left"),
            f1: true,
            precondition: ctxIsMergeEditor,
        });
    }
...
export class ToggleActiveConflictInput2 extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12584, "Toggle Current Conflict from Right"),
            f1: true,
            precondition: ctxIsMergeEditor,
        });
    }
...
export class CompareInput1WithBaseCommand extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12585, "Compare Input 1 With Base"),
            shortTitle: localize(12566, null),
            f1: true,
            precondition: ctxIsMergeEditor,
...
export class CompareInput2WithBaseCommand extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12586, "Compare Input 2 With Base"),
            shortTitle: localize(12567, null),
            f1: true,
            precondition: ctxIsMergeEditor,
...
export class OpenBaseFile extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12587, "Open Base File"),
            f1: true,
            precondition: ctxIsMergeEditor,
        });
    }
...
export class AcceptAllInput1 extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12588, "Accept All Incoming Changes from Left"),
            f1: true,
            precondition: ctxIsMergeEditor,
            menu: { id: MenuId.MergeInput1Toolbar, group: 'primary' },
...
export class AcceptAllInput2 extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12589, "Accept All Current Changes from Right"),
            f1: true,
            precondition: ctxIsMergeEditor,
            menu: { id: MenuId.MergeInput2Toolbar, group: 'primary' },
            icon: Codicon.checkAll,
...
export class ResetToBaseAndAutoMergeCommand extends MergeEditorAction {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12590, "Reset Result"),
            shortTitle: localize(12568, null),
            f1: true,
            precondition: ctxIsMergeEditor,
...
export class ResetCloseWithConflictsChoice extends Action2 {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12591, "Reset Choice for \'Close with Conflicts\'"),
            f1: true,
        });
    }
    run(accessor) {
...
export class AcceptAllCombination extends MergeEditorAction2 {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12592, "Accept All Combination"),
            f1: true,
        });
    }
...
export class AcceptMerge extends MergeEditorAction2 {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12593, "Complete Merge"),
            f1: true,
            precondition: ctxIsMergeEditor,
            keybinding: [
                {
    ...
    async runWithMergeEditor({ inputModel, editorIdentifier, viewModel }, accessor) {
        ...
        if (viewModel.model.unhandledConflictsCount.get() > 0) {
            const { confirmed } = await dialogService.confirm({
                message: localize(12569, null, basename(inputModel.resultUri)),
                detail: localize(12570, null),
                primaryButton: localize(12571, null)
            });
            if (!confirmed) {
                return {
                    successful: false
...
export class ToggleBetweenInputs extends MergeEditorAction2 {
    constructor() {
        super({
            ...
            category: mergeEditorCategory,
            title: localize2(12594, "Toggle Between Merge Editor Inputs"),
            f1: true,
            precondition: ctxIsMergeEditor,
            keybinding: [
                {
