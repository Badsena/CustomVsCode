...
export class ShowWebViewEditorFindWidgetAction extends Action2 {
    ...
    static { this.LABEL = nls.localize(17287, null); }
    constructor() {
        super({
...
export class HideWebViewEditorFindCommand extends Action2 {
    ...
    static { this.LABEL = nls.localize(17288, null); }
    constructor() {
        super({
...
export class WebViewEditorFindNextCommand extends Action2 {
    ...
    static { this.LABEL = nls.localize(17289, null); }
    constructor() {
        super({
...
export class WebViewEditorFindPreviousCommand extends Action2 {
    ...
    static { this.LABEL = nls.localize(17290, null); }
    constructor() {
        super({
...
export class ReloadWebviewAction extends Action2 {
    ...
    static { this.LABEL = nls.localize2(17291, "Reload Webviews"); }
    constructor() {
        super({
