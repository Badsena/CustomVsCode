...
let Debugger = class Debugger {
    ...
    async createDebugAdapter(session) {
        ...
        throw new Error(nls.localize(10265, null, this.type));
    }
    ...
    getInitialConfigurationContent(initialConfigs) {
        ...
        const comment1 = nls.localize(10266, null);
        const comment2 = nls.localize(10267, null);
        const comment3 = nls.localize(10268, null, 'https://go.microsoft.com/fwlink/?linkid=830387');
        let content = [
            '{',
            `\t// ${comment1}`,
            `\t// ${comment2}`,
    ...
    getSchemaAttributes(definitions) {
        ...
        return Object.entries(this.debuggerContribution.configurationAttributes).map(([request, attributes]) => {
            ...
            properties['type'] = {
                ...
                description: nls.localize(10269, null),
                pattern: '^(?!node2)',
                ...
                errorMessage: nls.localize(10270, null),
                patternErrorMessage: nls.localize(10271, null)
            };
            properties['request'] = {
                enum: [request],
                description: nls.localize(10272, null),
            };
            ...
            attributesCopy.properties = {
                ...
                ...{
                    windows: {
                        ...
                        description: nls.localize(10273, null),
                    },
                    osx: {
                        $ref: `#/definitions/${platformSpecificDefinitionId}`,
                        description: nls.localize(10274, null),
                    },
                    linux: {
                        $ref: `#/definitions/${platformSpecificDefinitionId}`,
                        description: nls.localize(10275, null),
                    }
                }
            };
