...
export class ExpressionContainer {
    ...
    async fetchVariables(start, count, filter) {
        try {
            ...
            const vars = response.body.variables.filter(v => !!v).map((v) => {
                ...
                return new Variable(this.session, this.threadId, this, 0, '', undefined, nls.localize(10279, null), 0, 0, undefined, { kind: 'virtual' }, undefined, undefined, false);
            });
    ...
    async evaluateExpression(expression, session, stackFrame, context, keepLazyVars = false, location) {
        if (!session || (!stackFrame && context !== 'repl')) {
            this.value = context === 'repl' ? nls.localize(10280, null) : Expression.DEFAULT_VALUE;
            this.reference = 0;
            return false;
        }
        this.session = session;
...
export class Expression extends ExpressionContainer {
    static { this.DEFAULT_VALUE = nls.localize(10281, null); }
    ...
    get stateLabel() {
        if (this.stoppedDetails) {
            return this.stoppedDetails.description ||
                (this.stoppedDetails.reason ? nls.localize(10282, null, this.stoppedDetails.reason) : nls.localize(10283, null));
        }
        return nls.localize(10284, null);
    }
    /**
...
export class Breakpoint extends BaseBreakpoint {
    ...
    get message() {
        if (this.textFileService.isDirty(this.uri)) {
            return nls.localize(10285, null);
        }
