    ...
    constructor() {
        super({
            ...
            title: {
                ...
                mnemonicTitle: nls.localize(10060, null)
            },
            metadata: {
                description: nls.localize2(10064, 'Opens the file used to configure how your program is debugged')
            },
            f1: true,
            icon: debugConfigure,
        ...
        if (configurationManager.selectedConfiguration.name) {
            ...
            if (launches.length === 1) {
                ...
                const picked = await quickInputService.pick(picks, {
                    activeItem: picks[0],
                    placeHolder: nls.localize(10061, null)
                });
                if (picked) {
