...
let StackAccessibilityProvider = class StackAccessibilityProvider {
    ...
    getAriaLabel(e) {
        ...
        if (e instanceof CallStackFrame) {
            if (e.source && e.line) {
                return localize(9663, null, e.name, e.line, this.labelService.getUriLabel(e.source, { relative: true }));
...
let MissingCodeRenderer = class MissingCodeRenderer {
    ...
    renderElement(element, _index, templateData) {
        ...
        templateData.label.element.setResource({
            name: cast.name,
            description: localize(9665, null, cast.line, cast.column),
    ...
    renderTemplate(container) {
        ...
        store.add(button.onDidClick(() => {
            ...
            this.loadFrames(data.current).catch(e => {
                this.notificationService.error(localize(9666, null, e.message));
            });
        }));
        return data;
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(9667, 'Open File'),
