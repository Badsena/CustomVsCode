...
class ToggleBreakpointAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(9884, "Toggle Breakpoint"),
                mnemonicTitle: nls.localize(9873, null),
            },
            category: nls.localize2(9885, "Debug"),
            f1: true,
...
class ConditionalBreakpointAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(9886, "Debug: Add Conditional Breakpoint..."),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            menuOpts: {
                menuId: MenuId.MenubarNewBreakpointMenu,
                title: nls.localize(9874, null),
                group: '1_breakpoints',
                order: 1,
                when: CONTEXT_DEBUGGERS_AVAILABLE
            }
...
class LogPointAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(9887, "Debug: Add Logpoint..."),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            menuOpts: [
                {
                    menuId: MenuId.MenubarNewBreakpointMenu,
                    title: nls.localize(9875, null),
                    group: '1_breakpoints',
                    order: 4,
                    when: CONTEXT_DEBUGGERS_AVAILABLE,
                }
...
class TriggerByBreakpointAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize(9876, null),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            alias: 'Debug: Triggered Breakpoint...',
            menuOpts: [
                {
                    menuId: MenuId.MenubarNewBreakpointMenu,
                    title: nls.localize(9877, null),
                    group: '1_breakpoints',
                    order: 4,
                    when: CONTEXT_DEBUGGERS_AVAILABLE,
                }
...
class EditBreakpointAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize(9878, null),
            alias: 'Debug: Edit Existing Breakpoint',
            precondition: CONTEXT_DEBUGGERS_AVAILABLE,
            menuOpts: {
                menuId: MenuId.MenubarNewBreakpointMenu,
                title: nls.localize(9879, null),
                group: '1_breakpoints',
                order: 1,
                when: CONTEXT_DEBUGGERS_AVAILABLE
            }
...
class OpenDisassemblyViewAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(9888, "Open Disassembly View"),
                mnemonicTitle: nls.localize(9880, null),
            },
...
class ToggleDisassemblyViewSourceCodeAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(9889, "Toggle Source Code in Disassembly View"),
                mnemonicTitle: nls.localize(9881, null),
            },
            metadata: {
                description: nls.localize2(9890, 'Shows or hides source code in disassembly')
            },
            f1: true,
        });
    }
...
export class RunToCursorAction extends EditorAction {
    ...
    static { this.LABEL = nls.localize2(9891, "Run to Cursor"); }
    constructor() {
        super({
...
export class SelectionToReplAction extends EditorAction {
    ...
    static { this.LABEL = nls.localize2(9892, "Evaluate in Debug Console"); }
    constructor() {
        super({
...
export class SelectionToWatchExpressionsAction extends EditorAction {
    ...
    static { this.LABEL = nls.localize2(9893, "Add to Watch"); }
    constructor() {
        super({
...
class ShowDebugHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(9894, "Debug: Show Hover"),
...
const NO_TARGETS_MESSAGE = nls.localize(9882, null);
class StepIntoTargetsAction extends EditorAction {
    static { this.ID = 'editor.debug.action.stepIntoTargets'; }
    static { this.LABEL = nls.localize(9883, null); }
    constructor() {
        super({
...
class GoToNextBreakpointAction extends GoToBreakpointAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(9895, "Debug: Go to Next Breakpoint"),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE
        });
    }
}
class GoToPreviousBreakpointAction extends GoToBreakpointAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(9896, "Debug: Go to Previous Breakpoint"),
            precondition: CONTEXT_DEBUGGERS_AVAILABLE
        });
    }
}
class CloseExceptionWidgetAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(9897, "Close Exception Widget"),
