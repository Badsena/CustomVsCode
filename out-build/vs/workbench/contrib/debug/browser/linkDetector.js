...
let LinkDetector = class LinkDetector {
    ...
    decorateLink(link, uri, fulltext, hoverBehavior, onClick) {
        ...
        const followLink = uri && this.tunnelService.canTunnel(uri) ? localize(10077, null) : localize(10078, null);
        const title = link.ariaLabel = fulltext
            ? (platform.isMacintosh ? localize(10079, null, followLink, fulltext) : localize(10080, null, followLink, fulltext))
            : (platform.isMacintosh ? localize(10081, null, followLink) : localize(10082, null, followLink));
