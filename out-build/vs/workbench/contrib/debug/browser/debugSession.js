...
let DebugSession = class DebugSession {
    ...
    async launchOrAttach(config) {
        if (!this.raw) {
            throw new Error(localize(9991, null, 'launch or attach'));
        }
    ...
    async restart() {
        if (!this.raw) {
            throw new Error(localize(9992, null, 'restart'));
        }
        this.cancelAllRequests();
        if (this._options.lifecycleManagedByParent && this.parentSession) {
    ...
    async sendBreakpoints(modelUri, breakpointsToSend, sourceModified) {
        if (!this.raw) {
            throw new Error(localize(9993, null, 'breakpoints'));
        }
    ...
    async sendFunctionBreakpoints(fbpts) {
        if (!this.raw) {
            throw new Error(localize(9994, null, 'function breakpoints'));
        }
        if (this.raw.readyForBreakpoints) {
    ...
    async sendExceptionBreakpoints(exbpts) {
        if (!this.raw) {
            throw new Error(localize(9995, null, 'exception breakpoints'));
        }
        if (this.raw.readyForBreakpoints) {
    ...
    dataBytesBreakpointInfo(address, bytes) {
        if (this.raw?.capabilities.supportsDataBreakpointBytes === false) {
            throw new Error(localize(9996, null));
        }
    ...
    async _dataBreakpointInfo(args) {
        if (!this.raw) {
            throw new Error(localize(9997, null, 'data breakpoints info'));
        }
        if (!this.raw.readyForBreakpoints) {
            throw new Error(localize(9998, null));
        }
    ...
    async sendDataBreakpoints(dataBreakpoints) {
        if (!this.raw) {
            throw new Error(localize(9999, null, 'data breakpoints'));
        }
        if (this.raw.readyForBreakpoints) {
    ...
    async sendInstructionBreakpoints(instructionBreakpoints) {
        if (!this.raw) {
            throw new Error(localize(10000, null, 'instruction breakpoints'));
        }
        if (this.raw.readyForBreakpoints) {
    ...
    async breakpointsLocations(uri, lineNumber) {
        if (!this.raw) {
            throw new Error(localize(10001, null, 'breakpoints locations'));
        }
    ...
    customRequest(request, args) {
        if (!this.raw) {
            throw new Error(localize(10002, null, request));
        }
        return this.raw.custom(request, args);
    }
    stackTrace(threadId, startFrame, levels, token) {
        if (!this.raw) {
            throw new Error(localize(10003, null, 'stackTrace'));
        }
    ...
    async exceptionInfo(threadId) {
        if (!this.raw) {
            throw new Error(localize(10004, null, 'exceptionInfo'));
        }
    ...
    scopes(frameId, threadId) {
        if (!this.raw) {
            throw new Error(localize(10005, null, 'scopes'));
        }
    ...
    variables(variablesReference, threadId, filter, start, count) {
        if (!this.raw) {
            throw new Error(localize(10006, null, 'variables'));
        }
    ...
    evaluate(expression, frameId, context, location) {
        if (!this.raw) {
            throw new Error(localize(10007, null, 'evaluate'));
        }
    ...
    async restartFrame(frameId, threadId) {
        ...
        if (!this.raw) {
            throw new Error(localize(10008, null, 'restartFrame'));
        }
    ...
    async next(threadId, granularity) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(10009, null, 'next'));
        }
    ...
    async stepIn(threadId, targetId, granularity) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(10010, null, 'stepIn'));
        }
        this.setLastSteppingGranularity(threadId, granularity);
    ...
    async stepOut(threadId, granularity) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(10011, null, 'stepOut'));
        }
        this.setLastSteppingGranularity(threadId, granularity);
    ...
    async stepBack(threadId, granularity) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(10012, null, 'stepBack'));
        }
        this.setLastSteppingGranularity(threadId, granularity);
    ...
    async continue(threadId) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(10013, null, 'continue'));
        }
    ...
    async reverseContinue(threadId) {
        await this.waitForTriggeredBreakpoints();
        if (!this.raw) {
            throw new Error(localize(10014, null, 'reverse continue'));
        }
        await this.raw.reverseContinue({ threadId });
    }
    async pause(threadId) {
        if (!this.raw) {
            throw new Error(localize(10015, null, 'pause'));
        }
        await this.raw.pause({ threadId });
    }
    async terminateThreads(threadIds) {
        if (!this.raw) {
            throw new Error(localize(10016, null, 'terminateThreads'));
        }
        await this.raw.terminateThreads({ threadIds });
    }
    setVariable(variablesReference, name, value) {
        if (!this.raw) {
            throw new Error(localize(10017, null, 'setVariable'));
        }
        return this.raw.setVariable({ variablesReference, name, value });
    }
    setExpression(frameId, expression, value) {
        if (!this.raw) {
            throw new Error(localize(10018, null, 'setExpression'));
        }
        return this.raw.setExpression({ expression, value, frameId });
    }
    gotoTargets(source, line, column) {
        if (!this.raw) {
            throw new Error(localize(10019, null, 'gotoTargets'));
        }
        return this.raw.gotoTargets({ source, line, column });
    }
    goto(threadId, targetId) {
        if (!this.raw) {
            throw new Error(localize(10020, null, 'goto'));
        }
        return this.raw.goto({ threadId, targetId });
    }
    loadSource(resource) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(10021, null, 'loadSource')));
        }
    ...
    async getLoadedSources() {
        if (!this.raw) {
            return Promise.reject(new Error(localize(10022, null, 'getLoadedSources')));
        }
    ...
    async completions(frameId, threadId, text, position, token) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(10023, null, 'completions')));
        }
    ...
    async stepInTargets(frameId) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(10024, null, 'stepInTargets')));
        }
    ...
    async cancel(progressId) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(10025, null, 'cancel')));
        }
        return this.raw.cancel({ progressId });
    }
    async disassemble(memoryReference, offset, instructionOffset, instructionCount) {
        if (!this.raw) {
            return Promise.reject(new Error(localize(10026, null, 'disassemble')));
        }
    ...
    registerListeners() {
        ...
        this.rawListeners.add(this.raw.onDidTerminateDebugee(async (event) => {
            aria.status(localize(10033, null));
