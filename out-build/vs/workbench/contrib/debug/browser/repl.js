...
let Repl = class Repl extends FilterViewPane {
    ...
    constructor(options, debugService, instantiationService, storageService, themeService, modelService, contextKeyService, codeEditorService, viewDescriptorService, contextMenuService, configurationService, textResourcePropertiesService, editorService, keybindingService, openerService, hoverService, menuService, languageFeaturesService, logService) {
        ...
        super({
            ...options,
            filterOptions: {
                placeholder: localize(10095, null),
                text: filterText,
    ...
    get refreshScheduler() {
        ...
        return new RunOnceScheduler(async () => {
            ...
            this.filterWidget.updateBadge(total === filtered || total === 0 ? undefined : localize(10096, null, filtered, total));
    ...
    getAriaLabel() {
        let ariaLabel = localize(10097, null);
        ...
        if (keybinding) {
            ariaLabel = localize(10098, null, ariaLabel, keybinding);
        }
        else {
            ariaLabel = localize(10099, null, ariaLabel);
        }
        return ariaLabel;
    }
    onContextMenu(e) {
    ...
    updateInputDecoration() {
        ...
        if (this.isReadonly && this.replInput.hasTextFocus() && !this.replInput.getValue()) {
            ...
            decorations.push({
                ...
                renderOptions: {
                    after: {
                        contentText: localize(10100, null),
...
class AcceptReplInputAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(10109, "Debug Console: Accept Input"),
...
registerAction2(class extends ViewAction {
    constructor() {
        super({
            ...
            viewId: REPL_VIEW_ID,
            title: localize2(10110, 'Clear Console'),
            metadata: {
                description: localize2(10111, 'Clears all program output from your debug REPL')
            },
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10112, "Focus on Debug Console View"),
        });
    }
    async run(accessor) {
