...
export function createDisconnectMenuItemAction(action, disposables, accessor, options) {
    ...
    const dropdownAction = disposables.add(new Action('notebook.moreRunActions', localize(10057, null), 'codicon-chevron-down', true));
...
registerDebugToolBarItem(STEP_BACK_ID, localize(10058, null), 50, icons.debugStepBack, CONTEXT_STEP_BACK_SUPPORTED, CONTEXT_DEBUG_STATE.isEqualTo('stopped'));
registerDebugToolBarItem(REVERSE_CONTINUE_ID, localize(10059, null), 55, icons.debugReverseContinue, CONTEXT_STEP_BACK_SUPPORTED, CONTEXT_DEBUG_STATE.isEqualTo('stopped'));
