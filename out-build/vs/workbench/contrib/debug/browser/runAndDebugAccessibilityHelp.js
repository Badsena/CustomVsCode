...
let RunAndDebugAccessibilityHelpProvider = class RunAndDebugAccessibilityHelpProvider extends Disposable {
    ...
    provideContent() {
        return [
            localize(10154, null, '<keybinding:workbench.view.debug>'),
            localize(10155, null, '<keybinding:workbench.action.debug.start>'),
            localize(10156, null, '<keybinding:workbench.panel.repl.view.focus>'),
            AccessibilityHelpNLS.setBreakpoint,
            AccessibilityHelpNLS.addToWatch,
            localize(10157, null),
            localize(10158, null, '<keybinding:workbench.action.debug.restart>'),
            localize(10159, null, '<keybinding:workbench.action.debug.stop>'),
            localize(10160, null, '<keybinding:workbench.action.debug.continue>'),
            localize(10161, null, '<keybinding:workbench.action.debug.stepInto>'),
            localize(10162, null, '<keybinding:workbench.action.debug.stepOver>'),
            localize(10163, null, '<keybinding:workbench.action.debug.stepOut>'),
            localize(10164, null),
            localize(10165, null, '<keybinding:workbench.debug.action.focusBreakpointsView>'),
            localize(10166, null, '<keybinding:workbench.debug.action.focusCallStackView>'),
            localize(10167, null, '<keybinding:workbench.debug.action.focusVariablesView>'),
            localize(10168, null, '<keybinding:workbench.debug.action.focusWatchView>'),
            localize(10169, null, 'accessibility.debugWatchVariableAnnouncements'),
        ].join('\n');
    }
};
