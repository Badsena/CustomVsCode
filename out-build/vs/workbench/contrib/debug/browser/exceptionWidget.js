...
const $ = dom.$;
// theming
const debugExceptionWidgetBorder = registerColor('debugExceptionWidget.border', '#a31515', nls.localize(10072, null));
const debugExceptionWidgetBackground = registerColor('debugExceptionWidget.background', { dark: '#420b0d', light: '#f1dfde', hcDark: '#420b0d', hcLight: '#f1dfde' }, nls.localize(10073, null));
let ExceptionWidget = class ExceptionWidget extends ZoneWidget {
    ...
    _fillContainer(container) {
        ...
        label.textContent = this.exceptionInfo.id ? nls.localize(10074, null, this.exceptionInfo.id) : nls.localize(10075, null);
        let ariaLabel = label.textContent;
        const actionBar = this._disposables.add(new ActionBar(actions));
        actionBar.push(new Action('editor.closeExceptionWidget', nls.localize(10076, null), ThemeIcon.asClassName(widgetClose), true, async () => {
