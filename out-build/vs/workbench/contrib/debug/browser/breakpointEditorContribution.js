...
const breakpointHelperDecoration = {
    ...
    glyphMarginHoverMessage: new MarkdownString().appendText(nls.localize(9511, null)),
...
let BreakpointEditorContribution = class BreakpointEditorContribution {
            ...
            if (e.event.rightButton || (env.isMacintosh && e.event.leftButton && e.event.ctrlKey)) {
                ...
                if (breakpoints.length) {
                    ...
                    if (isShiftPressed) {
                        ...
                        const breakpointType = logPoint ? nls.localize(9512, null) : nls.localize(9513, null);
                        const disabledBreakpointDialogMessage = nls.localize(9514, null, breakpointType.toLowerCase(), logPoint ? nls.localize(9515, null) : nls.localize(9516, null));
                        const enabledBreakpointDialogMessage = nls.localize(9517, null, breakpointType.toLowerCase(), logPoint ? nls.localize(9518, null) : nls.localize(9519, null));
                        await this.dialogService.prompt({
                            type: severity.Info,
                            message: enabled ? enabledBreakpointDialogMessage : disabledBreakpointDialogMessage,
                            buttons: [
                                {
                                    label: nls.localize(9520, null, breakpointType),
                                    run: () => breakpoints.forEach(bp => this.debugService.removeBreakpoints(bp.getId()))
                                },
                                {
                                    label: nls.localize(9521, null, enabled ? nls.localize(9522, null) : nls.localize(9523, null), breakpointType),
    ...
    getContextMenuActions(breakpoints, uri, lineNumber, column) {
        ...
        if (breakpoints.length === 1) {
            const breakpointType = breakpoints[0].logMessage ? nls.localize(9524, null) : nls.localize(9525, null);
            actions.push(toAction({
                id: 'debug.removeBreakpoint', label: nls.localize(9526, null, breakpointType), enabled: true, run: async () => {
                    await this.debugService.removeBreakpoints(breakpoints[0].getId());
                }
            }));
            actions.push(toAction({
                id: 'workbench.debug.action.editBreakpointAction',
                label: nls.localize(9527, null, breakpointType),
                enabled: true,
            ...
            actions.push(toAction({
                ...
                label: breakpoints[0].enabled ? nls.localize(9528, null, breakpointType) : nls.localize(9529, null, breakpointType),
                enabled: true,
            ...
            actions.push(new SubmenuAction('debug.removeBreakpoints', nls.localize(9530, null), sorted.map(bp => toAction({
                id: 'removeInlineBreakpoint',
                label: bp.column ? nls.localize(9531, null, bp.column) : nls.localize(9532, null),
                enabled: true,
                run: () => this.debugService.removeBreakpoints(bp.getId())
            }))));
            actions.push(new SubmenuAction('debug.editBreakpoints', nls.localize(9533, null), sorted.map(bp => toAction({
                id: 'editBreakpoint',
                label: bp.column ? nls.localize(9534, null, bp.column) : nls.localize(9535, null),
                enabled: true,
                run: () => Promise.resolve(this.showBreakpointWidget(bp.lineNumber, bp.column))
            }))));
            actions.push(new SubmenuAction('debug.enableDisableBreakpoints', nls.localize(9536, null), sorted.map(bp => toAction({
                id: bp.enabled ? 'disableColumnBreakpoint' : 'enableColumnBreakpoint',
                label: bp.enabled ? (bp.column ? nls.localize(9537, null, bp.column) : nls.localize(9538, null))
                    : (bp.column ? nls.localize(9539, null, bp.column) : nls.localize(9540, null)),
                enabled: true,
...
export const debugIconBreakpointForeground = registerColor('debugIcon.breakpointForeground', '#E51400', nls.localize(9546, null));
const debugIconBreakpointDisabledForeground = registerColor('debugIcon.breakpointDisabledForeground', '#848484', nls.localize(9547, null));
const debugIconBreakpointUnverifiedForeground = registerColor('debugIcon.breakpointUnverifiedForeground', '#848484', nls.localize(9548, null));
const debugIconBreakpointCurrentStackframeForeground = registerColor('debugIcon.breakpointCurrentStackframeForeground', { dark: '#FFCC00', light: '#BE8700', hcDark: '#FFCC00', hcLight: '#BE8700' }, nls.localize(9549, null));
const debugIconBreakpointStackframeForeground = registerColor('debugIcon.breakpointStackframeForeground', '#89D185', nls.localize(9550, null));
