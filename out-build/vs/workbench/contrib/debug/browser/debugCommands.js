...
export const DEBUG_COMMAND_CATEGORY = nls.localize2(9836, 'Debug');
export const RESTART_LABEL = nls.localize2(9837, "Restart");
export const STEP_OVER_LABEL = nls.localize2(9838, "Step Over");
export const STEP_INTO_LABEL = nls.localize2(9839, "Step Into");
export const STEP_INTO_TARGET_LABEL = nls.localize2(9840, "Step Into Target");
export const STEP_OUT_LABEL = nls.localize2(9841, "Step Out");
export const PAUSE_LABEL = nls.localize2(9842, "Pause");
export const DISCONNECT_LABEL = nls.localize2(9843, "Disconnect");
export const DISCONNECT_AND_SUSPEND_LABEL = nls.localize2(9844, "Disconnect and Suspend");
export const STOP_LABEL = nls.localize2(9845, "Stop");
export const CONTINUE_LABEL = nls.localize2(9846, "Continue");
export const FOCUS_SESSION_LABEL = nls.localize2(9847, "Focus Session");
export const SELECT_AND_START_LABEL = nls.localize2(9848, "Select and Start Debugging");
export const DEBUG_CONFIGURE_LABEL = nls.localize(9829, null, 'launch.json');
export const DEBUG_START_LABEL = nls.localize2(9849, "Start Debugging");
export const DEBUG_RUN_LABEL = nls.localize2(9850, "Start Without Debugging");
export const NEXT_DEBUG_CONSOLE_LABEL = nls.localize2(9851, "Focus Next Debug Console");
export const PREV_DEBUG_CONSOLE_LABEL = nls.localize2(9852, "Focus Previous Debug Console");
export const OPEN_LOADED_SCRIPTS_LABEL = nls.localize2(9853, "Open Loaded Script...");
export const CALLSTACK_TOP_LABEL = nls.localize2(9854, "Navigate to Top of Call Stack");
export const CALLSTACK_BOTTOM_LABEL = nls.localize2(9855, "Navigate to Bottom of Call Stack");
export const CALLSTACK_UP_LABEL = nls.localize2(9856, "Navigate Up Call Stack");
export const CALLSTACK_DOWN_LABEL = nls.localize2(9857, "Navigate Down Call Stack");
export const COPY_EVALUATE_PATH_LABEL = nls.localize2(9858, "Copy as Expression");
export const COPY_VALUE_LABEL = nls.localize2(9859, "Copy Value");
export const COPY_ADDRESS_LABEL = nls.localize2(9860, "Copy Address");
export const ADD_TO_WATCH_LABEL = nls.localize2(9861, "Add to Watch");
export const SELECT_DEBUG_CONSOLE_LABEL = nls.localize2(9862, "Select Debug Console");
export const SELECT_DEBUG_SESSION_LABEL = nls.localize2(9863, "Select Debug Session");
...
CommandsRegistry.registerCommand({
    ...
    handler: async (accessor) => {
            ...
            if (source) {
                ...
                if (targets && targets.length) {
                    ...
                    if (targets.length > 1) {
                        ...
                        const pick = await quickInputService.pick(picks, { placeHolder: nls.localize(9830, null) });
                        if (!pick) {
                            return;
                        }
                        id = pick._id;
        ...
        return notificationService.warn(nls.localize(9831, null));
    }
});
CommandsRegistry.registerCommand({
    id: CALLSTACK_TOP_ID,
    ...
    handler: async (accessor, _, context) => {
        ...
        session.stepInTargets(frame.frameId).then(targets => {
            ...
            if (targets?.length) {
                ...
                qp.placeholder = nls.localize(9833, null);
            }
        });
    }
});
...
registerAction2(class AddConfigurationAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(9864, "Add Configuration..."),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
            menu: {
...
registerAction2(class ToggleExceptionBreakpointsAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(9865, "Toggle Exception Breakpoints"),
            category: DEBUG_COMMAND_CATEGORY,
            f1: true,
    ...
    async run(accessor) {
        ...
        quickPick.placeholder = nls.localize(9835, null);
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(9866, "Attach to Current Code Renderer"),
        });
    }
    async run(accessor) {
