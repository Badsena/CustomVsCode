...
class LoadedScriptsRenderer {
    ...
    render(element, labels, data, filterData) {
        ...
        if (element instanceof RootFolderTreeItem) {
            ...
            options.title = nls.localize(10083, null);
...
class LoadedSciptsAccessibilityProvider {
    getWidgetAriaLabel() {
        return nls.localize(10084, null);
    }
    getAriaLabel(element) {
        if (element instanceof RootFolderTreeItem) {
            return nls.localize(10085, null, element.getLabel());
        }
        if (element instanceof SessionTreeItem) {
            return nls.localize(10086, null, element.getLabel());
        }
        if (element.hasChildren()) {
            return nls.localize(10087, null, element.getLabel());
        }
        else {
            return nls.localize(10088, null, element.getLabel());
        }
    }
}
