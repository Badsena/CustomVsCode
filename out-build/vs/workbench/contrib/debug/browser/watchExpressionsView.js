...
let WatchExpressionsRenderer = class WatchExpressionsRenderer extends AbstractExpressionsRenderer {
    ...
    getInputBoxOptions(expression, settingValue) {
        ...
        return {
            ...
            ariaLabel: localize(10184, null),
            placeholder: localize(10185, null),
...
class WatchExpressionsAccessibilityProvider {
    getWidgetAriaLabel() {
        return localize(10186, null);
    }
    getAriaLabel(element) {
        if (element instanceof Expression) {
            return localize(10187, null, element.name, element.value);
        }
        // Variable
        return localize(10188, null, element.name, element.value);
    }
}
...
export const ADD_WATCH_LABEL = localize(10190, null);
...
export const REMOVE_WATCH_EXPRESSIONS_LABEL = localize(10191, null);
