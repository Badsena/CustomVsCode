...
let ReleaseNotesManager = class ReleaseNotesManager extends Disposable {
    constructor(_environmentService, _keybindingService, _languageService, _openerService, _requestService, _configurationService, _editorService, _editorGroupService, _codeEditorService, _webviewWorkbenchService, _extensionService, _productService, _instantiationService, _updateService, _commandService) {
        super();
    ...
    async show(version, useCurrentFile) {
        ...
        const html = await this.renderBody(this._lastMeta);
        const title = nls.localize(16834, null, version);
    ...
    async loadReleaseNotes(version, useCurrentFile) {
        ...
        const unassigned = nls.localize(16835, null);
		...
		<html>
			...
			<body>
				...
				<script nonce="${nonce}">
					...
					label.textContent = '${nls.localize(16836, null)}';
    ...
    getUpdateAction() {
        ...
        switch (state.type) {
            case "available for download" /* StateType.AvailableForDownload */:
                return { label: nls.localize(16837, null), commandId: 'update.downloadNow' };
            case "downloaded" /* StateType.Downloaded */:
                return { label: nls.localize(16838, null), commandId: 'update.install' };
            case "ready" /* StateType.Ready */:
                return { label: nls.localize(16839, null), commandId: 'update.restart' };
            default:
                return undefined;
        }
    }
