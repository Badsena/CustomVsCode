...
const NLS_FIND_INPUT_LABEL = nls.localize(9203, null);
const NLS_FIND_INPUT_PLACEHOLDER = nls.localize(9204, null);
const NLS_PREVIOUS_MATCH_BTN_LABEL = nls.localize(9205, null);
const NLS_NEXT_MATCH_BTN_LABEL = nls.localize(9206, null);
const NLS_CLOSE_BTN_LABEL = nls.localize(9207, null);
...
export class SimpleFindWidget extends Widget {
    ...
    _updateFindInputAriaLabel() {
        ...
        if (!this._accessibilityHelpHintAnnounced && this._configurationService.getValue('accessibility.verbosity.find') && this._accessibilityService.isScreenReaderOptimized()) {
            ...
            if (keybinding) {
                findLabel += ', ' + nls.localize(9208, null, keybinding);
    ...
    _announceSearchResults(label, searchString) {
        if (!searchString) {
            return nls.localize(9209, null);
        }
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? nls.localize(9210, null, label)
                : nls.localize(9211, null, label, searchString);
        }
        return nls.localize(9212, null, label, searchString);
    }
}
export const simpleFindWidgetSashBorder = registerColor('simpleFindWidget.sashBorder', { dark: '#454545', light: '#C8C8C8', hcDark: '#6FC3DF', hcLight: '#0F4A85' }, nls.localize(9213, null));
