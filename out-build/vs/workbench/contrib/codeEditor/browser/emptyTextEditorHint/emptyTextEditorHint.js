...
let EmptyTextEditorHintContentWidget = class EmptyTextEditorHintContentWidget extends Disposable {
        ...
        this.contextMenuService.showContextMenu({
            ...
            getActions: () => {
                return [{
                        ...
                        label: localize(9196, null),
                        tooltip: localize(9197, null),
                        enabled: true,
                        class: undefined,
                        run: () => {
                            disableHint();
    ...
    getHint() {
        ...
        const hintMsg = (hasInlineChatProvider ? localize(9198, null, keybindingLabels.at(0) ?? '', keybindingLabels.at(1) ?? '') : localize(9199, null, keybindingLabels.at(1) ?? '')).replaceAll(' ()', '');
        ...
        const ariaLabel = hasInlineChatProvider ?
            localize(9200, null, ...keybindingLabels) :
            localize(9201, null, ...keybindingLabels);
    ...
    getDomNode() {
        if (!this.domNode) {
            ...
            this.ariaLabel = ariaLabel.concat(localize(9202, null, "accessibility.verbosity.emptyEditorHint" /* AccessibilityVerbositySettingId.EmptyEditorHint */));
