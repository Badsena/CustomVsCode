        ...
        if (!isEmbeddedDiffEditor) {
            ...
            this._register(autorunWithStore((reader, store) => {
                ...
                if (onlyWhiteSpaceChange.read(reader)) {
                    const helperWidget = store.add(this._instantiationService.createInstance(FloatingEditorClickWidget, this._diffEditor.getModifiedEditor(), localize(9078, null), null));
            ...
            this._register(this._diffEditor.onDidUpdateDiff(() => {
                ...
                if (diffComputationResult && diffComputationResult.quitEarly) {
                    this._notificationService.prompt(Severity.Warning, localize(9079, null, this._diffEditor.maxComputationTime), [{
                            label: localize(9080, null),
                            run: () => {
