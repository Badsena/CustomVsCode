...
export class DiffEditorAccessibilityHelp {
    ...
    getProvider(accessor) {
        ...
        const switchSides = localize(9073, null, '<keybinding:diffEditor.switchSide>');
        const diffEditorActiveAnnouncement = localize(9074, null);
        ...
        const content = [
            localize(9075, null),
            localize(9076, null, '<keybinding:' + AccessibleDiffViewerNext.id + '>', '<keybinding:' + AccessibleDiffViewerPrev.id + '>'),
            switchSides,
            diffEditorActiveAnnouncement,
            localize(9077, null, keys.join(', ')),
        ];
