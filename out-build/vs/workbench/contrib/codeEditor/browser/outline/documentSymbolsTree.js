...
let DocumentSymbolRenderer = class DocumentSymbolRenderer {
    ...
    renderElement(node, _index, template) {
        ...
        const options = {
            ...
            extraClasses,
            title: localize(9222, null, element.symbol.name, symbolKindNames[element.symbol.kind])
        };
    ...
    _renderMarkerInfo(element, template) {
        ...
        if (!configBadges || !problem) {
            ...
            template.decoration.title = count === 1 ? localize(9223, null) : localize(9224, null, count);
            ...
            template.decoration.title = localize(9225, null);
            template.decoration.style.setProperty('--outline-element-color', cssColor);
        }
    }
    disposeTemplate(_template) {
