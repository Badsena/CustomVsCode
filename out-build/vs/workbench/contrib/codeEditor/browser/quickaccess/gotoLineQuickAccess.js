...
class GotoLineAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(9230, 'Go to Line/Column...'),
            f1: true,
            keybinding: {
...
Registry.as(QuickAccessExtensions.Quickaccess).registerQuickAccessProvider({
    ...
    placeholder: localize(9226, null),
    helpEntries: [{ description: localize(9227, null), commandId: GotoLineAction.ID }]
});
class GotoOffsetAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(9231, 'Go to Offset...'),
            f1: true
        });
    }
    async run(accessor) {
...
Registry.as(QuickAccessExtensions.Quickaccess).registerQuickAccessProvider({
    ...
    placeholder: localize(9228, null),
    helpEntries: [{ description: localize(9229, null), commandId: GotoOffsetAction.ID }]
});
