...
const EDITOR_WORD_WRAP = new RawContextKey('editorWordWrap', false, nls.localize(9257, null));
/**
...
class ToggleWordWrapAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(9261, "View: Toggle Word Wrap"),
