...
let LanguageConfigurationFileHandler = LanguageConfigurationFileHandler_1 = class LanguageConfigurationFileHandler extends Disposable {
    ...
    async _readConfigFile(configFileLocation) {
        try {
            ...
            if (errors.length) {
                console.error(nls.localize(9262, null, configFileLocation.toString(), errors.map(e => (`[${e.offset}, ${e.length}] ${getParseErrorMessage(e.error)}`)).join('\n')));
            }
            if (getNodeType(configuration) !== 'object') {
                console.error(nls.localize(9263, null, configFileLocation.toString()));
                configuration = {};
            }
...
const schema = {
    ...
    definitions: {
        openBracket: {
            type: 'string',
            description: nls.localize(9264, null)
        },
        closeBracket: {
            type: 'string',
            description: nls.localize(9265, null)
        },
        bracketPair: {
            type: 'array',
            items: [{
    ...
    properties: {
        comments: {
            ...
            description: nls.localize(9266, null),
            type: 'object',
            properties: {
                blockComment: {
                    type: 'array',
                    description: nls.localize(9267, null),
                    items: [{
                            type: 'string',
                            description: nls.localize(9268, null)
                        }, {
                            type: 'string',
                            description: nls.localize(9269, null)
                        }]
                },
                lineComment: {
                    type: 'object',
                    description: nls.localize(9270, null),
                    properties: {
                        comment: {
                            type: 'string',
                            description: nls.localize(9271, null)
                        },
                        noIndent: {
                            type: 'boolean',
                            description: nls.localize(9272, null),
                            default: false
                        }
                    },
                    required: ['comment'],
        ...
        brackets: {
            default: [['(', ')'], ['[', ']'], ['{', '}']],
            markdownDescription: nls.localize(9273, null, '\`colorizedBracketPairs\`'),
            type: 'array',
            items: {
        ...
        colorizedBracketPairs: {
            default: [['(', ')'], ['[', ']'], ['{', '}']],
            markdownDescription: nls.localize(9274, null, '\`brackets\`'),
            type: 'array',
            items: {
                $ref: '#/definitions/bracketPair'
            }
        ...
        autoClosingPairs: {
            default: [['(', ')'], ['[', ']'], ['{', '}']],
            description: nls.localize(9275, null),
            type: 'array',
            items: {
                oneOf: [{
                        $ref: '#/definitions/bracketPair'
                        ...
                        properties: {
                            ...
                            notIn: {
                                type: 'array',
                                description: nls.localize(9276, null),
                                items: {
                                    enum: ['string', 'comment']
                                }
                            }
        ...
        autoCloseBefore: {
            default: ';:.,=}])> \n\t',
            description: nls.localize(9277, null),
            type: 'string',
        },
        surroundingPairs: {
            default: [['(', ')'], ['[', ']'], ['{', '}']],
            description: nls.localize(9278, null),
            type: 'array',
            items: {
                oneOf: [{
                        $ref: '#/definitions/bracketPair'
        ...
        wordPattern: {
            default: '',
            description: nls.localize(9279, null),
            type: ['string', 'object'],
            properties: {
                pattern: {
                    type: 'string',
                    description: nls.localize(9280, null),
                    default: '',
                },
                flags: {
                    type: 'string',
                    description: nls.localize(9281, null),
                    default: 'g',
                    pattern: '^([gimuy]+)$',
                    patternErrorMessage: nls.localize(9282, null)
                }
            }
        },
        indentationRules: {
            ...
            description: nls.localize(9283, null),
            type: 'object',
            properties: {
                increaseIndentPattern: {
                    type: ['string', 'object'],
                    description: nls.localize(9284, null),
                    properties: {
                        pattern: {
                            type: 'string',
                            description: nls.localize(9285, null),
                            default: '',
                        },
                        flags: {
                            type: 'string',
                            description: nls.localize(9286, null),
                            default: '',
                            pattern: '^([gimuy]+)$',
                            patternErrorMessage: nls.localize(9287, null)
                        }
                    }
                },
                decreaseIndentPattern: {
                    type: ['string', 'object'],
                    description: nls.localize(9288, null),
                    properties: {
                        pattern: {
                            type: 'string',
                            description: nls.localize(9289, null),
                            default: '',
                        },
                        flags: {
                            type: 'string',
                            description: nls.localize(9290, null),
                            default: '',
                            pattern: '^([gimuy]+)$',
                            patternErrorMessage: nls.localize(9291, null)
                        }
                    }
                },
                indentNextLinePattern: {
                    type: ['string', 'object'],
                    description: nls.localize(9292, null),
                    properties: {
                        pattern: {
                            type: 'string',
                            description: nls.localize(9293, null),
                            default: '',
                        },
                        flags: {
                            type: 'string',
                            description: nls.localize(9294, null),
                            default: '',
                            pattern: '^([gimuy]+)$',
                            patternErrorMessage: nls.localize(9295, null)
                        }
                    }
                },
                unIndentedLinePattern: {
                    type: ['string', 'object'],
                    description: nls.localize(9296, null),
                    properties: {
                        pattern: {
                            type: 'string',
                            description: nls.localize(9297, null),
                            default: '',
                        },
                        flags: {
                            type: 'string',
                            description: nls.localize(9298, null),
                            default: '',
                            pattern: '^([gimuy]+)$',
                            patternErrorMessage: nls.localize(9299, null)
                        }
                    }
                }
            }
        ...
        folding: {
            type: 'object',
            description: nls.localize(9300, null),
            properties: {
                offSide: {
                    type: 'boolean',
                    description: nls.localize(9301, null),
                },
                markers: {
                    type: 'object',
                    description: nls.localize(9302, null),
                    properties: {
                        start: {
                            type: 'string',
                            description: nls.localize(9303, null)
                        },
                        end: {
                            type: 'string',
                            description: nls.localize(9304, null)
                        },
                    }
                }
            }
        ...
        onEnterRules: {
            type: 'array',
            description: nls.localize(9305, null),
            items: {
                type: 'object',
                description: nls.localize(9306, null),
                required: ['beforeText', 'action'],
                properties: {
                    beforeText: {
                        type: ['string', 'object'],
                        description: nls.localize(9307, null),
                        properties: {
                            pattern: {
                                type: 'string',
                                description: nls.localize(9308, null),
                                default: '',
                            },
                            flags: {
                                type: 'string',
                                description: nls.localize(9309, null),
                                default: '',
                                pattern: '^([gimuy]+)$',
                                patternErrorMessage: nls.localize(9310, null)
                            }
                        }
                    },
                    afterText: {
                        type: ['string', 'object'],
                        description: nls.localize(9311, null),
                        properties: {
                            pattern: {
                                type: 'string',
                                description: nls.localize(9312, null),
                                default: '',
                            },
                            flags: {
                                type: 'string',
                                description: nls.localize(9313, null),
                                default: '',
                                pattern: '^([gimuy]+)$',
                                patternErrorMessage: nls.localize(9314, null)
                            }
                        }
                    },
                    previousLineText: {
                        type: ['string', 'object'],
                        description: nls.localize(9315, null),
                        properties: {
                            pattern: {
                                type: 'string',
                                description: nls.localize(9316, null),
                                default: '',
                            },
                            flags: {
                                type: 'string',
                                description: nls.localize(9317, null),
                                default: '',
                                pattern: '^([gimuy]+)$',
                                patternErrorMessage: nls.localize(9318, null)
                            }
                        }
                    },
                    action: {
                        type: ['string', 'object'],
                        description: nls.localize(9319, null),
                        required: ['indent'],
                        default: { 'indent': 'indent' },
                        properties: {
                            indent: {
                                type: 'string',
                                description: nls.localize(9320, null),
                                default: 'indent',
                                enum: ['none', 'indent', 'indentOutdent', 'outdent'],
                                markdownEnumDescriptions: [
                                    nls.localize(9321, null),
                                    nls.localize(9322, null),
                                    nls.localize(9323, null),
                                    nls.localize(9324, null)
                                ]
                            },
                            appendText: {
                                type: 'string',
                                description: nls.localize(9325, null),
                                default: '',
                            },
                            removeText: {
                                type: 'number',
                                description: nls.localize(9326, null),
                                default: 0,
                            }
                        }
                    }
