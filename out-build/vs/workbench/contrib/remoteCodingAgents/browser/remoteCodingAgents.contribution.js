...
const extensionPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: localize(14091, null),
        type: 'array',
        items: {
            type: 'object',
            properties: {
                id: {
                    description: localize(14092, null),
                    type: 'string',
                },
                command: {
                    description: localize(14093, null),
                    type: 'string'
                },
                displayName: {
                    description: localize(14094, null),
                    type: 'string'
                },
                description: {
                    description: localize(14095, null),
                    type: 'string'
                },
                followUpRegex: {
                    description: localize(14096, null),
                    type: 'string',
                },
                when: {
                    description: localize(14097, null),
                    type: 'string'
                },
            },
