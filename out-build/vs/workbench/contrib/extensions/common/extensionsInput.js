...
const ExtensionEditorIcon = registerIcon('extensions-editor-label-icon', Codicon.extensions, localize(11090, null));
export class ExtensionsInput extends EditorInput {
    ...
    getName() {
        return localize(11091, null, this._extension.displayName);
    }
    getIcon() {
