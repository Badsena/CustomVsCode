...
const RuntimeExtensionsEditorIcon = registerIcon('runtime-extensions-editor-label-icon', Codicon.extensions, nls.localize(11102, null));
export class RuntimeExtensionsInput extends EditorInput {
    ...
    getName() {
        return nls.localize(11103, null);
    }
    getIcon() {
