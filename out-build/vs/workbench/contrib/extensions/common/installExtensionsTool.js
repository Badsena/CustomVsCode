...
export const InstallExtensionsToolData = {
    ...
    displayName: localize(11095, null),
    ...
    userDescription: localize(11096, null),
...
let InstallExtensionsTool = class InstallExtensionsTool {
    ...
    async prepareToolInvocation(context, token) {
        ...
        return {
            confirmationMessages: {
                title: localize(11097, null),
                message: new MarkdownString(localize(11098, null)),
            },
            toolSpecificData: {
                kind: 'extensions',
    ...
    async invoke(invocation, _countTokens, _progress, token) {
        ...
        return {
            content: [{
                    kind: 'text',
                    value: installed.length ? localize(11099, null, installed.map(e => e.identifier.id).join(', ')) : localize(11100, null),
                }]
        };
    }
};
