...
export const ExtensionsConfigurationSchema = {
    ...
    type: 'object',
    title: localize(11085, null),
    additionalProperties: false,
    properties: {
        recommendations: {
            type: 'array',
            description: localize(11086, null),
            items: {
                type: 'string',
                pattern: EXTENSION_IDENTIFIER_PATTERN,
                errorMessage: localize(11087, null)
            },
        },
        unwantedRecommendations: {
            type: 'array',
            description: localize(11088, null),
            items: {
                type: 'string',
                pattern: EXTENSION_IDENTIFIER_PATTERN,
                errorMessage: localize(11089, null)
            },
        },
    }
};
