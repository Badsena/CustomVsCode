...
function getAriaLabelForExtension(extension) {
    ...
    const publisher = extension.publisherDomain?.verified ? localize(10920, null, extension.publisherDisplayName) : localize(10921, null, extension.publisherDisplayName);
    const deprecated = extension?.deprecationInfo ? localize(10922, null) : '';
    const rating = extension?.rating ? localize(10923, null, extension.rating.toFixed(2), extension.ratingCount) : '';
...
class UnknownExtensionRenderer {
    ...
    renderTemplate(container) {
        ...
        dom.append(messageContainer, dom.$('span.error-marker')).textContent = localize(10925, null);
        dom.append(messageContainer, dom.$('span.message')).textContent = localize(10926, null);
