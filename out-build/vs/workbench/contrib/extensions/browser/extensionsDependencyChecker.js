    ...
    constructor(extensionService, extensionsWorkbenchService, notificationService, hostService) {
        ...
        MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
            command: {
                ...
                category: localize(10886, null),
                title: localize(10887, null)
            }
        });
    }
        ...
        if (missingDependencies.length) {
            ...
            if (extensions.length) {
                ...
                this.notificationService.notify({
                    ...
                    message: localize(10888, null),
                    actions: {
                        primary: [new Action('realod', localize(10889, null), '', true, () => this.hostService.reload())]
                    }
                });
            }
        }
        else {
            this.notificationService.info(localize(10890, null));
        }
    }
};
