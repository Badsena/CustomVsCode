...
Registry.as(Extensions.Quickaccess).registerQuickAccessProvider({
    ...
    placeholder: localize(10547, null),
    helpEntries: [{ description: localize(10548, null) }]
});
// Editor
Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(ExtensionEditor, ExtensionEditor.ID, localize(10549, null)), [
    new SyncDescriptor(ExtensionsInput)
]);
export const VIEW_CONTAINER = Registry.as(ViewContainerExtensions.ViewContainersRegistry).registerViewContainer({
    id: VIEWLET_ID,
    title: localize2(10657, "Extensions"),
    openCommandActionDescriptor: {
        id: VIEWLET_ID,
        mnemonicTitle: localize(10550, null),
...
Registry.as(ConfigurationExtensions.Configuration)
    ...
    properties: {
        'extensions.autoUpdate': {
            ...
            description: localize(10558, null),
            default: true,
        ...
        'extensions.autoCheckUpdates': {
            type: 'boolean',
            description: localize(10559, null),
            default: true,
            scope: 1 /* ConfigurationScope.APPLICATION */,
            tags: ['usesOnlineServices']
        },
        'extensions.ignoreRecommendations': {
            type: 'boolean',
            description: localize(10560, null),
            default: false
        },
        'extensions.showRecommendationsOnlyOnDemand': {
            type: 'boolean',
            deprecationMessage: localize(10561, null),
            default: false,
            tags: ['usesOnlineServices']
        },
        'extensions.closeExtensionDetailsOnViewChange': {
            type: 'boolean',
            description: localize(10562, null),
            default: false
        },
        'extensions.confirmedUriHandlerExtensionIds': {
            ...
            description: localize(10563, null),
            default: [],
            scope: 1 /* ConfigurationScope.APPLICATION */
        },
        'extensions.webWorker': {
            ...
            description: localize(10567, null),
            default: 'auto'
        },
        'extensions.supportVirtualWorkspaces': {
            type: 'object',
            markdownDescription: localize(10568, null),
            patternProperties: {
        ...
        'extensions.experimental.affinity': {
            type: 'object',
            markdownDescription: localize(10569, null),
            patternProperties: {
                '([a-z0-9A-Z][a-z0-9-A-Z]*)\\.([a-z0-9A-Z][a-z0-9-A-Z]*)$': {
                    type: 'integer',
                    default: 1
        ...
        [WORKSPACE_TRUST_EXTENSION_SUPPORT]: {
            type: 'object',
            scope: 1 /* ConfigurationScope.APPLICATION */,
            markdownDescription: localize(10570, null),
            patternProperties: {
                '([a-z0-9A-Z][a-z0-9-A-Z]*)\\.([a-z0-9A-Z][a-z0-9-A-Z]*)$': {
                    type: 'object',
                    properties: {
                        'supported': {
                            ...
                            description: localize(10574, null),
                        },
                        'version': {
                            type: 'string',
                            description: localize(10575, null),
                        }
                    }
                }
            }
        ...
        'extensions.experimental.deferredStartupFinishedActivation': {
            type: 'boolean',
            description: localize(10576, null),
            default: false
        },
        'extensions.experimental.issueQuickAccess': {
            type: 'boolean',
            description: localize(10577, null),
            default: true
        },
        'extensions.allowOpenInModalEditor': {
            type: 'boolean',
            description: localize(10578, null),
        ...
        [VerifyExtensionSignatureConfigKey]: {
            type: 'boolean',
            description: localize(10579, null),
            default: true,
            scope: 1 /* ConfigurationScope.APPLICATION */,
            included: isNative
        },
        [AutoRestartConfigurationKey]: {
            type: 'boolean',
            description: localize(10580, null),
            default: false,
            included: product.quality !== 'stable'
        },
        [ExtensionGalleryServiceUrlConfigKey]: {
            type: 'string',
            description: localize(10581, null),
            default: '',
            scope: 1 /* ConfigurationScope.APPLICATION */,
            tags: ['usesOnlineServices'],
            included: false,
        ...
        'extensions.supportNodeGlobalNavigator': {
            type: 'boolean',
            description: localize(10583, null),
            default: false,
        },
        [ExtensionRequestsTimeoutConfigKey]: {
            type: 'number',
            description: localize(10584, null),
            default: 60_000,
            scope: 1 /* ConfigurationScope.APPLICATION */,
...
CommandsRegistry.registerCommand('_extensions.manage', (accessor, extensionId, tab, preserveFocus, feature) => {
    ...
    if (extension) {
        ...
        throw new Error(localize(10585, null, extensionId));
    }
});
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: localize(10586, null),
        args: [
            {
                name: 'extensionIdOrVSIXUri',
                description: localize(10587, null),
                ...
                schema: {
                    ...
                    'properties': {
                        'installOnlyNewlyAddedFromExtensionPackVSIX': {
                            'type': 'boolean',
                            'description': localize(10588, null),
                            default: false
                        },
                        'installPreReleaseVersion': {
                            'type': 'boolean',
                            'description': localize(10589, null),
                            default: false
                        },
                        'donotSync': {
                            'type': 'boolean',
                            'description': localize(10590, null),
                            default: false
                        },
                        'justification': {
                            'type': ['string', 'object'],
                            'description': localize(10591, null),
                        },
                        'enable': {
                            'type': 'boolean',
                            'description': localize(10592, null),
                            default: false
                        },
                        'context': {
                            'type': 'object',
                            'description': localize(10593, null),
                        }
                    }
                }
            }
        ...
        try {
            if (typeof arg === 'string') {
                ...
                if (extension?.enablementState === 1 /* EnablementState.DisabledByExtensionKind */) {
                    ...
                    if (!gallery) {
                        throw new Error(localize(10594, null, arg));
                    }
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: localize(10595, null),
        args: [
            {
                name: localize(10596, null),
                schema: {
                    'type': 'string'
                }
            }
    ...
    handler: async (accessor, id) => {
        if (!id) {
            throw new Error(localize(10597, null));
        }
        const extensionManagementService = accessor.get(IExtensionManagementService);
        const installed = await extensionManagementService.getInstalled();
        const [extensionToUninstall] = installed.filter(e => areSameExtensions(e.identifier, { id }));
        if (!extensionToUninstall) {
            throw new Error(localize(10598, null, id));
        }
        if (extensionToUninstall.isBuiltin) {
            throw new Error(localize(10599, null, id));
        }
        try {
...
CommandsRegistry.registerCommand({
    ...
    metadata: {
        description: localize(10600, null),
        args: [
            {
                name: localize(10601, null),
                schema: { 'type': 'string' }
            }
        ]
    },
...
let ExtensionsContributions = class ExtensionsContributions extends Disposable {
    ...
    registerQuickAccessProvider() {
        if (this.extensionManagementServerService.localExtensionManagementServer
            ...
            Registry.as(Extensions.Quickaccess).registerQuickAccessProvider({
                ...
                placeholder: localize(10602, null),
                helpEntries: [{ description: localize(10603, null) }]
            });
        }
    }
    // Global actions
    registerGlobalActions() {
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10658, 'Focus on Extensions View'),
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10659, 'Install Extensions'),
            category: ExtensionsLocalizedLabel,
            menu: {
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10662, 'Check for Extension Updates'),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
                    when: ContextKeyExpr.and(CONTEXT_HAS_GALLERY, ContextKeyExpr.or(CONTEXT_HAS_LOCAL_SERVER, CONTEXT_HAS_REMOTE_SERVER, CONTEXT_HAS_WEB_SERVER))
            ...
            run: async () => {
                ...
                if (outdated.length) {
                    ...
                    return this.dialogService.info(localize(10607, null));
                }
            }
        });
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10663, 'Enable Auto Update for All Extensions'),
            category: ExtensionsLocalizedLabel,
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10664, 'Disable Auto Update for All Extensions'),
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10665, 'Update All Extensions'),
            category: ExtensionsLocalizedLabel,
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10666, 'Enable All Extensions'),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10667, 'Enable All Extensions for this Workspace'),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10668, 'Disable All Installed Extensions'),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
                    when: ContextKeyExpr.or(CONTEXT_HAS_LOCAL_SERVER, CONTEXT_HAS_REMOTE_SERVER, CONTEXT_HAS_WEB_SERVER)
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10669, 'Disable All Installed Extensions for this Workspace'),
            category: ExtensionsLocalizedLabel,
            menu: {
                id: MenuId.CommandPalette,
                when: ContextKeyExpr.and(WorkbenchStateContext.notEqualsTo('empty'), ContextKeyExpr.or(CONTEXT_HAS_LOCAL_SERVER, CONTEXT_HAS_REMOTE_SERVER, CONTEXT_HAS_WEB_SERVER))
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10670, 'Install from VSIX...'),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
            ...
            run: async (accessor) => {
                ...
                const vsixPaths = await fileDialogService.showOpenDialog({
                    title: localize(10608, null),
                    filters: [{ name: 'VSIX Extensions', extensions: ['vsix'] }],
                    canSelectFiles: true,
                    canSelectMany: true,
                    openLabel: mnemonicButtonLabel(localize(10609, null))
                });
                if (vsixPaths) {
        ...
        this.registerExtensionAction({
            ...
            run: async (accessor, resources) => {
                ...
                if (requireReload) {
                    notificationService.prompt(Severity.Info, vsixs.length > 1 ? localize(10611, null)
                        : localize(10612, null), [{
                            label: localize(10613, null),
                            run: () => hostService.reload()
                        }]);
                }
                else if (requireRestart) {
                    notificationService.prompt(Severity.Info, vsixs.length > 1 ? localize(10614, null)
                        : localize(10615, null), [{
                            label: localize(10616, null),
                            run: () => extensionsWorkbenchService.updateRunningExtensions()
                        }]);
                }
                else {
                    notificationService.prompt(Severity.Info, vsixs.length > 1 ? localize(10617, null) : localize(10618, null), []);
                }
            }
        });
        this.registerExtensionAction({
            id: 'workbench.extensions.action.installExtensionFromLocation',
            title: localize2(10671, 'Install Extension from Location...'),
            ...
            run: async (accessor) => {
                ...
                if (isWeb) {
                    return new Promise((c, e) => {
                        ...
                        quickPick.title = localize(10619, null);
                        quickPick.customButton = true;
                        quickPick.customLabel = localize(10620, null);
                        quickPick.placeholder = localize(10621, null);
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10672, 'Show Featured Extensions'),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            menuTitles: {
                [extensionsFilterSubMenu.id]: localize(10626, null)
            },
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10675, 'Show Installed Extensions'),
            category: ExtensionsLocalizedLabel,
            f1: true,
            menu: [{
                    id: extensionsFilterSubMenu,
        ...
        this.registerExtensionAction({
            ...
            menuTitles: {
                [extensionsFilterSubMenu.id]: localize(10630, null)
            },
            run: () => this.extensionsWorkbenchService.openSearch('@updates')
        });
        this.registerExtensionAction({
            id: LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID,
            title: localize2(10678, 'Show Extensions Unsupported By Workspace'),
            category: ExtensionsLocalizedLabel,
            menu: [{
                    id: MenuId.CommandPalette,
                    when: ContextKeyExpr.or(CONTEXT_HAS_LOCAL_SERVER, CONTEXT_HAS_REMOTE_SERVER),
        ...
        this.registerExtensionAction({
            ...
            menuTitles: {
                [extensionsFilterSubMenu.id]: localize(10633, null)
            },
        ...
        MenuRegistry.appendMenuItem(extensionsFilterSubMenu, {
            ...
            title: localize(10634, null),
            when: ContextKeyExpr.and(ContextKeyExpr.or(CONTEXT_HAS_GALLERY, DefaultViewsContext)),
            group: '4_sort',
            order: 1,
        });
        [
            { id: 'installs', title: localize(10635, null), precondition: BuiltInExtensionsContext.negate(), sortCapability: "InstallCount" /* SortBy.InstallCount */ },
            { id: 'rating', title: localize(10636, null), precondition: BuiltInExtensionsContext.negate(), sortCapability: "WeightedRating" /* SortBy.WeightedRating */ },
            { id: 'name', title: localize(10637, null), precondition: BuiltInExtensionsContext.negate(), sortCapability: "Title" /* SortBy.Title */ },
            { id: 'publishedDate', title: localize(10638, null), precondition: BuiltInExtensionsContext.negate(), sortCapability: "PublishedDate" /* SortBy.PublishedDate */ },
            { id: 'updateDate', title: localize(10639, null), precondition: ContextKeyExpr.and(SearchMarketplaceExtensionsContext.negate(), RecommendedExtensionsContext.negate(), BuiltInExtensionsContext.negate()), sortCapability: 'UpdateDate' },
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10681, 'Clear Extensions Search Results'),
            category: ExtensionsLocalizedLabel,
    ...
    registerContextMenuActions() {
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10683, 'Show Pre-Release Version'),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10684, 'Show Release Version'),
            menu: {
                id: MenuId.ExtensionContext,
                group: INSTALL_ACTIONS_GROUP,
                order: 1,
        ...
        this.registerExtensionAction({
            ...
            run: async (accessor, extensionId) => {
                ...
                const extension = this.extensionsWorkbenchService.local.filter(e => areSameExtensions(e.identifier, { id: extensionId }))[0]
                    || (await this.extensionsWorkbenchService.getExtensions([{ id: extensionId }], CancellationToken.None))[0];
                if (extension) {
                    const name = localize(10646, null, extension.displayName);
                    const id = localize(10647, null, extensionId);
                    const description = localize(10648, null, extension.description);
                    const verision = localize(10649, null, extension.version);
                    const publisher = localize(10650, null, extension.publisherDisplayName);
                    const link = extension.url ? localize(10651, null, `${extension.url}`) : null;
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10686, 'Copy Extension ID'),
            menu: {
                id: MenuId.ExtensionContext,
                group: '1_copy'
            },
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10687, 'Copy Link'),
            menu: {
                id: MenuId.ExtensionContext,
                group: '1_copy',
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10688, 'Settings'),
            menu: {
                id: MenuId.ExtensionContext,
                group: '2_configure',
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10689, "Account Preferences"),
            menu: {
                id: MenuId.ExtensionContext,
                group: '2_configure',
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10690, 'Keyboard Shortcuts'),
            menu: {
                id: MenuId.ExtensionContext,
                group: '2_configure',
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10691, "Apply Extension to all Profiles"),
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10692, "Sync This Extension"),
            menu: {
                id: MenuId.ExtensionContext,
                group: '2_configure',
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10693, "Ignore Recommendation"),
            menu: {
                id: MenuId.ExtensionContext,
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10694, "Undo Ignored Recommendation"),
            menu: {
                id: MenuId.ExtensionContext,
                group: '3_recommendations',
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10695, "Add to Workspace Recommendations"),
            menu: {
                id: MenuId.ExtensionContext,
                group: '3_recommendations',
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10696, "Remove from Workspace Recommendations"),
            menu: {
                id: MenuId.ExtensionContext,
                group: '3_recommendations',
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10697, "Add Extension to Workspace Recommendations"),
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10698, "Add Extension to Workspace Folder Recommendations"),
            category: EXTENSIONS_CATEGORY,
            menu: {
                id: MenuId.CommandPalette,
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10699, "Add Extension to Workspace Ignored Recommendations"),
            category: EXTENSIONS_CATEGORY,
            menu: {
                id: MenuId.CommandPalette,
                when: ContextKeyExpr.and(WorkbenchStateContext.isEqualTo('workspace'), ContextKeyExpr.equals('resourceScheme', Schemas.extension)),
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10700, "Add Extension to Workspace Folder Ignored Recommendations"),
            category: EXTENSIONS_CATEGORY,
            menu: {
                id: MenuId.CommandPalette,
                when: ContextKeyExpr.and(WorkbenchStateContext.isEqualTo('folder'), ContextKeyExpr.equals('resourceScheme', Schemas.extension)),
        ...
        this.registerExtensionAction({
            ...
            title: localize2(10701, "Manage Trusted Extension Publishers"),
            category: EXTENSIONS_CATEGORY,
            f1: true,
            run: async (accessor) => {
                const quickInputService = accessor.get(IQuickInputService);
                ...
                const result = await quickInputService.pick(trustedPublisherItems, {
                    canPickMany: true,
                    title: localize(10655, null),
                    placeHolder: localize(10656, null),
                });
                if (result) {
...
export { ExtensionToolsContribution };
...
registerAction2(class ExtensionsGallerySignInAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(10702, 'Sign in to access Extensions Marketplace'),
            menu: {
