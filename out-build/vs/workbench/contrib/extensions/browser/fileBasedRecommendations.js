...
let FileBasedRecommendations = class FileBasedRecommendations extends ExtensionRecommendations {
        ...
        [...this.fileBasedRecommendations.keys()]
            ...
            recommendations.push({
                ...
                reason: {
                    ...
                    reasonText: localize(11079, null)
                }
            });
        });
    ...
    promptFromRecommendations(uri, model, extensionRecommendations) {
        ...
        if (importantRecommendations.size &&
            this.promptRecommendedExtensionForFileType(languageName && isImportantRecommendationForLanguage && language !== PLAINTEXT_LANGUAGE_ID ? localize(11080, null, languageName) : basename(uri), language, [...importantRecommendations])) {
            return;
        }
    }
