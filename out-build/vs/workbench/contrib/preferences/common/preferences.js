...
export const PREVIEW_INDICATOR_DESCRIPTION = localize(13804, null);
export const EXPERIMENTAL_INDICATOR_DESCRIPTION = localize(13805, null);
export const ADVANCED_INDICATOR_DESCRIPTION = localize(13806, null);
