...
let SettingsSearchFilterDropdownMenuActionViewItem = class SettingsSearchFilterDropdownMenuActionViewItem extends DropdownMenuActionViewItem {
    ...
    getActions() {
        return [
            this.createToggleAction('modifiedSettingsSearch', localize(13714, null), localize(13715, null), `@${MODIFIED_SETTING_TAG}`),
            new Separator(),
            this.createAction('extSettingsSearch', localize(13716, null), localize(13717, null), `@${EXTENSION_SETTING_TAG}`, true),
            this.createAction('featuresSettingsSearch', localize(13718, null), localize(13719, null), `@${FEATURE_SETTING_TAG}`, true),
            this.createAction('tagSettingsSearch', localize(13720, null), localize(13721, null), `@${GENERAL_TAG_SETTING_TAG}`, true),
            this.createAction('langSettingsSearch', localize(13722, null), localize(13723, null), `@${LANGUAGE_SETTING_TAG}`, true),
            this.createAction('idSettingsSearch', localize(13724, null), localize(13725, null), `@${ID_SETTING_TAG}`, false),
            new Separator(),
            this.createToggleAction('onlineSettingsSearch', localize(13726, null), localize(13727, null), '@tag:usesOnlineServices'),
            this.createToggleAction('policySettingsSearch', localize(13728, null), localize(13729, null), `@${POLICY_SETTING_TAG}`),
            new Separator(),
            this.createMutuallyExclusiveToggleAction('stableSettingsSearch', localize(13730, null), localize(13731, null), `@stable`, ['@tag:preview', '@tag:experimental']),
            this.createMutuallyExclusiveToggleAction('previewSettingsSearch', localize(13732, null), localize(13733, null), `@tag:preview`, ['@stable', '@tag:experimental']),
            this.createMutuallyExclusiveToggleAction('experimentalSettingsSearch', localize(13734, null), localize(13735, null), `@tag:experimental`, ['@stable', '@tag:preview']),
            new Separator(),
            this.createToggleAction('advancedSettingsSearch', localize(13736, null), localize(13737, null), `@tag:${ADVANCED_SETTING_TAG}`),
        ];
    }
};
