...
let DefineKeybindingWidget = class DefineKeybindingWidget extends Widget {
    ...
    constructor(parent, instantiationService) {
        ...
        const message = nls.localize(13477, null);
    ...
    printExisting(numberOfExisting) {
        if (numberOfExisting > 0) {
            ...
            const text = numberOfExisting === 1 ? nls.localize(13478, null, numberOfExisting) : nls.localize(13479, null, numberOfExisting);
    ...
    onKeybinding(keybinding) {
        ...
        if (this._chords) {
            for (let i = 1; i < this._chords.length; i++) {
                this._outputNode.appendChild(document.createTextNode(nls.localize(13480, null)));
