...
Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(SettingsEditor2, SettingsEditor2.ID, nls.localize(13493, null)), [
    new SyncDescriptor(SettingsEditor2Input)
]);
Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(PreferencesEditor, PreferencesEditor.ID, nls.localize(13494, null)), [
...
Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(KeybindingsEditor, KeybindingsEditor.ID, nls.localize(13495, null)), [
...
const OPEN_USER_SETTINGS_UI_TITLE = nls.localize2(13508, "Open Settings (UI)");
const OPEN_USER_SETTINGS_JSON_TITLE = nls.localize2(13509, "Open User Settings (JSON)");
const OPEN_APPLICATION_SETTINGS_JSON_TITLE = nls.localize2(13510, "Open Application Settings (JSON)");
...
let PreferencesActionsContribution = class PreferencesActionsContribution extends Disposable {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: {
                        ...nls.localize2(13511, "Settings"),
                        mnemonicTitle: nls.localize(13496, null),
                    },
                    keybinding: {
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13512, "Open Settings (UI)"),
                    category,
                    f1: true,
                });
            }
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    metadata: {
                        description: nls.localize2(13513, "Opens the JSON file containing the current user profile settings")
                    },
                    category,
                    f1: true,
                });
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13514, "Open User Settings"),
                    category,
                    f1: true,
                });
            }
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13515, "Open Default Settings (JSON)"),
                    category,
                    f1: true,
                });
            }
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13516, "Open Workspace Settings"),
                    category,
                    menu: {
                        id: MenuId.CommandPalette,
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13517, "Open Accessibility Settings"),
                    category,
                    menu: {
                        id: MenuId.CommandPalette,
                        when: WorkbenchStateContext.notEqualsTo('empty')
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13518, "Open Workspace Settings (JSON)"),
                    category,
                    menu: {
                        id: MenuId.CommandPalette,
                        when: WorkbenchStateContext.notEqualsTo('empty')
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13519, "Open Folder Settings"),
                    category,
                    menu: {
                        id: MenuId.CommandPalette,
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13520, "Open Folder Settings (JSON)"),
                    category,
                    menu: {
                        id: MenuId.CommandPalette,
                        when: WorkbenchStateContext.isEqualTo('workspace')
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    category,
                    f1: true,
                    title: nls.localize2(13521, "Toggle AI Settings Search")
                });
            }
            run(accessor) {
                const editorPane = accessor.get(IEditorService).activeEditorPane;
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13522, "Show untrusted workspace settings"),
                });
            }
            run(accessor) {
            ...
            this._register(registerAction2(class extends Action2 {
                constructor() {
                    super({
                        ...
                        title: nls.localize2(13523, "Open Remote Settings ({0})", hostLabel),
                        category,
                        menu: {
                            id: MenuId.CommandPalette,
            ...
            this._register(registerAction2(class extends Action2 {
                constructor() {
                    super({
                        ...
                        title: nls.localize2(13524, "Open Remote Settings (JSON) ({0})", hostLabel),
                        category,
                        menu: {
                            id: MenuId.CommandPalette,
                            when: RemoteNameContext.notEqualsTo('')
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    category,
                    f1: true,
                    title: nls.localize2(13525, "Focus Settings Search")
                });
            }
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    category,
                    f1: true,
                    title: nls.localize2(13526, "Clear Settings Search Results")
                });
            }
            run(accessor) {
                const preferencesEditor = getPreferencesEditor(accessor);
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    category,
                    title: nls.localize2(13527, "Focus Settings Table of Contents")
                });
            }
            run(accessor) {
                const preferencesEditor = getPreferencesEditor(accessor);
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    f1: true,
                    category,
                    title: nls.localize2(13528, "Show Setting Context Menu")
                });
            }
            run(accessor) {
                const preferencesEditor = getPreferencesEditor(accessor);
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    f1: true,
                    category,
                    title: nls.localize2(13529, "Move Focus Up One Level")
                });
            }
            run(accessor) {
                const preferencesEditor = getPreferencesEditor(accessor);
    ...
    registerKeybindingsActions() {
        const that = this;
        const category = nls.localize2(13530, "Preferences");
        const id = 'workbench.action.openGlobalKeybindings';
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    id,
                    title: nls.localize2(13531, "Open Keyboard Shortcuts"),
                    shortTitle: nls.localize(13504, null),
                    category,
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13532, "Open Default Keyboard Shortcuts (JSON)"),
                    category,
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13533, "Open Keyboard Shortcuts (JSON)"),
                    category,
                    icon: preferencesOpenSettingsIcon,
                    menu: [
                        { id: MenuId.CommandPalette },
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13534, "Show System Keybindings"),
                    menu: [
                        {
                            id: MenuId.EditorTitle,
                            when: ContextKeyExpr.and(CONTEXT_KEYBINDINGS_EDITOR),
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13535, "Show Extension Keybindings"),
                    menu: [
                        {
                            id: MenuId.EditorTitle,
                            when: ContextKeyExpr.and(CONTEXT_KEYBINDINGS_EDITOR),
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13536, "Show User Keybindings"),
                    menu: [
                        {
                            id: MenuId.EditorTitle,
                            when: ContextKeyExpr.and(CONTEXT_KEYBINDINGS_EDITOR),
            ...
            profileScopedActionDisposables.add(registerAction2(class DefineKeybindingAction extends Action2 {
                constructor() {
                    ...
                    super({
                        ...
                        title: nls.localize2(13537, "Define Keybinding"),
                        f1: true,
                        precondition: when,
                        keybinding: {
                            weight: 200 /* KeybindingWeight.WorkbenchContrib */,
        ...
        this._register(registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: nls.localize2(13538, "Open Settings (JSON)"),
                    icon: preferencesOpenSettingsIcon,
                    menu: [{
                            id: MenuId.EditorTitle,
