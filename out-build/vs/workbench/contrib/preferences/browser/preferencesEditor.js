...
let PreferencesEditor = class PreferencesEditor extends EditorPane {
    ...
    onDidSelectPreferencesEditorPane(id) {
        ...
        if (selectedAction) {
            this.searchWidget.inputBox.setPlaceHolder(localize(13543, null, selectedAction.descriptor.title));
            this.searchWidget.inputBox.setAriaLabel(localize(13544, null, selectedAction.descriptor.title));
        }
