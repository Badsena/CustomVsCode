...
let SettingsTargetsWidget = class SettingsTargetsWidget extends Widget {
    ...
    resetLabels() {
        ...
        this.userLocalSettings.label = localize(13580, null);
        this.userRemoteSettings.label = localize(13581, null) + (hostLabel ? ` [${hostLabel}]` : '');
        this.workspaceSettings.label = localize(13582, null);
        this.folderSettingsAction.label = localize(13583, null);
    }
    create(parent) {
        ...
        this.userLocalSettings.tooltip = localize(13585, null);
        ...
        const remoteAuthority = this.environmentService.remoteAuthority;
        const hostLabel = remoteAuthority && this.labelService.getHostLabel(Schemas.vscodeRemote, remoteAuthority);
        this.userRemoteSettings.tooltip = localize(13586, null) + (hostLabel ? ` [${hostLabel}]` : '');
    ...
    async update() {
        ...
        this.workspaceSettings.tooltip = localize(13589, null);
    }
};
