...
const NLS_KB_LAYOUT_ERROR_MESSAGE = nls.localize(13474, null);
    ...
    _createDecoration(isError, uiLabel, usLabel, model, keyNode) {
        ...
        if (isError) {
            ...
            if (usLabel && uiLabel !== usLabel) {
                msg = new MarkdownString(nls.localize(13475, null, uiLabel, usLabel));
                ...
                msg = new MarkdownString(nls.localize(13476, null, uiLabel));
