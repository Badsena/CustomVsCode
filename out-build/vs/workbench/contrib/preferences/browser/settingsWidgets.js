...
let ListSettingWidget = class ListSettingWidget extends AbstractListSettingWidget {
    ...
    renderEdit(item, idx) {
        ...
        okButton.label = localize(13758, null);
        ...
        cancelButton.label = localize(13759, null);
    ...
    addTooltipsToRow(rowElementGroup, { value, sibling }) {
        const title = isUndefinedOrNull(sibling)
            ? localize(13760, null, value.data)
            : localize(13761, null, value.data, sibling);
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(13762, null),
            editActionTooltip: localize(13763, null),
            addButtonLabel: localize(13764, null),
            inputPlaceholder: localize(13765, null),
            siblingInputPlaceholder: localize(13766, null),
        };
    }
...
export class ExcludeSettingWidget extends ListSettingWidget {
    ...
    addTooltipsToRow(rowElementGroup, item) {
        let title = isUndefinedOrNull(item.sibling)
            ? localize(13767, null, item.value.data)
            : localize(13768, null, item.value.data, item.sibling);
        if (item.source) {
            title += localize(13769, null, item.source);
        }
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(13770, null),
            editActionTooltip: localize(13771, null),
            addButtonLabel: localize(13772, null),
            inputPlaceholder: localize(13773, null),
            siblingInputPlaceholder: localize(13774, null),
        };
    }
}
export class IncludeSettingWidget extends ListSettingWidget {
    ...
    addTooltipsToRow(rowElementGroup, item) {
        let title = isUndefinedOrNull(item.sibling)
            ? localize(13775, null, item.value.data)
            : localize(13776, null, item.value.data, item.sibling);
        if (item.source) {
            title += localize(13777, null, item.source);
        }
        const markdownTitle = new MarkdownString().appendMarkdown(title);
        const { rowElement } = rowElementGroup;
        this.listDisposables.add(this.hoverService.setupDelayedHover(rowElement, { content: markdownTitle }));
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(13778, null),
            editActionTooltip: localize(13779, null),
            addButtonLabel: localize(13780, null),
            inputPlaceholder: localize(13781, null),
            siblingInputPlaceholder: localize(13782, null),
        };
    }
}
let ObjectSettingDropdownWidget = class ObjectSettingDropdownWidget extends AbstractListSettingWidget {
    ...
    addTooltipsToRow(rowElementGroup, item) {
        ...
        if (item.source) {
            accessibleDescription = localize(13787, null, item.key.data, item.value.data, item.source);
        }
        else {
            accessibleDescription = localize(13788, null, item.key.data, item.value.data);
        }
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(13789, null),
            resetActionTooltip: localize(13790, null),
            editActionTooltip: localize(13791, null),
            addButtonLabel: localize(13792, null),
            keyHeaderText: localize(13793, null),
            valueHeaderText: localize(13794, null),
        };
    }
};
...
let ObjectSettingCheckboxWidget = class ObjectSettingCheckboxWidget extends AbstractListSettingWidget {
    ...
    addTooltipsToRow(rowElementGroup, item) {
        const accessibleDescription = localize(13795, null, item.key.data, item.value.data);
    ...
    getLocalizedStrings() {
        return {
            deleteActionTooltip: localize(13796, null),
            resetActionTooltip: localize(13797, null),
            editActionTooltip: localize(13798, null),
            addButtonLabel: localize(13799, null),
            keyHeaderText: localize(13800, null),
            valueHeaderText: localize(13801, null),
        };
    }
};
