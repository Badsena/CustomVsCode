...
export class ListMcpServerCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12165, 'List Servers'),
            icon: Codicon.server,
            category,
            f1: true,
    ...
    async run(accessor) {
        ...
        pick.placeholder = localize(12134, null);
        ...
        store.add(autorun(reader => {
            ...
            pick.items = [
                { id: '$add', label: localize(12135, null), description: localize(12136, null), alwaysShow: true, iconClass: ThemeIcon.asClassName(Codicon.add) },
...
export class McpConfirmationServerOptionsCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12166, 'Server Options'),
            category,
...
export class McpServerOptionsCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12167, 'Server Options'),
            category,
            f1: false,
        });
    }
    async run(accessor, id) {
        ...
        items.push({ type: 'separator', label: localize(12138, null) });
        // Only show start when server is stopped or in error state
        if (McpConnectionState.canBeStarted(serverState.state)) {
            items.push({
                label: localize(12139, null),
                action: 'start'
            });
        }
        else {
            items.push({
                label: localize(12140, null),
                action: 'stop'
            });
            items.push({
                label: localize(12141, null),
                action: 'restart'
            });
        }
        ...
        if (configTarget) {
            items.push({
                label: localize(12142, null),
                action: 'config',
            });
        }
        items.push({
            label: localize(12143, null),
            action: 'showOutput'
        });
        items.push({ type: 'separator', label: localize(12144, null) }, {
            label: localize(12145, null),
            description: localize(12146, null),
            action: 'configSampling'
        });
        if (samplingService.hasLogs(server)) {
            items.push({
                label: localize(12147, null),
                description: localize(12148, null),
                action: 'samplingLog',
            });
        }
        const capabilities = server.capabilities.get();
        if (capabilities === undefined || (capabilities & 16 /* McpCapability.Resources */)) {
            items.push({ type: 'separator', label: localize(12149, null) });
            items.push({
                label: localize(12150, null),
                action: 'resources',
            });
        }
        const pick = await quickInputService.pick(items, {
            placeHolder: localize(12151, null, server.definition.label),
        });
        if (!pick) {
            return;
        }
        switch (pick.action) {
            ...
            case 'samplingLog':
                editorService.openEditor({
                    ...
                    label: localize(12152, null, server.definition.label),
                });
                break;
            default:
                assertNever(pick);
            ...
            return instaService.createInstance(class extends MenuEntryActionViewItem {
                ...
                getHoverContents({ state, servers } = displayedStateCurrent.get()) {
                    const link = (s) => createMarkdownCommandLink({
                        ...
                        tooltip: localize(12155, null, s.definition.label),
                    });
                    ...
                    if (state === 1 /* DisplayedState.NewTools */) {
                        markdown = new MarkdownString(single
                            ? localize(12156, null, names)
                            : localize(12157, null, names));
                    }
                    else if (state === 2 /* DisplayedState.Error */) {
                        markdown = new MarkdownString(single
                            ? localize(12158, null, names)
                            : localize(12159, null, names));
                    }
                    else {
                    ...
                    return {
                        element: (token) => {
                            ...
                            const settingLabelStr = localize(12160, null);
                ...
                getLabelForState({ state, servers } = displayedStateCurrent.get()) {
                    if (state === 1 /* DisplayedState.NewTools */) {
                        return localize(12161, null, servers.length || 1);
                    }
                    else if (state === 2 /* DisplayedState.Error */) {
                        return localize(12162, null, servers.length || 1);
                    }
                    else if (state === 3 /* DisplayedState.Refreshing */) {
                        return localize(12163, null);
                    }
                    else {
                        return null;
                    }
...
export class ResetMcpTrustCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12168, "Reset Trust"),
            category,
            f1: true,
...
export class ResetMcpCachedTools extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12169, "Reset Cached Tools"),
            category,
            f1: true,
            precondition: ContextKeyExpr.and(McpContextKeys.toolsCount.greater(0), ChatContextKeys.Setup.hidden.negate()),
        });
...
export class AddConfigurationAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12170, "Add Server..."),
            metadata: {
                description: localize2(12171, "Installs a new Model Context protocol to the mcp.json settings"),
            },
            category,
            f1: true,
            precondition: ChatContextKeys.Setup.hidden.negate(),
...
export class InstallFromManifestAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12172, "Install Server from Manifest..."),
            metadata: {
                description: localize2(12173, "Install an MCP server from a JSON manifest file"),
            },
            category,
            f1: true,
            precondition: ChatContextKeys.Setup.hidden.negate(),
...
export class RemoveStoredInput extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12174, "Reset Cached Tools"),
            category,
            f1: false,
        });
    }
...
export class EditStoredInput extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12175, "Edit Stored Input"),
            category,
            f1: false,
        });
    }
...
export class ShowConfiguration extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12176, "Show Configuration"),
            category,
            f1: false,
        });
    }
...
export class ShowOutput extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12177, "Show Output"),
            category,
            f1: false,
        });
    }
...
export class RestartServer extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12178, "Restart Server"),
            category,
            f1: false,
        });
    }
...
export class StartServer extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12179, "Start Server"),
            category,
            f1: false,
        });
    }
...
export class StopServer extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12180, "Stop Server"),
            category,
            f1: false,
        });
    }
...
export class McpBrowseCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12181, "MCP Servers"),
            tooltip: localize2(12182, "Browse MCP Servers"),
            category,
            icon: Codicon.search,
            precondition: ChatContextKeys.Setup.hidden.negate(),
            menu: [{
...
MenuRegistry.appendMenuItem(MenuId.CommandPalette, {
    command: {
        id: "workbench.mcp.browseServers" /* McpCommandIds.Browse */,
        title: localize2(12183, "Browse MCP Servers"),
        category,
        precondition: ChatContextKeys.Setup.hidden.negate(),
    },
});
export class ShowInstalledMcpServersCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12184, "Show Installed Servers"),
            category,
...
MenuRegistry.appendMenuItem(CHAT_CONFIG_MENU_ID, {
    command: {
        id: "workbench.mcp.showInstalledServers" /* McpCommandIds.ShowInstalled */,
        title: localize2(12185, "MCP Servers")
    },
...
export class OpenUserMcpResourceCommand extends OpenMcpResourceCommand {
    constructor() {
        super({
            ...
            title: localize2(12186, "Open User Configuration"),
            category,
            f1: true,
            precondition: ChatContextKeys.Setup.hidden.negate(),
        });
...
export class OpenRemoteUserMcpResourceCommand extends OpenMcpResourceCommand {
    constructor() {
        super({
            ...
            title: localize2(12187, "Open Remote User Configuration"),
            category,
            f1: true,
...
export class OpenWorkspaceFolderMcpResourceCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12188, "Open Workspace Folder MCP Configuration"),
            category,
            f1: true,
...
export class OpenWorkspaceMcpResourceCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12189, "Open Workspace MCP Configuration"),
            category,
            f1: true,
...
export class McpBrowseResourcesCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12190, "Browse Resources..."),
            category,
...
export class McpConfigureSamplingModels extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12191, "Configure SamplingModel"),
            category,
        });
    }
    async run(accessor, server) {
        ...
        const picked = await quickInputService.pick(allItems, {
            placeHolder: localize(12164, null, server.definition.label),
            canPickMany: true,
        });
        if (picked) {
...
export class McpStartPromptingServerCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12192, "Start Prompting Server"),
            category,
            f1: false,
        });
    }
...
export class McpSkipCurrentAutostartCommand extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(12193, "Skip Current Autostart"),
            category,
            f1: false,
        });
    }
