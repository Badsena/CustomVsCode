            ...
            for (const { id, name, arg } of expr.unresolved()) {
                if (!this._configurationResolverService.resolvableVariables.has(name)) {
                    ...
                    diagnostics.push({
                        ...
                        message: localize(12290, null, name, getClosestMatchingVariable(name) + (arg ? `:${arg}` : '')),
            ...
            switch (state) {
                case 3 /* McpConnectionState.Kind.Error */:
                    lenses.push({
                        ...
                        command: {
                            ...
                            title: '$(error) ' + localize(12291, null),
                ...
                case 1 /* McpConnectionState.Kind.Starting */:
                    lenses.push({
                        ...
                        command: {
                            id: "workbench.mcp.showOutput" /* McpCommandIds.ShowOutput */,
                            title: '$(loading~spin) ' + localize(12294, null),
                            arguments: [server.definition.id],
                        },
                    }, {
                        range,
                ...
                case 2 /* McpConnectionState.Kind.Running */:
                    lenses.push({
                        ...
                        command: {
                            id: "workbench.mcp.showOutput" /* McpCommandIds.ShowOutput */,
                            title: '$(check) ' + localize(12296, null),
                            arguments: [server.definition.id],
                        },
                    }, {
                        range,
                ...
                case 0 /* McpConnectionState.Kind.Stopped */:
                    lenses.push({
                        ...
                        command: {
                            ...
                            title: '$(debug-start) ' + localize(12300, null),
                            arguments: [server.definition.id, { autoTrustChanges: true }],
                        },
                    });
                    if (canDebug) {
            ...
            if (state !== 3 /* McpConnectionState.Kind.Error */) {
                ...
                if (toolCount) {
                    lenses.push({
                        ...
                        command: {
                            id: '',
                            title: localize(12302, null, toolCount),
                        }
                    });
                }
                ...
                if (promptCount) {
                    lenses.push({
                        ...
                        command: {
                            ...
                            title: localize(12303, null, promptCount),
                            arguments: [server],
                        }
                    });
                }
    ...
    async _provideInlayHints(model, range) {
        ...
        function pushAnnotation(savedId, offset, saved) {
            const tooltip = new MarkdownString([
                createMarkdownCommandLink({ id: "workbench.mcp.editStoredInput" /* McpCommandIds.EditStoredInput */, text: localize(12305, null), arguments: [savedId, model.uri, mcpConfigurationSection, inConfig.target], tooltip: localize(12306, null) }),
                createMarkdownCommandLink({ id: "workbench.mcp.removeStoredInput" /* McpCommandIds.RemoveStoredInput */, text: localize(12307, null), arguments: [inConfig.scope, savedId], tooltip: localize(12308, null) }),
                createMarkdownCommandLink({ id: "workbench.mcp.removeStoredInput" /* McpCommandIds.RemoveStoredInput */, text: localize(12309, null), arguments: [inConfig.scope], tooltip: localize(12310, null) }),
            ].join(' | '), { isTrusted: true });
            const hint = {
