...
let PublisherWidget = class PublisherWidget extends McpServerWidget {
    ...
    render() {
        ...
        if (this.small) {
            ...
            this.containerHover = this.disposables.add(this.hoverService.setupManagedHover(getDefaultHoverDelegate('mouse'), this.element, localize(12442, null, this.mcpServer.publisherDisplayName)));
            dom.append(this.element, publisherDisplayName);
            if (this.mcpServer.gallery?.publisherDomain?.verified) {
                dom.append(this.element, verifiedPublisher);
                ...
                this.containerHover.update(localize(12443, null, this.mcpServer.gallery?.publisherDomain.link));
...
export const mcpStarredIconColor = registerColor('mcpIcon.starForeground', { light: '#DF6100', dark: '#FF8E00', hcDark: '#FF8E00', hcLight: textLinkForeground }, localize(12446, null), false);
