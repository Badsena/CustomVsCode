...
Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(McpServerEditor, McpServerEditor.ID, localize(12129, null)), [
...
Registry.as(QuickAccessExtensions.Quickaccess).registerQuickAccessProvider({
    ...
    placeholder: localize(12130, null),
    helpEntries: [{
            description: localize(12131, null),
