...
let McpServersListView = class McpServersListView extends AbstractExtensionsListView {
    ...
    createWelcomeContent(welcomeContainer) {
        ...
        title.textContent = localize(12426, null);
        const settingsCommandLink = createMarkdownCommandLink({ id: 'workbench.action.openSettings', arguments: [`@id:${mcpGalleryServiceEnablementConfig}`], text: mcpGalleryServiceEnablementConfig, tooltip: localize(12427, null) }).toString();
        const description = dom.append(welcomeContent, dom.$('.mcp-welcome-description'));
        const markdownResult = this._register(this.markdownRendererService.render(new MarkdownString(localize(12428, null), { isTrusted: { enabledCommands: ['workbench.action.openSettings'] } })
            .appendMarkdown('\n\n')
            .appendMarkdown(localize(12429, null, settingsCommandLink))));
        ...
        const button = this._register(new Button(buttonContainer, {
            title: localize(12430, null),
            ...defaultButtonStyles
        }));
        button.label = localize(12431, null);
        this._register(button.onDidClick(async () => {
            const { result } = await this.dialogService.prompt({
                type: 'info',
                message: localize(12432, null),
                custom: {
                    markdownDetails: [{
                            markdown: new MarkdownString(localize(12433, null, settingsCommandLink), { isTrusted: true })
                        }]
                },
                buttons: [
                    { label: localize(12434, null), run: () => true },
                    { label: localize(12435, null), run: () => false }
                ]
            });
            if (result) {
        ...
        if (this.bodyTemplate) {
            ...
            if (this.isBodyVisible()) {
                if (message) {
                    ...
                    this.bodyTemplate.messageBox.textContent = localize(12436, null);
                }
        ...
        Registry.as(ViewExtensions.ViewsRegistry).registerViews([
            {
                ...
                name: localize2(12437, "MCP Servers - Installed"),
            ...
            },
            {
                ...
                name: localize2(12438, "MCP Servers"),
            ...
            },
            {
                ...
                name: localize2(12439, "MCP Servers"),
                ctorDescriptor: new SyncDescriptor(McpServersListView, [{}]),
            ...
            },
            {
                ...
                name: localize2(12440, "MCP Servers"),
            ...
            },
            {
                ...
                name: localize2(12441, "MCP Servers"),
