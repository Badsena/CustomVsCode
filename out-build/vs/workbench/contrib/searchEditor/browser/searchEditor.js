...
let SearchEditor = class SearchEditor extends AbstractTextCodeEditor {
    ...
    createQueryEditor(container, scopedInstantiationService, inputBoxFocusedContextKey) {
        ...
        const toggleQueryDetailsLabel = localize(14730, null);
        ...
        const filesToIncludeTitle = localize(14731, null);
        ...
        const excludesTitle = localize(14733, null);
    ...
    toggleRunAgainMessage(show) {
        ...
        if (show) {
            const runAgainLink = DOM.append(this.messageBox, DOM.$('a.pointer.prominent.message', {}, localize(14735, null)));
    ...
    iterateThroughMatches(reverse) {
        ...
        alert(localize(14736, null, matchText, matchLineText, file.slice(0, file.length - 1)));
    }
    focusNextResult() {
    ...
    getAriaLabel() {
        return this.getInput()?.getName() ?? localize(14737, null);
    }
};
...
export { SearchEditor };
const searchEditorTextInputBorder = registerColor('searchEditor.textInputBorder', inputBorder, localize(14738, null));
