...
Registry.as(EditorExtensions.EditorPane).registerEditorPane(EditorPaneDescriptor.create(SearchEditor, SearchEditor.ID, localize(14710, null)), [
...
//#endregion
//#region Actions
const category = localize2(14713, 'Search Editor');
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14714, 'Delete File Results'),
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14715, 'New Search Editor'),
            category,
            f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14716, 'Open Search Editor'),
            category,
            f1: true,
            metadata: openArgMetadata
        });
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14717, 'Open New Search Editor to the Side'),
            category,
            f1: true,
            metadata: openArgMetadata
        });
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14718, 'Open Results in Editor'),
            category,
            f1: true,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14719, 'Search Again'),
            category,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14720, 'Focus Search Editor Input'),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14721, 'Focus Search Editor Files to Include'),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
        });
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14722, 'Focus Search Editor Files to Exclude'),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
        });
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14723, 'Toggle Match Case'),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14724, 'Toggle Match Whole Word'),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
            keybinding: Object.assign({
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14725, "Toggle Use Regular Expression"),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
            keybinding: Object.assign({
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14726, "Toggle Context Lines"),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14727, "Increase Context Lines"),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14728, "Decrease Context Lines"),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
            keybinding: {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(14729, "Select All Matches"),
            category,
            f1: true,
            precondition: SearchEditorConstants.InSearchEditor,
            keybinding: {
