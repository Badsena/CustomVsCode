...
let SearchWidget = class SearchWidget extends Widget {
    ...
    static { this.REPLACE_ALL_DISABLED_LABEL = nls.localize(14696, null); }
    static { this.REPLACE_ALL_ENABLED_LABEL = (keyBindingService2) => {
        return keyBindingService2.appendKeybinding(nls.localize(14697, null), ReplaceAllAction.ID);
    }; }
    ...
    _updateSearchInputAriaLabel(includeHint) {
        ...
        let searchLabel = nls.localize(14698, null);
        ...
        if (includeHint && !this._accessibilityHelpHintAnnounced && this.configurationService.getValue('accessibility.verbosity.find') && this.accessibilityService.isScreenReaderOptimized()) {
            ...
            if (keybinding) {
                searchLabel += ', ' + nls.localize(14699, null, keybinding);
                ...
                this._labelResetTimeout = disposableTimeout(() => {
                    if (this.searchInput) {
                        this.searchInput.inputBox.setAriaLabel(nls.localize(14700, null));
                    }
                }, 1000);
            }
        }
    ...
    renderSearchInput(parent, options) {
        ...
        const inputOptions = {
            label: nls.localize(14702, null),
            validation: (value) => this.validateSearchInput(value),
            placeholder: nls.localize(14703, null),
        ...
        this.showContextToggle = new Toggle({
            isChecked: false,
            title: this.keybindingService.appendKeybinding(nls.localize(14704, null), ToggleSearchEditorContextLinesCommandId),
    ...
    renderReplaceInput(parent, options) {
        ...
        this.replaceInput = this._register(new ContextScopedReplaceInput(replaceBox, this.contextViewService, {
            label: nls.localize(14705, null),
            placeholder: nls.localize(14706, null),
