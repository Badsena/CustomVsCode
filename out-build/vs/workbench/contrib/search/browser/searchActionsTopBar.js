...
registerAction2(class ClearSearchHistoryCommandAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14588, "Clear Search History"),
            category,
            f1: true
        });
    }
...
registerAction2(class CancelSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14589, "Cancel Search"),
            icon: searchStopIcon,
            category,
            f1: true,
...
registerAction2(class RefreshAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14590, "Refresh"),
...
registerAction2(class CollapseDeepestExpandedLevelAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14591, "Collapse All"),
            category,
...
registerAction2(class ExpandAllAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14592, "Expand All"),
            category,
...
registerAction2(class ClearSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14593, "Clear Search Results"),
            category,
...
registerAction2(class ViewAsTreeAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14594, "View as Tree"),
            category,
...
registerAction2(class ViewAsListAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14595, "View as List"),
            category,
...
registerAction2(class SearchWithAIAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14596, "Search with AI"),
            category,
            f1: true,
