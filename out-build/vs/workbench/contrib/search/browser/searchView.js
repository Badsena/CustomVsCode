...
const SEARCH_CANCELLED_MESSAGE = nls.localize(14641, null);
...
let SearchView = class SearchView extends ViewPane {
    ...
    renderBody(parent) {
        ...
        const toggleQueryDetailsLabel = nls.localize(14642, null);
        ...
        const filesToIncludeTitle = nls.localize(14643, null);
        ...
        this.inputPatternIncludes = this._register(this.instantiationService.createInstance(IncludePatternInputWidget, folderIncludesList, this.contextViewService, {
            ...
            placeholder: nls.localize(14644, null),
        ...
        const excludesTitle = nls.localize(14645, null);
        dom.append(excludesList, $('h4', undefined, excludesTitle));
        this.inputPatternExcludes = this._register(this.instantiationService.createInstance(ExcludePatternInputWidget, excludesList, this.contextViewService, {
            ariaLabel: excludesTitle,
            placeholder: nls.localize(14646, null),
            showPlaceholderOnFocus: true,
    ...
    replaceAll() {
        ...
        const confirmation = {
            title: nls.localize(14647, null),
            message: this.buildReplaceAllConfirmationMessage(occurrences, fileCount, replaceValue),
            primaryButton: nls.localize(14648, null)
        };
    ...
    buildAfterReplaceAllMessage(occurrences, fileCount, replaceValue) {
        if (occurrences === 1) {
            if (fileCount === 1) {
                if (replaceValue) {
                    return nls.localize(14649, null, occurrences, fileCount, replaceValue);
                }
                return nls.localize(14650, null, occurrences, fileCount);
            }
            if (replaceValue) {
                return nls.localize(14651, null, occurrences, fileCount, replaceValue);
            }
            return nls.localize(14652, null, occurrences, fileCount);
        }
        if (fileCount === 1) {
            if (replaceValue) {
                return nls.localize(14653, null, occurrences, fileCount, replaceValue);
            }
            return nls.localize(14654, null, occurrences, fileCount);
        }
        if (replaceValue) {
            return nls.localize(14655, null, occurrences, fileCount, replaceValue);
        }
        return nls.localize(14656, null, occurrences, fileCount);
    }
        ...
        if (occurrences === 1) {
            if (fileCount === 1) {
                if (displayReplaceValue) {
                    return nls.localize(14657, null, occurrences, fileCount, displayReplaceValue);
                }
                return nls.localize(14658, null, occurrences, fileCount);
            }
            if (displayReplaceValue) {
                return nls.localize(14659, null, occurrences, fileCount, displayReplaceValue);
            }
            return nls.localize(14660, null, occurrences, fileCount);
        }
        if (fileCount === 1) {
            if (displayReplaceValue) {
                return nls.localize(14661, null, occurrences, fileCount, displayReplaceValue);
            }
            return nls.localize(14662, null, occurrences, fileCount);
        }
        if (displayReplaceValue) {
            return nls.localize(14663, null, occurrences, fileCount, displayReplaceValue);
        }
        return nls.localize(14664, null, occurrences, fileCount);
    }
    clearMessage() {
    ...
    clearSearchResults(clearInput = true) {
        ...
        this.tree.ariaLabel = nls.localize(14665, null);
    ...
    validateQuery(query) {
        ...
        return Promise.all(folderQueriesExistP).then(existResults => {
            ...
            if (!query.folderQueries.length || existingFolderQueries.length) {
                ...
                const searchPathNotFoundError = nls.localize(14666, null, nonExistantPath);
    ...
    appendSearchWithAIButton(messageEl) {
        const searchWithAIButtonTooltip = this.keybindingService.appendKeybinding(nls.localize(14667, null), "search.action.searchWithAI" /* Constants.SearchCommandIds.SearchWithAIActionId */);
        const searchWithAIButtonText = nls.localize(14668, null);
        ...
        if (!allResults) {
            ...
            if (!completed) {
                ...
                if (hasIncludes && hasExcludes) {
                    message = nls.localize(14669, null, includePatternText, excludePatternText);
                }
                else if (hasIncludes) {
                    message = nls.localize(14670, null, includePatternText);
                }
                else if (hasExcludes) {
                    message = nls.localize(14671, null, excludePatternText);
                }
                else {
                    message = nls.localize(14672, null);
                }
            }
            else {
                if (hasIncludes && hasExcludes) {
                    message = nls.localize(14673, null, includePatternText, excludePatternText);
                }
                else if (hasIncludes) {
                    message = nls.localize(14674, null, includePatternText);
                }
                else if (hasExcludes) {
                    message = nls.localize(14675, null, excludePatternText);
                }
                else {
                    message = nls.localize(14676, null);
                }
            }
            ...
            if (!completed) {
                const searchAgainButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(14677, null), () => this.triggerQueryChange({ preserveFocus: false }), this.hoverService));
                dom.append(messageEl, searchAgainButton.element);
            }
            else if (hasIncludes || hasExcludes) {
                const searchAgainButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(14678, null), this.onSearchAgain.bind(this), this.hoverService));
                dom.append(messageEl, searchAgainButton.element);
            }
            else {
                const openSettingsButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(14679, null), this.onOpenSettings.bind(this), this.hoverService));
            ...
            aria.status(nls.localize(14680, null, this.viewModel.searchResult.count(), this.viewModel.searchResult.fileCount()));
        }
        if (completed && completed.limitHit) {
            completed.messages.push({ type: TextSearchCompleteMessageType.Warning, text: nls.localize(14681, null) });
        }
    ...
    updateSearchResultCount(disregardExcludesAndIgnores, onlyOpenEditors, clear = false) {
        ...
        this.tree.ariaLabel = resultMsg + nls.localize(14682, null, this.searchResult.query?.contentPattern.pattern ?? '');
        dom.append(messageEl, resultMsg);
        if (fileCount > 0) {
            if (disregardExcludesAndIgnores) {
                const excludesDisabledMessage = ' - ' + nls.localize(14683, null) + ' ';
                const enableExcludesButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(14684, null), this.onEnableExcludes.bind(this), this.hoverService, nls.localize(14685, null)));
                dom.append(messageEl, $('span', undefined, excludesDisabledMessage, '(', enableExcludesButton.element, ')'));
            }
            if (onlyOpenEditors) {
                const searchingInOpenMessage = ' - ' + nls.localize(14686, null) + ' ';
                const disableOpenEditorsButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(14687, null), this.onDisableSearchInOpenEditors.bind(this), this.hoverService, nls.localize(14688, null)));
                dom.append(messageEl, $('span', undefined, searchingInOpenMessage, '(', disableOpenEditorsButton.element, ')'));
            }
            dom.append(messageEl, ' - ');
            const openInEditorTooltip = this.keybindingService.appendKeybinding(nls.localize(14689, null), "search.action.openInEditor" /* Constants.SearchCommandIds.OpenInEditorCommandId */);
            const openInEditorButton = this.messageDisposables.add(new SearchLinkButton(nls.localize(14690, null), () => this.instantiationService.invokeFunction(createEditorFromSearchResult, this.searchResult, this.searchIncludePattern.getValue(), this.searchExcludePattern.getValue(), this.searchIncludePattern.onlySearchInOpenEditors()), this.hoverService, openInEditorTooltip));
    ...
    updateKeywordSuggestionUI(keyword) {
        ...
        if (this._cachedKeywords.length > 0) {
            ...
            const resultMsg = nls.localize(14691, null);
            dom.append(messageEl, resultMsg);
    ...
    buildResultCountMessage(resultCount, fileCount) {
        if (resultCount === 1 && fileCount === 1) {
            return nls.localize(14692, null, resultCount, fileCount);
        }
        else if (resultCount === 1) {
            return nls.localize(14693, null, resultCount, fileCount);
        }
        else if (fileCount === 1) {
            return nls.localize(14694, null, resultCount, fileCount);
        }
        else {
            return nls.localize(14695, null, resultCount, fileCount);
        }
    }
