...
let ReplaceService = class ReplaceService {
    ...
    static { this.REPLACE_SAVE_SOURCE = SaveSourceRegistry.registerSource('searchReplace.source', nls.localize(14411, null)); }
    ...
    async openReplacePreview(element, preserveFocus, sideBySide, pinned) {
        ...
        const editor = await this.editorService.openEditor({
            ...
            label: nls.localize(14412, null, fileMatch.name(), fileMatch.name()),
