...
registerAction2(class RestrictSearchToFolderAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14555, "Restrict Search to Folder"),
            category,
            keybinding: {
...
registerAction2(class ExcludeFolderFromSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14556, "Exclude Folder from Search"),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class ExcludeFileTypeFromSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14557, "Exclude File Type from Search"),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class IncludeFileTypeInSearchAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14558, "Include File Type from Search"),
            category,
            menu: [
                {
                    id: MenuId.SearchContext,
...
registerAction2(class RevealInSideBarForSearchResultsAction extends Action2 {
    constructor() {
        super({
            ...
            title: nls.localize2(14559, "Reveal in Explorer View"),
            category,
            menu: [{
                    id: MenuId.SearchContext,
...
registerAction2(class FindInFilesAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...nls.localize2(14560, "Find in Files"),
                mnemonicTitle: nls.localize(14552, null),
            },
            metadata: {
                description: nls.localize(14553, null),
                args: [
                    {
                        name: nls.localize(14554, null),
                        schema: {
                            type: 'object',
                            properties: {
                                query: { 'type': 'string' },
...
registerAction2(class FindInFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(14561, "Find in Folder..."),
            category,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
registerAction2(class FindInWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(14562, "Find in Workspace..."),
            category,
            menu: [
                {
                    id: MenuId.ExplorerContext,
