...
let AnythingQuickAccessProvider = class AnythingQuickAccessProvider extends PickerQuickAccessProvider {
    ...
    doGetPicks(filter, options, disposables, token) {
        ...
        if (this.pickState.isQuickNavigating) {
            if (picks.length > 0) {
                picks.push({ type: 'separator', label: localize(14391, null) });
            }
            ...
            if (historyEditorPicks.length !== 0) {
                picks.push({ type: 'separator', label: localize(14392, null) });
        ...
        return {
            ...
            additionalPicks: (async () => {
                ...
                return additionalPicks.length > 0 ? [
                    { type: 'separator', label: this.configuration.includeSymbols ? localize(14393, null) : localize(14394, null) },
                    ...additionalPicks
                ] : [];
            })(),
    ...
    getHelpPicks(query, token, runOptions) {
        ...
        const providers = this.lazyRegistry.value.getQuickAccessProviders(this.contextKeyService)
            ...
            return {
                ...
                ariaLabel: localize(14395, null, label, helpEntry.description),
                accept: () => {
    ...
    createAnythingPick(resourceOrEditor, configuration) {
        ...
        return {
            resource,
            label,
            ariaLabel: isDirty ? localize(14400, null, labelAndDescription) : labelAndDescription,
            description,
