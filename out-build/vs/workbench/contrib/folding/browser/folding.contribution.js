...
let DefaultFoldingRangeProvider = class DefaultFoldingRangeProvider extends Disposable {
    ...
    async _updateConfigValues() {
        ...
        DefaultFoldingRangeProvider_1.extensionItemLabels.push(nls.localize(11550, null));
        DefaultFoldingRangeProvider_1.extensionDescriptions.push(nls.localize(11551, null));
...
Registry.as(ConfigurationExtensions.Configuration).registerConfiguration({
    ...
    properties: {
        [DefaultFoldingRangeProvider.configName]: {
            description: nls.localize(11552, null),
            type: ['string', 'null'],
            default: null,
