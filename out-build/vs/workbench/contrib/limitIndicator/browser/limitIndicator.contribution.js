...
const configureSettingsLabel = nls.localize(11861, null);
/**
...
class ColorDecorationAccessor {
    constructor() {
        ...
        this.name = nls.localize(11862, null);
        this.label = nls.localize(11863, null);
        this.source = nls.localize(11864, null);
...
class FoldingRangeAccessor {
    constructor() {
        ...
        this.name = nls.localize(11865, null);
        this.label = nls.localize(11866, null);
        this.source = nls.localize(11867, null);
    ...
    updateStatusItem(info) {
        ...
        if (info && info.limited !== false) {
            const status = {
                ...
                detail: nls.localize(11868, null, info.limited),
