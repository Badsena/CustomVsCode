...
let NativeTitlebarPart = class NativeTitlebarPart extends BrowserTitlebarPart {
    ...
    constructor(id, targetWindow, editorGroupsContainer, contextMenuService, configurationService, environmentService, instantiationService, themeService, storageService, layoutService, contextKeyService, hostService, nativeHostService, editorGroupService, editorService, menuService, keybindingService, commandService) {
    ...
    createContentArea(parent) {
        ...
        if (!hasNativeTitlebar(this.configurationService) && // not for native title bars
            ...
            this._register(addDisposableListener(exitButton, EventType.CLICK, (e) => {
                EventHelper.stop(e);
                this.commandService.executeCommand('amypo.exit').catch(() => {
...
let MainNativeTitlebarPart = class MainNativeTitlebarPart extends NativeTitlebarPart {
    constructor(contextMenuService, configurationService, environmentService, instantiationService, themeService, storageService, layoutService, contextKeyService, hostService, nativeHostService, editorGroupService, editorService, menuService, keybindingService, commandService) {
