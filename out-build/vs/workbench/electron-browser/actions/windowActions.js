...
export class CloseWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(17763, "Close Window"),
                mnemonicTitle: localize(17749, null),
            },
            f1: true,
            keybinding: {
...
export class CloseOtherWindowsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(17764, "Close Other Windows"),
            f1: true
        });
    }
    async run(accessor) {
...
export class ZoomInAction extends BaseZoomAction {
    constructor() {
        super({
            ...
            title: {
                ...localize2(17765, "Zoom In"),
                mnemonicTitle: localize(17750, null),
            },
...
export class ZoomOutAction extends BaseZoomAction {
    constructor() {
        super({
            ...
            title: {
                ...localize2(17766, "Zoom Out"),
                mnemonicTitle: localize(17751, null),
            },
            category: Categories.View,
            f1: true,
            keybinding: {
...
export class ZoomResetAction extends BaseZoomAction {
    constructor() {
        super({
            ...
            title: {
                ...localize2(17767, "Reset Zoom"),
                mnemonicTitle: localize(17752, null),
            },
            category: Categories.View,
            f1: true,
            keybinding: {
    ...
    async run(accessor) {
        ...
        for (const window of mainWindows) {
            ...
            if (mapMainWindowToAuxiliaryWindows.size > 0) {
                picks.push({ type: 'separator', label: auxiliaryWindows ? localize(17756, null) : undefined });
            }
            ...
            const pick = {
                windowId: window.id,
                label: window.title,
                ariaLabel: window.dirty ? localize(17757, null, window.title) : window.title,
                iconClasses: getIconClasses(modelService, languageService, resource, fileKind),
                description: (currentWindowId === window.id) ? localize(17758, null) : undefined,
            ...
            if (auxiliaryWindows) {
                for (const auxiliaryWindow of auxiliaryWindows) {
                    const pick = {
                        ...
                        description: (currentWindowId === auxiliaryWindow.id) ? localize(17759, null) : undefined,
        ...
        const pick = await quickInputService.pick(picks, {
            ...
            placeHolder: localize(17760, null),
...
export class SwitchWindowAction extends BaseSwitchWindow {
    constructor() {
        super({
            ...
            title: localize2(17768, 'Switch Window...'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: 0,
...
export class QuickSwitchWindowAction extends BaseSwitchWindow {
    constructor() {
        super({
            ...
            title: localize2(17769, 'Quick Switch Window...'),
...
export class ToggleWindowAlwaysOnTopAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(17770, "Toggle Window Always on Top"),
            f1: true,
