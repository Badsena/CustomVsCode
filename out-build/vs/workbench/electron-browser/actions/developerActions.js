...
export class ToggleDevToolsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17737, 'Toggle Developer Tools'),
...
export class ConfigureRuntimeArgumentsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17738, 'Configure Runtime Arguments'),
...
export class ReloadWindowWithExtensionsDisabledAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17739, 'Reload with Extensions Disabled'),
            category: Categories.Developer,
            f1: true
        });
    }
...
export class OpenUserDataFolderAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17740, 'Reveal User Data Folder'),
            category: Categories.Developer,
            f1: true
        });
    }
...
export class ShowGPUInfoAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17741, 'Show GPU Info'),
            category: Categories.Developer,
            f1: true
        });
    }
...
export class ShowContentTracingAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(17742, 'Show Content Tracing'),
            category: Categories.Developer,
            f1: true
        });
    }
...
export class StopTracing extends Action2 {
    ...
    constructor() {
        super({
            id: StopTracing.ID,
            title: localize2(17743, 'Stop Tracing'),
            category: Categories.Developer,
            f1: true
        });
    }
    async run(accessor) {
        ...
        if (!environmentService.args.trace) {
            const { confirmed } = await dialogService.confirm({
                message: localize(17733, null),
                primaryButton: localize(17734, null),
            });
            if (confirmed) {
        ...
        await progressService.withProgress({
            ...
            title: localize(17735, null),
            cancellable: false,
            detail: localize(17736, null)
