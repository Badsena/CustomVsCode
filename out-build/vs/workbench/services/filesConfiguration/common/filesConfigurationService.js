...
let FilesConfigurationService = class FilesConfigurationService extends Disposable {
    ...
    static { this.READONLY_MESSAGES = {
        providerReadonly: { value: localize(18495, null), isTrusted: true },
        sessionReadonly: { value: localize(18496, null, 'workbench.action.files.setActiveEditorWriteableInSession'), isTrusted: true },
        configuredReadonly: { value: localize(18497, null, `workbench.action.openSettings?${encodeURIComponent('["files.readonly"]')}`, 'workbench.action.files.toggleActiveEditorReadonlyInSession'), isTrusted: true },
        fileLocked: { value: localize(18498, null, 'workbench.action.files.setActiveEditorWriteableInSession'), isTrusted: true },
        fileReadonly: { value: localize(18499, null), isTrusted: true }
    }; }
