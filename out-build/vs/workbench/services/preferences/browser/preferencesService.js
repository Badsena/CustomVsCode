...
let PreferencesService = class PreferencesService extends Disposable {
    ...
    openWorkspaceSettings(options = {}) {
        if (!this.workspaceSettingsResource) {
            this.notificationService.info(nls.localize(18612, null));
    ...
    async openGlobalKeybindingSettings(textual, options) {
        ...
        if (textual) {
            const emptyContents = '// ' + nls.localize(18613, null) + '\n[\n]';
            ...
            if (openDefaultKeybindings) {
                ...
                await Promise.all([
                    this.editorService.openEditor({ resource: this.defaultKeybindingsResource, options: { pinned: true, preserveFocus: true, revealIfOpened: true, override: DEFAULT_EDITOR_ASSOCIATION.id }, label: nls.localize(18614, null), description: '' }, sourceGroupId),
    ...
    openDefaultKeybindingsFile() {
        return this.editorService.openEditor({ resource: this.defaultKeybindingsResource, label: nls.localize(18615, null) });
    }
        ...
        try {
            ...
            if (error.fileOperationResult === 1 /* FileOperationResult.FILE_NOT_FOUND */) {
                try {
                    ...
                    throw new Error(nls.localize(18616, null, this.labelService.getUriLabel(resource, { relative: true }), getErrorMessage(error2)));
                }
            }
            else {
                throw error;
