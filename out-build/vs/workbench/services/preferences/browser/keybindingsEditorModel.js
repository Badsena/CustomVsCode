...
const SOURCE_SYSTEM = localize(18605, null);
const SOURCE_EXTENSION = localize(18606, null);
const SOURCE_USER = localize(18607, null);
...
let KeybindingsEditorModel = KeybindingsEditorModel_1 = class KeybindingsEditorModel extends EditorModel {
    ...
    static getCommandDefaultLabel(menuCommand) {
        if (!Language.isDefaultVariant()) {
            if (menuCommand && menuCommand.title && menuCommand.title.original) {
                ...
                return category ? localize(18608, null, category, title) : title;
            }
        }
        return null;
    }
    static getCommandLabel(menuCommand, editorActionLabel) {
        if (menuCommand) {
            ...
            return category ? localize(18609, null, category, title) : title;
        }
...
class KeybindingItemMatches {
    ...
    wordMatchesAltModifier(word) {
        ...
        if (strings.equalsIgnoreCase(localize(18610, null), word)) {
            return true;
        }
        return false;
    }
    ...
    wordMatchesMetaModifier(word) {
        ...
        if (strings.equalsIgnoreCase(localize(18611, null), word)) {
            return true;
        }
        return false;
    }
