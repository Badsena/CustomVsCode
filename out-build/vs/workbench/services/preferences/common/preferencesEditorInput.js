...
const SettingsEditorIcon = registerIcon('settings-editor-label-icon', Codicon.settings, nls.localize(18617, null));
let SettingsEditor2Input = class SettingsEditor2Input extends EditorInput {
    ...
    getName() {
        return nls.localize(18618, null);
    }
    getIcon() {
...
const PreferencesEditorIcon = registerIcon('preferences-editor-label-icon', Codicon.settings, nls.localize(18619, null));
export class PreferencesEditorInput extends EditorInput {
    ...
    getName() {
        return nls.localize(18620, null);
    }
    getIcon() {
