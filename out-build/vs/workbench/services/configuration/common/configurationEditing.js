...
let ConfigurationEditing = class ConfigurationEditing {
    ...
    async save(model, operation) {
        try {
            ...
            throw new ConfigurationEditingError(nls.localize(18099, null, this.stringifyTarget(operation.target), error.message), 13 /* ConfigurationEditingErrorCode.ERROR_INTERNAL */);
        }
    }
    ...
    onInvalidConfigurationError(error, operation) {
        const openStandAloneConfigurationActionLabel = operation.workspaceStandAloneConfigurationKey === TASKS_CONFIGURATION_KEY ? nls.localize(18100, null)
            : operation.workspaceStandAloneConfigurationKey === LAUNCH_CONFIGURATION_KEY ? nls.localize(18101, null)
                : operation.workspaceStandAloneConfigurationKey === MCP_CONFIGURATION_KEY ? nls.localize(18102, null)
                    : null;
        if (openStandAloneConfigurationActionLabel) {
            ...
            this.notificationService.prompt(Severity.Error, error.message, [{
                    label: nls.localize(18103, null),
                    run: () => this.openSettings(operation)
                }]);
        }
    }
    onConfigurationFileDirtyError(error, operation, scopes) {
        const openStandAloneConfigurationActionLabel = operation.workspaceStandAloneConfigurationKey === TASKS_CONFIGURATION_KEY ? nls.localize(18104, null)
            : operation.workspaceStandAloneConfigurationKey === LAUNCH_CONFIGURATION_KEY ? nls.localize(18105, null)
                : null;
        if (openStandAloneConfigurationActionLabel) {
            this.notificationService.prompt(Severity.Error, error.message, [{
                    label: nls.localize(18106, null),
                    run: () => {
    ...
    toErrorMessage(error, target, operation) {
        switch (error) {
            // API constraints
            case 12 /* ConfigurationEditingErrorCode.ERROR_POLICY_CONFIGURATION */: return nls.localize(18109, null, operation.key);
            case 0 /* ConfigurationEditingErrorCode.ERROR_UNKNOWN_KEY */: return nls.localize(18110, null, this.stringifyTarget(target), operation.key);
            case 1 /* ConfigurationEditingErrorCode.ERROR_INVALID_WORKSPACE_CONFIGURATION_APPLICATION */: return nls.localize(18111, null, operation.key);
            case 2 /* ConfigurationEditingErrorCode.ERROR_INVALID_WORKSPACE_CONFIGURATION_MACHINE */: return nls.localize(18112, null, operation.key);
            case 3 /* ConfigurationEditingErrorCode.ERROR_INVALID_FOLDER_CONFIGURATION */: return nls.localize(18113, null, operation.key);
            case 4 /* ConfigurationEditingErrorCode.ERROR_INVALID_USER_TARGET */: return nls.localize(18114, null, operation.key);
            case 5 /* ConfigurationEditingErrorCode.ERROR_INVALID_WORKSPACE_TARGET */: return nls.localize(18115, null, operation.key);
            case 6 /* ConfigurationEditingErrorCode.ERROR_INVALID_FOLDER_TARGET */: return nls.localize(18116, null);
            case 7 /* ConfigurationEditingErrorCode.ERROR_INVALID_RESOURCE_LANGUAGE_CONFIGURATION */: return nls.localize(18117, null, operation.key);
            case 8 /* ConfigurationEditingErrorCode.ERROR_NO_WORKSPACE_OPENED */: return nls.localize(18118, null, this.stringifyTarget(target));
            // User issues
            case 11 /* ConfigurationEditingErrorCode.ERROR_INVALID_CONFIGURATION */: {
                if (operation.workspaceStandAloneConfigurationKey === TASKS_CONFIGURATION_KEY) {
                    return nls.localize(18119, null);
                }
                if (operation.workspaceStandAloneConfigurationKey === LAUNCH_CONFIGURATION_KEY) {
                    return nls.localize(18120, null);
                }
                if (operation.workspaceStandAloneConfigurationKey === MCP_CONFIGURATION_KEY) {
                    return nls.localize(18121, null);
                }
                switch (target) {
                    case 1 /* EditableConfigurationTarget.USER_LOCAL */:
                        return nls.localize(18122, null);
                    case 2 /* EditableConfigurationTarget.USER_REMOTE */:
                        return nls.localize(18123, null);
                    case 3 /* EditableConfigurationTarget.WORKSPACE */:
                        return nls.localize(18124, null);
                    case 4 /* EditableConfigurationTarget.WORKSPACE_FOLDER */: {
                        ...
                        return nls.localize(18125, null, workspaceFolderName);
                    }
                    default:
                        return '';
                }
            ...
            case 9 /* ConfigurationEditingErrorCode.ERROR_CONFIGURATION_FILE_DIRTY */: {
                if (operation.workspaceStandAloneConfigurationKey === TASKS_CONFIGURATION_KEY) {
                    return nls.localize(18126, null);
                }
                if (operation.workspaceStandAloneConfigurationKey === LAUNCH_CONFIGURATION_KEY) {
                    return nls.localize(18127, null);
                }
                if (operation.workspaceStandAloneConfigurationKey === MCP_CONFIGURATION_KEY) {
                    return nls.localize(18128, null);
                }
                switch (target) {
                    case 1 /* EditableConfigurationTarget.USER_LOCAL */:
                        return nls.localize(18129, null);
                    case 2 /* EditableConfigurationTarget.USER_REMOTE */:
                        return nls.localize(18130, null);
                    case 3 /* EditableConfigurationTarget.WORKSPACE */:
                        return nls.localize(18131, null);
                    case 4 /* EditableConfigurationTarget.WORKSPACE_FOLDER */: {
                        let workspaceFolderName = '<<unknown>>';
                        if (operation.resource) {
                            const folder = this.contextService.getWorkspaceFolder(operation.resource);
                        ...
                        return nls.localize(18132, null, workspaceFolderName);
                    }
                    default:
                        return '';
                }
            ...
            case 10 /* ConfigurationEditingErrorCode.ERROR_CONFIGURATION_FILE_MODIFIED_SINCE */:
                if (operation.workspaceStandAloneConfigurationKey === TASKS_CONFIGURATION_KEY) {
                    return nls.localize(18133, null);
                }
                if (operation.workspaceStandAloneConfigurationKey === LAUNCH_CONFIGURATION_KEY) {
                    return nls.localize(18134, null);
                }
                if (operation.workspaceStandAloneConfigurationKey === MCP_CONFIGURATION_KEY) {
                    return nls.localize(18135, null);
                }
                switch (target) {
                    case 1 /* EditableConfigurationTarget.USER_LOCAL */:
                        return nls.localize(18136, null);
                    case 2 /* EditableConfigurationTarget.USER_REMOTE */:
                        return nls.localize(18137, null);
                    case 3 /* EditableConfigurationTarget.WORKSPACE */:
                        return nls.localize(18138, null);
                    case 4 /* EditableConfigurationTarget.WORKSPACE_FOLDER */:
                        return nls.localize(18139, null);
                }
            case 13 /* ConfigurationEditingErrorCode.ERROR_INTERNAL */: return nls.localize(18140, null, this.stringifyTarget(target));
        }
    }
    stringifyTarget(target) {
        switch (target) {
            case 1 /* EditableConfigurationTarget.USER_LOCAL */:
                return nls.localize(18141, null);
            case 2 /* EditableConfigurationTarget.USER_REMOTE */:
                return nls.localize(18142, null);
            case 3 /* EditableConfigurationTarget.WORKSPACE */:
                return nls.localize(18143, null);
            case 4 /* EditableConfigurationTarget.WORKSPACE_FOLDER */:
                return nls.localize(18144, null);
            default:
                return '';
        }
    }
