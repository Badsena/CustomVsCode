...
const iconConfigurationExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: nls.localize(18852, null),
        type: 'object',
        propertyNames: {
            pattern: iconIdPattern,
            description: nls.localize(18853, null),
            patternErrorMessage: nls.localize(18854, null),
        },
        additionalProperties: {
            ...
            properties: {
                description: {
                    type: 'string',
                    description: nls.localize(18855, null),
                },
                default: {
                    anyOf: [
                        iconReferenceSchema,
                        {
                            ...
                            properties: {
                                fontPath: {
                                    description: nls.localize(18856, null),
                                    type: 'string'
                                },
                                fontCharacter: {
                                    description: nls.localize(18857, null),
                                    type: 'string'
                                }
                            },
                    ...
                    description: nls.localize(18858, null),
                }
            },
        ...
        iconConfigurationExtPoint.setHandler((extensions, delta) => {
            for (const extension of delta.added) {
                ...
                if (!extensionValue || typeof extensionValue !== 'object') {
                    collector.error(nls.localize(18859, null));
                    return;
                }
                for (const id in extensionValue) {
                    if (!id.match(iconIdPattern)) {
                        collector.error(nls.localize(18860, null));
                        return;
                    }
                    ...
                    if (typeof iconContribution.description !== 'string' || iconContribution.description.length === 0) {
                        collector.error(nls.localize(18861, null));
                        return;
                    }
                    ...
                    if (typeof defaultIcon === 'string') {
                        ...
                        if (!format) {
                            collector.warn(nls.localize(18862, null, fileExt));
                            return;
                        }
                        ...
                        if (!resources.isEqualOrParent(iconFontLocation, extensionLocation)) {
                            collector.warn(nls.localize(18863, null, iconFontLocation.path, extensionLocation.path));
                            return;
                        }
                        ...
                        collector.error(nls.localize(18864, null));
                    }
                }
            }
