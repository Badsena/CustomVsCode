...
const textmateColorSchema = {
    ...
    definitions: {
        ...
        settings: {
            type: 'object',
            description: nls.localize(18798, null),
            properties: {
                foreground: {
                    type: 'string',
                    description: nls.localize(18799, null),
                    format: 'color-hex',
                    default: '#ff0000'
                },
                background: {
                    type: 'string',
                    deprecationMessage: nls.localize(18800, null)
                },
                fontStyle: {
                    type: 'string',
                    description: nls.localize(18801, null),
                    pattern: '^(\\s*\\b(italic|bold|underline|strikethrough))*\\s*$',
                    patternErrorMessage: nls.localize(18802, null),
                    defaultSnippets: [
                        { label: nls.localize(18803, null), bodyText: '""' },
                        { body: 'italic' },
                        { body: 'bold' },
                        { body: 'underline' },
                        { body: 'strikethrough' },
                ...
                fontFamily: {
                    type: 'string',
                    description: nls.localize(18804, null)
                },
                fontSize: {
                    type: 'number',
                    description: nls.localize(18805, null)
                },
                lineHeight: {
                    type: 'number',
                    description: nls.localize(18806, null)
                }
            },
    ...
    items: {
        ...
        properties: {
            name: {
                type: 'string',
                description: nls.localize(18807, null)
            },
            scope: {
                description: nls.localize(18808, null),
                anyOf: [
                    {
                        enum: textMateScopes
                    },
...
const colorThemeSchema = {
    ...
    properties: {
        colors: {
            description: nls.localize(18809, null),
        ...
        tokenColors: {
            anyOf: [{
                    type: 'string',
                    description: nls.localize(18810, null)
                },
                {
                    description: nls.localize(18811, null),
        ...
        semanticHighlighting: {
            type: 'boolean',
            description: nls.localize(18812, null)
        },
        semanticTokenColors: {
            type: 'object',
            description: nls.localize(18813, null),
