...
const configurationExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: nls.localize(18768, null),
        type: 'array',
        items: {
            type: 'object',
            properties: {
                id: {
                    type: 'string',
                    description: nls.localize(18769, null),
                    pattern: colorIdPattern,
                    patternErrorMessage: nls.localize(18770, null),
                },
                description: {
                    type: 'string',
                    description: nls.localize(18771, null),
                },
                defaults: {
                    type: 'object',
                    properties: {
                        light: {
                            description: nls.localize(18772, null),
                            type: 'string',
                            anyOf: [
                        ...
                        dark: {
                            description: nls.localize(18773, null),
                            type: 'string',
                            anyOf: [
                                colorReferenceSchema,
                                { type: 'string', format: 'color-hex' }
                        ...
                        highContrast: {
                            description: nls.localize(18774, null),
                            type: 'string',
                            anyOf: [
                                colorReferenceSchema,
                                { type: 'string', format: 'color-hex' }
                        ...
                        highContrastLight: {
                            description: nls.localize(18775, null),
                            type: 'string',
                            anyOf: [
                                colorReferenceSchema,
                                { type: 'string', format: 'color-hex' }
        ...
        configurationExtPoint.setHandler((extensions, delta) => {
            for (const extension of delta.added) {
                ...
                if (!extensionValue || !Array.isArray(extensionValue)) {
                    collector.error(nls.localize(18776, null));
                    return;
                }
...
class ColorDataRenderer extends Disposable {
    ...
    render(manifest) {
        ...
        const headers = [
            nls.localize(18784, null),
            nls.localize(18785, null),
            nls.localize(18786, null),
            nls.localize(18787, null),
            nls.localize(18788, null),
        ];
