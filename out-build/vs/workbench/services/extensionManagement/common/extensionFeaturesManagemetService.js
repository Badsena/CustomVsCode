        ...
        if (featureState.disabled === undefined) {
            ...
            if (feature.access.requireUserConsent) {
                ...
                const confirmationResult = await this.dialogService.confirm({
                    title: localize(18281, null, feature.label),
                    message: localize(18282, null, extensionDescription?.displayName ?? extension._lower, feature.label),
                    detail: justification ?? feature.description,
                    custom: true,
                    primaryButton: localize(18283, null),
                    cancelButton: localize(18284, null),
                });
