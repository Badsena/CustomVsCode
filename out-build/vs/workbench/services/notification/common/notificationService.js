...
let NotificationService = class NotificationService extends Disposable {
    ...
    notify(notification) {
        ...
        if (notification.neverShowAgain) {
            ...
            const neverShowAgainAction = toDispose.add(new Action('workbench.notification.neverShowAgain', localize(18601, null), undefined, true, async () => {
                // Close notification
                handle.close();
                // Remember choice
