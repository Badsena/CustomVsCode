...
let EditorResolverService = class EditorResolverService extends Disposable {
    ...
    async doHandleConflictingDefaults(resource, editorName, untypedInput, currentEditor, group) {
        ...
        const handle = this.notificationService.prompt(Severity.Warning, localize(18232, null), [{
                label: localize(18233, null),
                run: async () => {
            ...
            {
                label: localize(18234, null, editorName),
    ...
    mapEditorsToQuickPickEntry(resource, showDefaultPicker) {
        ...
        const currentlyActiveLabel = localize(18235, null);
        const currentDefaultLabel = localize(18236, null);
        const currentDefaultAndActiveLabel = localize(18237, null);
        ...
        if (!showDefaultPicker && extname(resource) !== '') {
            ...
            const configureDefaultEntry = {
                ...
                label: localize(18238, null, `*${extname(resource)}`),
            };
    ...
    async doPickEditor(editor, showDefaultPicker) {
        ...
        const placeHolderMessage = showDefaultPicker ?
            localize(18239, null, `*${extname(resource)}`) :
            localize(18240, null, basename(resource));
