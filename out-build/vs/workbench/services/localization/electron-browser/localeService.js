...
let NativeLocaleService = class NativeLocaleService {
    ...
    async validateLocaleFile() {
        try {
            ...
            this.notificationService.notify({
                ...
                message: localize(18594, null),
                actions: {
                    primary: [
                        toAction({
                            id: 'openArgv',
                            label: localize(18595, null),
        ...
        try {
            ...
            if (!installedLanguages.some(installedLanguage => installedLanguage.id === languagePackItem.id)) {
                ...
                await this.progressService.withProgress({
                    ...
                    title: localize(18596, null, languagePackItem.label),
    ...
    async showRestartDialog(languageName) {
        const { confirmed } = await this.dialogService.confirm({
            message: localize(18597, null, this.productService.nameLong, languageName),
            detail: localize(18598, null, languageName, this.productService.nameLong),
            primaryButton: localize(18599, null),
        });
        return confirmed;
    }
};
