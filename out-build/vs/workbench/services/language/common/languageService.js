...
export const languagesExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: localize(18559, null),
        type: 'array',
        items: {
            type: 'object',
            ...
            properties: {
                id: {
                    description: localize(18560, null),
                    type: 'string'
                },
                aliases: {
                    description: localize(18561, null),
                    type: 'array',
                    items: {
                        type: 'string'
                    }
                ...
                extensions: {
                    description: localize(18562, null),
                    default: ['.foo'],
                    type: 'array',
                    items: {
                        type: 'string'
                ...
                filenames: {
                    description: localize(18563, null),
                    type: 'array',
                    items: {
                        type: 'string'
                    }
                ...
                filenamePatterns: {
                    description: localize(18564, null),
                    type: 'array',
                    items: {
                        type: 'string'
                    }
                ...
                mimetypes: {
                    description: localize(18565, null),
                    type: 'array',
                    items: {
                        type: 'string'
                    }
                ...
                firstLine: {
                    description: localize(18566, null),
                    type: 'string'
                },
                configuration: {
                    description: localize(18567, null),
                    type: 'string',
                    default: './language-configuration.json'
                },
                icon: {
                    type: 'object',
                    description: localize(18568, null),
                    properties: {
                        light: {
                            description: localize(18569, null),
                            type: 'string'
                        },
                        dark: {
                            description: localize(18570, null),
                            type: 'string'
                        }
                    }
                }
        ...
        languagesExtPoint.setHandler((extensions) => {
            ...
            for (let i = 0, len = extensions.length; i < len; i++) {
                ...
                if (!Array.isArray(extension.value)) {
                    extension.collector.error(localize(18577, null, languagesExtPoint.name));
                    continue;
                }
...
function isValidLanguageExtensionPoint(value, collector) {
    if (!value) {
        collector?.error(localize(18578, null, languagesExtPoint.name));
        return false;
    }
    if (typeof value.id !== 'string') {
        collector?.error(localize(18579, null, 'id'));
        return false;
    }
    if (!isUndefinedOrStringArray(value.extensions)) {
        collector?.error(localize(18580, null, 'extensions'));
        return false;
    }
    if (!isUndefinedOrStringArray(value.filenames)) {
        collector?.error(localize(18581, null, 'filenames'));
        return false;
    }
    if (typeof value.firstLine !== 'undefined' && typeof value.firstLine !== 'string') {
        collector?.error(localize(18582, null, 'firstLine'));
        return false;
    }
    if (typeof value.configuration !== 'undefined' && typeof value.configuration !== 'string') {
        collector?.error(localize(18583, null, 'configuration'));
        return false;
    }
    if (!isUndefinedOrStringArray(value.aliases)) {
        collector?.error(localize(18584, null, 'aliases'));
        return false;
    }
    if (!isUndefinedOrStringArray(value.mimetypes)) {
        collector?.error(localize(18585, null, 'mimetypes'));
        return false;
    }
    if (typeof value.icon !== 'undefined') {
        if (typeof value.icon !== 'object' || typeof value.icon.light !== 'string' || typeof value.icon.dark !== 'string') {
            collector?.error(localize(18586, null, 'icon', 'light', 'dark'));
            return false;
        }
    }
    return true;
