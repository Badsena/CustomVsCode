...
export function getSyncAreaLabel(source) {
    switch (source) {
        case "settings" /* SyncResource.Settings */: return localize(19050, null);
        case "keybindings" /* SyncResource.Keybindings */: return localize(19051, null);
        case "snippets" /* SyncResource.Snippets */: return localize(19052, null);
        case "prompts" /* SyncResource.Prompts */: return localize(19053, null);
        case "tasks" /* SyncResource.Tasks */: return localize(19054, null);
        case "mcp" /* SyncResource.Mcp */: return localize(19055, null);
        case "extensions" /* SyncResource.Extensions */: return localize(19056, null);
        case "globalState" /* SyncResource.GlobalState */: return localize(19057, null);
        case "profiles" /* SyncResource.Profiles */: return localize(19058, null);
        case "workspaceState" /* SyncResource.WorkspaceState */: return localize(19059, null);
    }
}
...
export const SYNC_TITLE = localize2(19061, "Settings Sync");
export const SYNC_VIEW_ICON = registerIcon('settings-sync-view-icon', Codicon.sync, localize(19060, null));
// Contexts
...
export const DOWNLOAD_ACTIVITY_ACTION_DESCRIPTOR = {
    ...
    title: localize2(19062, "Download Settings Sync Activity"),
