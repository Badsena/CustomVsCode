...
let NativeElevatedFileService = class NativeElevatedFileService {
    ...
    async writeFileElevated(resource, value, options) {
        const trusted = await this.workspaceTrustRequestService.requestWorkspaceTrust({
            message: isWindows ? localize(18492, null, this.labelService.getUriLabel(resource)) : localize(18493, null, this.labelService.getUriLabel(resource)),
        });
        if (!trusted) {
            throw new Error(localize(18494, null));
        }
