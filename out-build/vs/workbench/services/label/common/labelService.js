...
const resourceLabelFormattersExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: localize(18546, null),
        type: 'array',
        items: {
            type: 'object',
            ...
            properties: {
                scheme: {
                    type: 'string',
                    description: localize(18547, null),
                },
                authority: {
                    type: 'string',
                    description: localize(18548, null),
                },
                formatting: {
                    description: localize(18549, null),
                    type: 'object',
                    properties: {
                        label: {
                            type: 'string',
                            description: localize(18550, null)
                        },
                        separator: {
                            type: 'string',
                            description: localize(18551, null)
                        },
                        stripPathStartingSeparator: {
                            type: 'boolean',
                            description: localize(18552, null)
                        },
                        tildify: {
                            type: 'boolean',
                            description: localize(18553, null)
                        },
                        workspaceSuffix: {
                            type: 'string',
                            description: localize(18554, null)
                        }
                    }
                }
            }
...
let LabelService = class LabelService extends Disposable {
    ...
    doGetWorkspaceLabel(workspaceUri, options) {
        ...
        if (isUntitledWorkspace(workspaceUri, this.environmentService)) {
            return localize(18555, null);
        }
        // Workspace: Temporary
        if (isTemporaryWorkspace(workspaceUri)) {
            return localize(18556, null);
        }
        // Workspace: Saved
        ...
        switch (options?.verbose) {
            ...
            case 2 /* Verbosity.LONG */:
                label = localize(18557, null, this.getUriLabel(joinPath(dirname(workspaceUri), filename)));
                break;
            case 1 /* Verbosity.MEDIUM */:
            default:
                label = localize(18558, null, filename);
                break;
        }
