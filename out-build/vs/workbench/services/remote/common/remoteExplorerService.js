...
const getStartedWalkthrough = {
    ...
    properties: {
        id: {
            description: nls.localize(18664, null),
            type: 'string'
        },
    }
};
const remoteHelpExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: nls.localize(18665, null),
        type: 'object',
        properties: {
            'getStarted': {
                description: nls.localize(18666, null),
                oneOf: [
                    { type: 'string' },
            ...
            'documentation': {
                description: nls.localize(18667, null),
                type: 'string'
            },
            'feedback': {
                description: nls.localize(18668, null),
                type: 'string',
                markdownDeprecationMessage: nls.localize(18669, null, '`reportIssue`')
            },
            'reportIssue': {
                description: nls.localize(18670, null),
                type: 'string'
            },
            'issues': {
                description: nls.localize(18671, null),
                type: 'string'
            }
        }
    }
