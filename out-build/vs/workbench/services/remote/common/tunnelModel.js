...
export const forwardedPortsFeaturesEnabled = new RawContextKey('forwardedPortsViewEnabled', false, nls.localize(18672, null));
export const forwardedPortsViewEnabled = new RawContextKey('forwardedPortsViewOnlyEnabled', false, nls.localize(18673, null));
...
export const UserTunnelSource = {
    ...
    description: nls.localize(18674, null)
};
export const AutoTunnelSource = {
    source: TunnelSource.Auto,
    description: nls.localize(18675, null)
};
...
let TunnelModel = class TunnelModel extends Disposable {
    ...
    async showPortMismatchModalIfNeeded(tunnel, expectedLocal, attributes) {
        ...
        const mismatchString = nls.localize(18676, null, expectedLocal, tunnel.tunnelRemotePort, tunnel.tunnelLocalPort);
            ...
            for (const tunnel of tunnels) {
                ...
                this.detected.set(makeAddress(tunnel.remoteAddress.host, tunnel.remoteAddress.port), {
                    ...
                    source: {
                        ...
                        description: nls.localize(18677, null)
                    }
                });
