...
function isValidContributedKeyBinding(keyBinding, rejects) {
    if (!keyBinding) {
        rejects.push(nls.localize(18516, null));
        return false;
    }
    if (typeof keyBinding.command !== 'string') {
        rejects.push(nls.localize(18517, null, 'command'));
        return false;
    }
    if (keyBinding.key && typeof keyBinding.key !== 'string') {
        rejects.push(nls.localize(18518, null, 'key'));
        return false;
    }
    if (keyBinding.when && typeof keyBinding.when !== 'string') {
        rejects.push(nls.localize(18519, null, 'when'));
        return false;
    }
    if (keyBinding.mac && typeof keyBinding.mac !== 'string') {
        rejects.push(nls.localize(18520, null, 'mac'));
        return false;
    }
    if (keyBinding.linux && typeof keyBinding.linux !== 'string') {
        rejects.push(nls.localize(18521, null, 'linux'));
        return false;
    }
    if (keyBinding.win && typeof keyBinding.win !== 'string') {
        rejects.push(nls.localize(18522, null, 'win'));
        return false;
    }
    return true;
}
const keybindingType = {
    ...
    properties: {
        command: {
            description: nls.localize(18523, null),
            type: 'string'
        },
        args: {
            description: nls.localize(18524, null)
        },
        key: {
            description: nls.localize(18525, null),
            type: 'string'
        },
        mac: {
            description: nls.localize(18526, null),
            type: 'string'
        },
        linux: {
            description: nls.localize(18527, null),
            type: 'string'
        },
        win: {
            description: nls.localize(18528, null),
            type: 'string'
        },
        when: {
            description: nls.localize(18529, null),
            type: 'string'
        },
    }
};
const keybindingsExtPoint = ExtensionsRegistry.registerExtensionPoint({
    ...
    jsonSchema: {
        description: nls.localize(18530, null),
        oneOf: [
            keybindingType,
            {
                type: 'array',
...
let WorkbenchKeybindingService = WorkbenchKeybindingService_1 = class WorkbenchKeybindingService extends AbstractKeybindingService {
    ...
    _handleKeybinding(extensionId, isBuiltin, idx, keybindings, collector, result) {
        ...
        if (rejects.length > 0) {
            collector.error(nls.localize(18531, null, keybindingsExtPoint.name, rejects.join('\n')));
        }
    }
    ...
    static _getAllCommandsAsComment(boundCommands) {
        ...
        return '// ' + nls.localize(18532, null) + '\n// - ' + pretty;
    }
        ...
        this.schema = {
            ...
            definitions: {
                ...
                'commandNames': {
                    ...
                    'description': nls.localize(18534, null),
                },
                'commandType': {
                    'anyOf': [
                        {
                        ...
                        },
                        {
                            ...
                            'enumDescriptions': this.commandsEnumDescriptions,
                            'description': nls.localize(18535, null),
                        },
                        {
                            'type': 'string'
                        },
            ...
            items: {
                ...
                'properties': {
                    'key': {
                        'type': 'string',
                        'description': nls.localize(18536, null),
                    },
                    'command': {
                        'anyOf': [
                            {
                                ...
                                'then': {
                                    ...
                                    'errorMessage': nls.localize(18537, null, 'string')
                                },
                                'else': {
                    ...
                    'when': {
                        'type': 'string',
                        'description': nls.localize(18538, null)
                    },
                    'args': {
                        'description': nls.localize(18539, null)
                    }
                },
