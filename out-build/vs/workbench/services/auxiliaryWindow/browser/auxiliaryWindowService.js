...
let AuxiliaryWindow = class AuxiliaryWindow extends BaseWindow {
    ...
    preventUnload(e) {
        e.preventDefault();
        e.returnValue = localize(18074, null);
    }
...
let BrowserAuxiliaryWindowService = class BrowserAuxiliaryWindowService extends Disposable {
    ...
    async open(options) {
        ...
        if (!targetWindow) {
            throw new Error(localize(18075, null));
        }
    ...
    async openWindow(options) {
        ...
        if (!auxiliaryWindow && isWeb) {
            return (await this.dialogService.prompt({
                ...
                message: localize(18076, null),
                custom: {
                    markdownDetails: [{ markdown: new MarkdownString(localize(18077, null, 'https://aka.ms/allow-vscode-popup'), true) }]
                },
                buttons: [
                    {
                        label: localize(18078, null),
