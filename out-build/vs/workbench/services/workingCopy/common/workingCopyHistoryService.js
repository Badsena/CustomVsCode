...
export class WorkingCopyHistoryModel {
    ...
    static { this.FILE_SAVED_SOURCE = SaveSourceRegistry.registerSource('default.source', localize(19217, null)); }
...
let WorkingCopyHistoryService = class WorkingCopyHistoryService extends Disposable {
    ...
    static { this.FILE_MOVED_SOURCE = SaveSourceRegistry.registerSource('moved.source', localize(19218, null)); }
    static { this.FILE_RENAMED_SOURCE = SaveSourceRegistry.registerSource('renamed.source', localize(19219, null)); }
...
let NativeWorkingCopyHistoryService = class NativeWorkingCopyHistoryService extends WorkingCopyHistoryService {
    ...
    onWillShutdown(e) {
        ...
        e.join(this.storeAll(e.token), { id: 'join.workingCopyHistory', label: localize(19220, null) });
    }
    onDidChangeModels() {
