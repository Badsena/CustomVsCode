    ...
    async doOpen(workspace, options) {
        ...
        if (!opened) {
            await this.dialogService.prompt({
                ...
                message: workspace ?
                    localize(18509, null, this.getRecentLabel(workspace)) :
                    localize(18510, null),
                custom: {
                    markdownDetails: [{ markdown: new MarkdownString(localize(18511, null, 'https://aka.ms/allow-vscode-popup'), true) }]
                },
                buttons: [
                    {
                        label: localize(18512, null),
