                ...
                if (installExtensionInfos.length) {
                    if (token) {
                        ...
                        for (const installExtensionInfo of installExtensionInfos) {
                            ...
                            progress?.(localize(18958, null, installExtensionInfo.extension.displayName ?? installExtensionInfo.extension.identifier.id));
...
export class ExtensionsResourceTreeItem {
    constructor() {
        ...
        this.label = { label: localize(18959, null) };
    ...
    async getChildren() {
        ...
        return extensions.map(e => ({
            ...
            description: e.applicationScoped ? localize(18960, null) : undefined,
            ...
            checkbox: that.checkbox ? {
                ...
                tooltip: localize(18961, null, e.displayName || e.identifier.id),
                accessibilityInformation: {
                    label: localize(18962, null, e.displayName || e.identifier.id),
                }
            } : undefined,
