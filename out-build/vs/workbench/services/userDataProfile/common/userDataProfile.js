...
export const defaultUserDataProfileIcon = registerIcon('defaultProfile-icon', Codicon.settings, localize(19017, null));
export const PROFILES_TITLE = localize2(19019, 'Profiles');
export const PROFILES_CATEGORY = { ...PROFILES_TITLE };
export const PROFILE_EXTENSION = 'code-profile';
export const PROFILE_FILTER = [{ name: localize(19018, null), extensions: [PROFILE_EXTENSION] }];
