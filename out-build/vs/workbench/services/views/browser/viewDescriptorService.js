...
let ViewDescriptorService = class ViewDescriptorService extends Disposable {
    ...
    registerGeneratedViewContainer(location, existingId) {
        ...
        const container = this.viewContainersRegistry.registerViewContainer({
            ...
            title: { value: localize(19063, null), original: 'User View Container' }, // having a placeholder title - this should not be shown anywhere
                ...
                disposables.add(registerAction2(class extends ViewPaneContainerAction {
                    constructor() {
                        super({
                            ...
                            metadata: {
                                description: localize2(19065, 'Toggles the visibility of the {0} view if the view container it is located in is visible', viewDescriptor.name.value)
                            },
                            menu: [{
                                    id: ViewsSubMenu,
                ...
                disposables.add(registerAction2(class extends ViewPaneContainerAction {
                    constructor() {
                        super({
                            ...
                            viewPaneContainerId: viewContainerModel.viewContainer.id,
                            title: localize(19064, null, viewDescriptor.name.value),
                            metadata: {
                                description: localize2(19066, 'Hides the {0} view if it is visible and the view container it is located in is visible', viewDescriptor.name.value)
                            },
                            precondition: viewDescriptor.canToggleVisibility && (!viewContainerModel.isVisible(viewDescriptor.id) || viewContainerModel.visibleViewDescriptors.length > 1) ? ContextKeyExpr.true() : ContextKeyExpr.false(),
                            menu: [{
                                    id: MenuId.ViewTitleContext,
        ...
        return registerAction2(class ResetViewLocationAction extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(19067, "Reset Location"),
                    menu: [{
                            id: MenuId.ViewContainerTitleContext,
                            group: '1_viewActions',
