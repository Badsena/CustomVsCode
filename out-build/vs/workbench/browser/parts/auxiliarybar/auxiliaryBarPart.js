...
let AuxiliaryBarPart = class AuxiliaryBarPart extends AbstractPaneCompositePart {
    ...
    fillExtraContextMenuActions(actions) {
        ...
        const toggleShowLabelsAction = toAction({
            ...
            label: this.configuration.showLabels ? localize(3913, null) : localize(3914, null),
        ...
        actions.push(...[
            new Separator(),
            new SubmenuAction('workbench.action.panel.position', localize(3915, null), positionActions),
            toAction({ id: ToggleSidebarPositionAction.ID, label: currentPositionRight ? localize(3916, null) : localize(3917, null), run: () => this.commandService.executeCommand(ToggleSidebarPositionAction.ID) }),
            toggleShowLabelsAction,
            toAction({ id: ToggleAuxiliaryBarAction.ID, label: localize(3918, null), run: () => this.commandService.executeCommand(ToggleAuxiliaryBarAction.ID) })
        ]);
    }
