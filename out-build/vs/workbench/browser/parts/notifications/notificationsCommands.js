...
export function registerNotificationCommands(center, toasts, model) {
    ...
    CommandsRegistry.registerCommand(TOGGLE_DO_NOT_DISTURB_MODE_BY_SOURCE, accessor => {
        ...
        picker.placeholder = localize(4507, null);
    ...
    const category = localize2(4509, 'Notifications');
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: { id: SHOW_NOTIFICATIONS_CENTER, title: localize2(4510, 'Show Notifications'), category } });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: { id: HIDE_NOTIFICATIONS_CENTER, title: localize2(4511, 'Hide Notifications'), category }, when: NotificationsCenterVisibleContext });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: { id: CLEAR_ALL_NOTIFICATIONS, title: localize2(4512, 'Clear All Notifications'), category } });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: { id: ACCEPT_PRIMARY_ACTION_NOTIFICATION, title: localize2(4513, 'Accept Notification Primary Action'), category } });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: { id: TOGGLE_DO_NOT_DISTURB_MODE, title: localize2(4514, 'Toggle Do Not Disturb Mode'), category } });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: { id: TOGGLE_DO_NOT_DISTURB_MODE_BY_SOURCE, title: localize2(4515, 'Toggle Do Not Disturb Mode By Source...'), category } });
    MenuRegistry.appendMenuItem(MenuId.CommandPalette, { command: { id: FOCUS_NOTIFICATION_TOAST, title: localize2(4516, 'Focus Notification Toast'), category }, when: NotificationsToastsVisibleContext });
    // Bell icon in the title bar (when notifications are positioned at top-right)
    MenuRegistry.appendMenuItem(MenuId.TitleBar, {
        command: {
            id: TOGGLE_NOTIFICATIONS_CENTER,
            title: localize(4508, null),
            icon: Codicon.bell,
        },
        group: 'navigation',
        order: 10000,
...
registerAction2(class SetNotificationsPositionBottomRight extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4517, 'Bottom Right'),
...
registerAction2(class SetNotificationsPositionBottomLeft extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4518, 'Bottom Left'),
...
registerAction2(class SetNotificationsPositionTopRight extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4519, 'Top Right'),
