    ...
    getProvider(accessor) {
        ...
        function getProvider() {
            ...
            function getContentForNotification() {
                ...
                return withSeverityPrefix(notification.source ? localize(4472, null, message, notification.source) : message, notification.severity);
            }
...
function getActionsFromNotification(notification, accessibilitySignalService) {
    ...
    if (actions) {
        actions.push({
            id: 'clearNotification', label: localize(4473, null), tooltip: localize(4474, null), run: () => {
                notification.close();
