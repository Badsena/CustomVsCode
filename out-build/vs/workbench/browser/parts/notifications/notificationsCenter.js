...
let NotificationsCenter = class NotificationsCenter extends Themable {
    ...
    updateTitle() {
        ...
        if (this.model.notifications.length === 0) {
            notificationsCenterTitle.textContent = localize(4500, null);
            clearAllAction.enabled = false;
        }
        else {
            notificationsCenterTitle.textContent = localize(4501, null);
    ...
    create() {
                    ...
                    return this._register(this.instantiationService.createInstance(DropdownMenuActionViewItem, action, {
                        getActions() {
                            const actions = [toAction({
                                    ...
                                    label: that.notificationService.getFilter() === NotificationsFilter.OFF ? localize(4503, null) : localize(4504, null),
                            ...
                            if (sortedFilters.length > NotificationsCenter_1.MAX_NOTIFICATION_SOURCES) {
                                actions.push(new Separator());
                                actions.push(that._register(that.instantiationService.createInstance(ToggleDoNotDisturbBySourceAction, ToggleDoNotDisturbBySourceAction.ID, localize(4505, null))));
                            }
                            return actions;
                        },
                    }, this.contextMenuService, {
        ...
        this.notificationsList = this.instantiationService.createInstance(NotificationsList, this.notificationsCenterContainer, {
            widgetAriaLabel: localize(4506, null)
        });
