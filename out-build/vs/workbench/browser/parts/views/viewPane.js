...
const viewPaneContainerExpandedIcon = registerIcon('view-pane-container-expanded', Codicon.chevronDown, nls.localize(4668, null));
const viewPaneContainerCollapsedIcon = registerIcon('view-pane-container-collapsed', Codicon.chevronRight, nls.localize(4669, null));
...
let ViewWelcomeController = class ViewWelcomeController {
    ...
    onDidChangeViewWelcomeState() {
        ...
        this.element = $('.welcome-view-content', { tabIndex: 0, role: 'region', 'aria-label': nls.localize(4670, null) });
        if (this._wide) {
...
let ViewPane = class ViewPane extends Pane {
    ...
    renderHeader(container) {
        ...
        this.toolbar = this.instantiationService.createInstance(WorkbenchToolBar, actions, {
            ...
            ariaLabel: nls.localize(4671, null, this.title),
    ...
    _getAriaLabel(title, description) {
        ...
        return nls.localize(4672, null, title);
    }
    updateTitle(title) {
        const calculatedTitle = this.calculateTitle(title);
