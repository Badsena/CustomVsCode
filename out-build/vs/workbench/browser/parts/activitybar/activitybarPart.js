...
let ActivityBarCompositeBar = class ActivityBarCompositeBar extends PaneCompositeBar {
    ...
    fillContextMenuActions(actions, e) {
        ...
        if (menuBarVisibility === 'compact' || menuBarVisibility === 'hidden' || menuBarVisibility === 'toggle') {
            actions.unshift(...[toAction({ id: 'toggleMenuVisibility', label: localize(3863, null), checked: menuBarVisibility === 'compact', run: () => this.configurationService.updateValue("window.menuBarVisibility" /* MenuSettings.MenuBarVisibility */, menuBarVisibility === 'compact' ? 'toggle' : 'compact') }), new Separator()]);
        }
        if (menuBarVisibility === 'compact' && this.menuBarContainer && e?.target) {
            if (isAncestor(e.target, this.menuBarContainer)) {
                actions.unshift(...[toAction({ id: 'hideCompactMenu', label: localize(3864, null), run: () => this.configurationService.updateValue("window.menuBarVisibility" /* MenuSettings.MenuBarVisibility */, 'toggle') }), new Separator()]);
            }
        }
    ...
    getActivityBarContextMenuActions() {
        ...
        const actions = [
            new SubmenuAction('workbench.action.activityBar.position', localize(3865, null), positionActions),
        ];
        ...
        if (activityBarPosition === "default" /* ActivityBarPosition.DEFAULT */) {
            ...
            const sizeActions = [
                toAction({ id: 'workbench.action.activityBar.size.default', label: localize(3866, null), checked: !isCompact, run: () => this.configurationService.updateValue("workbench.activityBar.compact" /* LayoutSettings.ACTIVITY_BAR_COMPACT */, false) }),
                toAction({ id: 'workbench.action.activityBar.size.compact', label: localize(3867, null), checked: isCompact, run: () => this.configurationService.updateValue("workbench.activityBar.compact" /* LayoutSettings.ACTIVITY_BAR_COMPACT */, true) }),
            ];
            actions.push(new SubmenuAction('workbench.action.activityBar.size', localize(3868, null), sizeActions));
        }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3879, 'Move Activity Bar to Side'),
                mnemonicTitle: localize(3869, null),
            },
            shortTitle: localize(3870, null),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3880, 'Move Activity Bar to Top'),
                mnemonicTitle: localize(3871, null),
            },
            shortTitle: localize(3872, null),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3881, 'Move Activity Bar to Bottom'),
                mnemonicTitle: localize(3873, null),
            },
            shortTitle: localize(3874, null),
            category: Categories.View,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3882, 'Hide Activity Bar'),
                mnemonicTitle: localize(3875, null),
            },
            shortTitle: localize(3876, null),
            category: Categories.View,
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3883, 'Previous Primary Side Bar View'),
            category: Categories.View,
            f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3884, 'Next Primary Side Bar View'),
            category: Categories.View,
            f1: true
        }, 0 /* ViewContainerLocation.Sidebar */, 1);
    }
...
registerAction2(class FocusActivityBarAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3885, 'Focus Activity Bar'),
            category: Categories.View,
            f1: true
        });
    }
