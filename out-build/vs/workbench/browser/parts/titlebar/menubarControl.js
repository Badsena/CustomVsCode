...
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'File',
        original: 'File',
        mnemonicTitle: localize(4615, null),
    },
    order: 1
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Edit',
        original: 'Edit',
        mnemonicTitle: localize(4616, null)
    },
    order: 2
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Selection',
        original: 'Selection',
        mnemonicTitle: localize(4617, null)
    },
    order: 3
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'View',
        original: 'View',
        mnemonicTitle: localize(4618, null)
    },
    order: 4
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Go',
        original: 'Go',
        mnemonicTitle: localize(4619, null)
    },
    order: 5
});
MenuRegistry.appendMenuItem(MenuId.MenubarMainMenu, {
    ...
    title: {
        value: 'Terminal',
        original: 'Terminal',
        mnemonicTitle: localize(4620, null)
    },
    order: 7
});
/*
...
export class MenubarControl extends Disposable {
    ...
    notifyUserOfCustomMenubarAccessibility() {
        ...
        const message = localize(4621, null);
        this.notificationService.prompt(Severity.Info, message, [
            {
                label: localize(4622, null),
                run: () => {
        ...
        registerAction2(class extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(4630, 'Focus Application Menu'),
                    keybinding: {
    ...
    getUpdateAction() {
        ...
        switch (state.type) {
            case "idle" /* StateType.Idle */:
                return toAction({
                    id: 'update.check', label: localize(4623, null), enabled: true, run: () => this.updateService.checkForUpdates(true)
                });
            case "checking for updates" /* StateType.CheckingForUpdates */:
                return toAction({ id: 'update.checking', label: localize(4624, null), enabled: false, run: () => { } });
            case "available for download" /* StateType.AvailableForDownload */:
                return toAction({
                    id: 'update.downloadNow', label: localize(4625, null), enabled: true, run: () => this.updateService.downloadUpdate(true)
                });
            case "downloading" /* StateType.Downloading */:
            case "overwriting" /* StateType.Overwriting */:
                return toAction({ id: 'update.downloading', label: localize(4626, null), enabled: false, run: () => { } });
            case "downloaded" /* StateType.Downloaded */:
                return isMacintosh ? null : toAction({
                    id: 'update.install', label: localize(4627, null), enabled: true, run: () => this.updateService.applyUpdate()
                });
            case "updating" /* StateType.Updating */:
                return toAction({ id: 'update.updating', label: localize(4628, null), enabled: false, run: () => { } });
            case "ready" /* StateType.Ready */:
                return toAction({
                    id: 'update.restart', label: localize(4629, null), enabled: true, run: () => this.updateService.quitAndInstall()
                });
            default:
                return null;
        }
