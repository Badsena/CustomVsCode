...
let CommandCenterCenterViewItem = class CommandCenterCenterViewItem extends BaseActionViewItem {
                ...
                actionViewItemProvider: (action, options) => {
                    ...
                    return this._instaService.createInstance(class CommandCenterQuickPickItem extends BaseActionViewItem {
                        ...
                        _getLabel() {
                            ...
                            if (!label) {
                                label = localize(4609, null);
                            }
                            if (prefix) {
                                label = localize(4610, null, prefix, label);
                            }
                            if (suffix) {
                                label = localize(4611, null, label, suffix);
                            }
    ...
    getTooltip() {
        ...
        const title = kb
            ? localize(4612, null, this._windowTitle.workspaceName, kb, this._windowTitle.value)
            : localize(4613, null, this._windowTitle.workspaceName, this._windowTitle.value);
        return title;
    }
};
