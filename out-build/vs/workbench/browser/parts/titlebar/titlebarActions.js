...
registerAction2(class ToggleCommandCenter extends ToggleTitleBarConfigAction {
    constructor() {
        super("window.commandCenter" /* LayoutSettings.COMMAND_CENTER */, localize(4631, null), localize(4632, null), 1, IsCompactTitleBarContext.toNegated());
    }
});
registerAction2(class ToggleNavigationControl extends ToggleTitleBarConfigAction {
    constructor() {
        super('workbench.navigationControl.enabled', localize(4633, null), localize(4634, null), 2, ContextKeyExpr.and(IsCompactTitleBarContext.toNegated(), ContextKeyExpr.has(`config.${"window.commandCenter" /* LayoutSettings.COMMAND_CENTER */}`)));
    }
});
registerAction2(class ToggleLayoutControl extends ToggleTitleBarConfigAction {
    constructor() {
        super("workbench.layoutControl.enabled" /* LayoutSettings.LAYOUT_ACTIONS */, localize(4635, null), localize(4636, null), 4);
    }
});
registerAction2(class ToggleNotificationsButton extends ToggleTitleBarConfigAction {
    constructor() {
        super("workbench.notifications.showInTitleBar" /* NotificationsSettings.NOTIFICATIONS_BUTTON */, localize(4637, null), localize(4638, null), 5, ContextKeyExpr.equals(`config.${"workbench.notifications.position" /* NotificationsSettings.NOTIFICATIONS_POSITION */}`, "top-right" /* NotificationsPosition.TOP_RIGHT */));
    }
});
...
registerAction2(class ShowCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4647, "Show Custom Title Bar"),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4648, "Hide Custom Title Bar"),
...
registerAction2(class HideCustomTitleBar extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4649, "Hide Custom Title Bar In Full Screen"),
...
export const ACCOUNTS_ACTIVITY_TILE_ACTION = {
    ...
    label: localize(4643, null),
    tooltip: localize(4644, null),
    class: undefined,
    enabled: true,
    run: function () { }
};
export const GLOBAL_ACTIVITY_TITLE_ACTION = {
    ...
    label: localize(4645, null),
    tooltip: localize(4646, null),
    class: undefined,
    enabled: true,
    run: function () { }
};
