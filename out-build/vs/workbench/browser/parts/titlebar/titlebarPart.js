...
import { getTitleBarStyle, hasCustomTitlebar, hasNativeTitlebar, DEFAULT_CUSTOM_TITLEBAR_HEIGHT, getWindowControlsStyle, hasNativeMenu } from '../../../../platform/window/common/window.js';
        ...
        this._register(registerAction2(class FocusTitleBar extends Action2 {
            constructor() {
                super({
                    ...
                    title: localize2(4651, 'Focus Title Bar'),
