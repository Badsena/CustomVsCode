...
let StatusbarPart = class StatusbarPart extends Part {
    ...
    getContextMenuActions(event) {
        ...
        actions.push(toAction({ id: ToggleStatusbarVisibilityAction.ID, label: localize(4608, null), run: () => this.instantiationService.invokeFunction(accessor => new ToggleStatusbarVisibilityAction().run(accessor)) }));
