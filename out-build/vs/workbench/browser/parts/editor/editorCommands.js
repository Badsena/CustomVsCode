...
function registerEditorMoveCopyCommand() {
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: localize(4305, null),
            args: [
                {
                    name: localize(4306, null),
                    description: localize(4307, null),
    ...
    KeybindingsRegistry.registerCommandAndKeybindingRule({
        ...
        metadata: {
            description: localize(4308, null),
            args: [
                {
                    name: localize(4309, null),
                    description: localize(4310, null),
                    constraint: isSelectedEditorsMoveCopyArg,
                    schema: moveCopyJSONSchema
                }
            ]
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4314, 'Split Editor in Group'),
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4315, 'Join Editor in Group'),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4316, 'Toggle Split Editor in Group'),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4317, 'Toggle Layout of Split Editor in Group'),
                category: Categories.View,
                precondition: SideBySideEditorActiveContext,
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4318, 'Focus First Side in Active Editor'),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4319, 'Focus Second Side in Active Editor'),
                category: Categories.View,
                precondition: ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4320, 'Focus Other Side in Active Editor'),
                category: Categories.View,
                precondition: ContextKeyExpr.or(SideBySideEditorActiveContext, TextCompareEditorActiveContext),
                f1: true
            });
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4321, 'Toggle Editor Group Lock'),
                category: Categories.View,
                f1: true
            });
        }
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4322, 'Lock Editor Group'),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4323, 'Unlock Editor Group'),
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4324, 'Open Modal Editor in Main Window'),
                category: Categories.View,
                f1: true,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4325, 'Open Modal Editor in New Window'),
                category: Categories.View,
                f1: true,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4326, 'Maximize Modal Editor'),
                category: Categories.View,
                f1: true,
                precondition: EditorPartModalContext,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4327, 'Close Modal Editor'),
                category: Categories.View,
                f1: true,
                icon: Codicon.close,
                precondition: EditorPartModalContext,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4328, 'Navigate to Previous Item in Modal Editor'),
                category: Categories.View,
    ...
    registerAction2(class extends Action2 {
        constructor() {
            super({
                ...
                title: localize2(4329, 'Navigate to Next Item in Modal Editor'),
                category: Categories.View,
                precondition: ContextKeyExpr.and(EditorPartModalContext, EditorPartModalNavigationContext),
                keybinding: {
