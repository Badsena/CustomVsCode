...
let EditorGroupView = EditorGroupView_1 = class EditorGroupView extends Themable {
    ...
    updateContainer() {
        ...
        if (this.isEmpty) {
            ...
            this.element.setAttribute('aria-label', localize(4340, null, this.ariaLabel));
        }
    ...
    get label() {
        if (this.groupsLabel) {
            return localize(4341, null, this.groupsLabel, this._index + 1);
        }
        return localize(4342, null, this._index + 1);
    }
    get ariaLabel() {
        if (this.groupsLabel) {
            return localize(4343, null, this.groupsLabel, this._index + 1);
        }
        return localize(4344, null, this._index + 1);
    }
    get disposed() {
    ...
    doMoveOrCopyEditorAcrossGroups(editor, target, openOptions, internalOptions) {
        ...
        if (!keepCopy || editor.hasCapability(8 /* EditorInputCapabilities.Singleton */) /* singleton editors will always move */) {
            ...
            if (typeof canMoveVeto === 'string') {
                this.dialogService.error(canMoveVeto, localize(4345, null));
                return false;
            }
        }
