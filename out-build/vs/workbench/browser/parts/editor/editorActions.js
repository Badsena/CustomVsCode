...
export class SplitEditorAction extends AbstractSplitEditorAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(4194, 'Split Editor'),
            f1: true,
            keybinding: {
...
export class SplitEditorOrthogonalAction extends AbstractSplitEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4195, 'Split Editor Orthogonal'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class SplitEditorLeftAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4196, 'Split Editor Left'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 93 /* KeyCode.Backslash */)
...
export class SplitEditorRightAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4197, 'Split Editor Right'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 93 /* KeyCode.Backslash */)
...
export class SplitEditorUpAction extends ExecuteCommandAction {
    static { this.LABEL = localize(4170, null); }
    constructor() {
        super({
            id: SPLIT_EDITOR_UP,
            title: localize2(4198, "Split Editor Up"),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 93 /* KeyCode.Backslash */)
...
export class SplitEditorDownAction extends ExecuteCommandAction {
    static { this.LABEL = localize(4171, null); }
    constructor() {
        super({
            id: SPLIT_EDITOR_DOWN,
            title: localize2(4199, "Split Editor Down"),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: KeyChord(2048 /* KeyMod.CtrlCmd */ | 41 /* KeyCode.KeyK */, 2048 /* KeyMod.CtrlCmd */ | 93 /* KeyCode.Backslash */)
...
export class JoinTwoGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4200, 'Join Editor Group with Next Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class JoinAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4201, 'Join All Editor Groups'),
            f1: true,
            category: Categories.View
        });
    }
...
export class NavigateBetweenGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4202, 'Navigate Between Editor Groups'),
            f1: true,
            category: Categories.View
        });
    }
...
export class FocusActiveGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4203, 'Focus Active Editor Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class FocusFirstGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4204, 'Focus First Editor Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class FocusLastGroupAction extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4205, 'Focus Last Editor Group'),
            f1: true,
            category: Categories.View
...
export class FocusNextGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4206, 'Focus Next Editor Group'),
            f1: true,
            category: Categories.View
...
export class FocusPreviousGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4207, 'Focus Previous Editor Group'),
            f1: true,
            category: Categories.View
...
export class FocusLeftGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4208, 'Focus Left Editor Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class FocusRightGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4209, 'Focus Right Editor Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class FocusAboveGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4210, 'Focus Editor Group Above'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class FocusBelowGroup extends AbstractFocusGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4211, 'Focus Editor Group Below'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
let CloseEditorAction = class CloseEditorAction extends Action {
    ...
    static { this.LABEL = localize(4172, null); }
...
let UnpinEditorAction = class UnpinEditorAction extends Action {
    ...
    static { this.LABEL = localize(4173, null); }
    constructor(id, label, commandService) {
...
let CloseEditorTabAction = class CloseEditorTabAction extends Action {
    static { this.ID = 'workbench.action.closeActiveEditor'; }
    static { this.LABEL = localize(4174, null); }
...
export class RevertAndCloseEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4212, 'Revert and Close Editor'),
            f1: true,
            category: Categories.View
        });
    }
...
export class CloseLeftEditorsInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4213, 'Close Editors to the Left in Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class CloseAllEditorsAction extends AbstractCloseAllAction {
    ...
    static { this.LABEL = localize2(4214, 'Close All Editors'); }
    constructor() {
        super({
...
export class CloseAllEditorGroupsAction extends AbstractCloseAllAction {
    constructor() {
        super({
            ...
            title: localize2(4215, 'Close All Editor Groups'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class CloseEditorsInOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4216, 'Close Editors in Other Groups'),
            f1: true,
            category: Categories.View
        });
    }
...
export class CloseEditorInAllGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4217, 'Close Editor in All Groups'),
            f1: true,
            category: Categories.View
        });
    }
...
export class MoveGroupLeftAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4218, 'Move Editor Group Left'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveGroupRightAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4219, 'Move Editor Group Right'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveGroupUpAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4220, 'Move Editor Group Up'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveGroupDownAction extends AbstractMoveGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4221, 'Move Editor Group Down'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class DuplicateGroupLeftAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4222, 'Duplicate Editor Group Left'),
            f1: true,
            category: Categories.View
        }, 2 /* GroupDirection.LEFT */);
    }
...
export class DuplicateGroupRightAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4223, 'Duplicate Editor Group Right'),
            f1: true,
            category: Categories.View
        }, 3 /* GroupDirection.RIGHT */);
    }
...
export class DuplicateGroupUpAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4224, 'Duplicate Editor Group Up'),
            f1: true,
            category: Categories.View
        }, 0 /* GroupDirection.UP */);
    }
...
export class DuplicateGroupDownAction extends AbstractDuplicateGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4225, 'Duplicate Editor Group Down'),
            f1: true,
            category: Categories.View
        }, 1 /* GroupDirection.DOWN */);
    }
...
export class MinimizeOtherGroupsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4226, 'Expand Editor Group'),
            f1: true,
            category: Categories.View,
...
export class MinimizeOtherGroupsHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4227, 'Expand Editor Group and Hide Side Bars'),
            f1: true,
            category: Categories.View,
...
export class ResetGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4228, 'Reset Editor Group Sizes'),
            f1: true,
            category: Categories.View
        });
    }
...
export class ToggleGroupSizesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4229, 'Toggle Editor Group Sizes'),
            f1: true,
            category: Categories.View
        });
    }
...
export class MaximizeGroupHideSidebarAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4230, 'Maximize Editor Group and Hide Side Bars'),
            f1: true,
            category: Categories.View,
...
export class ToggleMaximizeEditorGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4231, 'Toggle Maximize Editor Group'),
            f1: true,
            category: Categories.View,
...
export class OpenNextEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4232, 'Open Next Editor'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class OpenPreviousEditor extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4233, 'Open Previous Editor'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class OpenNextEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4234, 'Open Next Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class OpenPreviousEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4235, 'Open Previous Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class OpenFirstEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4236, 'Open First Editor in Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class OpenLastEditorInGroup extends AbstractNavigateEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4237, 'Open Last Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class NavigateForwardAction extends Action2 {
    ...
    static { this.LABEL = localize(4177, null); }
    constructor() {
        super({
            id: NavigateForwardAction.ID,
            title: {
                ...localize2(4238, "Go Forward"),
                mnemonicTitle: localize(4178, null)
            },
            f1: true,
...
export class NavigateBackwardsAction extends Action2 {
    ...
    static { this.LABEL = localize(4179, null); }
    constructor() {
        super({
            id: NavigateBackwardsAction.ID,
            title: {
                ...localize2(4239, "Go Back"),
                mnemonicTitle: localize(4180, null)
            },
            f1: true,
...
export class NavigatePreviousAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4240, 'Go Previous'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateForwardInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4241, 'Go Forward in Edit Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateBackwardsInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4242, 'Go Back in Edit Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigatePreviousInEditsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4243, 'Go Previous in Edit Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateToLastEditLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4244, 'Go to Last Edit Location'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class NavigateForwardInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4245, 'Go Forward in Navigation Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateBackwardsInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4246, 'Go Back in Navigation Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigatePreviousInNavigationsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4247, 'Go Previous in Navigation Locations'),
            f1: true
        });
    }
    async run(accessor) {
...
export class NavigateToLastNavigationLocationAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4248, 'Go to Last Navigation Location'),
            f1: true
        });
    }
    async run(accessor) {
...
export class ReopenClosedEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(4249, 'Reopen Closed Editor'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class ClearRecentFilesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(4250, 'Clear Recently Opened...'),
            f1: true,
    ...
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: localize(4181, null),
            detail: localize(4182, null),
            primaryButton: localize(4183, null)
        });
        if (!confirmed) {
            return;
        }
...
export class ShowEditorsInActiveGroupByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(4251, 'Show Editors in Active Group By Most Recently Used'),
            f1: true,
            category: Categories.View
        });
    }
...
export class ShowAllEditorsByAppearanceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(4252, 'Show All Editors By Appearance'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class ShowAllEditorsByMostRecentlyUsedAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(4253, 'Show All Editors By Most Recently Used'),
            f1: true,
            category: Categories.View
        });
    }
...
export class QuickAccessPreviousRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4254, 'Quick Open Previous Recently Used Editor'),
            f1: true,
            category: Categories.View
...
export class QuickAccessLeastRecentlyUsedEditorAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4255, 'Quick Open Least Recently Used Editor'),
            f1: true,
            category: Categories.View
        }, AllEditorsByMostRecentlyUsedQuickAccess.PREFIX, undefined);
    }
...
export class QuickAccessPreviousRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4256, 'Quick Open Previous Recently Used Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class QuickAccessLeastRecentlyUsedEditorInGroupAction extends AbstractQuickAccessEditorAction {
    constructor() {
        super({
            ...
            title: localize2(4257, 'Quick Open Least Recently Used Editor in Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class QuickAccessPreviousEditorFromHistoryAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(4258, 'Quick Open Previous Editor from History'),
            f1: true
        });
    }
    async run(accessor) {
...
export class OpenNextRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4259, 'Open Next Recently Used Editor'),
            f1: true,
            category: Categories.View
        });
    }
...
export class OpenPreviousRecentlyUsedEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4260, 'Open Previous Recently Used Editor'),
            f1: true,
            category: Categories.View
        });
    }
...
export class OpenNextRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4261, 'Open Next Recently Used Editor In Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class OpenPreviousRecentlyUsedEditorInGroupAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4262, 'Open Previous Recently Used Editor In Group'),
            f1: true,
            category: Categories.View
        });
    }
...
export class ClearEditorHistoryWithoutConfirmAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4263, 'Clear Editor History without Confirmation'),
            f1: true,
...
export class ClearEditorHistoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4264, 'Clear Editor History'),
            f1: true
        });
    }
    async run(accessor) {
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: localize(4184, null),
            detail: localize(4185, null),
            primaryButton: localize(4186, null)
        });
        if (!confirmed) {
            return;
        }
...
export class MoveEditorLeftInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4265, 'Move Editor Left'),
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveEditorRightInGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4266, 'Move Editor Right'),
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveEditorToStartAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4267, 'Move Editor to Start'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToEndAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4268, 'Move Editor to End'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4269, 'Move Editor into Previous Group'),
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: 2048 /* KeyMod.CtrlCmd */ | 512 /* KeyMod.Alt */ | 15 /* KeyCode.LeftArrow */,
                mac: {
...
export class MoveEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4270, 'Move Editor into Next Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
                primary: 2048 /* KeyMod.CtrlCmd */ | 512 /* KeyMod.Alt */ | 17 /* KeyCode.RightArrow */,
...
export class MoveEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4271, 'Move Editor into Group Above'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4272, 'Move Editor into Group Below'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToLeftGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4273, 'Move Editor into Left Group'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4274, 'Move Editor into Right Group'),
            f1: true,
            category: Categories.View
...
export class MoveEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4275, 'Move Editor into First Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class MoveEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4276, 'Move Editor into Last Group'),
            f1: true,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
export class SplitEditorToPreviousGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4277, 'Split Editor into Previous Group'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToNextGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4278, 'Split Editor into Next Group'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToAboveGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4279, 'Split Editor into Group Above'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToBelowGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4280, 'Split Editor into Group Below'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToLeftGroupAction extends ExecuteCommandAction {
    ...
    static { this.LABEL = localize(4187, null); }
    constructor() {
        super({
            id: 'workbench.action.splitEditorToLeftGroup',
            title: localize2(4281, "Split Editor into Left Group"),
            f1: true,
            category: Categories.View
...
export class SplitEditorToRightGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4282, 'Split Editor into Right Group'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToFirstGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4283, 'Split Editor into First Group'),
            f1: true,
            category: Categories.View
...
export class SplitEditorToLastGroupAction extends ExecuteCommandAction {
    constructor() {
        super({
            ...
            title: localize2(4284, 'Split Editor into Last Group'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutSingleAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(4285, 'Single Column Editor Layout'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutTwoColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(4286, 'Two Columns Editor Layout'),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}], orientation: 0 /* GroupOrientation.HORIZONTAL */ });
    }
...
export class EditorLayoutThreeColumnsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(4287, 'Three Columns Editor Layout'),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: 0 /* GroupOrientation.HORIZONTAL */ });
    }
...
export class EditorLayoutTwoRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(4288, 'Two Rows Editor Layout'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutThreeRowsAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(4289, 'Three Rows Editor Layout'),
            f1: true,
            category: Categories.View
        }, LAYOUT_EDITOR_GROUPS_COMMAND_ID, { groups: [{}, {}, {}], orientation: 1 /* GroupOrientation.VERTICAL */ });
    }
...
export class EditorLayoutTwoByTwoGridAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(4290, 'Grid Editor Layout (2x2)'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutTwoColumnsBottomAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(4291, 'Two Columns Bottom Editor Layout'),
            f1: true,
            category: Categories.View
...
export class EditorLayoutTwoRowsRightAction extends ExecuteCommandAction {
    ...
    constructor() {
        super({
            ...
            title: localize2(4292, 'Two Rows Right Editor Layout'),
            f1: true,
            category: Categories.View
...
export class NewEditorGroupLeftAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4293, 'New Editor Group to the Left'),
            f1: true,
            category: Categories.View
        }, 2 /* GroupDirection.LEFT */);
    }
...
export class NewEditorGroupRightAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4294, 'New Editor Group to the Right'),
            f1: true,
            category: Categories.View
        }, 3 /* GroupDirection.RIGHT */);
    }
...
export class NewEditorGroupAboveAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4295, 'New Editor Group Above'),
            f1: true,
            category: Categories.View
        }, 0 /* GroupDirection.UP */);
    }
...
export class NewEditorGroupBelowAction extends AbstractCreateEditorGroupAction {
    constructor() {
        super({
            ...
            title: localize2(4296, 'New Editor Group Below'),
            f1: true,
            category: Categories.View
        }, 1 /* GroupDirection.DOWN */);
    }
...
export class ToggleEditorTypeAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4297, 'Toggle Editor Type'),
            f1: true,
            category: Categories.View,
...
export class ReOpenInTextEditorAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(4298, 'Reopen Editor with Text Editor'),
            f1: true,
            category: Categories.View,
            precondition: ActiveEditorAvailableEditorIdsContext
        });
...
export class MoveEditorToNewWindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...localize2(4299, "Move Editor into New Window"),
            mnemonicTitle: localize(4188, null),
        }, undefined, true);
    }
}
export class CopyEditorToNewindowAction extends BaseMoveCopyEditorToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_INTO_NEW_WINDOW_COMMAND_ID, {
            ...localize2(4300, "Copy Editor into New Window"),
            mnemonicTitle: localize(4189, null),
...
export class MoveEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(MOVE_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...localize2(4301, "Move Editor Group into New Window"),
            mnemonicTitle: localize(4190, null),
        }, true);
    }
}
export class CopyEditorGroupToNewWindowAction extends BaseMoveCopyEditorGroupToNewWindowAction {
    constructor() {
        super(COPY_EDITOR_GROUP_INTO_NEW_WINDOW_COMMAND_ID, {
            ...localize2(4302, "Copy Editor Group into New Window"),
            mnemonicTitle: localize(4191, null),
        }, false);
    }
}
export class RestoreEditorsToMainWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(4303, "Restore Editors into Main Window"),
                mnemonicTitle: localize(4192, null),
            },
            f1: true,
...
export class NewEmptyEditorWindowAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(4304, "New Empty Editor Window"),
                mnemonicTitle: localize(4193, null),
            },
            f1: true,
            category: Categories.View
        });
