...
let ModalEditorPart = class ModalEditorPart {
    ...
    async create(options) {
        ...
        const previousButton = disposables.add(new Button(navigationContainer, { title: localize(4442, null) }));
        ...
        const nextButton = disposables.add(new Button(navigationContainer, { title: localize(4443, null) }));
        ...
        disposables.add(Event.runAndSubscribe(editorPart.onDidChangeNavigation, ((navigation) => {
            if (navigation && navigation.total > 1) {
                ...
                navigationLabel.textContent = localize(4444, null, navigation.current + 1, navigation.total);
...
let ModalEditorPartImpl = class ModalEditorPartImpl extends EditorPart {
    ...
    constructor(windowId, editorPartsView, modalElement, options, instantiationService, themeService, configurationService, storageService, layoutService, hostService, contextKeyService) {
        ...
        super(editorPartsView, `workbench.parts.modalEditor.${id}`, localize(4445, null), windowId, instantiationService, themeService, configurationService, storageService, layoutService, hostService, contextKeyService);
