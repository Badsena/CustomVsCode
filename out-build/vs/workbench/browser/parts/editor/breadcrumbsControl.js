...
const separatorIcon = registerIcon('breadcrumb-separator', Codicon.chevronRight, localize(3986, null));
let BreadcrumbsControl = class BreadcrumbsControl {
    ...
    static { this.CK_BreadcrumbsPossible = new RawContextKey('breadcrumbsPossible', false, localize(3987, null)); }
    static { this.CK_BreadcrumbsVisible = new RawContextKey('breadcrumbsVisible', false, localize(3988, null)); }
    static { this.CK_BreadcrumbsActive = new RawContextKey('breadcrumbsActive', false, localize(3989, null)); }
        ...
        const updateBreadcrumbs = () => {
            ...
            if (items.length === 0) {
                ...
                this._widget.setItems([new class extends BreadcrumbsItem {
                        render(container) {
                            container.textContent = localize(3990, null);
                        }
                        equals(other) {
                            return other === this;
                        }
...
registerAction2(class ToggleBreadcrumb extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3993, "Toggle Breadcrumbs"),
            shortTitle: localize2(3994, "Breadcrumbs"),
            category: Categories.View,
            toggled: {
                condition: ContextKeyExpr.equals('config.breadcrumbs.enabled', true),
                title: localize(3991, null),
                mnemonicTitle: localize(3992, null)
            },
            menu: [
...
registerAction2(class FocusAndSelectBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3995, "Focus and Select Breadcrumbs"),
...
registerAction2(class FocusBreadcrumbs extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3996, "Focus Breadcrumbs"),
            precondition: BreadcrumbsControl.CK_BreadcrumbsVisible,
            keybinding: {
                weight: 200 /* KeybindingWeight.WorkbenchContrib */,
...
registerAction2(class CopyBreadcrumbPath extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3997, "Copy Breadcrumbs Path"),
            category: Categories.View,
            precondition: BreadcrumbsControl.CK_BreadcrumbsVisible,
            f1: true,
            menu: [{
