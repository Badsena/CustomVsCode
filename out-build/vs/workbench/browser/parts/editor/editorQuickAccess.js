            ...
            return {
                ...
                ariaLabel: (() => {
                    if (mapGroupIdToGroupAriaLabel.size > 1) {
                        return isDirty ?
                            localize(4369, null, nameAndDescription, mapGroupIdToGroupAriaLabel.get(groupId)) :
                            localize(4370, null, nameAndDescription, mapGroupIdToGroupAriaLabel.get(groupId));
                    }
                    return isDirty ? localize(4371, null, nameAndDescription) : nameAndDescription;
                })(),
                description,
