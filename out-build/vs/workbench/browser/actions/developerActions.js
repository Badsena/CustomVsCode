...
class InspectContextKeysAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3624, 'Inspect Context Keys'),
...
class ToggleScreencastModeAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3625, 'Toggle Screencast Mode'),
            category: Categories.Developer,
            f1: true
        });
    }
...
class LogStorageAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3626, "Log Storage Database Contents"),
            category: Categories.Developer,
            f1: true
        });
    }
    run(accessor) {
        ...
        storageService.log();
        dialogService.info(localize(3598, null), localize(3599, null));
    }
}
class LogWorkingCopiesAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3627, "Log Working Copies"),
            category: Categories.Developer,
            f1: true
        });
    }
...
class RemoveLargeStorageEntriesAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3628, 'Remove Large Storage Database Entries...'),
            category: Categories.Developer,
            f1: true
        });
    }
    async run(accessor) {
                ...
                for (const key of storageService.keys(scope, target)) {
                    ...
                    if (value && (!environmentService.isBuilt /* show all keys in dev */ || value.length > RemoveLargeStorageEntriesAction.SIZE_THRESHOLD)) {
                        items.push({
                            ...
                            detail: localize(3600, null, scope === -1 /* StorageScope.APPLICATION */ ? localize(3601, null) : scope === 0 /* StorageScope.PROFILE */ ? localize(3602, null) : localize(3603, null), target === 1 /* StorageTarget.MACHINE */ ? localize(3604, null) : localize(3605, null)),
                        });
                    }
                }
            }
        ...
        const selectedItems = await new Promise(resolve => {
            ...
            picker.customLabel = localize(3606, null);
            picker.placeholder = localize(3607, null);
            if (items.length === 0) {
                picker.description = localize(3608, null);
            }
            picker.show();
        ...
        const { confirmed } = await dialogService.confirm({
            type: 'warning',
            message: localize(3609, null),
            detail: localize(3610, null, selectedItems.map(item => item.label).join('\n')),
            primaryButton: localize(3611, null)
        });
        if (!confirmed) {
            return;
        }
...
class StartTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3629, 'Start Tracking Disposables'),
            category: Categories.Developer,
            f1: true,
...
class SnapshotTrackedDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3630, 'Snapshot Tracked Disposables'),
            category: Categories.Developer,
            f1: true,
...
class StopTrackDisposables extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3631, 'Stop Tracking Disposables'),
            category: Categories.Developer,
            f1: true,
...
class PolicyDiagnosticsAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3632, 'Policy Diagnostics'),
            category: Categories.Developer,
            f1: true
        });
    }
...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        'screencastMode.verticalOffset': {
            ...
            minimum: 0,
            maximum: 90,
            description: localize(3613, null)
        },
        'screencastMode.fontSize': {
            ...
            minimum: 20,
            maximum: 100,
            description: localize(3614, null)
        },
        'screencastMode.keyboardOptions': {
            type: 'object',
            description: localize(3615, null),
            properties: {
                'showKeys': {
                    type: 'boolean',
                    default: true,
                    description: localize(3616, null)
                },
                'showKeybindings': {
                    type: 'boolean',
                    default: true,
                    description: localize(3617, null)
                },
                'showCommands': {
                    type: 'boolean',
                    default: true,
                    description: localize(3618, null)
                },
                'showCommandGroups': {
                    type: 'boolean',
                    default: false,
                    description: localize(3619, null)
                },
                'showSingleEditorCursorMoves': {
                    type: 'boolean',
                    default: true,
                    description: localize(3620, null)
                }
            },
            default: {
                'showKeys': true,
        ...
        'screencastMode.keyboardOverlayTimeout': {
            ...
            minimum: 500,
            maximum: 5000,
            description: localize(3621, null)
        },
        'screencastMode.mouseIndicatorColor': {
            type: 'string',
            format: 'color-hex',
            default: '#FF0000',
            description: localize(3622, null)
        },
        'screencastMode.mouseIndicatorSize': {
            ...
            minimum: 20,
            maximum: 100,
            description: localize(3623, null)
        },
    }
});
