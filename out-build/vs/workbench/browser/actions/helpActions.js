...
class KeybindingsReferenceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3641, "Keyboard Shortcuts Reference"),
                mnemonicTitle: localize(3633, null),
            },
...
class OpenIntroductoryVideosUrlAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3642, "Video Tutorials"),
                mnemonicTitle: localize(3634, null),
            },
            category: Categories.Help,
            f1: true,
            menu: {
...
class OpenTipsAndTricksUrlAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3643, "Tips and Tricks"),
                mnemonicTitle: localize(3635, null),
            },
            category: Categories.Help,
            f1: true,
            menu: {
...
class OpenDocumentationUrlAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3644, "Documentation"),
                mnemonicTitle: localize(3636, null),
            },
            category: Categories.Help,
            f1: true,
            menu: {
...
class OpenNewsletterSignupUrlAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3645, 'Signup for the VS Code Newsletter'),
            category: Categories.Help,
            f1: true
        });
    }
...
class OpenYouTubeUrlAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3646, "Join Us on YouTube"),
                mnemonicTitle: localize(3637, null),
            },
            category: Categories.Help,
            f1: true,
            menu: {
...
class OpenRequestFeatureUrlAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3647, "Search Feature Requests"),
                mnemonicTitle: localize(3638, null),
            },
            category: Categories.Help,
            f1: true,
            menu: {
...
class OpenLicenseUrlAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3648, "View License"),
                mnemonicTitle: localize(3639, null),
            },
            category: Categories.Help,
            f1: true,
            menu: {
...
class OpenPrivacyStatementUrlAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3649, "Privacy Statement"),
                mnemonicTitle: localize(3640, null),
            },
            category: Categories.Help,
            f1: true,
            menu: {
...
class GetStartedWithAccessibilityFeatures extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3650, 'Get Started with Accessibility Features'),
            category: Categories.Help,
            f1: true,
            menu: {
                id: MenuId.MenubarHelpMenu,
...
class AskVSCodeCopilot extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3651, 'Ask @vscode'),
            category: Categories.Help,
            f1: true,
...
MenuRegistry.appendMenuItem(MenuId.MenubarHelpMenu, {
    command: {
        id: AskVSCodeCopilot.ID,
        title: localize2(3652, 'Ask @vscode'),
    },
    order: 7,
    group: '1_welcome',
