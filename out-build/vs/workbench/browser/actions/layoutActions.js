...
// Register Icons
const menubarIcon = registerIcon('menuBar', Codicon.layoutMenubar, localize(3653, null));
const activityBarLeftIcon = registerIcon('activity-bar-left', Codicon.layoutActivitybarLeft, localize(3654, null));
const activityBarRightIcon = registerIcon('activity-bar-right', Codicon.layoutActivitybarRight, localize(3655, null));
const panelLeftIcon = registerIcon('panel-left', Codicon.layoutSidebarLeft, localize(3656, null));
const panelLeftOffIcon = registerIcon('panel-left-off', Codicon.layoutSidebarLeftOff, localize(3657, null));
const panelRightIcon = registerIcon('panel-right', Codicon.layoutSidebarRight, localize(3658, null));
const panelRightOffIcon = registerIcon('panel-right-off', Codicon.layoutSidebarRightOff, localize(3659, null));
const panelIcon = registerIcon('panel-bottom', Codicon.layoutPanel, localize(3660, null));
const statusBarIcon = registerIcon('statusBar', Codicon.layoutStatusbar, localize(3661, null));
const panelAlignmentLeftIcon = registerIcon('panel-align-left', Codicon.layoutPanelLeft, localize(3662, null));
const panelAlignmentRightIcon = registerIcon('panel-align-right', Codicon.layoutPanelRight, localize(3663, null));
const panelAlignmentCenterIcon = registerIcon('panel-align-center', Codicon.layoutPanelCenter, localize(3664, null));
const panelAlignmentJustifyIcon = registerIcon('panel-align-justify', Codicon.layoutPanelJustify, localize(3665, null));
const quickInputAlignmentTopIcon = registerIcon('quickInputAlignmentTop', Codicon.arrowUp, localize(3666, null));
const quickInputAlignmentCenterIcon = registerIcon('quickInputAlignmentCenter', Codicon.circle, localize(3667, null));
const fullscreenIcon = registerIcon('fullscreen', Codicon.screenFull, localize(3668, null));
const centerLayoutIcon = registerIcon('centerLayoutIcon', Codicon.layoutCentered, localize(3669, null));
const zenModeIcon = registerIcon('zenMode', Codicon.target, localize(3670, null));
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3744, "Toggle Centered Layout"),
                mnemonicTitle: localize(3671, null),
            },
...
class MoveSidebarRightAction extends MoveSidebarPositionAction {
    ...
    constructor() {
        super(MoveSidebarRightAction.ID, localize2(3745, "Move Primary Side Bar Right"), 1 /* Position.RIGHT */);
    }
}
class MoveSidebarLeftAction extends MoveSidebarPositionAction {
    static { this.ID = 'workbench.action.moveSideBarLeft'; }
    constructor() {
        super(MoveSidebarLeftAction.ID, localize2(3746, "Move Primary Side Bar Left"), 0 /* Position.LEFT */);
    }
}
...
export class ToggleSidebarPositionAction extends Action2 {
    ...
    static { this.LABEL = localize(3672, null); }
    static getLabel(layoutService) {
        return layoutService.getSideBarPosition() === 0 /* Position.LEFT */ ? localize(3673, null) : localize(3674, null);
    }
    constructor() {
        super({
            id: ToggleSidebarPositionAction.ID,
            title: localize2(3747, "Toggle Primary Side Bar Position"),
            category: Categories.View,
            f1: true
        });
    }
...
const configureLayoutIcon = registerIcon('configure-layout-icon', Codicon.layout, localize(3675, null));
MenuRegistry.appendMenuItem(MenuId.LayoutControlMenu, {
    submenu: MenuId.LayoutControlMenuSubmenu,
    title: localize(3676, null),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3748, "Toggle Editor Area Visibility"),
                mnemonicTitle: localize(3683, null),
            },
            category: Categories.View,
            f1: true,
...
export class ToggleSidebarVisibilityAction extends Action2 {
    ...
    static { this.LABEL = localize(3685, null); }
    constructor() {
        super({
            id: ToggleSidebarVisibilityAction.ID,
            title: localize2(3749, 'Toggle Primary Side Bar Visibility'),
            toggled: {
                condition: SideBarVisibleContext,
                title: localize(3686, null),
                mnemonicTitle: localize(3687, null),
            },
            metadata: {
                description: localize(3688, null),
            },
            category: Categories.View,
            f1: true,
            keybinding: {
...
export class ToggleStatusbarVisibilityAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3750, "Toggle Status Bar Visibility"),
                mnemonicTitle: localize(3694, null),
            },
            category: Categories.View,
            f1: true,
...
export class HideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3751, 'Hide Editor Tabs');
        super("workbench.editor.showTabs" /* LayoutSettings.EDITOR_TABS_MODE */, "none" /* EditorTabsMode.NONE */, title, HideEditorTabsAction.ID, precondition, localize2(3752, "Hide Tab Bar"));
    }
}
export class ZenHideEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3753, 'Hide Editor Tabs in Zen Mode');
        super("zenMode.showTabs" /* ZenModeSettings.SHOW_TABS */, "none" /* EditorTabsMode.NONE */, title, ZenHideEditorTabsAction.ID, precondition, localize2(3754, "Hide Tab Bar in Zen Mode"));
    }
}
...
export class ShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3755, 'Show Multiple Editor Tabs');
        super("workbench.editor.showTabs" /* LayoutSettings.EDITOR_TABS_MODE */, "multiple" /* EditorTabsMode.MULTIPLE */, title, ShowMultipleEditorTabsAction.ID, precondition, localize2(3756, "Show Tab Bar with multiple tabs"));
    }
}
export class ZenShowMultipleEditorTabsAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3757, 'Show Multiple Editor Tabs in Zen Mode');
        super("zenMode.showTabs" /* ZenModeSettings.SHOW_TABS */, "multiple" /* EditorTabsMode.MULTIPLE */, title, ZenShowMultipleEditorTabsAction.ID, precondition, localize2(3758, "Show Tab Bar in Zen Mode"));
    }
}
...
export class ShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3759, 'Show Single Editor Tab');
        super("workbench.editor.showTabs" /* LayoutSettings.EDITOR_TABS_MODE */, "single" /* EditorTabsMode.SINGLE */, title, ShowSingleEditorTabAction.ID, precondition, localize2(3760, "Show Tab Bar with one Tab"));
    }
}
export class ZenShowSingleEditorTabAction extends AbstractSetShowTabsAction {
    ...
    constructor() {
        ...
        const title = localize2(3761, 'Show Single Editor Tab in Zen Mode');
        super("zenMode.showTabs" /* ZenModeSettings.SHOW_TABS */, "single" /* EditorTabsMode.SINGLE */, title, ZenShowSingleEditorTabAction.ID, precondition, localize2(3762, "Show Tab Bar in Zen Mode with one Tab"));
    }
}
...
export class EditorActionsTitleBarAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3763, "Move Editor Actions to Title Bar"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3764, "Move Editor Actions from the tab bar to the title bar") },
            f1: true
        });
    }
    run(accessor) {
...
export class EditorActionsDefaultAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3765, "Move Editor Actions to Tab Bar"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3766, "Move Editor Actions from the title bar to the tab bar") },
            f1: true
        });
    }
    run(accessor) {
...
export class HideEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3767, "Hide Editor Actions"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3768, "Hide Editor Actions in the tab and title bar") },
            f1: true
        });
    }
    run(accessor) {
...
export class ShowEditorActionsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3769, "Show Editor Actions"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3770, "Make Editor Actions visible.") },
            f1: true
        });
    }
    run(accessor) {
...
export class ConfigureEditorTabsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3771, "Configure Tabs"),
            category: Categories.View,
        });
    }
    run(accessor) {
...
export class ConfigureEditorAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3772, "Configure Editors"),
            category: Categories.View,
        });
    }
    run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3773, "Separate Pinned Editor Tabs"),
            category: Categories.View,
            ...
            metadata: { description: localize2(3774, "Toggle whether pinned editor tabs are shown on a separate row above unpinned tabs.") },
            f1: true
        });
    }
    run(accessor) {
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3775, "Toggle Zen Mode"),
                mnemonicTitle: localize(3698, null),
            },
            precondition: IsAuxiliaryWindowFocusedContext.toNegated(),
            category: Categories.View,
            f1: true,
    ...
    registerAction2(class ToggleMenubarAction extends Action2 {
        constructor() {
            super({
                ...
                title: {
                    ...localize2(3776, "Toggle Menu Bar"),
                    mnemonicTitle: localize(3699, null),
                },
                category: Categories.View,
                f1: true,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3777, "Reset View Locations"),
            category: Categories.View,
            f1: true
        });
    }
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3778, "Move View"),
            category: Categories.View,
            f1: true
        });
    }
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: localize(3701, null, containerModel.title)
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: localize(3702, null, containerModel.title)
                        });
                        hasAddedView = true;
                    }
                    results.push({
            ...
            containerModel.visibleViewDescriptors.forEach(viewDescriptor => {
                if (viewDescriptor.canMoveView) {
                    if (!hasAddedView) {
                        results.push({
                            type: 'separator',
                            label: localize(3703, null, containerModel.title)
                        });
                        hasAddedView = true;
                    }
                    results.push({
    ...
    async getView(quickInputService, viewDescriptorService, paneCompositePartService, viewId) {
        ...
        quickPick.placeholder = localize(3704, null);
...
class MoveFocusedViewAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3779, "Move Focused View"),
            category: Categories.View,
    ...
    run(accessor, viewId) {
        ...
        if (focusedViewId === undefined || focusedViewId.trim() === '') {
            dialogService.error(localize(3705, null));
            return;
        }
        const viewDescriptor = viewDescriptorService.getViewDescriptorById(focusedViewId);
        if (!viewDescriptor?.canMoveView) {
            dialogService.error(localize(3706, null));
            return;
        }
        const disposables = new DisposableStore();
        const quickPick = disposables.add(quickInputService.createQuickPick({ useSeparators: true }));
        quickPick.placeholder = localize(3707, null);
        quickPick.title = localize(3708, null, viewDescriptor.name.value);
        const items = [];
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3780, "Reset Focused View Location"),
            category: Categories.View,
            f1: true,
            precondition: FocusedViewContext.notEqualsTo('')
        });
    ...
    run(accessor) {
        ...
        if (!viewDescriptor) {
            dialogService.error(localize(3715, null));
            return;
        }
...
class IncreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3781, 'Increase Current View Size'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class IncreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3782, 'Increase Editor Width'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class IncreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3783, 'Increase Editor Height'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class DecreaseViewSizeAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3784, 'Decrease Current View Size'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class DecreaseViewWidthAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3785, 'Decrease Editor Width'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
class DecreaseViewHeightAction extends BaseResizeViewAction {
    constructor() {
        super({
            ...
            title: localize2(3786, 'Decrease Editor Height'),
            f1: true,
            precondition: IsAuxiliaryWindowFocusedContext.toNegated()
        });
    }
...
registerAction2(class AlignQuickInputTopAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3787, 'Align Quick Input Top'),
            f1: false
        });
    }
    run(accessor) {
...
registerAction2(class AlignQuickInputCenterAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3788, 'Align Quick Input Center'),
            f1: false
        });
    }
    run(accessor) {
...
const CreateToggleLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: localize(3716, null),
        inactiveAriaLabel: localize(3717, null),
        useButtons: true,
    };
};
const CreateOptionLayoutItem = (id, active, label, visualIcon) => {
    return {
        ...
        activeAriaLabel: localize(3718, null),
        useButtons: false
    };
};
...
if (!isMacintosh || !isNative) {
    ToggleVisibilityActions.push(CreateToggleLayoutItem('workbench.action.toggleMenuBar', MenuBarToggledContext, localize(3719, null), menubarIcon));
}
ToggleVisibilityActions.push(...[
    CreateToggleLayoutItem(ToggleActivityBarVisibilityActionId, ContextKeyExpr.notEquals('config.workbench.activityBar.location', 'hidden'), localize(3720, null), { whenA: ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'), iconA: activityBarLeftIcon, iconB: activityBarRightIcon }),
    CreateToggleLayoutItem(ToggleSidebarVisibilityAction.ID, SideBarVisibleContext, localize(3721, null), { whenA: ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'), iconA: panelLeftIcon, iconB: panelRightIcon }),
    CreateToggleLayoutItem(ToggleAuxiliaryBarAction.ID, AuxiliaryBarVisibleContext, localize(3722, null), { whenA: ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'), iconA: panelRightIcon, iconB: panelLeftIcon }),
    CreateToggleLayoutItem(TogglePanelAction.ID, PanelVisibleContext, localize(3723, null), panelIcon),
    CreateToggleLayoutItem(ToggleStatusbarVisibilityAction.ID, ContextKeyExpr.equals('config.workbench.statusBar.visible', true), localize(3724, null), statusBarIcon),
]);
const MoveSideBarActions = [
    CreateOptionLayoutItem(MoveSidebarLeftAction.ID, ContextKeyExpr.equals('config.workbench.sideBar.location', 'left'), localize(3725, null), panelLeftIcon),
    CreateOptionLayoutItem(MoveSidebarRightAction.ID, ContextKeyExpr.equals('config.workbench.sideBar.location', 'right'), localize(3726, null), panelRightIcon),
];
const AlignPanelActions = [
    CreateOptionLayoutItem('workbench.action.alignPanelLeft', PanelAlignmentContext.isEqualTo('left'), localize(3727, null), panelAlignmentLeftIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelRight', PanelAlignmentContext.isEqualTo('right'), localize(3728, null), panelAlignmentRightIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelCenter', PanelAlignmentContext.isEqualTo('center'), localize(3729, null), panelAlignmentCenterIcon),
    CreateOptionLayoutItem('workbench.action.alignPanelJustify', PanelAlignmentContext.isEqualTo('justify'), localize(3730, null), panelAlignmentJustifyIcon),
];
const QuickInputActions = [
    CreateOptionLayoutItem('workbench.action.alignQuickInputTop', QuickInputAlignmentContextKey.isEqualTo('top'), localize(3731, null), quickInputAlignmentTopIcon),
    CreateOptionLayoutItem('workbench.action.alignQuickInputCenter', QuickInputAlignmentContextKey.isEqualTo('center'), localize(3732, null), quickInputAlignmentCenterIcon),
];
const MiscLayoutOptions = [
    CreateOptionLayoutItem('workbench.action.toggleFullScreen', IsMainWindowFullscreenContext, localize(3733, null), fullscreenIcon),
    CreateOptionLayoutItem('workbench.action.toggleZenMode', InEditorZenModeContext, localize(3734, null), zenModeIcon),
    CreateOptionLayoutItem('workbench.action.toggleCenteredLayout', IsMainEditorCenteredLayoutContext, localize(3735, null), centerLayoutIcon),
];
...
registerAction2(class CustomizeLayoutAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3789, "Customize Layout..."),
            f1: true,
            icon: configureLayoutIcon,
            menu: [
                {
    ...
    run(accessor) {
        ...
        quickPick.title = localize(3741, null);
        const closeButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.close),
            tooltip: localize(3742, null)
        };
        const resetButton = {
            alwaysVisible: true,
            iconClass: ThemeIcon.asClassName(Codicon.discard),
            tooltip: localize(3743, null)
        };
        quickPick.buttons = [
            resetButton,
            closeButton
