...
registerAction2(class extends BaseNavigationAction {
    constructor() {
        super({
            ...
            title: localize2(3793, 'Navigate to the View on the Left'),
...
registerAction2(class extends BaseNavigationAction {
    constructor() {
        super({
            ...
            title: localize2(3794, 'Navigate to the View on the Right'),
            category: Categories.View,
            f1: true
        }, 3 /* Direction.Right */);
    }
...
registerAction2(class extends BaseNavigationAction {
    constructor() {
        super({
            ...
            title: localize2(3795, 'Navigate to the View Above'),
            category: Categories.View,
            f1: true
        }, 0 /* Direction.Up */);
    }
...
registerAction2(class extends BaseNavigationAction {
    constructor() {
        super({
            ...
            title: localize2(3796, 'Navigate to the View Below'),
            category: Categories.View,
            f1: true
        }, 1 /* Direction.Down */);
    }
...
registerAction2(class extends BaseFocusAction {
    constructor() {
        super({
            ...
            title: localize2(3797, 'Focus Next Part'),
            category: Categories.View,
            f1: true,
            keybinding: {
...
registerAction2(class extends BaseFocusAction {
    constructor() {
        super({
            ...
            title: localize2(3798, 'Focus Previous Part'),
            category: Categories.View,
            f1: true,
            keybinding: {
