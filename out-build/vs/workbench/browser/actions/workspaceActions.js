...
export class OpenFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3844, 'Open Folder...'),
            category: Categories.File,
            f1: true,
...
export class OpenFolderViaWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3845, 'Open Folder...'),
            category: Categories.File,
            f1: true,
...
export class OpenFileFolderAction extends Action2 {
    ...
    static { this.LABEL = localize2(3846, 'Open...'); }
    constructor() {
        super({
...
class OpenWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3847, 'Open Workspace from File...'),
            category: Categories.File,
            f1: true,
...
class CloseWorkspaceAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3848, 'Close Workspace'),
...
class OpenWorkspaceConfigFileAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3849, 'Open Workspace Configuration File'),
            category: workspacesCategory,
            f1: true,
...
export class RemoveRootFolderAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3850, 'Remove Folder from Workspace...'),
            category: workspacesCategory,
            f1: true,
...
class SaveWorkspaceAsAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3851, 'Save Workspace As...'),
            category: workspacesCategory,
            f1: true,
            precondition: EnterMultiRootWorkspaceSupportContext
        });
...
class DuplicateWorkspaceInNewWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3852, 'Duplicate As Workspace in New Window'),
            category: workspacesCategory,
            f1: true,
            precondition: EnterMultiRootWorkspaceSupportContext
        });
