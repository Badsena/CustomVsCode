...
class BaseOpenRecentAction extends Action2 {
    ...
    async run(accessor) {
        ...
        let keyMods;
        const workspaceSeparator = { type: 'separator', label: hasWorkspaces ? localize(3818, null) : localize(3819, null) };
        const fileSeparator = { type: 'separator', label: localize(3820, null) };
        const picks = [workspaceSeparator, ...workspacePicks, fileSeparator, ...filePicks];
        const pick = await quickInputService.pick(picks, {
            contextKey: inRecentFilesPickerContextKey,
            activeItem: [...workspacePicks, ...filePicks][autoFocusSecondEntry ? 1 : 0],
            placeHolder: isMacintosh ? localize(3821, null) : localize(3822, null),
            ...
            onDidTriggerItemButton: async (context) => {
                ...
                // Dirty Folder/Workspace
                    ...
                    const { confirmed } = await dialogService.confirm({
                        title: isDirtyWorkspace ? localize(3823, null) : localize(3824, null),
                        message: isDirtyWorkspace ? localize(3825, null) : localize(3826, null),
                        detail: isDirtyWorkspace ? localize(3827, null) : localize(3828, null)
                    });
                    if (confirmed) {
    ...
    toQuickPick(modelService, languageService, labelService, recent, kind) {
        ...
        return {
            iconClasses,
            label: name,
            ariaLabel: kind.isDirty ? isWorkspace ? localize(3829, null, name) : localize(3830, null, name) : name,
...
export class OpenRecentAction extends BaseOpenRecentAction {
    ...
    constructor() {
        super({
            ...
            title: {
                ...localize2(3835, "Open Recent..."),
                mnemonicTitle: localize(3831, null),
            },
...
class QuickPickRecentAction extends BaseOpenRecentAction {
    constructor() {
        super({
            ...
            title: localize2(3836, 'Quick Open Recent...'),
            category: Categories.File,
...
class ToggleFullScreenAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3837, "Toggle Full Screen"),
                mnemonicTitle: localize(3832, null),
            },
...
export class ReloadWindowAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(3838, 'Reload Window'),
...
class ShowAboutDialogAction extends Action2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(3839, "About"),
                mnemonicTitle: localize(3833, null),
            },
...
class AmypoAboutAction extends Action2 {
    constructor() {
        super({
            id: 'amypo.about',
            title: localize2(3840, "About Amypo Coder"),
            category: Categories.Help,
            f1: true
        });
    }
...
class BlurAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3841, 'Remove keyboard focus from focused element')
        });
    }
    run() {
