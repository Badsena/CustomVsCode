            ...
            'properties': {
                'security.allowedUNCHosts': {
                    ...
                    'items': {
                        'type': 'string',
                        'pattern': '^[^\\\\]+$',
                        'patternErrorMessage': localize(4963, null)
                    },
                    'default': [],
                    'markdownDescription': localize(4964, null),
                    'scope': 3 /* ConfigurationScope.APPLICATION_MACHINE */
                },
                'security.restrictUNCAccess': {
                    'type': 'boolean',
                    'default': true,
                    'markdownDescription': localize(4965, null),
                    'scope': 3 /* ConfigurationScope.APPLICATION_MACHINE */
                }
            }
        });
        ...
        const configurationNode = {
            ...
            'properties': {
                [CONFIG_NEW_WINDOW_PROFILE]: {
                    ...
                    'enumItemLabels': [...this.userDataProfilesService.profiles.map(() => ''), localize(4966, null)],
                    'description': localize(4967, null),
                    'scope': 1 /* ConfigurationScope.APPLICATION */,
                }
            }
        };
