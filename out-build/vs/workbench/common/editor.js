...
export const DEFAULT_EDITOR_ASSOCIATION = {
    id: 'default',
    displayName: localize(5046, null),
    providerDisplayName: localize(5047, null)
};
/**
...
export function createTooLargeFileError(group, input, options, message, preferencesService) {
    return createEditorOpenError(message, [
        toAction({
            id: 'workbench.action.openLargeFile', label: localize(5048, null), run: () => {
        ...
        toAction({
            id: 'workbench.action.configureEditorLargeFileConfirmation', label: localize(5049, null), run: () => {
