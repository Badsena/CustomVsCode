...
export const VIEWS_LOG_NAME = localize(5214, null);
export const defaultViewIcon = registerIcon('default-view-icon', Codicon.window, localize(5215, null));
    ...
    addViews(viewDescriptors, viewContainer) {
        ...
        for (const viewDescriptor of viewDescriptors) {
            if (this.getView(viewDescriptor.id) !== null) {
                throw new Error(localize(5216, null, viewDescriptor.id));
            }
...
export class NoTreeViewError extends Error {
    constructor(treeViewId) {
        super(localize(5217, null, treeViewId));
