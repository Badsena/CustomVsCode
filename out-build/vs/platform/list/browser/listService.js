...
configurationRegistry.registerConfiguration({
    ...
    properties: {
        [multiSelectModifierSettingKey]: {
            ...
            default: 'ctrlCmd',
            description: localize(2248, null)
        ...
        [openModeSettingKey]: {
            ...
            default: 'singleClick',
            description: localize(2249, null)
        ...
        [horizontalScrollingKey]: {
            type: 'boolean',
            default: false,
            description: localize(2250, null)
        },
        [scrollByPageKey]: {
            type: 'boolean',
            default: false,
            description: localize(2251, null)
        },
        [treeIndentKey]: {
            type: 'number',
            default: 8,
            minimum: 4,
            maximum: 40,
            description: localize(2252, null)
        },
        [treeRenderIndentGuidesKey]: {
            type: 'string',
            enum: ['none', 'onHover', 'always'],
            default: 'onHover',
            description: localize(2253, null)
        },
        [listSmoothScrolling]: {
            type: 'boolean',
            default: false,
            description: localize(2254, null),
        },
        [mouseWheelScrollSensitivityKey]: {
            type: 'number',
            default: 1,
            markdownDescription: localize(2255, null)
        },
        [fastScrollSensitivityKey]: {
            type: 'number',
            default: 5,
            markdownDescription: localize(2256, null)
        },
        [defaultFindModeSettingKey]: {
            ...
            default: 'highlight',
            description: localize(2259, null)
        },
        [keyboardNavigationSettingKey]: {
            ...
            default: 'highlight',
            description: localize(2263, null),
            deprecated: true,
            deprecationMessage: localize(2264, null)
        },
        [defaultFindMatchTypeSettingKey]: {
            ...
            default: 'fuzzy',
            description: localize(2267, null)
        },
        [treeExpandMode]: {
            type: 'string',
            enum: ['singleClick', 'doubleClick'],
            default: 'singleClick',
            description: localize(2268, null),
        },
        [treeStickyScroll]: {
            type: 'boolean',
            default: true,
            description: localize(2269, null),
        },
        [treeStickyScrollMaxElements]: {
            type: 'number',
            minimum: 1,
            default: 7,
            markdownDescription: localize(2270, null, '`#workbench.tree.enableStickyScroll#`'),
        },
        [typeNavigationModeSettingKey]: {
            type: 'string',
            enum: ['automatic', 'trigger'],
            default: 'automatic',
            markdownDescription: localize(2271, null),
        }
    }
});
