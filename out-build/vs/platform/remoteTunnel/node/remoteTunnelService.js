    ...
    async updateTunnelProcess() {
        ...
        const onOutput = (a, isErr) => {
            ...
            if (!this.environmentService.isBuilt && a.startsWith('   Compiling')) {
                this.setTunnelStatus(TunnelStates.connecting(localize(2393, null)));
            }
        };
        ...
        if (session && session.token) {
            ...
            this.setTunnelStatus(TunnelStates.connecting(localize(2394, null, session.accountLabel, session.providerId)));
        ...
        if (hostName) {
            this.setTunnelStatus(TunnelStates.connecting(localize(2395, null, hostName)));
        }
        else {
            this.setTunnelStatus(TunnelStates.connecting(localize(2396, null)));
        }
