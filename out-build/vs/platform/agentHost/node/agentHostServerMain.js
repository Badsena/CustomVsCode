...
async function main() {
    ...
    if (options.quiet) {
        ...
        const logger = loggerService.createLogger('agenthost-server', { name: localize(1884, null) });
    ...
    const registeredAgents = observableValue('agents', []);
    // File service
...
main();
//# sourceMappingURL=agentHostServerMain.js.map