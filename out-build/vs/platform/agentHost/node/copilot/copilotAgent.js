...
let CopilotAgent = class CopilotAgent extends Disposable {
    ...
    async _handlePermissionRequest(request, invocation) {
        ...
        const permissionKind = ["shell" /* PermissionKind.Shell */, "write" /* PermissionKind.Write */, "mcp" /* PermissionKind.Mcp */, "read" /* PermissionKind.Read */, "url" /* PermissionKind.Url */].includes(request.kind)
            ? request.kind
            : "read" /* PermissionKind.Read */; // Treat unknown kinds as read (safest default)
