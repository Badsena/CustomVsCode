...
const errorEmptyString = localize(1949, null);
const hintEmptyString = localize(1950, null);
const errorNoInAfterNot = localize(1951, null);
const errorClosingParenthesis = localize(1952, null);
const errorUnexpectedToken = localize(1953, null);
const hintUnexpectedToken = localize(1954, null);
const errorUnexpectedEOF = localize(1955, null);
const hintUnexpectedEOF = localize(1956, null);
/**
...
export class Parser {
    ...
    _errExpectedButGot(expected, got, additionalInfo) {
        const message = localize(1957, null, expected, Scanner.getLexeme(got));
        ...
        if (parser.lexingErrors.length > 0) {
            return parser.lexingErrors.map((se) => ({
                errorMessage: se.additionalInfo ?
                    localize(1958, null, se.additionalInfo) :
                    localize(1959, null),
                offset: se.offset,
