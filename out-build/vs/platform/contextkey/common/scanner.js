...
function hintDidYouMean(...meant) {
    switch (meant.length) {
        case 1:
            return localize(1969, null, meant[0]);
        case 2:
            return localize(1970, null, meant[0], meant[1]);
        case 3:
            return localize(1971, null, meant[0], meant[1], meant[2]);
        default: // we just don't expect that many
            return undefined;
    }
}
const hintDidYouForgetToOpenOrCloseQuote = localize(1972, null);
const hintDidYouForgetToEscapeSlash = localize(1973, null);
/**
