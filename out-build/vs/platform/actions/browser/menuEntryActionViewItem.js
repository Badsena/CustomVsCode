...
let MenuEntryActionViewItem = class MenuEntryActionViewItem extends ActionViewItem {
    ...
    getTooltip() {
        ...
        if (!this._wantsAltCommand && this._menuItemAction.alt?.enabled) {
            ...
            title = localize(1856, null, title, UILabelProvider.modifierLabels[OS].altKey, altTitleSection);
        }
        return title;
    }
    updateClass() {
    ...
    updateLabel() {
        ...
        if (this.label) {
            ...
            if (this._options?.conversational) {
                this.label.textContent = localize(1857, null, this._action.label, kb2);
            }
            else {
                this.label.textContent = localize(1858, null, this._action.label, kb2);
            }
        }
    }
