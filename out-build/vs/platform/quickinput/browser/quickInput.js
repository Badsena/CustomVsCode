...
export const InQuickInputContextKey = new RawContextKey(inQuickInputContextKeyValue, false, localize(2363, null));
...
export const QuickInputAlignmentContextKey = new RawContextKey(quickInputAlignmentContextKeyValue, 'top', localize(2364, null));
export const quickInputTypeContextKeyValue = 'quickInputType';
export const QuickInputTypeContextKey = new RawContextKey(quickInputTypeContextKeyValue, undefined, localize(2365, null));
export const endOfQuickInputBoxContextKeyValue = 'cursorAtEndOfQuickInputBox';
export const EndOfQuickInputBoxContextKey = new RawContextKey(endOfQuickInputBoxContextKeyValue, false, localize(2366, null));
export const endOfQuickInputBoxContext = ContextKeyExpr.has(endOfQuickInputBoxContextKeyValue);
export const backButton = {
    iconClass: ThemeIcon.asClassName(Codicon.quickInputBack),
    tooltip: localize(2367, null),
    handle: -1 // TODO
};
export class QuickInput extends Disposable {
    static { this.noPromptMessage = localize(2368, null); }
    constructor(ui) {
        super();
        this.ui = ui;
    ...
    getSteps() {
        if (this.step && this.totalSteps) {
            return localize(2369, null, this.step, this.totalSteps);
        }
        if (this.step) {
...
export class QuickPick extends QuickInput {
    static { this.DEFAULT_ARIA_LABEL = localize(2370, null); }
    constructor(ui) {
        super(ui);
        this._value = '';
    ...
    get okLabel() {
        return this._okLabel ?? localize(2371, null);
    }
    set okLabel(okLabel) {
