...
let QuickInputController = class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        const checkAll = this._register(new TriStateCheckbox(localize(2378, null), false, { ...defaultCheckboxStyles, size: 15 }));
        ...
        const visibleCount = this._register(new CountBadge(visibleCountContainer, { countFormat: localize(2379, null) }, this.styles.countBadge));
        const countContainer = dom.append(filterContainer, $('.quick-input-count'));
        countContainer.setAttribute('aria-live', 'polite');
        const count = this._register(new CountBadge(countContainer, { countFormat: localize(2380, null) }, this.styles.countBadge));
        ...
        ok.label = localize(2381, null);
        this._register(ok.onDidClick(e => {
            this.onDidAcceptEmitter.fire();
        }));
        const customButtonContainer = dom.append(headerContainer, $('.quick-input-action'));
        const customButton = this._register(new Button(customButtonContainer, { ...this.styles.button, supportIcons: true }));
        customButton.label = localize(2382, null);
    ...
    show(controller) {
        ...
        backButton.tooltip = backKeybindingLabel ? localize(2383, null, backKeybindingLabel) : localize(2384, null);
