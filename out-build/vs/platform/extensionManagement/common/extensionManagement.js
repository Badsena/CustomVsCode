...
export const ExtensionsLocalizedLabel = localize2(2099, "Extensions");
export const PreferencesLocalizedLabel = localize2(2100, 'Preferences');
...
Registry.as(Extensions.Configuration)
    ...
    properties: {
        [AllowedExtensionsConfigKey]: {
            ...
            type: 'object',
            markdownDescription: localize(2081, null),
            default: '*',
            defaultSnippets: [{
                    body: {},
                    description: localize(2082, null),
                }, {
                    body: {
                        '*': true
                    },
                    description: localize(2083, null),
                }],
            ...
            patternProperties: {
                    ...
                    anyOf: [
                        {
                            ...
                            description: localize(2085, null),
                            enumDescriptions: [
                                localize(2086, null),
                                localize(2087, null),
                                localize(2088, null),
                        ...
                        },
                        {
                            ...
                            description: localize(2089, null),
                        },
                    ]
                },
                '([a-z0-9A-Z][a-z0-9-A-Z]*)$': {
                    type: ['boolean', 'string'],
                    enum: [true, false, 'stable'],
                    description: localize(2090, null),
                    enumDescriptions: [
                        localize(2091, null),
                        localize(2092, null),
                        localize(2093, null),
                ...
                '\\*': {
                    type: 'boolean',
                    enum: [true, false],
                    description: localize(2094, null),
                    enumDescriptions: [
                        localize(2095, null),
                        localize(2096, null)
                    ],
        ...
        [VerifyExtensionSignatureConfigKey]: {
            type: 'boolean',
            description: localize(2097, null, "Amypo Coder"),
            default: false,
            scope: 1 /* ConfigurationScope.APPLICATION */,
            policy: {
                ...
                localization: {
                    description: {
                        ...
                        value: localize(2098, null, "Amypo Coder"),
                    }
                }
            }
        }
