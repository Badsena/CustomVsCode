    ...
    constructor() {
        ...
        this.tokenStylingSchema = {
            ...
            definitions: {
                style: {
                    type: 'object',
                    description: nls.localize(2758, null),
                    properties: {
                        foreground: {
                            type: 'string',
                            description: nls.localize(2759, null),
                            format: 'color-hex',
                            default: '#ff0000'
                        },
                        background: {
                            type: 'string',
                            deprecationMessage: nls.localize(2760, null)
                        },
                        fontStyle: {
                            type: 'string',
                            description: nls.localize(2761, null),
                            pattern: fontStylePattern,
                            patternErrorMessage: nls.localize(2762, null),
                            defaultSnippets: [
                                { label: nls.localize(2763, null), bodyText: '""' },
                                { body: 'italic' },
                                { body: 'bold' },
                                { body: 'underline' },
                                { body: 'strikethrough' },
                        ...
                        bold: {
                            type: 'boolean',
                            description: nls.localize(2764, null),
                        },
                        italic: {
                            type: 'boolean',
                            description: nls.localize(2765, null),
                        },
                        underline: {
                            type: 'boolean',
                            description: nls.localize(2766, null),
                        },
                        strikethrough: {
                            type: 'boolean',
                            description: nls.localize(2767, null),
                        }
                    },
...
function createDefaultTokenClassificationRegistry() {
    ...
    // default token types
    registerTokenType('comment', nls.localize(2768, null), [['comment']]);
    registerTokenType('string', nls.localize(2769, null), [['string']]);
    registerTokenType('keyword', nls.localize(2770, null), [['keyword.control']]);
    registerTokenType('number', nls.localize(2771, null), [['constant.numeric']]);
    registerTokenType('regexp', nls.localize(2772, null), [['constant.regexp']]);
    registerTokenType('operator', nls.localize(2773, null), [['keyword.operator']]);
    registerTokenType('namespace', nls.localize(2774, null), [['entity.name.namespace']]);
    registerTokenType('type', nls.localize(2775, null), [['entity.name.type'], ['support.type']]);
    registerTokenType('struct', nls.localize(2776, null), [['entity.name.type.struct']]);
    registerTokenType('class', nls.localize(2777, null), [['entity.name.type.class'], ['support.class']]);
    registerTokenType('interface', nls.localize(2778, null), [['entity.name.type.interface']]);
    registerTokenType('enum', nls.localize(2779, null), [['entity.name.type.enum']]);
    registerTokenType('typeParameter', nls.localize(2780, null), [['entity.name.type.parameter']]);
    registerTokenType('function', nls.localize(2781, null), [['entity.name.function'], ['support.function']]);
    registerTokenType('member', nls.localize(2782, null), [], 'method', 'Deprecated use `method` instead');
    registerTokenType('method', nls.localize(2783, null), [['entity.name.function.member'], ['support.function']]);
    registerTokenType('macro', nls.localize(2784, null), [['entity.name.function.preprocessor']]);
    registerTokenType('variable', nls.localize(2785, null), [['variable.other.readwrite'], ['entity.name.variable']]);
    registerTokenType('parameter', nls.localize(2786, null), [['variable.parameter']]);
    registerTokenType('property', nls.localize(2787, null), [['variable.other.property']]);
    registerTokenType('enumMember', nls.localize(2788, null), [['variable.other.enummember']]);
    registerTokenType('event', nls.localize(2789, null), [['variable.other.event']]);
    registerTokenType('decorator', nls.localize(2790, null), [['entity.name.decorator'], ['entity.name.function']]);
    registerTokenType('label', nls.localize(2791, null), undefined);
    // default token modifiers
    registry.registerTokenModifier('declaration', nls.localize(2792, null), undefined);
    registry.registerTokenModifier('documentation', nls.localize(2793, null), undefined);
    registry.registerTokenModifier('static', nls.localize(2794, null), undefined);
    registry.registerTokenModifier('abstract', nls.localize(2795, null), undefined);
    registry.registerTokenModifier('deprecated', nls.localize(2796, null), undefined);
    registry.registerTokenModifier('modification', nls.localize(2797, null), undefined);
    registry.registerTokenModifier('async', nls.localize(2798, null), undefined);
    registry.registerTokenModifier('readonly', nls.localize(2799, null), undefined);
