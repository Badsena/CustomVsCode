...
export class DiskFileSystemProviderChannel extends AbstractDiskFileSystemProviderChannel {
    ...
    async delete(uriTransformer, _resource, opts) {
        ...
        try {
            ...
            throw createFileSystemProviderError(isWindows ? localize(2221, null, basename(filePath), toErrorMessage(error)) : localize(2222, null, basename(filePath), toErrorMessage(error)), FileSystemProviderErrorCode.Unknown);
        }
    }
    //#endregion
