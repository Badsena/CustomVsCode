...
export function registerConfiguration() {
    ...
    configurationRegistry.registerConfiguration({
        id: 'settingsSync',
        order: 30,
        title: localize(2858, null),
        type: 'object',
        properties: {
            [CONFIG_SYNC_KEYBINDINGS_PER_PLATFORM]: {
                type: 'boolean',
                description: localize(2859, null),
                default: true,
            ...
            'settingsSync.ignoredExtensions': {
                'type': 'array',
                markdownDescription: localize(2860, null),
                items: [{
                        type: 'string',
                        pattern: EXTENSION_IDENTIFIER_PATTERN,
                        errorMessage: localize(2861, null)
                    }],
                'default': [],
                'scope': 1 /* ConfigurationScope.APPLICATION */,
                uniqueItems: true,
            ...
            'settingsSync.ignoredSettings': {
                'type': 'array',
                description: localize(2862, null),
                'default': [],
                'scope': 1 /* ConfigurationScope.APPLICATION */,
