    ...
    async generateSyncPreview(remoteUserData, lastSyncUserData, isRemoteDataFromCurrentMachine, userDataSyncConfiguration) {
        ...
        if (remoteContent) {
            ...
            if (this.hasErrors(localContent, true)) {
                throw new UserDataSyncError(localize(2848, null), "LocalInvalidContent" /* UserDataSyncErrorCode.LocalInvalidContent */, this.resource);
            }
    ...
    async applyResult(remoteUserData, lastSyncUserData, resourcePreviews, force) {
        ...
        if (content !== null) {
            ...
            if (this.hasErrors(content, true)) {
                throw new UserDataSyncError(localize(2849, null), "LocalInvalidContent" /* UserDataSyncErrorCode.LocalInvalidContent */, this.resource);
            }
        }
