...
class AutoSync extends Disposable {
    ...
    async createAndRunSyncTask(disableCache, token) {
        ...
        if (this.manifest === null && await this.userDataSyncService.hasPreviouslySynced()) {
            if (this.hasSyncServiceChanged()) {
                if (await this.hasDefaultServiceChanged()) {
                    throw new UserDataAutoSyncError(localize(2851, null), "DefaultServiceChanged" /* UserDataSyncErrorCode.DefaultServiceChanged */);
                }
                else {
                    throw new UserDataAutoSyncError(localize(2852, null), "ServiceChanged" /* UserDataSyncErrorCode.ServiceChanged */);
                }
            }
            else {
                // Sync was turned off in the cloud
                throw new UserDataAutoSyncError(localize(2853, null), "TurnedOff" /* UserDataSyncErrorCode.TurnedOff */);
            }
        }
        ...
        if (sessionId && this.manifest && sessionId !== this.manifest.session) {
            if (this.hasSyncServiceChanged()) {
                if (await this.hasDefaultServiceChanged()) {
                    throw new UserDataAutoSyncError(localize(2854, null), "DefaultServiceChanged" /* UserDataSyncErrorCode.DefaultServiceChanged */);
                }
                else {
                    throw new UserDataAutoSyncError(localize(2855, null), "ServiceChanged" /* UserDataSyncErrorCode.ServiceChanged */);
                }
            }
            else {
                throw new UserDataAutoSyncError(localize(2856, null), "SessionExpired" /* UserDataSyncErrorCode.SessionExpired */);
            }
        }
        ...
        if (currentMachine?.disabled) {
            ...
            throw new UserDataAutoSyncError(localize(2857, null), "TurnedOff" /* UserDataSyncErrorCode.TurnedOff */);
        }
