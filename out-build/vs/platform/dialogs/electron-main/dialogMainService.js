...
let DialogMainService = class DialogMainService {
    ...
    pickFileFolder(options, window) {
        return this.doPick({ ...options, pickFolders: true, pickFiles: true, title: localize(1984, null) }, window);
    }
    pickFolder(options, window) {
        let optionsInternal = {
            ...options,
            pickFolders: true,
            title: localize(1985, null)
        };
        if (isWindows) {
            ...
            optionsInternal = {
                ...optionsInternal,
                buttonLabel: mnemonicButtonLabel(localize(1986, null)).withMnemonic
            };
        }
        return this.doPick(optionsInternal, window);
    }
    pickFile(options, window) {
        return this.doPick({ ...options, pickFiles: true, title: localize(1987, null) }, window);
    }
    pickWorkspace(options, window) {
        const title = localize(1988, null);
        const buttonLabel = mnemonicButtonLabel(localize(1989, null)).withMnemonic;
