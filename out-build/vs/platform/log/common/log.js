...
export function LogLevelToLocalizedString(logLevel) {
    switch (logLevel) {
        case LogLevel.Trace: return { original: 'Trace', value: nls.localize(2272, null) };
        case LogLevel.Debug: return { original: 'Debug', value: nls.localize(2273, null) };
        case LogLevel.Info: return { original: 'Info', value: nls.localize(2274, null) };
        case LogLevel.Warning: return { original: 'Warning', value: nls.localize(2275, null) };
        case LogLevel.Error: return { original: 'Error', value: nls.localize(2276, null) };
        case LogLevel.Off: return { original: 'Off', value: nls.localize(2277, null) };
    }
}
