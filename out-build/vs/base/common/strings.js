 ...
 */
export function count(value, substr) {
    let result = 0;
...
export function truncate(value, maxLength, suffix = Ellipsis) {
    if (value.length <= maxLength) {
        return value;
    }
    return `${value.substr(0, maxLength)}${suffix}`;
}
export function truncateMiddle(value, maxLength, suffix = Ellipsis) {
    if (value.length <= maxLength) {
        return value;
    }
...
export function joinStrings(items, separator) {
...
export function indexOfPattern(str, re) {
...
export function getIndentationLength(str) {
...
export function endsWithIgnoreCase(str, candidate) {
 ...
 */
export function lcut(text, n, prefix = '') {
 ...
 */
export function rcut(text, n, suffix = '') {
...
export function* forAnsiStringParts(str) {
    let last = 0;
 ...
 * // '\n\\w\n> '
 */
export function removeAnsiEscapeCodesFromPrompt(str) {
...
export class AmbiguousCharacters {
    ...
    static { this.cache = new LRUCachedFunction((localesStr) => {
...
export class InvisibleCharacters {
    ...
    static containsInvisibleCharacter(str) {
        for (let i = 0; i < str.length; i++) {
            const codePoint = str.codePointAt(i);
            if (typeof codePoint === 'number' && (InvisibleCharacters.isInvisibleCharacter(codePoint) || codePoint === 32 /* CodePoint.space */)) {
                return true;
            }
        }
        return false;
