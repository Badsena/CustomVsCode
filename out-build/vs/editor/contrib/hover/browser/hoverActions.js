...
export class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1307, "Show or Focus Hover"),
            ...
            metadata: {
                description: nls.localize2(1308, 'Show or focus the editor hover which shows documentation, references, and other content for a symbol at the current cursor position.'),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
...
export class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1309, "Show Definition Preview Hover"),
            ...
            precondition: undefined,
            metadata: {
                description: nls.localize2(1310, 'Show the definition preview hover in the editor.'),
            },
        });
    }
    run(accessor, editor) {
...
export class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1311, "Hide Hover"),
...
export class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1312, "Scroll Up Hover"),
            ...
            metadata: {
                description: nls.localize2(1313, 'Scroll up the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1314, "Scroll Down Hover"),
            ...
            metadata: {
                description: nls.localize2(1315, 'Scroll down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1316, "Scroll Left Hover"),
            ...
            metadata: {
                description: nls.localize2(1317, 'Scroll left the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1318, "Scroll Right Hover"),
            ...
            metadata: {
                description: nls.localize2(1319, 'Scroll right the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1320, "Page Up Hover"),
            ...
            metadata: {
                description: nls.localize2(1321, 'Page up the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1322, "Page Down Hover"),
            ...
            metadata: {
                description: nls.localize2(1323, 'Page down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1324, "Go To Top Hover"),
            ...
            metadata: {
                description: nls.localize2(1325, 'Go to the top of the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1326, "Go To Bottom Hover"),
            ...
            metadata: {
                description: nls.localize2(1327, 'Go to the bottom of the editor hover.')
            },
        });
    }
    run(accessor, editor) {
