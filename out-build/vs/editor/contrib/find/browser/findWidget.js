...
const findCollapsedIcon = registerIcon('find-collapsed', Codicon.chevronRight, nls.localize(1148, null));
const findExpandedIcon = registerIcon('find-expanded', Codicon.chevronDown, nls.localize(1149, null));
export const findSelectionIcon = registerIcon('find-selection', Codicon.selection, nls.localize(1150, null));
export const findReplaceIcon = registerIcon('find-replace', Codicon.replace, nls.localize(1151, null));
export const findReplaceAllIcon = registerIcon('find-replace-all', Codicon.replaceAll, nls.localize(1152, null));
export const findPreviousMatchIcon = registerIcon('find-previous-match', Codicon.arrowUp, nls.localize(1153, null));
export const findNextMatchIcon = registerIcon('find-next-match', Codicon.arrowDown, nls.localize(1154, null));
const NLS_FIND_DIALOG_LABEL = nls.localize(1155, null);
const NLS_FIND_INPUT_LABEL = nls.localize(1156, null);
const NLS_FIND_INPUT_PLACEHOLDER = nls.localize(1157, null);
const NLS_PREVIOUS_MATCH_BTN_LABEL = nls.localize(1158, null);
const NLS_NEXT_MATCH_BTN_LABEL = nls.localize(1159, null);
const NLS_TOGGLE_SELECTION_FIND_TITLE = nls.localize(1160, null);
const NLS_CLOSE_BTN_LABEL = nls.localize(1161, null);
const NLS_REPLACE_INPUT_LABEL = nls.localize(1162, null);
const NLS_REPLACE_INPUT_PLACEHOLDER = nls.localize(1163, null);
const NLS_REPLACE_BTN_LABEL = nls.localize(1164, null);
const NLS_REPLACE_ALL_BTN_LABEL = nls.localize(1165, null);
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = nls.localize(1166, null);
const NLS_MATCHES_COUNT_LIMIT_TITLE = nls.localize(1167, null, MATCHES_LIMIT);
export const NLS_MATCHES_LOCATION = nls.localize(1168, null);
export const NLS_NO_RESULTS = nls.localize(1169, null);
...
export class FindWidget extends Widget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        ...
        if (label === NLS_NO_RESULTS) {
            result = searchString === ''
                ? nls.localize(1170, null, label)
                : nls.localize(1171, null, label, searchString);
        }
        else if (currentMatch) {
            const ariaLabel = nls.localize(1172, null, label, searchString, currentMatch.startLineNumber + ':' + currentMatch.startColumn);
            ...
            result = nls.localize(1173, null, label, searchString);
        }
        return result;
    }
    /**
    ...
    _updateFindInputAriaLabel() {
        ...
        if (!this._accessibilityHelpHintAnnounced && this._configurationService.getValue('accessibility.verbosity.find') && this._accessibilityService.isScreenReaderOptimized()) {
            ...
            if (accessibilityHelpKeybinding) {
                const hint = nls.localize(1174, null, accessibilityHelpKeybinding);
                findLabel = nls.localize(1175, null, findLabel, hint);
                replaceLabel = nls.localize(1176, null, replaceLabel, hint);
            }
