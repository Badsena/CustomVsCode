    ...
    replaceAll() {
        if (this._model) {
            if (this._editor.getModel()?.isTooLargeForHeapOperation()) {
                this._notificationService.warn(nls.localize(1131, null));
                return false;
            }
...
export class StartFindWithArgsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1140, "Find with Arguments"),
...
export class StartFindWithSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1141, "Find with Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: null,
                primary: 0,
    ...
    if (!runMatch()) {
        ...
        if (!runMatch()) {
            ...
            if (wasFindWidgetVisible && state.matchesCount === 0 && state.searchString) {
                alertFn(nls.localize(1133, null, NLS_NO_RESULTS, state.searchString));
            }
        }
    }
}
export const NextMatchFindAction = registerMultiEditorAction(new MultiEditorAction({
    ...
    label: nls.localize2(1142, "Find Next"),
    precondition: undefined,
    kbOpts: [{
...
export const PreviousMatchFindAction = registerMultiEditorAction(new MultiEditorAction({
    ...
    label: nls.localize2(1143, "Find Previous"),
    precondition: undefined,
    kbOpts: [{
            kbExpr: EditorContextKeys.focus,
...
export class MoveToMatchFindAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1144, "Go to Match..."),
    ...
    run(accessor, editor) {
        ...
        if (matchesCount < 1) {
            ...
            notificationService.notify({
                ...
                message: nls.localize(1134, null)
            });
            return;
        }
        ...
        inputBox.placeholder = nls.localize(1135, null, matchesCount);
        ...
        const updatePickerAndEditor = (value) => {
            ...
            if (typeof index === 'number') {
                ...
                inputBox.validationMessage = nls.localize(1136, null, controller.getState().matchesCount);
        ...
        disposables.add(inputBox.onDidAccept(() => {
            ...
            if (typeof index === 'number') {
                ...
                inputBox.validationMessage = nls.localize(1137, null, controller.getState().matchesCount);
            }
        }));
...
export class NextSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1145, "Find Next Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export class PreviousSelectionMatchFindAction extends SelectionMatchFindAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1146, "Find Previous Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export const StartFindReplaceAction = registerMultiEditorAction(new MultiEditorAction({
    ...
    label: nls.localize2(1147, "Replace"),
    precondition: ContextKeyExpr.or(EditorContextKeys.focus, ContextKeyExpr.has('editorIsOpen')),
    kbOpts: {
        kbExpr: null,
