...
export const ctxHasSymbols = new RawContextKey('hasSymbols', false, localize(1290, null));
...
let SymbolNavigationService = class SymbolNavigationService {
    ...
    _showMessage() {
        ...
        const message = kb
            ? localize(1291, null, this._currentIdx + 1, this._currentModel.references.length, kb.getLabel())
            : localize(1292, null, this._currentIdx + 1, this._currentModel.references.length);
