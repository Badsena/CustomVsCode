...
export const ctxReferenceSearchVisible = new RawContextKey('referenceSearchVisible', false, nls.localize(1273, null));
let ReferencesController = class ReferencesController {
    ...
    toggleWidget(range, modelPromise, peekMode) {
        ...
        this._widget.setTitle(nls.localize(1274, null));
            ...
            return this._widget.setModel(this._model).then(() => {
                if (this._widget && this._model && this._editor.hasModel()) { // might have been closed
                    ...
                    if (!this._model.isEmpty) {
                        this._widget.setMetaTitle(nls.localize(1275, null, this._model.title, this._model.references.length));
                    }
                    else {
