...
export class ToggleStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1654, "Toggle Editor Sticky Scroll"),
                mnemonicTitle: localize(1650, null),
            },
            metadata: {
                description: localize2(1655, "Toggle/enable the editor sticky scroll which shows the nested scopes at the top of the viewport"),
            },
            category: Categories.View,
            toggled: {
                condition: ContextKeyExpr.equals('config.editor.stickyScroll.enabled', true),
                title: localize(1651, null),
                mnemonicTitle: localize(1652, null),
            },
            menu: [
...
export class FocusStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1656, "Focus Editor Sticky Scroll"),
                mnemonicTitle: localize(1653, null),
            },
...
export class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1657, "Select the next editor sticky scroll line"),
...
export class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1658, "Select the previous sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
export class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1659, "Go to the focused sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
export class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1660, "Select Editor"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
