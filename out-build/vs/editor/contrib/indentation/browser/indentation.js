...
export class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1346, "Convert Indentation to Spaces"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1347, "Convert the tab indentation to spaces."),
            }
        });
    }
    run(accessor, editor) {
...
export class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1348, "Convert Indentation to Tabs"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1349, "Convert the spaces indentation to tabs."),
            }
        });
    }
    run(accessor, editor) {
    ...
    run(accessor, editor) {
        ...
        const picks = [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ? nls.localize(1342, null)
                : n === creationOpts.tabSize
                    ? nls.localize(1343, null)
                    : n === modelOpts.tabSize
                        ? nls.localize(1344, null)
                        : undefined)
        }));
        // auto focus the tabSize set for the current editor
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: nls.localize(1345, null), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
export class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: nls.localize2(1350, "Indent Using Tabs"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1351, "Use indentation with tabs."),
            }
        });
    }
}
export class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: nls.localize2(1352, "Indent Using Spaces"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1353, "Use indentation with spaces."),
            }
        });
    }
}
export class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: nls.localize2(1354, "Change Tab Display Size"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1355, "Change the space size equivalent of the tab."),
            }
        });
    }
}
export class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1356, "Detect Indentation from Content"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1357, "Detect the indentation from content."),
            }
        });
    }
    run(accessor, editor) {
...
export class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1358, "Reindent Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1359, "Reindent the lines of the editor."),
            },
...
export class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1360, "Reindent Selected Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1361, "Reindent the selected lines of the editor."),
            },
            canTriggerInlineEdits: true,
        });
    }
