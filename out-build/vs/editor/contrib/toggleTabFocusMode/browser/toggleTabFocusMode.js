...
export class ToggleTabFocusModeAction extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize2(1738, 'Toggle Tab Key Moves Focus'),
            ...
            metadata: {
                description: nls.localize2(1739, "Determines whether the tab key moves focus around the workbench or inserts the tab character in the current editor. This is also called tab trapping, tab navigation, or tab focus mode."),
            },
            f1: true
        });
    }
    run() {
        ...
        if (newValue) {
            alert(nls.localize(1736, null));
        }
        else {
            alert(nls.localize(1737, null));
        }
    }
}
