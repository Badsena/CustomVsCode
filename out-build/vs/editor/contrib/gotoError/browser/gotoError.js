...
export class NextMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = nls.localize2(1215, "Go to Next Problem (Error, Warning, Info)"); }
    constructor() {
        super(true, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-next', Codicon.arrowDown, nls.localize(1211, null)),
                group: 'navigation',
                order: 1
            }
        });
...
export class PrevMarkerAction extends MarkerNavigationAction {
    ...
    static { this.LABEL = nls.localize2(1216, "Go to Previous Problem (Error, Warning, Info)"); }
    constructor() {
        super(false, false, {
            ...
            menuOpts: {
                ...
                icon: registerIcon('marker-navigation-previous', Codicon.arrowUp, nls.localize(1212, null)),
                group: 'navigation',
                order: 2
            }
        });
...
export class NextMarkerInFilesAction extends MarkerNavigationAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: nls.localize2(1217, "Go to Next Problem in Files (Error, Warning, Info)"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export class PrevMarkerInFilesAction extends MarkerNavigationAction {
    ...
    constructor() {
        super(false, true, {
            ...
            label: nls.localize2(1218, "Go to Previous Problem in Files (Error, Warning, Info)"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
