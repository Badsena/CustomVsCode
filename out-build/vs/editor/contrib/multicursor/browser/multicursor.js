...
function announceCursorChange(previousCursorState, cursorState) {
    ...
    if (cursorDiff.length >= 1) {
        ...
        const msg = cursorDiff.length === 1 ? nls.localize(1491, null, cursorPositions) : nls.localize(1492, null, cursorPositions);
        status(msg);
    }
}
export class InsertCursorAbove extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1501, "Add Cursor Above"),
...
export class InsertCursorBelow extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1502, "Add Cursor Below"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertCursorAtEndOfEachLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1503, "Add Cursors to Line Ends"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1504, "Add Cursors to Bottom"),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1505, "Add Cursors to Top"),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
export class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1506, "Add Selection to Next Find Match"),
            precondition: undefined,
            kbOpts: {
...
export class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1507, "Add Selection to Previous Find Match"),
            precondition: undefined,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize(1497, null),
                order: 6
            }
        });
    }
...
export class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1508, "Move Last Selection to Next Find Match"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1509, "Move Last Selection to Previous Find Match"),
            precondition: undefined
        });
    }
    _run(multiCursorController, findController) {
...
export class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1510, "Select All Occurrences of Find Match"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export class CompatChangeAll extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1511, "Change All Occurrences"),
...
export class FocusNextCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1512, "Focus Next Cursor"),
            metadata: {
                description: nls.localize(1499, null),
                args: [],
            },
            precondition: undefined
        });
...
export class FocusPreviousCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1513, "Focus Previous Cursor"),
            metadata: {
                description: nls.localize(1500, null),
                args: [],
            },
            precondition: undefined
        });
