...
/** for debugging */
const _sticky = false;
export const CONTEXT_RENAME_INPUT_VISIBLE = new RawContextKey('renameInputVisible', false, nls.localize(1597, null));
export const CONTEXT_RENAME_INPUT_FOCUSED = new RawContextKey('renameInputFocused', false, nls.localize(1598, null));
let RenameWidget = class RenameWidget {
    ...
    beforeRender() {
        ...
        this._label.innerText = nls.localize(1599, null, this._keybindingService.lookupKeybinding(accept)?.getLabel(), this._keybindingService.lookupKeybinding(preview)?.getLabel());
...
class RenameCandidateListView {
    ...
    setCandidates(candidates) {
        ...
        aria.status(nls.localize(1600, null, candidates.length));
    }
    clearCandidates() {
...
class InputWithButton {
    ...
    get domNode() {
        if (!this._domNode) {
            ...
            this._inputNode.setAttribute('aria-label', nls.localize(1601, null));
            this._domNode.appendChild(this._inputNode);
            this._buttonNode = document.createElement('div');
            this._buttonNode.className = 'rename-suggestions-button';
            this._buttonNode.setAttribute('tabindex', '0');
            this._buttonGenHoverText = nls.localize(1602, null);
            this._buttonCancelHoverText = nls.localize(1603, null);
