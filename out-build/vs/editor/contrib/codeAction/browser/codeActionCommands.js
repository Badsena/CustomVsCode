...
const argsSchema = {
    ...
    properties: {
        'kind': {
            type: 'string',
            description: nls.localize(1019, null),
        },
        'apply': {
            type: 'string',
            description: nls.localize(1020, null),
            ...
            enumDescriptions: [
                nls.localize(1021, null),
                nls.localize(1022, null),
                nls.localize(1023, null),
            ]
        },
        'preferred': {
            type: 'boolean',
            default: false,
            description: nls.localize(1024, null),
        }
    }
};
...
export class QuickFixAction extends EditorAction2 {
    constructor() {
        super({
            ...
            title: nls.localize2(1041, "Quick Fix..."),
    ...
    runEditorCommand(_accessor, editor) {
        return triggerCodeActionsForEditorSelection(editor, nls.localize(1025, null), undefined, undefined, CodeActionTriggerSource.QuickFix);
    }
}
export class CodeActionCommand extends EditorCommand {
    ...
    runEditorCommand(_accessor, editor, userArgs) {
        ...
        return triggerCodeActionsForEditorSelection(editor, typeof userArgs?.kind === 'string'
            ? args.preferred
                ? nls.localize(1026, null, userArgs.kind)
                : nls.localize(1027, null, userArgs.kind)
            : args.preferred
                ? nls.localize(1028, null)
                : nls.localize(1029, null), {
            include: args.kind,
...
export class RefactorAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1042, "Refactor..."),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, EditorContextKeys.hasCodeActionsProvider),
            kbOpts: {
    ...
    run(_accessor, editor, userArgs) {
        ...
        return triggerCodeActionsForEditorSelection(editor, typeof userArgs?.kind === 'string'
            ? args.preferred
                ? nls.localize(1030, null, userArgs.kind)
                : nls.localize(1031, null, userArgs.kind)
            : args.preferred
                ? nls.localize(1032, null)
                : nls.localize(1033, null), {
...
export class SourceAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1043, "Source Action..."),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, EditorContextKeys.hasCodeActionsProvider),
            contextMenuOpts: {
                group: '1_modification',
                order: 2.1,
    ...
    run(_accessor, editor, userArgs) {
        ...
        return triggerCodeActionsForEditorSelection(editor, typeof userArgs?.kind === 'string'
            ? args.preferred
                ? nls.localize(1034, null, userArgs.kind)
                : nls.localize(1035, null, userArgs.kind)
            : args.preferred
                ? nls.localize(1036, null)
                : nls.localize(1037, null), {
...
export class OrganizeImportsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1044, "Organize Imports"),
            ...
            metadata: {
                description: nls.localize2(1045, "Organize imports in the current file. Also called 'Optimize Imports' by some tools")
            }
        });
    }
    run(_accessor, editor) {
        return triggerCodeActionsForEditorSelection(editor, nls.localize(1038, null), { include: CodeActionKind.SourceOrganizeImports, includeSourceActions: true }, "ifSingle" /* CodeActionAutoApply.IfSingle */, CodeActionTriggerSource.OrganizeImports);
    }
}
export class FixAllAction extends EditorAction {
    constructor() {
        super({
            id: fixAllCommandId,
            label: nls.localize2(1046, "Fix All"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, contextKeyForSupportedActions(CodeActionKind.SourceFixAll))
        });
    }
    run(_accessor, editor) {
        return triggerCodeActionsForEditorSelection(editor, nls.localize(1039, null), { include: CodeActionKind.SourceFixAll, includeSourceActions: true }, "ifSingle" /* CodeActionAutoApply.IfSingle */, CodeActionTriggerSource.FixAll);
    }
}
export class AutoFixAction extends EditorAction {
    constructor() {
        super({
            id: autoFixCommandId,
            label: nls.localize2(1047, "Auto Fix..."),
    ...
    run(_accessor, editor) {
        return triggerCodeActionsForEditorSelection(editor, nls.localize(1040, null), {
