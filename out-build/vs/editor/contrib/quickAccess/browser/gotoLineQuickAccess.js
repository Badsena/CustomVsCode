...
export class AbstractGotoLineQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    provideWithoutTextEditor(picker) {
        const label = localize(1539, null);
        picker.items = [{ label }];
    ...
    provideWithTextEditor(context, picker, token) {
        ...
        picker.ariaLabel = localize(1540, null);
        ...
        const updatePickerAndEditor = () => {
            ...
            picker.items = [{
                    ...
                    ariaLabel: lineNumber
                        ? localize(1542, null, lineNumber, column || 1)
                        : label,
                }];
    ...
    parsePosition(editor, value) {
        ...
        if (value.startsWith(':')) {
            ...
            if (isNaN(offset)) {
                ...
                return {
                    ...
                    label: this.useZeroBasedOffset ?
                        localize(1544, null, maxOffset - 1) :
                        localize(1545, null, maxOffset)
                };
            }
            else {
                ...
                return {
                    ...pos,
                    inOffsetMode: true,
                    label: localize(1546, null, pos.lineNumber, visibleColumn)
                };
            }
        }
        else {
            ...
            if (parts.length < 1 || isNaN(lineNumber)) {
                return {
                    label: localize(1547, null, maxLine)
                };
            }
            ...
            if (parts.length < 2 || isNaN(column)) {
                return {
                    ...
                    label: parts.length < 2 ?
                        localize(1548, null, lineNumber) :
                        localize(1549, null, lineNumber, maxColumn)
                };
            }
            ...
            return {
                lineNumber,
                column: realColumn,
                label: localize(1550, null, lineNumber, column)
            };
        }
    }
}
