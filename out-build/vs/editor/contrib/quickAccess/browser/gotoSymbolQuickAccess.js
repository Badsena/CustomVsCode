...
let AbstractGotoSymbolQuickAccessProvider = class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    provideWithoutTextEditor(picker) {
        this.provideLabelPick(picker, localize(1551, null));
    ...
    doProvideWithoutEditorSymbols(context, model, picker, token) {
        ...
        this.provideLabelPick(picker, localize(1552, null));
            ...
            try {
                ...
                if (items.length > 0) {
                    ...
                    if (query.original.length > 0) {
                        this.provideLabelPick(picker, localize(1553, null));
                    }
                    else {
                        this.provideLabelPick(picker, localize(1554, null));
                    }
                }
            }
            finally {
    ...
    async doGetSymbolPicks(symbolsPromise, query, options, token, model) {
        ...
        if (openSideBySideDirection) {
            buttons = [{
                    ...
                    tooltip: openSideBySideDirection === 'right' ? localize(1555, null) : localize(1556, null)
                }];
        }
        ...
        if (filterBySymbolKind) {
            ...
            symbolPicks = [
                { label: localize(1557, null, filteredSymbolPicks.length), type: 'separator' },
...
// #region NLS Helpers
const FALLBACK_NLS_SYMBOL_KIND = localize(1558, null);
const NLS_SYMBOL_KIND_CACHE = {
    [5 /* SymbolKind.Method */]: localize(1559, null),
    [11 /* SymbolKind.Function */]: localize(1560, null),
    [8 /* SymbolKind.Constructor */]: localize(1561, null),
    [12 /* SymbolKind.Variable */]: localize(1562, null),
    [4 /* SymbolKind.Class */]: localize(1563, null),
    [22 /* SymbolKind.Struct */]: localize(1564, null),
    [23 /* SymbolKind.Event */]: localize(1565, null),
    [24 /* SymbolKind.Operator */]: localize(1566, null),
    [10 /* SymbolKind.Interface */]: localize(1567, null),
    [2 /* SymbolKind.Namespace */]: localize(1568, null),
    [3 /* SymbolKind.Package */]: localize(1569, null),
    [25 /* SymbolKind.TypeParameter */]: localize(1570, null),
    [1 /* SymbolKind.Module */]: localize(1571, null),
    [6 /* SymbolKind.Property */]: localize(1572, null),
    [9 /* SymbolKind.Enum */]: localize(1573, null),
    [21 /* SymbolKind.EnumMember */]: localize(1574, null),
    [14 /* SymbolKind.String */]: localize(1575, null),
    [0 /* SymbolKind.File */]: localize(1576, null),
    [17 /* SymbolKind.Array */]: localize(1577, null),
    [15 /* SymbolKind.Number */]: localize(1578, null),
    [16 /* SymbolKind.Boolean */]: localize(1579, null),
    [18 /* SymbolKind.Object */]: localize(1580, null),
    [19 /* SymbolKind.Key */]: localize(1581, null),
    [7 /* SymbolKind.Field */]: localize(1582, null),
    [13 /* SymbolKind.Constant */]: localize(1583, null)
};
//#endregion
