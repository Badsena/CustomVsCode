    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: nls.localize(1766, null),
                message: nls.localize(1767, null),
                detail: nls.localize(1768, null, basename(model.uri)),
                primaryButton: nls.localize(1769, null),
                cancelButton: nls.localize(1770, null)
            });
        }
        finally {
            this._isPresentingDialog = false;
