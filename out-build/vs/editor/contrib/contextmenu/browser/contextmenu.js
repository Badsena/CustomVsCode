...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        actions.push(createEnumAction(nls.localize(1091, null), minimapOptions.enabled, 'editor.minimap.size', minimapOptions.size, [{
                label: nls.localize(1092, null),
                value: 'proportional'
            }, {
                label: nls.localize(1093, null),
                value: 'fill'
            }, {
                label: nls.localize(1094, null),
                value: 'fit'
            }]));
        actions.push(createEnumAction(nls.localize(1095, null), minimapOptions.enabled, 'editor.minimap.showSlider', minimapOptions.showSlider, [{
                label: nls.localize(1096, null),
                value: 'mouseover'
            }, {
                label: nls.localize(1097, null),
                value: 'always'
            }]));
        actions.push(createEnumAction(nls.localize(1098, null), minimapOptions.enabled, 'editor.minimap.side', minimapOptions.side, [{
                label: nls.localize(1099, null),
                value: 'right'
            }, {
                label: nls.localize(1100, null),
                value: 'left'
            }]));
        const useShadowDOM = this._editor.getOption(144 /* EditorOption.useShadowDOM */) && !isIOS; // Do not use shadow dom on IOS #122035
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1101, "Show Editor Context Menu"),
