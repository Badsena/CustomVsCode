...
const $ = dom.$;
const parameterHintsNextIcon = registerIcon('parameter-hints-next', Codicon.chevronDown, nls.localize(1515, null));
const parameterHintsPreviousIcon = registerIcon('parameter-hints-previous', Codicon.chevronUp, nls.localize(1516, null));
    ...
    render(hints) {
        ...
        if (activeParameter) {
            ...
            if (this.announcedLabel !== labelToAnnounce) {
                aria.alert(nls.localize(1517, null, labelToAnnounce));
...
registerColor('editorHoverWidget.highlightForeground', listHighlightForeground, nls.localize(1518, null));
