...
export const Context = {
    ...
    HasFocusedSuggestion: new RawContextKey('suggestWidgetHasFocusedSuggestion', false, localize(1661, null)),
    DetailsVisible: new RawContextKey('suggestWidgetDetailsVisible', false, localize(1662, null)),
    DetailsFocused: new RawContextKey('suggestWidgetDetailsFocused', false, localize(1663, null)),
    MultipleSuggestions: new RawContextKey('suggestWidgetMultipleSuggestions', false, localize(1664, null)),
    MakesTextEdit: new RawContextKey('suggestionMakesTextEdit', true, localize(1665, null)),
    AcceptSuggestionsOnEnter: new RawContextKey('acceptSuggestionOnEnter', true, localize(1666, null)),
    HasInsertAndReplaceRange: new RawContextKey('suggestionHasInsertAndReplaceRange', false, localize(1667, null)),
    InsertMode: new RawContextKey('suggestionInsertMode', undefined, { type: 'string', description: localize(1668, null) }),
    CanResolve: new RawContextKey('suggestionCanResolve', false, localize(1669, null)),
};
