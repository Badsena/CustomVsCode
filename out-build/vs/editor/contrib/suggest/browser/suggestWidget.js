 ...
 */
registerColor('editorSuggestWidget.background', editorWidgetBackground, nls.localize(1681, null));
registerColor('editorSuggestWidget.border', editorWidgetBorder, nls.localize(1682, null));
export const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', editorForeground, nls.localize(1683, null));
registerColor('editorSuggestWidget.selectedForeground', quickInputListFocusForeground, nls.localize(1684, null));
registerColor('editorSuggestWidget.selectedIconForeground', quickInputListFocusIconForeground, nls.localize(1685, null));
export const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', quickInputListFocusBackground, nls.localize(1686, null));
registerColor('editorSuggestWidget.highlightForeground', listHighlightForeground, nls.localize(1687, null));
registerColor('editorSuggestWidget.focusHighlightForeground', listFocusHighlightForeground, nls.localize(1688, null));
registerColor('editorSuggestWidgetStatus.foreground', transparent(editorSuggestWidgetForeground, .5), nls.localize(1689, null));
var State;
(function (State) {
...
let SuggestWidget = class SuggestWidget {
    ...
    static { this.LOADING_MESSAGE = nls.localize(1690, null); }
    static { this.NO_SUGGESTIONS_MESSAGE = nls.localize(1691, null); }
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        this._list = new List('SuggestWidget', this._listElement, {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => nls.localize(1692, null),
                ...
                getAriaLabel: (item) => {
                    ...
                    if (typeof item.completion.label !== 'string') {
                        ...
                        if (detail && description) {
                            label = nls.localize(1693, null, label, detail, description, kindLabel);
                        }
                        else if (detail) {
                            label = nls.localize(1694, null, label, detail, kindLabel);
                        }
                        else if (description) {
                            label = nls.localize(1695, null, label, description, kindLabel);
                        }
                    }
                    else {
                        label = nls.localize(1696, null, label, kindLabel);
                    }
                    ...
                    return nls.localize(1697, null, label, docs);
                },
            }
        });
