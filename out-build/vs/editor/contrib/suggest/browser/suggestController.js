...
let SuggestController = class SuggestController {
    ...
    _alertCompletionItem(item) {
        if (isNonEmptyArray(item.completion.additionalTextEdits)) {
            const msg = nls.localize(1670, null, item.textLabel, item.completion.additionalTextEdits.length);
            alert(msg);
        }
    }
...
export class TriggerSuggestAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1679, "Trigger Suggest"),
...
registerEditorCommand(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            order: 2,
            when: ContextKeyExpr.and(SuggestContext.HasFocusedSuggestion, SuggestContext.HasInsertAndReplaceRange, SuggestContext.InsertMode.isEqualTo('insert')),
            title: nls.localize(1674, null)
        }, {
            menuId: suggestWidgetStatusbarMenu,
            group: 'left',
            order: 2,
            when: ContextKeyExpr.and(SuggestContext.HasFocusedSuggestion, SuggestContext.HasInsertAndReplaceRange, SuggestContext.InsertMode.isEqualTo('replace')),
            title: nls.localize(1675, null)
        }]
}));
...
registerEditorCommand(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            title: nls.localize(1677, null)
        }, {
            menuId: suggestWidgetStatusbarMenu,
            group: 'right',
            order: 1,
            when: ContextKeyExpr.and(SuggestContext.DetailsVisible.toNegated(), SuggestContext.CanResolve),
            title: nls.localize(1678, null)
        }]
}));
registerEditorCommand(new SuggestCommand({
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1680, "Reset Suggest Widget Size"),
