...
const overviewRulerBracketMatchForeground = registerColor('editorOverviewRuler.bracketMatchForeground', '#A0A0A0', nls.localize(992, null));
class JumpToBracketAction extends EditorAction {
    constructor() {
        super({
            id: 'editor.action.jumpToBracket',
            label: nls.localize2(994, "Go to Bracket"),
...
class SelectToBracketAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(995, "Select to Bracket"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(996, "Select the text inside and including the brackets or curly braces"),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
...
class RemoveBracketsAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(997, "Remove Brackets"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
