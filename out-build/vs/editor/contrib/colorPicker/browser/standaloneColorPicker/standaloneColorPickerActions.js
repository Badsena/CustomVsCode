...
export class ShowOrFocusStandaloneColorPicker extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1077, "Show or Focus Standalone Color Picker"),
                mnemonicTitle: localize(1076, null),
            },
            ...
            metadata: {
                description: localize2(1078, "Show or focus a standalone color picker which uses the default color provider. It displays hex/rgb/hsl colors."),
            }
        });
    }
...
export class HideStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1079, "Hide the Color Picker"),
            ...
            metadata: {
                description: localize2(1080, "Hide the standalone color picker."),
            }
        });
    }
...
export class InsertColorWithStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1081, "Insert Color with Standalone Color Picker"),
            ...
            metadata: {
                description: localize2(1082, "Insert hex/rgb/hsl colors with the focused standalone color picker."),
            }
        });
    }
    run(_accessor, editor) {
