...
let SnippetController2 = class SnippetController2 {
    ...
    static { this.InSnippetMode = new RawContextKey('inSnippetMode', false, localize(1608, null)); }
    static { this.HasNextTabstop = new RawContextKey('hasNextTabstop', false, localize(1609, null)); }
    static { this.HasPrevTabstop = new RawContextKey('hasPrevTabstop', false, localize(1610, null)); }
                ...
                provideCompletionItems: (model, position) => {
                    ...
                    for (let i = 0; i < activeChoice.choice.options.length; i++) {
                        ...
                        suggestions.push({
                            ...
                            command: { id: 'jumpToNextSnippetPlaceholder', title: localize(1611, null) }
                        });
                    }
                    return { suggestions };
                }
