...
export class ShowNextInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1381, "Show Next Inline Suggestion"),
...
export class ShowPreviousInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1382, "Show Previous Inline Suggestion"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, InlineCompletionContextKeys.inlineSuggestionVisible),
            kbOpts: {
                weight: 100,
...
export class TriggerInlineSuggestionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1383, "Trigger Inline Suggestion"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize(1370, null),
                args: [{
                        name: 'args',
                        description: nls.localize(1371, null),
                        isOptional: true,
        ...
        if (validatedArgs?.showNoResultNotification) {
            if (!controller?.model.get()?.state.get()) {
                notificationService.notify({
                    ...
                    message: nls.localize(1372, null)
                });
            }
        }
    }
...
export class AcceptNextWordOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1384, "Accept Next Word Of Inline Suggestion"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, InlineCompletionContextKeys.inlineSuggestionVisible),
            kbOpts: {
...
export class AcceptNextLineOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1385, "Accept Next Line Of Inline Suggestion"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, InlineCompletionContextKeys.inlineSuggestionVisible),
            kbOpts: {
                weight: 100 /* KeybindingWeight.EditorContrib */ + 1,
            },
...
export class AcceptInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1386, "Accept Inline Suggestion"),
            ...
            menuOpts: [{
                    menuId: MenuId.InlineSuggestionToolbar,
                    title: nls.localize(1375, null),
                    group: 'primary',
                    order: 2,
                }, {
                    menuId: MenuId.InlineEditsActions,
                    title: nls.localize(1376, null),
                    group: 'primary',
                    order: 2,
                }],
            kbOpts: [
...
export class AcceptInlineCompletionAlternativeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1387, "Accept Inline Suggestion Alternative Action"),
...
export class JumpToNextInlineEdit extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1388, "Jump to next inline edit"),
            precondition: InlineCompletionContextKeys.inlineEditVisible,
            menuOpts: [{
                    menuId: MenuId.InlineEditsActions,
                    title: nls.localize(1377, null),
                    group: 'primary',
                    order: 1,
...
export class HideInlineCompletion extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1389, "Hide Inline Suggestion"),
            precondition: ContextKeyExpr.or(InlineCompletionContextKeys.inlineSuggestionVisible, InlineCompletionContextKeys.inlineEditVisible),
            kbOpts: {
...
export class ToggleInlineCompletionShowCollapsed extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1390, "Toggle Inline Suggestions Show Collapsed"),
