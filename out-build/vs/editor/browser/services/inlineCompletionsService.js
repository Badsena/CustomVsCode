...
const InlineCompletionsSnoozing = new RawContextKey('inlineCompletions.snoozed', false, localize(210, null));
...
export class SnoozeInlineCompletion extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(212, "Snooze Inline Suggestions"),
...
export class CancelSnoozeInlineCompletion extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(213, "Cancel Snooze Inline Suggestions"),
