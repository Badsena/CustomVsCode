...
export const UndoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_do',
            title: nls.localize(200, null),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(201, null),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize(202, null),
            order: 1
        }]
}));
...
export const RedoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            menuId: MenuId.MenubarEditMenu,
            group: '1_do',
            title: nls.localize(203, null),
            order: 2
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(204, null),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize(205, null),
            order: 2
        }]
}));
...
export const SelectAllCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_basic',
            title: nls.localize(206, null),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(207, null),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '9_select',
            title: nls.localize(208, null),
            order: 1
        }]
}));
