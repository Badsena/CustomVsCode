...
export class ToggleCollapseUnchangedRegions extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(216, 'Toggle Collapse Unchanged Regions'),
            icon: Codicon.map,
...
export class ToggleShowMovedCodeBlocks extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(217, 'Toggle Show Moved Code Blocks'),
            precondition: ContextKeyExpr.has('isInDiffEditor'),
        });
    }
    run(accessor, ...args) {
...
export class ToggleUseInlineViewWhenSpaceIsLimited extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(218, 'Toggle Use Inline View When Space Is Limited'),
            precondition: ContextKeyExpr.has('isInDiffEditor'),
        });
    }
    run(accessor, ...args) {
...
const diffEditorCategory = localize2(219, "Diff Editor");
export class SwitchSide extends EditorAction2 {
    constructor() {
        super({
            id: 'diffEditor.switchSide',
            title: localize2(220, 'Switch Side'),
...
export class ExitCompareMove extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(221, 'Exit Compare Move'),
            icon: Codicon.close,
...
export class CollapseAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(222, 'Collapse All Unchanged Regions'),
            icon: Codicon.fold,
            precondition: ContextKeyExpr.has('isInDiffEditor'),
            f1: true,
            category: diffEditorCategory,
...
export class ShowAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(223, 'Show All Unchanged Regions'),
            icon: Codicon.unfold,
            precondition: ContextKeyExpr.has('isInDiffEditor'),
            f1: true,
            category: diffEditorCategory,
...
export class AccessibleDiffViewerPrev extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(227, 'Go to Previous Difference'),
            category: accessibleDiffViewerCategory,
            precondition: ContextKeyExpr.has('isInDiffEditor'),
            keybinding: {
