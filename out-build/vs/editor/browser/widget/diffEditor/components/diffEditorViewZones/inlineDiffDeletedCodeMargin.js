            ...
            this._contextMenuService.showContextMenu({
                ...
                getActions: () => {
                    ...
                    actions.push(new Action('diff.clipboard.copyDeletedContent', isDeletion
                        ...
                        : (_diff.original.length > 1
                            ? localize(245, null)
                            : localize(246, null)), undefined, true, async () => {
                    ...
                    if (_diff.original.length > 1) {
                        actions.push(new Action('diff.clipboard.copyDeletedLineContent', isDeletion
                            ? localize(247, null, _diff.original.startLineNumber + currentLineNumberOffset)
                            : localize(248, null, _diff.original.startLineNumber + currentLineNumberOffset), undefined, true, async () => {
                    ...
                    if (!readOnly) {
                        actions.push(new Action('diff.inline.revertChange', localize(249, null), undefined, true, async () => {
