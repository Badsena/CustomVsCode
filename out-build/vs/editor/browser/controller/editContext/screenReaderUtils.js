...
export function ariaLabelForScreenReaderContent(options, keybindingService) {
    ...
    if (accessibilitySupport === 1 /* AccessibilitySupport.Disabled */) {
        ...
        const editorNotAccessibleMessage = nls.localize(192, null);
        if (toggleKeybindingLabel) {
            return nls.localize(193, null, editorNotAccessibleMessage, toggleKeybindingLabel);
        }
        else if (runCommandKeybindingLabel) {
            return nls.localize(194, null, editorNotAccessibleMessage, runCommandKeybindingLabel);
        }
        else if (keybindingEditorKeybindingLabel) {
            return nls.localize(195, null, editorNotAccessibleMessage, keybindingEditorKeybindingLabel);
        }
        else {
            // SOS
