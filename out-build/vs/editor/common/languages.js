...
(function (CompletionItemKinds) {
    ...
    function toLabel(kind) {
        switch (kind) {
            case 0 /* CompletionItemKind.Method */: return localize(876, null);
            case 1 /* CompletionItemKind.Function */: return localize(877, null);
            case 2 /* CompletionItemKind.Constructor */: return localize(878, null);
            case 3 /* CompletionItemKind.Field */: return localize(879, null);
            case 4 /* CompletionItemKind.Variable */: return localize(880, null);
            case 5 /* CompletionItemKind.Class */: return localize(881, null);
            case 6 /* CompletionItemKind.Struct */: return localize(882, null);
            case 7 /* CompletionItemKind.Interface */: return localize(883, null);
            case 8 /* CompletionItemKind.Module */: return localize(884, null);
            case 9 /* CompletionItemKind.Property */: return localize(885, null);
            case 10 /* CompletionItemKind.Event */: return localize(886, null);
            case 11 /* CompletionItemKind.Operator */: return localize(887, null);
            case 12 /* CompletionItemKind.Unit */: return localize(888, null);
            case 13 /* CompletionItemKind.Value */: return localize(889, null);
            case 14 /* CompletionItemKind.Constant */: return localize(890, null);
            case 15 /* CompletionItemKind.Enum */: return localize(891, null);
            case 16 /* CompletionItemKind.EnumMember */: return localize(892, null);
            case 17 /* CompletionItemKind.Keyword */: return localize(893, null);
            case 18 /* CompletionItemKind.Text */: return localize(894, null);
            case 19 /* CompletionItemKind.Color */: return localize(895, null);
            case 20 /* CompletionItemKind.File */: return localize(896, null);
            case 21 /* CompletionItemKind.Reference */: return localize(897, null);
            case 22 /* CompletionItemKind.Customcolor */: return localize(898, null);
            case 23 /* CompletionItemKind.Folder */: return localize(899, null);
            case 24 /* CompletionItemKind.TypeParameter */: return localize(900, null);
            case 25 /* CompletionItemKind.User */: return localize(901, null);
            case 26 /* CompletionItemKind.Issue */: return localize(902, null);
            case 27 /* CompletionItemKind.Tool */: return localize(903, null);
            case 28 /* CompletionItemKind.Snippet */: return localize(904, null);
            default: return '';
        }
    }
...
export const symbolKindNames = {
    [17 /* SymbolKind.Array */]: localize(905, null),
    [16 /* SymbolKind.Boolean */]: localize(906, null),
    [4 /* SymbolKind.Class */]: localize(907, null),
    [13 /* SymbolKind.Constant */]: localize(908, null),
    [8 /* SymbolKind.Constructor */]: localize(909, null),
    [9 /* SymbolKind.Enum */]: localize(910, null),
    [21 /* SymbolKind.EnumMember */]: localize(911, null),
    [23 /* SymbolKind.Event */]: localize(912, null),
    [7 /* SymbolKind.Field */]: localize(913, null),
    [0 /* SymbolKind.File */]: localize(914, null),
    [11 /* SymbolKind.Function */]: localize(915, null),
    [10 /* SymbolKind.Interface */]: localize(916, null),
    [19 /* SymbolKind.Key */]: localize(917, null),
    [5 /* SymbolKind.Method */]: localize(918, null),
    [1 /* SymbolKind.Module */]: localize(919, null),
    [2 /* SymbolKind.Namespace */]: localize(920, null),
    [20 /* SymbolKind.Null */]: localize(921, null),
    [15 /* SymbolKind.Number */]: localize(922, null),
    [18 /* SymbolKind.Object */]: localize(923, null),
    [24 /* SymbolKind.Operator */]: localize(924, null),
    [3 /* SymbolKind.Package */]: localize(925, null),
    [6 /* SymbolKind.Property */]: localize(926, null),
    [14 /* SymbolKind.String */]: localize(927, null),
    [22 /* SymbolKind.Struct */]: localize(928, null),
    [25 /* SymbolKind.TypeParameter */]: localize(929, null),
    [12 /* SymbolKind.Variable */]: localize(930, null),
};
/**
 * @internal
 */
export function getAriaLabelForSymbol(symbolName, kind) {
    return localize(931, null, symbolName, symbolKindNames[kind]);
}
