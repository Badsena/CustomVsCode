...
const editorConfiguration = {
    ...
    properties: {
        'editor.tabSize': {
            ...
            minimum: 1,
            maximum: 100,
            markdownDescription: nls.localize(279, null, '`#editor.detectIndentation#`')
        },
        'editor.indentSize': {
            'anyOf': [
                {
        ...
        'editor.insertSpaces': {
            ...
            markdownDescription: nls.localize(281, null, '`#editor.detectIndentation#`')
        },
        'editor.detectIndentation': {
            type: 'boolean',
            default: EDITOR_MODEL_DEFAULTS.detectIndentation,
            markdownDescription: nls.localize(282, null, '`#editor.tabSize#`', '`#editor.insertSpaces#`')
        },
        'editor.trimAutoWhitespace': {
            type: 'boolean',
            default: EDITOR_MODEL_DEFAULTS.trimAutoWhitespace,
            description: nls.localize(283, null)
        },
        'editor.largeFileOptimizations': {
            type: 'boolean',
            default: EDITOR_MODEL_DEFAULTS.largeFileOptimizations,
            description: nls.localize(284, null)
        },
        'editor.wordBasedSuggestions': {
            enum: ['off', 'offWithInlineSuggestions', 'currentDocument', 'matchingDocuments', 'allDocuments'],
            default: 'offWithInlineSuggestions',
            enumDescriptions: [
                nls.localize(285, null),
                nls.localize(286, null),
                nls.localize(287, null),
                nls.localize(288, null),
                nls.localize(289, null),
            ],
        ...
        'editor.experimental.treeSitterTelemetry': {
            type: 'boolean',
            default: false,
            markdownDescription: nls.localize(300, null),
            tags: ['experimental'],
            experiment: {
                mode: 'auto'
            }
        ...
        'editor.experimental.preferTreeSitter.css': {
            type: 'boolean',
            default: false,
            markdownDescription: nls.localize(301, null),
            tags: ['experimental'],
            experiment: {
                mode: 'auto'
            }
        ...
        'editor.experimental.preferTreeSitter.typescript': {
            type: 'boolean',
            default: false,
            markdownDescription: nls.localize(302, null),
            tags: ['experimental'],
            experiment: {
                mode: 'auto'
            }
        ...
        'editor.experimental.preferTreeSitter.regex': {
            type: 'boolean',
            default: false,
            markdownDescription: nls.localize(304, null),
            tags: ['experimental'],
            experiment: {
                mode: 'auto'
            }
        ...
        'editor.language.brackets': {
            ...
            description: nls.localize(305, null),
            items: {
                type: 'array',
                items: [
                    {
                        type: 'string',
                        description: nls.localize(306, null)
                    },
                    {
                        type: 'string',
        ...
        'editor.language.colorizedBracketPairs': {
            ...
            items: {
                ...
                items: [
                    {
                        type: 'string',
                        description: nls.localize(309, null)
                    },
                    {
                        type: 'string',
                        description: nls.localize(310, null)
                    }
                ]
            }
        },
        'diffEditor.maxComputationTime': {
            ...
            description: nls.localize(311, null)
        },
        'diffEditor.maxFileSize': {
            type: 'number',
            default: diffEditorDefaultOptions.maxFileSize,
            description: nls.localize(312, null)
        },
        ...
        'diffEditor.renderMarginRevertIcon': {
            ...
            description: nls.localize(316, null)
        },
        'diffEditor.renderGutterMenu': {
            type: 'boolean',
            default: diffEditorDefaultOptions.renderGutterMenu,
            description: nls.localize(317, null)
        },
        ...
        'diffEditor.wordWrap': {
            ...
            markdownEnumDescriptions: [
                ...
                nls.localize(323, null, '`#editor.wordWrap#`'),
            ]
        },
