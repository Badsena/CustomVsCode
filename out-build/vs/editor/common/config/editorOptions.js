    ...
    constructor() {
        ...
        super(29 /* EditorOption.comments */, 'comments', defaults, {
            ...
            'editor.comments.ignoreEmptyLines': {
                ...
                description: nls.localize(338, null)
            },
        });
    }
    validate(_input) {
...
class EditorEmptySelectionClipboard extends EditorBooleanOption {
    constructor() {
        super(45 /* EditorOption.emptySelectionClipboard */, 'emptySelectionClipboard', true, { description: nls.localize(339, null) });
    }
    compute(env, options, value) {
        ...
        super(50 /* EditorOption.find */, 'find', defaults, {
            ...
            'editor.find.autoFindInSelection': {
                ...
                enumDescriptions: [
                    ...
                    nls.localize(346, null),
                    nls.localize(347, null)
                ],
                description: nls.localize(348, null)
            },
            ...
            'editor.find.loop': {
                ...
                description: nls.localize(351, null)
            },
            'editor.find.closeOnResult': {
                type: 'boolean',
                default: defaults.closeOnResult,
                description: nls.localize(352, null)
            },
            'editor.find.history': {
                type: 'string',
...
export class EditorFontVariations extends BaseEditorOption {
    ...
    constructor() {
        super(63 /* EditorOption.fontVariations */, 'fontVariations', EditorFontVariations.OFF, {
            ...
            description: nls.localize(365, null),
            default: false
        });
    }
    validate(input) {
...
class EditorFontSize extends SimpleEditorOption {
    constructor() {
        super(61 /* EditorOption.fontSize */, 'fontSize', EDITOR_FONT_DEFAULTS.fontSize, {
            ...
            description: nls.localize(366, null)
        });
    }
    validate(input) {
            ...
            anyOf: [
                {
                    ...
                    errorMessage: nls.localize(367, null)
                },
                {
                    type: 'string',
...
class EditorGoToLocation extends BaseEditorOption {
    constructor() {
        ...
        const jsonSubset = {
            ...
            enumDescriptions: [
                nls.localize(369, null),
                nls.localize(370, null),
                nls.localize(371, null)
            ]
        };
        ...
        super(67 /* EditorOption.gotoLocation */, 'gotoLocation', defaults, {
            'editor.gotoLocation.multiple': {
                deprecationMessage: nls.localize(372, null),
            },
            'editor.gotoLocation.multipleDefinitions': {
                description: nls.localize(373, null),
                ...jsonSubset,
            },
            ...
            'editor.gotoLocation.multipleDeclarations': {
                description: nls.localize(375, null),
                ...jsonSubset,
            },
            'editor.gotoLocation.multipleImplementations': {
                description: nls.localize(376, null),
                ...jsonSubset,
            },
            'editor.gotoLocation.multipleReferences': {
                description: nls.localize(377, null),
                ...jsonSubset,
            },
        ...
        super(69 /* EditorOption.hover */, 'hover', defaults, {
            'editor.hover.enabled': {
                ...
                markdownEnumDescriptions: [
                    nls.localize(383, null),
                    nls.localize(384, null),
                    nls.localize(385, null, platform.isMacintosh ? `Command` : `Control`)
                ],
                description: nls.localize(386, null)
            },
            'editor.hover.delay': {
                type: 'number',
                ...
                minimum: 0,
                maximum: 10000,
                description: nls.localize(387, null)
            },
            'editor.hover.sticky': {
                type: 'boolean',
                default: defaults.sticky,
                description: nls.localize(388, null)
            },
            'editor.hover.hidingDelay': {
                type: 'integer',
                minimum: 0,
                default: defaults.hidingDelay,
                markdownDescription: nls.localize(389, null)
            },
            'editor.hover.above': {
                type: 'boolean',
            ...
            'editor.hover.showLongLineWarning': {
                ...
                description: nls.localize(391, null)
            },
        });
    }
    validate(_input) {
    ...
    constructor() {
        super(156 /* EditorOption.wrappingStrategy */, 'wrappingStrategy', 'simple', {
            'editor.wrappingStrategy': {
                enumDescriptions: [
                    nls.localize(392, null),
                    nls.localize(393, null)
                ],
                type: 'string',
                enum: ['simple', 'advanced'],
                default: 'simple',
                description: nls.localize(394, null)
            }
        });
    }
    validate(input) {
        ...
        super(73 /* EditorOption.lightbulb */, 'lightbulb', defaults, {
            'editor.lightbulb.enabled': {
                ...
                enumDescriptions: [
                    ...
                    nls.localize(397, null),
                ],
                description: nls.localize(398, null)
            }
        });
    }
    validate(_input) {
    ...
    constructor() {
        ...
        super(131 /* EditorOption.stickyScroll */, 'stickyScroll', defaults, {
            'editor.stickyScroll.enabled': {
                type: 'boolean',
                default: defaults.enabled,
                description: nls.localize(399, null)
            },
            'editor.stickyScroll.maxLineCount': {
                ...
                minimum: 1,
                maximum: 20,
                description: nls.localize(400, null)
            },
    ...
    constructor() {
        ...
        super(159 /* EditorOption.inlayHints */, 'inlayHints', defaults, {
            'editor.inlayHints.enabled': {
                ...
                markdownEnumDescriptions: [
                    nls.localize(404, null),
                    nls.localize(405, null, platform.isMacintosh ? `Ctrl+Option` : `Ctrl+Alt`),
                    nls.localize(406, null, platform.isMacintosh ? `Ctrl+Option` : `Ctrl+Alt`),
                    nls.localize(407, null),
                ],
            },
            'editor.inlayHints.fontSize': {
                type: 'number',
                default: defaults.fontSize,
                markdownDescription: nls.localize(408, null, '`#editor.fontSize#`', '`5`')
            },
            'editor.inlayHints.fontFamily': {
                type: 'string',
                default: defaults.fontFamily,
                markdownDescription: nls.localize(409, null, '`#editor.fontFamily#`')
            },
            ...
            'editor.inlayHints.maximumLength': {
                ...
                markdownDescription: nls.localize(411, null)
            }
        });
    }
    validate(_input) {
...
class EditorLineHeight extends EditorFloatOption {
    constructor() {
        super(75 /* EditorOption.lineHeight */, 'lineHeight', EDITOR_FONT_DEFAULTS.lineHeight, x => EditorFloatOption.clamp(x, 0, 150), { markdownDescription: nls.localize(412, null) }, 0, 150);
    }
    compute(env, options, value) {
    ...
    constructor() {
        ...
        super(81 /* EditorOption.minimap */, 'minimap', defaults, {
            ...
            'editor.minimap.autohide': {
                ...
                enumDescriptions: [
                    nls.localize(414, null),
                    nls.localize(415, null),
                    nls.localize(416, null),
                ],
                default: defaults.autohide,
                description: nls.localize(417, null)
            },
            'editor.minimap.size': {
                type: 'string',
                enum: ['proportional', 'fill', 'fit'],
                enumDescriptions: [
                    nls.localize(418, null),
                    nls.localize(419, null),
                    nls.localize(420, null),
                ],
            ...
            'editor.minimap.side': {
                ...
                description: nls.localize(422, null)
            },
            'editor.minimap.showSlider': {
                type: 'string',
                enum: ['always', 'mouseover'],
                default: defaults.showSlider,
                description: nls.localize(423, null)
            },
            'editor.minimap.scale': {
                ...
                maximum: 3,
                enum: [1, 2, 3],
                description: nls.localize(424, null)
            },
            'editor.minimap.renderCharacters': {
                type: 'boolean',
                default: defaults.renderCharacters,
                description: nls.localize(425, null)
            },
            'editor.minimap.maxColumn': {
                type: 'number',
                default: defaults.maxColumn,
                description: nls.localize(426, null)
            },
            ...
            'editor.minimap.showMarkSectionHeaders': {
                ...
                description: nls.localize(428, null)
            },
            ...
            'editor.minimap.sectionHeaderLetterSpacing': {
                ...
                description: nls.localize(431, null)
            }
        });
    }
    validate(_input) {
    ...
    constructor() {
        super(96 /* EditorOption.padding */, 'padding', { top: 0, bottom: 0 }, {
            'editor.padding.top': {
                ...
                minimum: 0,
                maximum: 1000,
                description: nls.localize(432, null)
            },
            'editor.padding.bottom': {
                ...
                minimum: 0,
                maximum: 1000,
                description: nls.localize(433, null)
            }
        });
    }
    validate(_input) {
    ...
    constructor() {
        ...
        super(98 /* EditorOption.parameterHints */, 'parameterHints', defaults, {
            ...
            'editor.parameterHints.cycle': {
                ...
                description: nls.localize(435, null)
            },
        });
    }
    validate(_input) {
    ...
    constructor() {
        ...
        const types = [
            { type: 'boolean' },
            {
                ...
                enumDescriptions: [nls.localize(436, null), nls.localize(437, null), nls.localize(438, null), nls.localize(439, null)]
            }
        ];
        super(102 /* EditorOption.quickSuggestions */, 'quickSuggestions', defaults, {
            anyOf: [
                { type: 'boolean' },
                {
                    type: 'string',
                    enum: ['on', 'inline', 'off', 'offWhenInlineCompletions'],
                    enumDescriptions: [nls.localize(440, null), nls.localize(441, null), nls.localize(442, null), nls.localize(443, null)]
                },
                {
                    type: 'object',
            ...
            default: defaults,
            markdownDescription: nls.localize(447, null, '`#editor.suggestOnTriggerCharacters#`'),
            experiment: {
                mode: 'auto'
            }
        });
...
class EditorRenderLineNumbersOption extends BaseEditorOption {
    constructor() {
        super(76 /* EditorOption.lineNumbers */, 'lineNumbers', { renderType: 1 /* RenderLineNumbersType.On */, renderFn: null }, {
            ...
            enumDescriptions: [
                nls.localize(448, null),
                nls.localize(449, null),
                nls.localize(450, null),
                nls.localize(451, null)
            ],
            default: 'on',
            description: nls.localize(452, null)
        });
    }
...
class EditorRulers extends BaseEditorOption {
    constructor() {
        const defaults = [];
        const columnSchema = { type: 'number', description: nls.localize(453, null) };
    ...
    constructor() {
        ...
        super(117 /* EditorOption.scrollbar */, 'scrollbar', defaults, {
            'editor.scrollbar.vertical': {
                ...
                enumDescriptions: [
                    nls.localize(456, null),
                    nls.localize(457, null),
                    nls.localize(458, null),
                ],
                default: 'auto',
            ...
            'editor.scrollbar.horizontal': {
                ...
                enum: ['auto', 'visible', 'hidden'],
                enumDescriptions: [
                    nls.localize(460, null),
                    nls.localize(461, null),
                    nls.localize(462, null),
                ],
                default: 'auto',
            ...
            'editor.scrollbar.ignoreHorizontalScrollbarInContentHeight': {
                ...
                description: nls.localize(467, null)
            }
        });
    }
    validate(_input) {
    ...
    constructor() {
        ...
        super(142 /* EditorOption.unicodeHighlighting */, 'unicodeHighlight', defaults, {
            [unicodeHighlightConfigKeys.nonBasicASCII]: {
                ...
                description: nls.localize(468, null)
            },
            ...
            [unicodeHighlightConfigKeys.ambiguousCharacters]: {
                ...
                description: nls.localize(470, null)
            },
            ...
            [unicodeHighlightConfigKeys.includeStrings]: {
                ...
                description: nls.localize(472, null)
            },
            [unicodeHighlightConfigKeys.allowedCharacters]: {
                restricted: true,
                type: 'object',
                default: defaults.allowedCharacters,
                description: nls.localize(473, null),
            ...
            [unicodeHighlightConfigKeys.allowedLocales]: {
                ...
                description: nls.localize(474, null)
            },
        });
    }
    applyUpdate(value, update) {
    ...
    constructor() {
        ...
        super(71 /* EditorOption.inlineSuggest */, 'inlineSuggest', defaults, {
            ...
            'editor.inlineSuggest.suppressInSnippetMode': {
                ...
                description: nls.localize(482, null),
            },
            'editor.inlineSuggest.minShowDelay': {
                ...
                minimum: 0,
                maximum: 10000,
                description: nls.localize(483, null),
            },
            'editor.inlineSuggest.experimental.suppressInlineSuggestions': {
                type: 'string',
                default: defaults.experimental.suppressInlineSuggestions,
                tags: ['experimental'],
                description: nls.localize(484, null),
                experiment: {
                    mode: 'auto'
                }
            },
            ...
            'editor.inlineSuggest.triggerCommandOnProviderChange': {
                ...
                tags: ['experimental'],
                description: nls.localize(486, null),
                experiment: {
                    mode: 'auto'
                }
            },
            'editor.inlineSuggest.experimental.showOnSuggestConflict': {
                ...
                description: nls.localize(487, null),
                experiment: {
                    mode: 'auto'
                }
            },
            ...
            'editor.inlineSuggest.edits.renderSideBySide': {
                ...
                description: nls.localize(491, null),
                enum: ['auto', 'never'],
                enumDescriptions: [
            ...
            'editor.inlineSuggest.edits.showCollapsed': {
                ...
                description: nls.localize(494, null),
                tags: ['nextEditSuggestions']
            },
        });
    }
    ...
    constructor() {
        ...
        super(21 /* EditorOption.bracketPairColorization */, 'bracketPairColorization', defaults, {
            'editor.bracketPairColorization.enabled': {
                type: 'boolean',
                default: defaults.enabled,
                markdownDescription: nls.localize(495, null, '`#workbench.colorCustomizations#`')
            },
            'editor.bracketPairColorization.independentColorPoolPerBracketType': {
                type: 'boolean',
                default: defaults.independentColorPoolPerBracketType,
                description: nls.localize(496, null)
            },
        });
    }
    validate(_input) {
    ...
    constructor() {
        ...
        super(22 /* EditorOption.guides */, 'guides', defaults, {
            'editor.guides.bracketPairs': {
                ...
                enumDescriptions: [
                    nls.localize(497, null),
                    nls.localize(498, null),
                    nls.localize(499, null),
                ],
            ...
            'editor.guides.bracketPairsHorizontal': {
                ...
                enum: [true, 'active', false],
                enumDescriptions: [
                    nls.localize(501, null),
                    nls.localize(502, null),
                    nls.localize(503, null),
                ],
                default: defaults.bracketPairsHorizontal,
                description: nls.localize(504, null)
            },
            'editor.guides.highlightActiveBracketPair': {
                type: 'boolean',
                default: defaults.highlightActiveBracketPair,
                description: nls.localize(505, null)
            },
            'editor.guides.indentation': {
                type: 'boolean',
                default: defaults.indentation,
                description: nls.localize(506, null)
            },
            'editor.guides.highlightActiveIndentation': {
                type: ['boolean', 'string'],
                enum: [true, 'always', false],
                enumDescriptions: [
                    nls.localize(507, null),
                    nls.localize(508, null),
                    nls.localize(509, null),
                ],
                default: defaults.highlightActiveIndentation,
                description: nls.localize(510, null)
            }
        });
    }
    validate(_input) {
    ...
    constructor() {
        ...
        super(134 /* EditorOption.suggest */, 'suggest', defaults, {
            'editor.suggest.insertMode': {
                ...
                enum: ['insert', 'replace'],
                enumDescriptions: [
                    nls.localize(511, null),
                    nls.localize(512, null),
                ],
                default: defaults.insertMode,
                description: nls.localize(513, null)
            },
            'editor.suggest.filterGraceful': {
                type: 'boolean',
                default: defaults.filterGraceful,
                description: nls.localize(514, null)
            },
            'editor.suggest.localityBonus': {
                type: 'boolean',
                default: defaults.localityBonus,
                description: nls.localize(515, null)
            },
            ...
            'editor.suggest.selectionMode': {
                ...
                enumDescriptions: [
                    nls.localize(517, null),
                    nls.localize(518, null),
                    nls.localize(519, null),
                    nls.localize(520, null),
                ],
                default: defaults.selectionMode,
                markdownDescription: nls.localize(521, null, '`#editor.quickSuggestions#`', '`#editor.suggestOnTriggerCharacters#`')
            },
            'editor.suggest.snippetsPreventQuickSuggestions': {
                type: 'boolean',
                default: defaults.snippetsPreventQuickSuggestions,
                description: nls.localize(522, null)
            },
            'editor.suggest.showIcons': {
                type: 'boolean',
                default: defaults.showIcons,
                description: nls.localize(523, null)
            },
            'editor.suggest.showStatusBar': {
                type: 'boolean',
                default: defaults.showStatusBar,
                description: nls.localize(524, null)
            },
            'editor.suggest.preview': {
                type: 'boolean',
                default: defaults.preview,
                description: nls.localize(525, null)
            },
            'editor.suggest.showInlineDetails': {
                type: 'boolean',
                default: defaults.showInlineDetails,
                description: nls.localize(526, null)
            },
            'editor.suggest.maxVisibleSuggestions': {
                type: 'number',
                deprecationMessage: nls.localize(527, null),
            },
            'editor.suggest.filteredTypes': {
                type: 'object',
                deprecationMessage: nls.localize(528, null)
            },
            ...
            'editor.suggest.showFields': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(534, null)
            },
            'editor.suggest.showVariables': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(535, null)
            },
            'editor.suggest.showClasses': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(536, null)
            },
            'editor.suggest.showStructs': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(537, null)
            },
            'editor.suggest.showInterfaces': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(538, null)
            },
            'editor.suggest.showModules': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(539, null)
            },
            'editor.suggest.showProperties': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(540, null)
            },
            'editor.suggest.showEvents': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(541, null)
            },
            ...
            'editor.suggest.showValues': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(544, null)
            },
            'editor.suggest.showConstants': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(545, null)
            },
            ...
            'editor.suggest.showKeywords': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(548, null)
            },
            'editor.suggest.showWords': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(549, null)
            },
            'editor.suggest.showColors': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(550, null)
            },
            'editor.suggest.showFiles': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(551, null)
            },
            ...
            'editor.suggest.showCustomcolors': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(553, null)
            },
            'editor.suggest.showFolders': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(554, null)
            },
            'editor.suggest.showTypeParameters': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(555, null)
            },
            'editor.suggest.showSnippets': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(556, null)
            },
            'editor.suggest.showUsers': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(557, null)
            },
            'editor.suggest.showIssues': {
                type: 'boolean',
                default: true,
                markdownDescription: nls.localize(558, null)
            }
        });
    }
    validate(_input) {
    ...
    constructor() {
        super(129 /* EditorOption.smartSelect */, 'smartSelect', {
            ...
            'editor.smartSelect.selectLeadingAndTrailingWhitespace': {
                description: nls.localize(559, null),
                default: true,
                type: 'boolean'
            },
            'editor.smartSelect.selectSubwords': {
                description: nls.localize(560, null),
                default: true,
                type: 'boolean'
            }
        });
    ...
    constructor() {
        ...
        super(43 /* EditorOption.dropIntoEditor */, 'dropIntoEditor', defaults, {
            'editor.dropIntoEditor.enabled': {
                type: 'boolean',
                default: defaults.enabled,
                markdownDescription: nls.localize(567, null),
            },
            'editor.dropIntoEditor.showDropSelector': {
                type: 'string',
                markdownDescription: nls.localize(568, null),
                enum: [
                    'afterDrop',
                    'never'
                ],
    ...
    constructor() {
        ...
        super(97 /* EditorOption.pasteAs */, 'pasteAs', defaults, {
            'editor.pasteAs.enabled': {
                type: 'boolean',
                default: defaults.enabled,
                markdownDescription: nls.localize(571, null),
            },
            'editor.pasteAs.showPasteSelector': {
                type: 'string',
                markdownDescription: nls.localize(572, null),
                enum: [
                    'afterPaste',
                    'never'
                ],
...
export const EditorOptions = {
    acceptSuggestionOnCommitCharacter: register(new EditorBooleanOption(0 /* EditorOption.acceptSuggestionOnCommitCharacter */, 'acceptSuggestionOnCommitCharacter', true, { markdownDescription: nls.localize(575, null) })),
    acceptSuggestionOnEnter: register(new EditorStringEnumOption(1 /* EditorOption.acceptSuggestionOnEnter */, 'acceptSuggestionOnEnter', 'on', ['on', 'smart', 'off'], {
        ...
        markdownDescription: nls.localize(577, null)
    })),
    ...
    accessibilityPageSize: register(new EditorIntOption(3 /* EditorOption.accessibilityPageSize */, 'accessibilityPageSize', 500, 1, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */, {
        description: nls.localize(578, null),
        tags: ['accessibility']
    })),
    ...
    allowVariableFontsInAccessibilityMode: register(new EditorBooleanOption(7 /* EditorOption.allowVariableFontsInAccessibilityMode */, 'allowVariableFontsInAccessibilityMode', false, {
        description: nls.localize(581, null),
        tags: ['accessibility']
    })),
    ariaLabel: register(new EditorStringOption(8 /* EditorOption.ariaLabel */, 'ariaLabel', nls.localize(582, null))),
    ...
    autoClosingBrackets: register(new EditorStringEnumOption(10 /* EditorOption.autoClosingBrackets */, 'autoClosingBrackets', 'languageDefined', ['always', 'languageDefined', 'beforeWhitespace', 'never'], {
        enumDescriptions: [
            '',
            nls.localize(584, null),
            nls.localize(585, null),
            '',
        ],
        description: nls.localize(586, null)
    })),
    autoClosingComments: register(new EditorStringEnumOption(11 /* EditorOption.autoClosingComments */, 'autoClosingComments', 'languageDefined', ['always', 'languageDefined', 'beforeWhitespace', 'never'], {
        enumDescriptions: [
            '',
            nls.localize(587, null),
            nls.localize(588, null),
            '',
        ],
        description: nls.localize(589, null)
    })),
    autoClosingDelete: register(new EditorStringEnumOption(13 /* EditorOption.autoClosingDelete */, 'autoClosingDelete', 'auto', ['always', 'auto', 'never'], {
        ...
        description: nls.localize(591, null)
    })),
    autoClosingOvertype: register(new EditorStringEnumOption(14 /* EditorOption.autoClosingOvertype */, 'autoClosingOvertype', 'auto', ['always', 'auto', 'never'], {
        enumDescriptions: [
            '',
            nls.localize(592, null),
            '',
        ],
        description: nls.localize(593, null)
    })),
    autoClosingQuotes: register(new EditorStringEnumOption(15 /* EditorOption.autoClosingQuotes */, 'autoClosingQuotes', 'languageDefined', ['always', 'languageDefined', 'beforeWhitespace', 'never'], {
        enumDescriptions: [
            '',
            nls.localize(594, null),
            nls.localize(595, null),
            '',
        ],
        description: nls.localize(596, null)
    })),
    autoIndent: register(new EditorEnumOption(16 /* EditorOption.autoIndent */, 'autoIndent', 4 /* EditorAutoIndentStrategy.Full */, 'full', ['none', 'keep', 'brackets', 'advanced', 'full'], _autoIndentFromString, {
        enumDescriptions: [
            ...
            nls.localize(600, null),
            nls.localize(601, null),
        ],
        description: nls.localize(602, null)
    })),
    autoIndentOnPaste: register(new EditorBooleanOption(17 /* EditorOption.autoIndentOnPaste */, 'autoIndentOnPaste', false, { description: nls.localize(603, null) })),
    autoIndentOnPasteWithinString: register(new EditorBooleanOption(18 /* EditorOption.autoIndentOnPasteWithinString */, 'autoIndentOnPasteWithinString', true, { description: nls.localize(604, null) })),
    ...
    autoSurround: register(new EditorStringEnumOption(20 /* EditorOption.autoSurround */, 'autoSurround', 'languageDefined', ['languageDefined', 'quotes', 'brackets', 'never'], {
        enumDescriptions: [
            ...
            nls.localize(606, null),
            nls.localize(607, null),
            ''
        ],
        description: nls.localize(608, null)
    })),
    bracketPairColorization: register(new BracketPairColorization()),
    bracketPairGuides: register(new GuideOptions()),
    stickyTabStops: register(new EditorBooleanOption(132 /* EditorOption.stickyTabStops */, 'stickyTabStops', false, { description: nls.localize(609, null) })),
    codeLens: register(new EditorBooleanOption(23 /* EditorOption.codeLens */, 'codeLens', true, { description: nls.localize(610, null) })),
    codeLensFontFamily: register(new EditorStringOption(24 /* EditorOption.codeLensFontFamily */, 'codeLensFontFamily', '', { description: nls.localize(611, null) })),
    codeLensFontSize: register(new EditorIntOption(25 /* EditorOption.codeLensFontSize */, 'codeLensFontSize', 0, 0, 100, {
        type: 'number',
        default: 0,
        minimum: 0,
        maximum: 100,
        markdownDescription: nls.localize(612, null)
    })),
    colorDecorators: register(new EditorBooleanOption(26 /* EditorOption.colorDecorators */, 'colorDecorators', true, { description: nls.localize(613, null) })),
    colorDecoratorActivatedOn: register(new EditorStringEnumOption(168 /* EditorOption.colorDecoratorsActivatedOn */, 'colorDecoratorsActivatedOn', 'clickAndHover', ['clickAndHover', 'hover', 'click'], {
        enumDescriptions: [
            nls.localize(614, null),
            nls.localize(615, null),
            nls.localize(616, null)
        ],
        description: nls.localize(617, null)
    })),
    colorDecoratorsLimit: register(new EditorIntOption(27 /* EditorOption.colorDecoratorsLimit */, 'colorDecoratorsLimit', 500, 1, 1000000, {
        markdownDescription: nls.localize(618, null)
    })),
    columnSelection: register(new EditorBooleanOption(28 /* EditorOption.columnSelection */, 'columnSelection', false, { description: nls.localize(619, null) })),
    comments: register(new EditorComments()),
    contextmenu: register(new EditorBooleanOption(30 /* EditorOption.contextmenu */, 'contextmenu', true)),
    copyWithSyntaxHighlighting: register(new EditorBooleanOption(31 /* EditorOption.copyWithSyntaxHighlighting */, 'copyWithSyntaxHighlighting', true, { description: nls.localize(620, null) })),
    cursorBlinking: register(new EditorEnumOption(32 /* EditorOption.cursorBlinking */, 'cursorBlinking', 1 /* TextEditorCursorBlinkingStyle.Blink */, 'blink', ['blink', 'smooth', 'phase', 'expand', 'solid'], cursorBlinkingStyleFromString, { description: nls.localize(621, null) })),
    cursorSmoothCaretAnimation: register(new EditorStringEnumOption(33 /* EditorOption.cursorSmoothCaretAnimation */, 'cursorSmoothCaretAnimation', 'off', ['off', 'explicit', 'on'], {
        enumDescriptions: [
            ...
            nls.localize(623, null),
            nls.localize(624, null)
        ],
        description: nls.localize(625, null)
    })),
    cursorStyle: register(new EditorEnumOption(34 /* EditorOption.cursorStyle */, 'cursorStyle', TextEditorCursorStyle.Line, 'line', ['line', 'block', 'underline', 'line-thin', 'block-outline', 'underline-thin'], cursorStyleFromString, { description: nls.localize(626, null) })),
    overtypeCursorStyle: register(new EditorEnumOption(92 /* EditorOption.overtypeCursorStyle */, 'overtypeCursorStyle', TextEditorCursorStyle.Block, 'block', ['line', 'block', 'underline', 'line-thin', 'block-outline', 'underline-thin'], cursorStyleFromString, { description: nls.localize(627, null) })),
    cursorSurroundingLines: register(new EditorIntOption(35 /* EditorOption.cursorSurroundingLines */, 'cursorSurroundingLines', 0, 0, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */, { description: nls.localize(628, null) })),
    cursorSurroundingLinesStyle: register(new EditorStringEnumOption(36 /* EditorOption.cursorSurroundingLinesStyle */, 'cursorSurroundingLinesStyle', 'default', ['default', 'all'], {
        enumDescriptions: [
            nls.localize(629, null),
            nls.localize(630, null)
        ],
        markdownDescription: nls.localize(631, null)
    })),
    cursorWidth: register(new EditorIntOption(37 /* EditorOption.cursorWidth */, 'cursorWidth', 0, 0, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */, { markdownDescription: nls.localize(632, null) })),
    cursorHeight: register(new EditorIntOption(38 /* EditorOption.cursorHeight */, 'cursorHeight', 0, 0, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */, { markdownDescription: nls.localize(633, null) })),
    ...
    doubleClickSelectsBlock: register(new EditorBooleanOption(173 /* EditorOption.doubleClickSelectsBlock */, 'doubleClickSelectsBlock', true, { description: nls.localize(634, null) })),
    dragAndDrop: register(new EditorBooleanOption(42 /* EditorOption.dragAndDrop */, 'dragAndDrop', true, { description: nls.localize(635, null) })),
    emptySelectionClipboard: register(new EditorEmptySelectionClipboard()),
    dropIntoEditor: register(new EditorDropIntoEditor()),
    editContext: register(new EditorBooleanOption(44 /* EditorOption.editContext */, 'editContext', true, {
        description: nls.localize(636, null),
    ...
    renderRichScreenReaderContent: register(new EditorBooleanOption(107 /* EditorOption.renderRichScreenReaderContent */, 'renderRichScreenReaderContent', false, {
        markdownDescription: nls.localize(637, null),
    })),
    ...
    experimentalGpuAcceleration: register(new EditorStringEnumOption(46 /* EditorOption.experimentalGpuAcceleration */, 'experimentalGpuAcceleration', 'off', ['off', 'on'], {
        tags: ['experimental'],
        enumDescriptions: [
            nls.localize(638, null),
            nls.localize(639, null),
        ],
        description: nls.localize(640, null)
    })),
    experimentalWhitespaceRendering: register(new EditorStringEnumOption(47 /* EditorOption.experimentalWhitespaceRendering */, 'experimentalWhitespaceRendering', 'svg', ['svg', 'font', 'off'], {
        enumDescriptions: [
            nls.localize(641, null),
            nls.localize(642, null),
            nls.localize(643, null),
        ],
        description: nls.localize(644, null)
    })),
    extraEditorClassName: register(new EditorStringOption(48 /* EditorOption.extraEditorClassName */, 'extraEditorClassName', '')),
    fastScrollSensitivity: register(new EditorFloatOption(49 /* EditorOption.fastScrollSensitivity */, 'fastScrollSensitivity', 5, x => (x <= 0 ? 5 : x), { markdownDescription: nls.localize(645, null) })),
    ...
    folding: register(new EditorBooleanOption(52 /* EditorOption.folding */, 'folding', true, { description: nls.localize(646, null) })),
    foldingStrategy: register(new EditorStringEnumOption(53 /* EditorOption.foldingStrategy */, 'foldingStrategy', 'auto', ['auto', 'indentation'], {
        enumDescriptions: [
            ...
            nls.localize(648, null),
        ],
        description: nls.localize(649, null)
    })),
    foldingHighlight: register(new EditorBooleanOption(54 /* EditorOption.foldingHighlight */, 'foldingHighlight', true, { description: nls.localize(650, null) })),
    foldingImportsByDefault: register(new EditorBooleanOption(55 /* EditorOption.foldingImportsByDefault */, 'foldingImportsByDefault', false, { description: nls.localize(651, null) })),
    ...
    { description: nls.localize(652, null) })),
    unfoldOnClickAfterEndOfLine: register(new EditorBooleanOption(57 /* EditorOption.unfoldOnClickAfterEndOfLine */, 'unfoldOnClickAfterEndOfLine', false, { description: nls.localize(653, null) })),
    fontFamily: register(new EditorStringOption(58 /* EditorOption.fontFamily */, 'fontFamily', EDITOR_FONT_DEFAULTS.fontFamily, { description: nls.localize(654, null) })),
    fontInfo: register(new EditorFontInfo()),
    fontLigatures2: register(new EditorFontLigatures()),
    fontSize: register(new EditorFontSize()),
    fontWeight: register(new EditorFontWeight()),
    fontVariations: register(new EditorFontVariations()),
    formatOnPaste: register(new EditorBooleanOption(64 /* EditorOption.formatOnPaste */, 'formatOnPaste', false, { description: nls.localize(655, null) })),
    formatOnType: register(new EditorBooleanOption(65 /* EditorOption.formatOnType */, 'formatOnType', false, { description: nls.localize(656, null) })),
    glyphMargin: register(new EditorBooleanOption(66 /* EditorOption.glyphMargin */, 'glyphMargin', true, { description: nls.localize(657, null) })),
    gotoLocation: register(new EditorGoToLocation()),
    hideCursorInOverviewRuler: register(new EditorBooleanOption(68 /* EditorOption.hideCursorInOverviewRuler */, 'hideCursorInOverviewRuler', false, { description: nls.localize(658, null) })),
    hover: register(new EditorHover()),
    inDiffEditor: register(new EditorBooleanOption(70 /* EditorOption.inDiffEditor */, 'inDiffEditor', false)),
    inertialScroll: register(new EditorBooleanOption(158 /* EditorOption.inertialScroll */, 'inertialScroll', false, { description: nls.localize(659, null) })),
    letterSpacing: register(new EditorFloatOption(72 /* EditorOption.letterSpacing */, 'letterSpacing', EDITOR_FONT_DEFAULTS.letterSpacing, x => EditorFloatOption.clamp(x, -5, 20), { description: nls.localize(660, null) })),
    ...
    linkedEditing: register(new EditorBooleanOption(78 /* EditorOption.linkedEditing */, 'linkedEditing', false, { description: nls.localize(661, null) })),
    links: register(new EditorBooleanOption(79 /* EditorOption.links */, 'links', true, { description: nls.localize(662, null) })),
    matchBrackets: register(new EditorStringEnumOption(80 /* EditorOption.matchBrackets */, 'matchBrackets', 'always', ['always', 'near', 'never'], { description: nls.localize(663, null) })),
    minimap: register(new EditorMinimap()),
    mouseStyle: register(new EditorStringEnumOption(82 /* EditorOption.mouseStyle */, 'mouseStyle', 'text', ['text', 'default', 'copy'])),
    mouseWheelScrollSensitivity: register(new EditorFloatOption(83 /* EditorOption.mouseWheelScrollSensitivity */, 'mouseWheelScrollSensitivity', 1, x => (x === 0 ? 1 : x), { markdownDescription: nls.localize(664, null) })),
    mouseWheelZoom: register(new EditorBooleanOption(84 /* EditorOption.mouseWheelZoom */, 'mouseWheelZoom', false, {
        markdownDescription: platform.isMacintosh
            ? nls.localize(665, null)
            : nls.localize(666, null)
    })),
    multiCursorMergeOverlapping: register(new EditorBooleanOption(85 /* EditorOption.multiCursorMergeOverlapping */, 'multiCursorMergeOverlapping', true, { description: nls.localize(667, null) })),
    multiCursorModifier: register(new EditorEnumOption(86 /* EditorOption.multiCursorModifier */, 'multiCursorModifier', 'altKey', 'alt', ['ctrlCmd', 'alt'], _multiCursorModifierFromString, {
        markdownEnumDescriptions: [
            nls.localize(668, null),
            nls.localize(669, null)
        ],
        markdownDescription: nls.localize(670, null)
    ...
    mouseMiddleClickAction: register(new EditorStringEnumOption(87 /* EditorOption.mouseMiddleClickAction */, 'mouseMiddleClickAction', 'default', ['default', 'openLink', 'ctrlLeftClick'], { description: nls.localize(671, null) })),
    multiCursorPaste: register(new EditorStringEnumOption(88 /* EditorOption.multiCursorPaste */, 'multiCursorPaste', 'spread', ['spread', 'full'], {
        markdownEnumDescriptions: [
            nls.localize(672, null),
            nls.localize(673, null)
        ],
        markdownDescription: nls.localize(674, null)
    })),
    multiCursorLimit: register(new EditorIntOption(89 /* EditorOption.multiCursorLimit */, 'multiCursorLimit', 10000, 1, 100000, {
        markdownDescription: nls.localize(675, null)
    })),
    occurrencesHighlight: register(new EditorStringEnumOption(90 /* EditorOption.occurrencesHighlight */, 'occurrencesHighlight', 'singleFile', ['off', 'singleFile', 'multiFile'], {
        markdownEnumDescriptions: [
            nls.localize(676, null),
            nls.localize(677, null),
            nls.localize(678, null)
        ],
        markdownDescription: nls.localize(679, null)
    })),
    occurrencesHighlightDelay: register(new EditorIntOption(91 /* EditorOption.occurrencesHighlightDelay */, 'occurrencesHighlightDelay', 0, 0, 2000, {
        description: nls.localize(680, null),
        tags: ['preview']
    })),
    overtypeOnPaste: register(new EditorBooleanOption(93 /* EditorOption.overtypeOnPaste */, 'overtypeOnPaste', true, { description: nls.localize(681, null) })),
    overviewRulerBorder: register(new EditorBooleanOption(94 /* EditorOption.overviewRulerBorder */, 'overviewRulerBorder', true, { description: nls.localize(682, null) })),
    ...
    definitionLinkOpensInPeek: register(new EditorBooleanOption(101 /* EditorOption.definitionLinkOpensInPeek */, 'definitionLinkOpensInPeek', false, { description: nls.localize(686, null) })),
    ...
    quickSuggestionsDelay: register(new EditorIntOption(103 /* EditorOption.quickSuggestionsDelay */, 'quickSuggestionsDelay', 10, 0, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */, {
        description: nls.localize(687, null),
        experiment: {
            mode: 'auto'
        }
    })),
    ...
    renameOnType: register(new EditorBooleanOption(106 /* EditorOption.renameOnType */, 'renameOnType', false, { description: nls.localize(688, null), markdownDeprecationMessage: nls.localize(689, null) })),
    renderControlCharacters: register(new EditorBooleanOption(108 /* EditorOption.renderControlCharacters */, 'renderControlCharacters', true, { description: nls.localize(690, null), restricted: true })),
    renderFinalNewline: register(new EditorStringEnumOption(109 /* EditorOption.renderFinalNewline */, 'renderFinalNewline', (platform.isLinux ? 'dimmed' : 'on'), ['off', 'on', 'dimmed'], { description: nls.localize(691, null) })),
    renderLineHighlight: register(new EditorStringEnumOption(110 /* EditorOption.renderLineHighlight */, 'renderLineHighlight', 'line', ['none', 'gutter', 'line', 'all'], {
        enumDescriptions: [
            ...
            '',
            '',
            nls.localize(692, null),
        ],
        description: nls.localize(693, null)
    })),
    renderLineHighlightOnlyWhenFocus: register(new EditorBooleanOption(111 /* EditorOption.renderLineHighlightOnlyWhenFocus */, 'renderLineHighlightOnlyWhenFocus', false, { description: nls.localize(694, null) })),
    ...
    renderWhitespace: register(new EditorStringEnumOption(113 /* EditorOption.renderWhitespace */, 'renderWhitespace', 'selection', ['none', 'boundary', 'selection', 'trailing', 'all'], {
        enumDescriptions: [
            '',
            nls.localize(695, null),
            nls.localize(696, null),
            nls.localize(697, null),
            ''
        ],
        description: nls.localize(698, null)
    })),
    ...
    roundedSelection: register(new EditorBooleanOption(115 /* EditorOption.roundedSelection */, 'roundedSelection', true, { description: nls.localize(699, null) })),
    rulers: register(new EditorRulers()),
    scrollbar: register(new EditorScrollbar()),
    scrollBeyondLastColumn: register(new EditorIntOption(118 /* EditorOption.scrollBeyondLastColumn */, 'scrollBeyondLastColumn', 4, 0, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */, { description: nls.localize(700, null) })),
    scrollBeyondLastLine: register(new EditorBooleanOption(119 /* EditorOption.scrollBeyondLastLine */, 'scrollBeyondLastLine', true, { description: nls.localize(701, null) })),
    scrollOnMiddleClick: register(new EditorBooleanOption(171 /* EditorOption.scrollOnMiddleClick */, 'scrollOnMiddleClick', false, { description: nls.localize(702, null) })),
    scrollPredominantAxis: register(new EditorBooleanOption(120 /* EditorOption.scrollPredominantAxis */, 'scrollPredominantAxis', true, { description: nls.localize(703, null) })),
    selectionClipboard: register(new EditorBooleanOption(121 /* EditorOption.selectionClipboard */, 'selectionClipboard', true, {
        description: nls.localize(704, null),
        included: platform.isLinux
    })),
    selectionHighlight: register(new EditorBooleanOption(122 /* EditorOption.selectionHighlight */, 'selectionHighlight', true, { description: nls.localize(705, null) })),
    selectionHighlightMaxLength: register(new EditorIntOption(123 /* EditorOption.selectionHighlightMaxLength */, 'selectionHighlightMaxLength', 200, 0, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */, { description: nls.localize(706, null) })),
    selectionHighlightMultiline: register(new EditorBooleanOption(124 /* EditorOption.selectionHighlightMultiline */, 'selectionHighlightMultiline', false, { description: nls.localize(707, null) })),
    ...
    showFoldingControls: register(new EditorStringEnumOption(126 /* EditorOption.showFoldingControls */, 'showFoldingControls', 'mouseover', ['always', 'never', 'mouseover'], {
        enumDescriptions: [
            ...
            nls.localize(710, null),
        ],
        description: nls.localize(711, null)
    })),
    showUnused: register(new EditorBooleanOption(127 /* EditorOption.showUnused */, 'showUnused', true, { description: nls.localize(712, null) })),
    showDeprecated: register(new EditorBooleanOption(157 /* EditorOption.showDeprecated */, 'showDeprecated', true, { description: nls.localize(713, null) })),
    ...
    snippetSuggestions: register(new EditorStringEnumOption(128 /* EditorOption.snippetSuggestions */, 'snippetSuggestions', 'inline', ['top', 'bottom', 'inline', 'none'], {
        enumDescriptions: [
            nls.localize(714, null),
            nls.localize(715, null),
            nls.localize(716, null),
            nls.localize(717, null),
        ],
        description: nls.localize(718, null)
    })),
    smartSelect: register(new SmartSelect()),
    smoothScrolling: register(new EditorBooleanOption(130 /* EditorOption.smoothScrolling */, 'smoothScrolling', false, { description: nls.localize(719, null) })),
    ...
    inlineCompletionsAccessibilityVerbose: register(new EditorBooleanOption(169 /* EditorOption.inlineCompletionsAccessibilityVerbose */, 'inlineCompletionsAccessibilityVerbose', false, { description: nls.localize(720, null) })),
    suggestFontSize: register(new EditorIntOption(135 /* EditorOption.suggestFontSize */, 'suggestFontSize', 0, 0, 1000, { markdownDescription: nls.localize(721, null, '`0`', '`#editor.fontSize#`') })),
    suggestLineHeight: register(new EditorIntOption(136 /* EditorOption.suggestLineHeight */, 'suggestLineHeight', 0, 0, 1000, { markdownDescription: nls.localize(722, null, '`0`', '`#editor.lineHeight#`') })),
    suggestOnTriggerCharacters: register(new EditorBooleanOption(137 /* EditorOption.suggestOnTriggerCharacters */, 'suggestOnTriggerCharacters', true, { description: nls.localize(723, null) })),
    suggestSelection: register(new EditorStringEnumOption(138 /* EditorOption.suggestSelection */, 'suggestSelection', 'first', ['first', 'recentlyUsed', 'recentlyUsedByPrefix'], {
        markdownEnumDescriptions: [
            ...
            nls.localize(726, null),
        ],
        description: nls.localize(727, null)
    })),
    tabCompletion: register(new EditorStringEnumOption(139 /* EditorOption.tabCompletion */, 'tabCompletion', 'off', ['on', 'off', 'onlySnippets'], {
        enumDescriptions: [
            nls.localize(728, null),
            nls.localize(729, null),
            nls.localize(730, null),
        ],
        description: nls.localize(731, null)
    })),
    tabIndex: register(new EditorIntOption(140 /* EditorOption.tabIndex */, 'tabIndex', 0, -1, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */)),
    trimWhitespaceOnDelete: register(new EditorBooleanOption(141 /* EditorOption.trimWhitespaceOnDelete */, 'trimWhitespaceOnDelete', false, { description: nls.localize(732, null) })),
    ...
    unusualLineTerminators: register(new EditorStringEnumOption(143 /* EditorOption.unusualLineTerminators */, 'unusualLineTerminators', 'prompt', ['auto', 'off', 'prompt'], {
        enumDescriptions: [
            nls.localize(733, null),
            nls.localize(734, null),
            nls.localize(735, null),
        ],
        description: nls.localize(736, null)
    })),
    useShadowDOM: register(new EditorBooleanOption(144 /* EditorOption.useShadowDOM */, 'useShadowDOM', true)),
    useTabStops: register(new EditorBooleanOption(145 /* EditorOption.useTabStops */, 'useTabStops', true, { description: nls.localize(737, null) })),
    wordBreak: register(new EditorStringEnumOption(146 /* EditorOption.wordBreak */, 'wordBreak', 'normal', ['normal', 'keepAll'], {
        markdownEnumDescriptions: [
            nls.localize(738, null),
            nls.localize(739, null),
        ],
        description: nls.localize(740, null)
    })),
    wordSegmenterLocales: register(new WordSegmenterLocales()),
    wordSeparators: register(new EditorStringOption(148 /* EditorOption.wordSeparators */, 'wordSeparators', USUAL_WORD_SEPARATORS, { description: nls.localize(741, null) })),
    wordWrap: register(new EditorStringEnumOption(149 /* EditorOption.wordWrap */, 'wordWrap', 'off', ['off', 'on', 'wordWrapColumn', 'bounded'], {
        markdownEnumDescriptions: [
            nls.localize(742, null),
            nls.localize(743, null),
            nls.localize(744, null),





            nls.localize(745, null),
        ...
        description: nls.localize(746, null)
    ...
    wordWrapColumn: register(new EditorIntOption(152 /* EditorOption.wordWrapColumn */, 'wordWrapColumn', 80, 1, 1073741824 /* Constants.MAX_SAFE_SMALL_INTEGER */, {
        markdownDescription: nls.localize(747, null)
    ...
    wrapOnEscapedLineFeeds: register(new EditorBooleanOption(160 /* EditorOption.wrapOnEscapedLineFeeds */, 'wrapOnEscapedLineFeeds', false, { markdownDescription: nls.localize(748, null) })),
    // Leave these at the end (because they have dependencies!)
    ...
    defaultColorDecorators: register(new EditorStringEnumOption(167 /* EditorOption.defaultColorDecorators */, 'defaultColorDecorators', 'auto', ['auto', 'always', 'never'], {
        enumDescriptions: [
            nls.localize(749, null),
            nls.localize(750, null),
            nls.localize(751, null),
        ],
        description: nls.localize(752, null)
    })),
    pixelRatio: register(new EditorPixelRatio()),
    tabFocusMode: register(new EditorBooleanOption(164 /* EditorOption.tabFocusMode */, 'tabFocusMode', false, { markdownDescription: nls.localize(753, null) })),
