...
class SharedProcessMain extends Disposable {
    ...
    async initServices() {
        ...
        // Log
        const sharedLogGroup = { id: 'shared', name: localize(187, null) };
        const logger = this._register(loggerService.createLogger('sharedprocess', { name: localize(188, null), group: sharedLogGroup }));
        ...
        // Request
        const networkLogger = this._register(loggerService.createLogger(`network-shared`, { name: localize(189, null), group: sharedLogGroup }));
