...
class ConnectionState extends Disposable {
    constructor(clientId, name, logService) {
        super();
        this.name = name;
...
let RemoteAgentHostContribution = class RemoteAgentHostContribution extends Disposable {
    ...
    constructor(_remoteAgentHostService, _chatSessionsService, _languageModelsService, _logService, _outputService, _instantiationService, _authenticationService, _defaultAccountService, _sessionsManagementService, _fileService) {
        super();
    ...
    _registerAgent(address, connection, agent, configuredName) {
        ...
        const listController = agentStore.add(this._instantiationService.createInstance(AgentHostSessionListController, sessionType, agent.provider, connection, displayName));
    ...
    async _pushAuthToken(connection) {
        try {
...
RemoteAgentHostContribution = __decorate([
    ...
    __param(7, IDefaultAccountService),
...
//# sourceMappingURL=remoteAgentHost.contribution.js.map