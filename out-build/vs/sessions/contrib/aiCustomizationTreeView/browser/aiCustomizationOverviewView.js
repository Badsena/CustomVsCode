...
let AICustomizationOverviewView = class AICustomizationOverviewView extends ViewPane {
    constructor(options, keybindingService, contextMenuService, configurationService, contextKeyService, viewDescriptorService, instantiationService, openerService, themeService, hoverService, editorService, promptsService, workspaceContextService, workspaceService, mcpService, agentPluginService) {
        ...
        // Initialize sections
        this.sections.push({ id: AICustomizationManagementSection.Agents, label: localize(3040, null), icon: agentIcon, count: 0 }, { id: AICustomizationManagementSection.Skills, label: localize(3041, null), icon: skillIcon, count: 0 }, { id: AICustomizationManagementSection.Instructions, label: localize(3042, null), icon: instructionsIcon, count: 0 }, { id: AICustomizationManagementSection.Prompts, label: localize(3043, null), icon: promptIcon, count: 0 }, { id: AICustomizationManagementSection.McpServers, label: localize(3044, null), icon: mcpServerIcon, count: 0 }, { id: AICustomizationManagementSection.Plugins, label: localize(3045, null), icon: pluginIcon, count: 0 });
        // Listen to changes
    ...
    renderSections() {
        ...
        for (const section of this.sections) {
            ...
            this._register(this.hoverService.setupDelayedHoverAtMouse(sectionElement, () => ({
                content: localize(3046, null, section.label),
