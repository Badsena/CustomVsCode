        ...
        for (const [index, config] of CUSTOMIZATION_ITEMS.entries()) {
            ...
            this._register(registerAction2(class extends Action2 {
                constructor() {
                    super({
                        id: config.id,
                        title: localize2(3298, '{0}', config.label),
                        menu: {
