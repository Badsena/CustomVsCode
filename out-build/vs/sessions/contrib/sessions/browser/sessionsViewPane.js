...
let AgenticSessionsViewPane = class AgenticSessionsViewPane extends ViewPane {
    constructor(options, keybindingService, contextMenuService, configurationService, contextKeyService, viewDescriptorService, instantiationService, openerService, themeService, hoverService, layoutService, activeSessionService, hostService, storageService) {
        ...
        const stored = this.storageService.get(GROUPING_STORAGE_KEY, 0 /* StorageScope.PROFILE */);
    ...
    createControls(parent) {
        ...
        const sessionsFilter = this._register(this.instantiationService.createInstance(AgentSessionsFilter, {
            ...
            providerLabelOverrides: new Map([
                [AgentSessionProviders.Background, localize(3306, null)],
            ]),
        }));
        ...
        newSessionButton.label = localize(3307, null);
    ...
    getSessionHoverPosition() {
        ...
        return {
            [0 /* ViewContainerLocation.Sidebar */]: sideBarPosition === 0 ? 1 /* HoverPosition.RIGHT */ : 0 /* HoverPosition.LEFT */,
            [2 /* ViewContainerLocation.AuxiliaryBar */]: sideBarPosition === 0 ? 0 /* HoverPosition.LEFT */ : 1 /* HoverPosition.RIGHT */,
            [3 /* ViewContainerLocation.ChatBar */]: 1 /* HoverPosition.RIGHT */,
            [1 /* ViewContainerLocation.Panel */]: 3 /* HoverPosition.ABOVE */
        }[viewLocation ?? 2 /* ViewContainerLocation.AuxiliaryBar */];
    }
...
export { AgenticSessionsViewPane };
...
registerAction2(class CloseSessionAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3308, "Close Session"),
            f1: true,
...
MenuRegistry.appendMenuItem(MenuId.ViewTitle, {
    ...
    title: localize2(3309, "Filter Sessions"),
    group: 'navigation',
    order: 3,
    icon: Codicon.filter,
...
registerAction2(class GroupByRepositoryAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3310, "Group by Repository"),
            icon: Codicon.repo,
            category: SessionsCategories.Sessions,
            menu: [{
                    id: MenuId.ViewTitle,
...
registerAction2(class GroupByDateAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3311, "Group by Date"),
...
registerAction2(class RefreshAgentSessionsViewerAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3312, "Refresh Sessions"),
...
registerAction2(class FindAgentSessionInViewerAction extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(3313, "Find Session"),
            icon: Codicon.search,
            menu: [{
                    id: MenuId.ViewTitle,
                    group: 'navigation',
