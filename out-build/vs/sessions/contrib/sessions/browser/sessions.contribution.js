...
const agentSessionsViewIcon = registerIcon('chat-sessions-icon', Codicon.commentDiscussionSparkle, localize(3299, null));
const AGENT_SESSIONS_VIEW_TITLE = localize2(3300, "Sessions");
