...
export const serverOptions = {
    /* ----- server setup ----- */
    'host': { type: 'string', cat: 'o', args: 'ip-address', description: nls.localize(2907, null) },
    'port': { type: 'string', cat: 'o', args: 'port | port range', description: nls.localize(2908, null) },
    'socket-path': { type: 'string', cat: 'o', args: 'path', description: nls.localize(2909, null) },
    'server-base-path': { type: 'string', cat: 'o', args: 'path', description: nls.localize(2910, null) },
    'connection-token': { type: 'string', cat: 'o', args: 'token', deprecates: ['connectionToken'], description: nls.localize(2911, null) },
    'connection-token-file': { type: 'string', cat: 'o', args: 'path', deprecates: ['connection-secret', 'connectionTokenFile'], description: nls.localize(2912, null) },
    'without-connection-token': { type: 'boolean', cat: 'o', description: nls.localize(2913, null) },
    'disable-websocket-compression': { type: 'boolean' },
    'print-startup-performance': { type: 'boolean' },
    'print-ip-address': { type: 'boolean' },
    'accept-server-license-terms': { type: 'boolean', cat: 'o', description: nls.localize(2914, null) },
    'server-data-dir': { type: 'string', cat: 'o', description: nls.localize(2915, null) },
    'telemetry-level': { type: 'string', cat: 'o', args: 'level', description: nls.localize(2916, null) },
    /* ----- vs code options ---	-- */
    ...
    'default-folder': { type: 'string', description: nls.localize(2917, null) },
    'default-workspace': { type: 'string', description: nls.localize(2918, null) },
    ...
    'start-server': { type: 'boolean', cat: 'e', description: nls.localize(2919, null) },
    /* ----- remote development options ----- */
    'enable-remote-auto-shutdown': { type: 'boolean' },
    'remote-auto-shutdown-without-delay': { type: 'boolean' },
    'inspect-ptyhost': { type: 'string', allowEmptyValue: true },
    'agent-host-port': { type: 'string', cat: 'o', args: 'port', description: nls.localize(2920, null) },
    'agent-host-path': { type: 'string', cat: 'o', args: 'path', description: nls.localize(2921, null) },
    'use-host-proxy': { type: 'boolean' },
    'without-browser-env-var': { type: 'boolean' },
    'reconnection-grace-time': { type: 'string', cat: 'o', args: 'seconds', description: nls.localize(2922, null) },
    /* ----- server cli ----- */
    'help': OPTIONS['help'],
